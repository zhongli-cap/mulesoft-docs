...
- Adding customization of the move to filename as a complement of the moveToDirectory setting 
- Adding zero-sized files support
- Reading thread pool limited by the smallest between maxConcurrentReads setting and the file match count
