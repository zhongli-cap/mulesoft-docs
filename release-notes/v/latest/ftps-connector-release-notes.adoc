...
link:/mule-user-guide/v/3.8/ftps-connector[FTPS Connector Guide]


== Version 1.0.8 - September 23, 2016

Release Notes for version 1.0.8 of the FTPS connector. These Release Notes accompany the link:/mule-user-guide/v/3.8/ftps-connector[FTPS Connector Guide].
...
Release Notes for version 1.0.7 of the FTPS connector. These Release Notes accompany the link:/mule-user-guide/v/3.8/ftps-connector[user guide].
...
- Learn how to Install and Configure Anypoint Connectors in Anypoint Studio link:i/mule-user-guide/v/3.8/installing-connectors[Installing Connectors].
