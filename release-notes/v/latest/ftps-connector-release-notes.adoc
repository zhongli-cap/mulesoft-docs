...
- Fixed error reported when trying to append contents to a non existing file (https://www.mulesoft.org/jira/browse/SE-6852[SE-6852]).
- Fixed potential thread leak on file size change detection.
