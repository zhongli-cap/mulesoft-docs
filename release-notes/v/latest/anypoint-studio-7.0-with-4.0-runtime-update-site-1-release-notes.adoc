...
Users must migrate Mule 3 projects to Mule 4 manually, before they can be used in Studio 7. See link:/mule-user-guide/v/4.1/mule-4-changes[Mule Runtime 4.0 Changes] for a list of changes.
