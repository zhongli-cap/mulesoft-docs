...
This release includes new API Manager features, support for link:/release-notes/api-designer-release-notes#api-designer-0-3-0-release-notes[API Designer 0.3], and bug fixes.

=== New Features

* API Manager 1.14.1 includes the capability to link:/api-manager/using-api-alerts[set alerts] for policy violations, response time, count, and codes.
* Advanced configuration support to customize the response timeout of the auto-generated proxy, which is a client proxy for the service with which you want to communicate.

To customize the response timeout of the auto-generated proxy you are creating for deployment. From the link:/api-manager/tutorial-set-up-and-deploy-an-api-proxy#navigate-to-the-api-version-details-page[API version details page] in Anypoint Platform, expand *Advanced Options* in the *Configure endpoint* dialog. In *Response Timeout*, type a value in milliseconds. 

=== Resolved Issues

* Fixed auto-generated proxy configured to incorrect WSDL defect. 
* Fixed problems with import/export of an API on Windows.
* API Designer v0.3 support

== API Manager 1.14.0

November 19, 2016

This release includes a improvements and bug fixes.
