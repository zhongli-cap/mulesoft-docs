...
* You can now specify a client ID and client secret when you create an API in API Manager. API Manager uses the credentials you specify instead of generating a unique 32-digit string.
