...
* You can now specify a client ID and client secret when you create a client application using API Manager's API. API Manager uses the credentials you specify instead of generating a unique 32-digit string.
