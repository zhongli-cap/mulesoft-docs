...
This release includes a new feature, improvements, and bug fixes.

=== New Feature

API Manager 1.14.0 includes the capability to link:/api-manager/using-api-alerts[set alerts] for policy violations, response time, count, and codes.
