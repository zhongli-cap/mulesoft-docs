...
+
To customize the response timeout of the auto-generated proxy deploy, use the advanced options as described in step 5 of section, "link:/api-manager/setting-up-an-api-proxy#setting-up-a-proxy[Setting up a Proxy]".
