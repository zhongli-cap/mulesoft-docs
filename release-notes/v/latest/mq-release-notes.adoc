...
Locations where MQ is available: Northern Virginia (us-east-1), Ireland (eu-west-1), London (eu-west-2), Singapore (ap-southeast-1), Sydney (ap-southeast-2), Central Canada (ca-central-1), and Oregon (us-west-2).
