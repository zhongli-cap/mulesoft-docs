...
This release also lets you forbid agents in a broker by specifying a comma-separated property in the deploy
properties of the Anypoint MQ connector. If MuleSoft makes a change in the broker that is no longer compatible with a specific version of the connector, you can forbid that version.
...
|MQ-316 |Ability to forbid certain user agents in broker
|===
