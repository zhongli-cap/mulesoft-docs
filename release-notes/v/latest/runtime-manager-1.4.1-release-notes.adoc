...
* If a user deletes a server group or cluster, he/she will need to manually remove any alerts associated with it. If the Alerts aren't deleted, they will NOT be triggered.
