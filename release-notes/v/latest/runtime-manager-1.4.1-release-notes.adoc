...
*CHHYBRID-1523*: If a node belonging to a Server group or cluster, restarts and an application specific event occurs. The alert for that condition wont be triggered even if the node comes back up online and the event occurs.
