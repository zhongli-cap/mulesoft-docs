...
=== Compatibility
DevKit version 3.9.4 is compatible with:
...
Since this version, DevKit started to use *Mule 3.9.0* as the compile Mule Version,
this doesn't change the compatibility range from a DevKit based connector.
...
=== Compatibility
DevKit version 3.9.1 is compatible with:
