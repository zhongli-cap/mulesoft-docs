...
** SEC-298: Incorrect logs when deploying Mule's oAuth provider.
** SEC-304: LazyTransformedInputStream is not being closed causing a memory leak.
**	SEC-305: Wrong grant type with special characters should be scaped.
