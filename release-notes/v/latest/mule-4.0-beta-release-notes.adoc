...
For a detailed overview of what’s new in Mule 4, please see the link:/mule-user-guide/v/4.1/mule-runtime-updates[What’s New in Mule 4 guide].
...
+
See link:/mule-user-guide/v/4.1/dataweave2-syntax-changes[DataWeave 2.0 Syntax Changes] for a full list of these changes.
