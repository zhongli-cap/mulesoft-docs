= Mule Runtime 4.0 EA Release Notes
:keywords: mule, 4.0, runtime, release notes

*November 19, 2017*

This is an Early Access release of Mule 4.0.0. We do not recommend that existing Mule customers migrate applications to Mule 4 at this time. This release is suitable for the following scenarios:
...
* Custom policies can leverage Mule core concepts and language. See custom policies [link to docs]

Note that Mule 4 is only supported on the new API Manager. See new API Manager [link to docs in docs.mulesoft.com] for how to configure API Gateway.
