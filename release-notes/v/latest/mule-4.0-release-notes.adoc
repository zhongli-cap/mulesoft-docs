...
== What’s new?
This release contains only bug fixes. See link:/mule-user-guide/v/4.1/mule-runtime-updates[What’s New in Mule 4] for a complete overview of what’s included in Mule 4.

== Gateway 4
Gateway leverages many of the improvements added in Mule 4. See link:/mule-user-guide/v/4.1/mule-runtime-updates[What’s New in Mule 4] for a complete overview.
