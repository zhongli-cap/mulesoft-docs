...
At this time, not all of the third party modules you may have been using with previous versions of Mule ESB have been upgraded to work with Mule ESB 3.4.0. Refer to the link:/mule-user-guide/v/3.7/third-party-software-in-mule[Third-Party Software In Mule] for complete details.  mailto:support@mulesoft.com[Contact MuleSoft] if you have a question about a specific module.
