...
* Support for link:/release-notes/mule-runtime-3.8.0-m1-release-notes[Mule 3.8], which unifies the API Gateway runtime with the core Mule runtime, adds additional TLS capabilities, additional tuning parameters for batch, and improved error messages.
