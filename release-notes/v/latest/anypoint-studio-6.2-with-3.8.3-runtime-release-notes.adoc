...
[TIP]
--
Updating your Anypoint Studio version using the update site does not update the bundled version of the runtime. +
To get the latest runtime version after updating Studio follow link:/anypoint-studio/v/6/download-and-launch-anypoint-studio#updating-studio[hese steps].
--
