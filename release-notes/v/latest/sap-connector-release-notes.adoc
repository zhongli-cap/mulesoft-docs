...
|Mule Runtime|3.7.3 or higher
|SAP R/3|Release 3.0.13 or higher
|SAP ECC|6.0 EhP 7 (SAP_APPL 607) or higher
...
* Identified 'table' and 'structure' types, as well as IDoc segments, in DataSense

=== SAP Connector 3.0.0 Fixes

* Connection pooling now supported
* Made "Expiration Time" field available. When set to a value above "0", the connector should support connection pooling.
