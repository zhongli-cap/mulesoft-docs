...
In addition, we have also fixed various issues and improved the link:/quickstarts/implement-and-test#create-a-project-based-on-a-raml[API Import] / link:/api-manager/api-sync-reference[Sync] feature introduced in 6.0.0.
