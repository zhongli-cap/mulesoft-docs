...
API Manager continues to support generating a proxy for referencing the domain, as described in link:/api-gateway-rt/api-gateway-domain[API Gateway domain] documentation. 
