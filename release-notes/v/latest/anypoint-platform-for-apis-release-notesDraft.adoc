...
* AP-2258: A tooltip is now displayed when the full API name is truncated in the UI.
* AP-2293: The problem related to resetting the client secret when using Internet Explorer 11 has been resolved.
* AP-2317: A list of grant types are now displaed in the application sidebar. (AP-2317)
* AP-2378: An example or default value that you set in the RAML is no longer hidden in the console.
* AP-2384: The API Designer is no longer overriding example files. The import process now overrides example files when configured to do so.
