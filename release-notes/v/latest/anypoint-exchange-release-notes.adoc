...
* Store all integration assets in one place in Exchange (Best practices, integration patterns, API Fragments, API Specifications, Examples, Templates, and Connectors).
...
* EXC-1522: Incorrect error message when an user with no Exchange Contributor permission within a Business Group tries to create an asset.
