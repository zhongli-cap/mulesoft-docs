...
. Install the Workday connectors that your application requires from the `Anypoint Connectors Update Site`. In Studio 6.3.0 and later, select `https://repository.mulesoft.org/connectors/releases/3.5.0`. Follow the instructions in the "New users" section. Your application should be running as it was previously.
