...
* Refer to the link:/mule-user-guide/v/3.7/workday-connector-6.0-migration-guide[Workday Connector 6.0 or above Migration Guide]to learn how to upgrade to Workday connector v6.0 or above.
