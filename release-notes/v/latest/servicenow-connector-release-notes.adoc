= ServiceNow Connector 5.2.0 Release Notes
:keywords: servicenow, connector, release notes

*_Select_*

Release notes for version 5.2.0 of the ServiceNow connector.

*Guide*: link:/mule-user-guide/v/3.7/servicenow-connector-5.2.0[ServiceNow Connector v5.2.0].
...
== ServiceNow Connector 5.2.0 - March 2, 2016

The ServiceNow Connector facilitates connections between Mule integration and ServiceNow applications.  The ServiceNow Connector v5.2.0 allows you to perform seven standard operations (insert, update, get, getKeys, getRecords,  deleteMultiple, deleteRecord) on the standard as well as the custom ServiceNow tables, along with any operations available through the installed plugins.

=== Version 5.2.0 Compatibility

The ServiceNow connector 5.2.0 is compatible with:
...
*Guide:* link:/mule-user-guide/v/3.7/servicenow-connector[ServiceNow Connector Version 4.0.1 and Older]
