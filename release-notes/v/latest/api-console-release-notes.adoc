...
* Declaring Arrays using defining items.
* Partially blocked visibility of Tooltip for Traits help.
* An example defined for the Query parameter.
...
Bump JS RAML Parser to link:link:https://github.com/raml-org/raml-js-parser-2/releases/tag/1.1.31[v1.1.31]
