...
First take a look at the link:/mule-fundamentals/v/3.2/about-mule-configuration[Mule 2.0 Configuration Guide] to see how a 2.0 Mule config compares to a 1.4 config.
