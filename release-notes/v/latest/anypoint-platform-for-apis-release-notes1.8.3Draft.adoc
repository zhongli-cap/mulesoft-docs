...
In this release, some features that customers purchase from MuleSoft are no longer available on a free-trial basis. These API Entitlements are now available for purchase. Contact MuleSoft for information about purchasing or extending your trial usage of API Entitlements.
