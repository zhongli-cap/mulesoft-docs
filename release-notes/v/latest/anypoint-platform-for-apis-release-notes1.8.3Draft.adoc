...
In this release, some features that customers contract with MuleSoft to use are no longer available to everyone for free on the Anypoint Platform site. If you have not purchased API Entitlements, the following changes take effect:

* The credentials for your organization are no longer available from the *Organization* tab.
...
Contact MuleSoft for information about purchasing or extending your trial usage of these features.
