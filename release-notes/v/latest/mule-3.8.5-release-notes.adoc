...
Mule Runtime 3.8.5 includes API Gateway enhancements, resolves issues, and makes library changes.
...
Because you might not be consuming request streams in your existing apps, this release turns off streaming by default. Set the following system properties to override this default for all HTTP requests in a container:
