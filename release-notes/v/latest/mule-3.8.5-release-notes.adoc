...
* Introducing Open ID Connect support. If the organization is suitable configured, you may leverage the out-of-the-box oAuth token enforcement policy based on Open ID Connect.
