...
* https://mule4-docs.mulesoft.com/connectors/salesforce-connector[Salesforce Connector 9.0.0]
...
* Support for publishing platform event messages using the Publish Platform Event Message operation
* Added new metadata types
* Provided new operations for Convert Lead, Find Duplicates By Ids, Change Own Password

=== Version 8.4.0 Fixed in this Release

The Apex SOAP call now works when that reconnection is triggered.
