...
* With version 8.2.0 the name of the parameter given to operations that were expecting an object of type BatchInfo as input has been changed from batch-info to batch-to-retrieve and this affects existing apps using those operations, now it is changed back.
...
Now is changed back to how it was in the past:
