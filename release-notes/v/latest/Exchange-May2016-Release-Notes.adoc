...
This new version of Anypoint Exchange includes new features & functionality for addressing the viewing and publishing of artifacts across a hierarchical org structure. Also within this version of Exchange aligns with the Anypoint Platform Styles and use of the new Nav Bar.
...
* Ability of Central IT (maybe the root org) to create artifacts and make them available to all Lines of Businesses (sub orgs)
* Ability of Central IT to locate artifacts published in a sub org and make it available to the rest of the business
* Ability of an LOB to publish artifacts for internal (to that sub org) consumption
