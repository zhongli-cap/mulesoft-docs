...
|link:/release-notes/anypoint-studio-6.1-with-3.8.1-runtime-update-site-2-release-notes[Anypoint Studio 6.1 Update Site 2 with Mule 3.8.1 Release Notes] |A development environment that accelerates productivity for cloud and on-premises integration and API development.
