...
|link:/release-notes/anypoint-studio-6.2-with-3.8.2-runtime-release-notes[Anypoint Studio 6.2 Mule 3.8.2 Release Notes] |A development environment that accelerates productivity for cloud and on-premises integration and API development.
