...
|link:/release-notes/apikit-3.8.0-release-notes[APIkit 3.8.0] | A toolkit that facilitates implementing a REST or SOAP API.
...
*Documentation*: link:/runtime-manager/mule-agent[Mule Agent]
