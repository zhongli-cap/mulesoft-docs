...
== Version 1.1.0 - September 21, 2016

Included in this release:

* Added support to SAS based authentication (ie allow to avoid providing username/password at configuration settings)
* Fixed message processing and acknowledge to ensure zero message loss operation (ie at-least-once delivery behavior)
