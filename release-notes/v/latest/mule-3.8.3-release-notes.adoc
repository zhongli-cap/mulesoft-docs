...
|===
|Software |Version
|JDK |JRE 1.8.0 (Recommended JRE 1.8.0_92)
|OS |MacOS 10.11.4, AIX 7.2, Windows 2012 R2 Server, Windows 10, Solaris 11.3, RHEL 7.2, RHEL 6.7, RHEL 5.11, Ubuntu Server 16.04, 14.04
|Application Servers |Tomcat 8, WebLogic 12cR2, WildFly 9, WebSphere 8, Jetty 8, Jetty 9
|Databases |Oracle 11g, Oracle 12c, MySQL 5.7, DB2 10.1, PostgreSQL 9.4, Derby 10.11.1.1, Microsoft SQL Server 2014 SP1
|JMS Provider |Active MQ 5.11, WebSphere MQ 7 (7.5), IBM MQ
|===
