...
* Fixed broken behaviour in unique control number enforcement of EDIFACT and X12 documents
* Made query attribute in *search* optional
* Fixed critical bug where the export download continues indefinitely when the download attempts exceed 15 tries
