...
The Analytics release introduces the folowing capabilities.

* Dashboarding capabality and significantly improved user experience and charts for API Consumer analytics
