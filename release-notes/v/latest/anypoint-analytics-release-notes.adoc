...
----
== Version 1.20.1 - December 3, 2016 (upcoming release)

The Analytics 1.20.1 release enables the alerting engine for API alerts functionality. The API Alerts functionality will be announced on API Manager page.
