...
* *Missing fields in the response* - Marketo made multiple small changes in their REST API, resulting in some of our entities not mapping all of the new fields. These entities were updated. In addition, the connector no longer fails when there are unknown fields present in the response.
