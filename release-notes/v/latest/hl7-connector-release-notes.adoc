...
[IMPORTANT]
HL7 Healthcare Toolkit consists of HL7 EDI Connector v3.0.0 and HL7 MLLP v1.0.0. Please go to xxx for HL7 MLLP v1.0.0 release notes.
...
|HL7 | v2.1, v2.2, v2.3, v2.3.1, v2.4, v2.5, v2.5.1, v2.6, v2.7, v2.7.1, v2.8, v2.8
|===
