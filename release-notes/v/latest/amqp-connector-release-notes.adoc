...
[IMPORTANT]
To support Exchange 2.0 properly, the feature ID of AMQP Connector has changed. Before you download  link:https://anypoint.mulesoft.com/exchange/org.mule.modules/mule-transport-amqp-studio/[v3.7.2 from Exchange 2.0],  *uninstall* the existing version of this connector in Studio.
