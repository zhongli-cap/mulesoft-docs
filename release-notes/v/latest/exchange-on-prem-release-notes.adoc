...
. link:/anypoint-exchange/anypoint-exchange#soap-apis[SOAP API (WSDL) support]
. Item type colors
. Auto populating URI for new items
. Auto resizing description container for editing
. Core services organization ID
. link:/anypoint-exchange/anypoint-exchange#business-groups-in-private-exchanges[Business groups]
. Artifact states
. Transition flows
. link:/anypoint-exchange/anypoint-exchange#enabling-exchange-permissions[Exchange roles]
. link:/anypoint-exchange/anypoint-exchange#install-private-exchange-connector-in-studio[Private Exchange connectors can be installed in Studio]
. link:/anypoint-exchange/anypoint-exchange#audit-logs[Audit log of all actions in a private Exchange]
. link:/anypoint-exchange/anypoint-exchange#rest-apis[The RAMLs label was changed to REST APIs]
. link:/anypoint-exchange/anypoint-exchange#soap-apis[The WSDLs label was changed to SOAP APIs]
