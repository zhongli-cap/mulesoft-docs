...
Additionally, once logged in to the Anypoint Platform, the Cloudhub and Runtime Manager users will now see *Runtime Manager* instead of "CloudHub", on the homepage.
...
* CHHYBRID-648:	Ability to delete Applications that are in an “Unknown” status.
