...
Mule Runtime 3.8.1 fixes a number of Community Edition and Enterprise Edition issues listed in subsequent sections. 
...
|AGW-851 | Exception is thrown if per resource level policy is applied when Anypoint Gateway restarts
