...
* link:/release-notes/odata-extension-release-notes-101[APIkit for OData 1.0.1 Release Notes]
* link:/release-notes/odata-extension-studio-plugin-release-notes[APIkit for OData 1.0.0 Release Notes]
