...
* *Mule application publication*: Enables publication of Mule Studio applications to the repository in the Mule Management Console and/or Mule iON (now known as CloudHub). Refer to link:/mule-user-guide/v/3.7/deploying-mule-applications[Deploying Mule Applications ] documentation for more details.

* *New templates* Includes several new project templates upon which to build a new Studio project. Refer to link:/mule-user-guide/v/3.7/anypoint-exchange[Anypoint Exchange] documentation for more details.
