...
* *Mule application publication*: Enables publication of Mule Studio applications to the repository in the Mule Management Console and/or Mule iON (now known as CloudHub). Refer to link:/mule-user-guide/v/3.3/deployment-scenarios[Deploying Mule Applications] documentation for more details.
...
Refer to link:/mule-user-guide/v/3.3/cxf-error-handling
[CXF Error Handling] for more detailed information regarding Web services and error handling.
