...
link:/connectors/netsuite-about[NetSuite Connector User Guide]
...
== Version 8.0 - July 22, 2017

This version provides access to Anypoint Platform > Design Center, Mule 4, and Studio 7.0 (and later).
