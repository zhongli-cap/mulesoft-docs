...
|SEC-240 |Mule ESB 3.7.0 requires version of link:/anypoint-platform-for-apis/external-oauth-2.0-token-validation-policy[Anypoint Enterprise Security] to be 1.5.0 or greater
