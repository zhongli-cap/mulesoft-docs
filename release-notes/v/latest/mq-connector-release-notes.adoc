...
== Version 1.1.1 - March 27, 2017 - Upcoming

Anypoint MQ connector provides access to a new HTTP client. The current *Client Mode* (or XML clientMode) changes
in this release to *SYNC* as the default. The previous default, MULE no longer applies.
