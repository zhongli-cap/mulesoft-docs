...
* Improved retry logic fix.

=== Fixed in this Release

* Improve Mule 3 Anypoint MQ connector with retry logic and exponential backoff. This fixes previously reported SocketTimeoutException and RestException errors. (MQ-1210)
