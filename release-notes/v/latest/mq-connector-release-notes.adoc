...
[IMPORTANT]
====
This version was removed from our repositories due to a bug affecting all the platform. If you use this version, please upgrade to a newer version as soon as possible to avoid affecting you or other MQ customers.
====
