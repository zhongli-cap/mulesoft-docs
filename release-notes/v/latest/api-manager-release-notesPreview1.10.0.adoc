...
link:/anypoint-platform-for-apis[API Manager] release notes include information about changes, enhancements, and bug fixes.
...
This release includes an important entitlement change, new features, and bug fixes:

* Entitlement change 
+
As of this release, Anypoint Platform accounts must have the appropriate API entitlements to continue running apps and using APIs. User accounts not properly entitled will no longer have access to API Manager functionality. If you have purchased API Management and experience account access issues following this release, please contact your account representative.
* Searching/sorting API portals on the Developer portal
+
On the link:/anypoint-platform-for-apis/engaging-users-of-your-api#creating-a-portal[Developer Portal], you can now search, browse, and sort API portals on this page. You can sort portals by name in ascending or descending alphabetical order.
* Searching/sorting apps that access an API
+
On the Developer Portal, on the *My applications tab*, you can also search, browse, and sort apps approved to access an API. 
* Searching/sorting APIs you own
+
The Applications tab on the link:/anypoint-platform-for-apis/walkthrough-proxy#navigate-to-the-api-version-details-page[API version details] page lists these APIs. Click the 
* Searching/sorting your organization's APIs 
+
To access the Developer portal, on the *API administration* page, click the hamburger menu and select *Developer portal*. To access your organization's APIs, on the *API administration* page, click the hamburger menu and select *Applications*. 
