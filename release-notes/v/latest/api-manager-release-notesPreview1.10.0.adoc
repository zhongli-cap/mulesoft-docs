...
* Searching for and sorting API portals on the Developer portal
+
On the link:/anypoint-platform-for-apis/engaging-users-of-your-api#creating-a-portal[Developer Portal], you can now search for and sort the list of API portals. Click the sort icon to sort alphabetically by name in ascending or descending.
* Searching for and sorting apps that access an API
+
On the Developer Portal, on the *My applications tab*, you can also search for and sort apps approved to access an API. 
* Searching/sorting APIs you own
+
You can search, browse, and sort the apps listed on Applications tab on the link:/anypoint-platform-for-apis/walkthrough-proxy#navigate-to-the-api-version-details-page[API version details] page.  
