...
* January 29-31: Customers with up to 2 APIs will be automatically upgraded.
...
Send us an email with your organization domain name to crowd@mulesoft.com if you want to be excluded from the automatic upgrade.
