...
MuleSoft will _automatically_ upgrade customers with 2 or fewer APIs unless your platform administrator opts out (<<opt_out>>). A self-service upgrade process will be available for the other customers.

The upgrade schedule depends on the number of APIs in your organization:

* January 29-31: Customers with 2 or fewer APIs will be automatically upgraded.
...
Send us an email with your organization ID to crowd@mulesoft.com if you want to be excluded from the automatic upgrade. You can find the ID within Access Management on Anypoint Platform.
