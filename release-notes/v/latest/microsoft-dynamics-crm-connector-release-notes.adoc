...
* Support efficient/compact input at execute and execute multiple operations (using Map instances in addition to typed POJOs)
* Support to use single transaction on multiple operations (create/update/delete/execute) for Dyanimcs CRM 2016 and higher
* Support to use a custom STS with Dynamics CRM Online version
