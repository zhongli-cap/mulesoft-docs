...
a|
Version
|Mule ESB Runtime |link:/release-notes/v/latest/mule-esb-3.7.0-release-notes[3.7.0] and newer
|Anypoint Studio |link:/release-notes/v/latest/anypoint-studio-june-2015-with-3.7.0-runtime-release-notes[June 2015]
|===
