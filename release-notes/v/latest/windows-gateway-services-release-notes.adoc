...
- Added: Installation pre-requisites checking.
- Fixed: Core impersonation logic (crashing due to bug in unmanaged code).
- Fixed: Impersonation for the MSMQ & Powershell connectors.
