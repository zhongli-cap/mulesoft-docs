...
MuleSoft is pleased to announce the release of the Mule Maven Plugin 2.1. This release adds support for deploying applications to Business Groups and to Anypoint Runtime Manager On-premise Edition.
