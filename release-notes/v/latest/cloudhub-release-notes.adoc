...
* Unification with the Anypoint Platform for APIs has resulted in significant changes to the link:/runtime-manager/deploying-to-cloudhub[user interface], link:/access-management/managing-accounts-roles-and-permissions[roles and permissions], link:/access-management/managing-cloudhub-environments[environments], and more. For more information on migrating from R39 to R40, see link:/release-notes/cloudhub-r40-migration-guide[CloudHub R40 Migration Guide].
...
* Support for link:/access-management/managing-cloudhub-environments[moving an application between environments].
...
* Introduced link:/access-management/managing-cloudhub-environments[CloudHub Sandbox environments]. Customers now have ability to create multiple development environments to accommodate the full lifecycle of an application, such as Development, QA and Production.
...
* Ability to access the link:http://forum.mulesoft.org/mulesoft/products/mulesoft_cloudhub[support portal]
...
* link:/access-management/managing-accounts-roles-and-permissions[Role Based Access Control] - add multiple users to your CloudHub account, set their roles, and collaborate on application development.
