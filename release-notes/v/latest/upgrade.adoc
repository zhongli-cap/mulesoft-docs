...
After this process completes, a user who schedules for an upgrade will receive an email confirming a successful upgrade. In case we encounter issues, we will automatically rollback an upgraded account to its previous experience. You can contact MuleSoft Customer Support with any questions on resolving these errors. 
