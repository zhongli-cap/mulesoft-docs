...
IMPORTANT: The upgrade process changes existing Anypoint Platform APIs, which affects CI/CD pipelines built against API Manager API and autodiscovery. See the "Continuous Integration and Delivery (CI/CD)" section below.
