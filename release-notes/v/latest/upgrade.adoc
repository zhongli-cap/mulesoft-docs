...
This step is fully automated. This takes place during the timeslot that you sign up for via a self-service portal. The estimated time is 15 min for 50 APIs.
