...
In this release, we focused on bug fixes for link:/release-notes/anypoint-studio-6.2-with-3.8.3-runtime-update-site-4-release-notes[Anypoint Studio 6.2.4].
