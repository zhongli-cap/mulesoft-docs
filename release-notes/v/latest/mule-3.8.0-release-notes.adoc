...
Mule HA includes a number of new improvements. First, it contains a new link:/mule-user-guide/v/3.8-m1/creating-and-managing-a-cluster-manually#quorum-management[quorum feature], which allows you to specify the minimum number of Mule instances to function. This allows you to more effectively deal with network splits in a cloud environment, such as AWS and Azure. Mule HA also includes a link:/mule-user-guide/v/3.8-m1/creating-and-managing-a-cluster-manually#object-store-persistence[persistence option] for storing ObjectStore data in a database. This improves resilience and allows you to create backups for recovery situations. Finally, it is now possible to link:/mule-user-guide/v/3.8-m1/creating-and-managing-a-cluster-manually#monitoring[monitor cluster members via JMX]. 
