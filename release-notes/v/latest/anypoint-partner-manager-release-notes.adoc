...
* Property-harvesting from lookup tables defined
...
* Creation of API keys scoped to each environment
* Define property-harvesting from lookup tables
* Allow multiple Target Channels per Document Type within a partner
