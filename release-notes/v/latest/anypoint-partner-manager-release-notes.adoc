...
* Dynamic hostname configuration and retrieval is now possible

=== Fixed in this Release

* Changing pages when using large lookup filters now works as expected
* Certificate file uploading now displays appropriate confirmation of successful upload
