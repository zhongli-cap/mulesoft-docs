...
* Enhanced and refined interface for working with link:/anypoint-b2b/lookup-tables[Lookup Tables]
...
* Error message visibility in the link:/anypoint-b2b/error-view[Errors View]
