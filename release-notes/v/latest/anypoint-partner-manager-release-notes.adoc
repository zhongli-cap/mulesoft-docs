...
* Ability to configure RosettaNet Information Framework (RNIF) link:/anypoint-b2b/endpoints[Endpoints]

=== Fixed in this Release

* Configuration validation for link:/anypoint-b2b/partner-conversations[Partner Conversations] improved
* Transaction Monitoring performance scaled for large numbers of transactions
