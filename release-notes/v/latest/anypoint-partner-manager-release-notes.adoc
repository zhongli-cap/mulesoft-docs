...
=== Version 1.7.0 Fixed in This Release

* Fixed - Track Document not saving (or displaying) metadata
* Fixed - Fields in LookupTable Data entry screen get confused with new filter option
* Fixed - Update db migration logic for '00ANY' problem
