...
// link:/release-notes/design-center-release-notes#1-3-january-27-2018

* link:/release-notes/design-center-release-notes#1-2-1-2-january-13-2018
...
* A new canvas top nav bar and promotion experience is added.
* Includes top level elements support.
* Supports an Object Store name other than default one.
...
* Does not retrieve double trace id in toast messages.
* Adds missing red lines in required fields for the file picker in the Web Service Consumer.
 
=== Known Limitations

* Some of the limitations of v1.2.0 apply to this version.
...
** Improved UI for URI parameters in visual design.

=== Fixed Issues and Changes

* Fixed an issue related to “Try It” was not working as expected with fields and data types in an API design that are marked as required: true.
