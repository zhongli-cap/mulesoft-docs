...
* Support for pagination of the project list.
* Improvements to the code editing view including IE browser stability
* Addition of a new visual editor for APIs that supports describing HTTP characteristics of an API including:
** Resources
** Methods
** Parameters
** Headers
...
* Root level API definition and documentation
* Support for examples at attribute and payload levels
* Grouping for resources and data types
* Read only RAML viewer
* Live RAML errors displayed in both visual editing UI and in code preview
