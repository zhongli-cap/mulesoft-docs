...
\\ * link:/release-notes/design-center-release-notes#1-3-5-march-10-2018[1.3.5]
* link:/release-notes/design-center-release-notes#1-3-5-march-10-2018[1.3.2]
...
This release includes flow design UX enhancements, flow design resolved issues, and known issues in Design Center 1.3.5. 

=== New Features and Enhancements

* For designing Mule apps
+
** Support for new connectors (DynamoDB, Remedy)
** Updated to support the latest DataWeave language server
+
* For designing API specifications and fragments
+
...
* Fixed an that prevented the display of the warning message "CONTENT_DOES_NOT_MATCH_THE_SCHEMA".

== Known Issues

* Some of the limitations of v1.3.0 apply to this version.
* Rest Connect connectors show `artifactId` instead of the name.
* The option to set an expression for repeated elements is temporary The * Select dropdown exceeds scrollable bounds.
