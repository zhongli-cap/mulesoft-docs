...
This document describes new flow design features and enhancements, known limitations, issues, and fixes in Design Center 1.3.

=== New Features, Enhancements, Changes, and Fixed Issues
