...
* Separate authentication database support; this version supports a collection of users/passwords to authenticate against a MongoDB database differnt from MongoDB database storing data.
