...
Mule supports MongoDB integration by using http://mongodb.github.io/mongo-java-driver/[MongoDB Java Driver].
...
- Added support for implicit transformers when running Mule 3.6.X.
...
- To access MuleSoft’s expert support team, subscribe to Mule Enterprise and log in to MuleSoft’s Customer Portal.
