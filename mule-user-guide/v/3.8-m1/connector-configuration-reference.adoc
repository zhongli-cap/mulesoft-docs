...
|*Operation* |Select an operation from the dropdown to specify the function that the connector should perform against the API or protocol. In the case of GitHub connection, you have many options, for example, "Get collaborator" or "Get commits"
|===
