...
* *<<Endpoint-Based Connector Configuration, Endpoint-based>>* connectors.

This document describes the general configuration for both of these types. For instructions on usage of a specific connector, consult the desired connector's documentation.
