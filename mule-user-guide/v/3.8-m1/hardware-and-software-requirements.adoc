...
Get more information about installing link:/mule-user-guide/v/3.8-m1/studio-in-eclipse[Studio as an Eclipse plug-in].

== See Also

* Learn how to link:/mule-user-guide/v/3.8-m1/downloading-and-starting-mule-esb[download, install, and launch] Mule.
* Learn more about installing an link:/mule-user-guide/v/3.8-m1/installing-an-enterprise-license[Enterprise license].
* link:/mule-fundamentals/v/3.8-m1/first-30-minutes-with-mule[Get started] with Anypoint Studio.
