...
In Mule 3.8.0, Mule Runtime and API Gateway Runtime are unified:

image:unified.png[unified]

Mule continues to support and document API Gateway 2.x and 1.3.x for customers who do not plan to upgrade immediately.
