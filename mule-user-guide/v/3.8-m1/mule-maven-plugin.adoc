...
This creates two properties in the CloudHub console: `key1=value` and `anotherKey=this is a value`. Note that the properties you specify override existing properties for this application in CloudHub.
