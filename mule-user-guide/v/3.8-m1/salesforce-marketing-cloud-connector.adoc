...
This document assumes that you are familiar with Mule, the link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Anypoint Studio interface], link:/mule-fundamentals/v/3.7/global-elements[Global Elements], link:/mule-user-guide/v/3.8-m1/datasense[DataSense], and link:/mule-user-guide/v/3.8-m1/batch-processing[batch processing] in Mule. Further, it assumes you are familiar with Salesforce Marketing Cloud.
...
. In the *Connection* section enter the username and password credentials used to access the Salesforce Marketing Cloud instance or reference them using the "placeholders" you may have set in a link:/mule-user-guide/v/3.8-m1/configuring-properties#properties-files[properties file].
