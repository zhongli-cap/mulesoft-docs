...
This guide helps you use link:https://en.wikipedia.org/wiki/Dependency_injection[dependency injection]. For registry information, see link:/mule-user-guide/v/3.8-m1/unifying-the-mule-registry[Unifying the Mule Registry].
