...
If you intend to employ an SAP endpoint in conjunction with a link:/mule-user-guide/v/3.8-m1/datamapper-user-guide-and-reference[DataMapper] or link:https:/mule-user-guide/v/3.8-m1/dataweave-reference-documentation[DataWeave] transformer to map and transform data, you can make use of Anypoint Studio's link:/mule-user-guide/v/3.8-m1/datasense[DataSense] functionality.
