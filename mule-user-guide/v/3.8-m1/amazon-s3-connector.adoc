...
`src` folder of your project. See link:/mule-user-guide/v/3.8-m1/configuring-properties[Learn how to configure properties].
...
link:/mule-user-guide/v/3.8-m1/deploying-to-multiple-environments[Deploying to Multiple Environments] for instructions on how to manage this.

. Keep the *Pooling Profile* and the *Reconnection tabs* with their default entries.
. Click *Test Connection* to confirm that the parameters of your global configuration are accurate, and that Mule is able to successfully connect to your instance of Amazon S3. Read more about this in  link:/mule-user-guide/v/3.8-m1/testing-connections[Testing Connections].
...
* Learn about link:/mule-user-guide/v/3.8-m1/using-maven-with-mule[Using Maven with Mule]
