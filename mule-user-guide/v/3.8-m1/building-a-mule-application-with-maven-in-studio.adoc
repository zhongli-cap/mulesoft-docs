...
+
. Open the connector's properties editor and Create a new *Conector Configuration* element by clicking the green plus sign image:add.png[plus sign].
...
----
<1> This class extends FunctionalTestCase, which is Mule's implementation of an abstract JUnit test case. For more information, see link:/mule-user-guide/v/3.8-m1/functional-testing[Functional Testing].
...
* Read more about link:/mule-user-guide/v/3.8-m1/using-maven-with-mule[Using Maven with Mule].

* Learn how to link:/mule-user-guide/v/3.8-m1/maven-support-in-anypoint-studio[configure your Studio Preferences to work with Maven].
...
* Access additional Maven link:/mule-user-guide/v/3.8-m1/maven-reference[reference] and link:/mule-user-guide/v/3.8-m1/configuring-maven-to-work-with-mule-esb[configuration] information.
