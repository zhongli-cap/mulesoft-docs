...
[TIP]
See link:/mule-user-guide/v/3.8-m1/dataweave-flat-file-schema[DataWeave Flat File Shcema] for instructions and examples on how to create the required schema file.
