...
* On the right: the DataWeave code editor. This allows you to leverage the full power of DataWeave syntax, which includes many tools that allow you to aggregate, normalize, group, join, partition, pivot and filter. See the link:/mule-user-guide/v/3.8-m1/dataweave-reference-documentation[DataWeave reference documentation] for a complete guide on the DataWeave language syntax.
...
For further reference about writing DataWeave code, see link:/mule-user-guide/v/3.8-m1/dataweave-reference-documentation[DataWeave Language Reference]
...
[TIP]
See link:/mule-user-guide/v/3.8-m1/dataweave-flat-file-schema[DataWeave Flat File Shcema] for instructions and examples on how to create the required schema for a flat file format.
...
[TIP]
See link:/mule-user-guide/v/3.8-m1/dataweave-flat-file-schema[DataWeave Flat File Shcema] for instructions and examples on how to create the required schema.
