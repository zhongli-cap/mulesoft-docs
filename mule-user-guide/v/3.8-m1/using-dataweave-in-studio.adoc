...
[TIP]
See link:/mule-user-guide/v/3.8-m1/dataweave-flat-file-schemas[DataWeave Flat File Shcemas] for instructions and examples on how to create the required schema for a flat file format.
