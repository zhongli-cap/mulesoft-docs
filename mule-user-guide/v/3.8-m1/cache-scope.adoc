...
By default, Mule stores all cached responses in an InMemoryObjectStore. xref:ccs[Creating a Caching Strategy] and define a new link:/mule-user-guide/v/3.8-m1/mule-object-stores[object store] if you want to customize the way Mule stores cached responses.
...
* Read more about link:/mule-user-guide/v/3.8-m1/scopes[Scopes] in Mule.
