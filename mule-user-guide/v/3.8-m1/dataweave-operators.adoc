...
* For details on how to create and use your own functions, see link:/mule-user-guide/v/3.8-m1/dataweave-types#functions-and-lambdas[Functions and Lambdas]

[TIP]
Check the link:/mule-user-guide/v/3.8-m1/dataweave-language-introduction#precedence-table[Precedence Table] to see the order in which expressions are compiled.
...
[TIP]
Check the link:/mule-user-guide/v/3.8-m1/dataweave-language-introduction#precedence-table[Precedence Table] to see what expressions are compiled before or after this one.
