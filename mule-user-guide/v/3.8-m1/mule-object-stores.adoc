...
[NOTE]
====
To use the link:mule-user-guide/v/3.8-m1/object-store-module-reference.adoc[object Store module] in Anypoint Studio, you must first download the *Object Store Connector* from the link:/mule-fundamentals/v/3.8/anypoint-exchange[Anypoint Exchange].
+
