...
This property can take three different values:`mysql`, `postgresql` and `default`. The `default` option should work with any other query strategy (e.g. Oracle and SQLServer).
