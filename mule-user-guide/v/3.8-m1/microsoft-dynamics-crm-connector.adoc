...
MuleSoft maintains this connector under the link:/mule-user-guide/v/3.8-m1/anypoint-connectors#connector-categories[_Select_] support policy.
...
Use the instructions in link:/mule-fundamentals/v/3.8-m1/anypoint-exchange#installing-a-connector-from-anypoint-exchange[Installing a Connector from Anypoint Exchange].
...
+
image:microsoft-dynamics-crm-connector-kerberos-connection.png[CRMKerberosConnection] 
...
The Anypoint Platform Gateway Service runs as a Windows service. Install using the instructions in the link:/mule-user-guide/v/3.8-m1/windows-gateway-services-guide[Windows Gateway Service guide] on a machine that is joined to the same domain as the Dynamics CRM instance that you want to authenticate against.
...
|Property |Usage
|*Query* a|
DataSense Query Language: The DSQL to run. The query is translated by the connector to a Fetch XML. For more information, see link:/mule-user-guide/v/3.8-m1/datasense-query-language[DataSense Query Language].
