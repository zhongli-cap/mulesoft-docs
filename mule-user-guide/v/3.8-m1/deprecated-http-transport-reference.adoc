...
The legacy endpoint-based connector will be removed in a future version. See link:/mule-user-guide/v/3.8-m1/http-connector[HTTP Connector] for more information about the HTTP operation-based connector and how to link:/mule-user-guide/v/3.8-m1/migrating-to-the-new-http-connector[migrate] your projects to it.
====
...
|Doc |http://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/http/package-summary.html[JavaDoc] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_http/namespace-overview.html[SchemaDoc]
...
You can use the link:/mule-user-guide/v/3.8-m1/https-transport-reference[HTTPS Transport Reference] to create secure connections over HTTP. If you want to secure requests to your HTTP endpoint, the HTTP connector supports HTTP Basic/Digest authentication methods (as well as the Mule generic header authentication). To configure HTTP Basic, you configure a link:/mule-user-guide/v/3.8-m1/configuring-security[Security Endpoint Filter] on an HTTP endpoint.
...
You must configure the security manager on the Mule instance against which this security filter authenticates. For information about security configuration options and examples, see link:/mule-user-guide/v/3.8-m1/configuring-security[Configuring Security]. For general information about endpoint configuration, see link:/mule-user-guide/v/3.8-m1/endpoint-configuration-reference[Endpoint Configuration Reference].
...
*Note*: In these code examples, `spring-beans-current.xsd` is a placeholder. Mule 3.7 and newer supports Spring version 4.1.6.
...
This connector also accepts all the attributes from the link:/mule-user-guide/v/3.8-m1/tcp-transport-reference[TCP connector].
...
The HTTP inbound endpoint attributes override those specified for the link:/mule-user-guide/v/3.8-m1/endpoint-configuration-reference[default inbound endpoint attributes].
...
The HTTP outbound endpoint attributes override those specified for the link:/mule-user-guide/v/3.8-m1/endpoint-configuration-reference[default outbound endpoint attributes].
...
The HTTP endpoint attributes override those specified for the link:/mule-user-guide/v/3.8-m1/endpoint-configuration-reference[default global endpoint attributes].
...
* See how to link:/mule-user-guide/v/3.8-m1/migrating-to-the-new-http-connector[Migrate to the New HTTP Connector]
* Get an overview about the new link:/mule-user-guide/v/3.8-m1/http-connector[HTTP Connector]
* See a reference about the new link:/mule-user-guide/v/3.8-m1/http-connector-reference[HTTP Connector Reference]
