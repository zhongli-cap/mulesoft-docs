...
This type of bridge can be combined with filters for easy message routing. For fast XPath routing of messages, you can use the link:/mule-user-guide/v/3.8-m1/sxc-module-reference[SXC Module Reference].
...
See the link:/mule-user-guide/v/3.8-m1/proxying-web-services-with-cxf[Proxying Web Services with CXF] for more details.
