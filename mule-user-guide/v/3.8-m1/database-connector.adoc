...
. Check that your database engine corresponds to what is described in <<Database Engines Supported Out of the Box, Database Engines Supported Out of the Box>>; if it does not, then add the database driver for your database engine.
