...
* *Query Timeout* - Indicates the minimum ammount of time (in seconds) before the connector will attempt to cancel a running querry. No timeout is used by default.
