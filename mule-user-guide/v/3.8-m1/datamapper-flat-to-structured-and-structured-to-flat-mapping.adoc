...
To test your mapping, use the link:/mule-user-guide/v/3.8-m1/previewing-datamapper-results-on-sample-data[Preview] feature by completing the following steps:
...
* Read about using in-memory databases for flat-file integration in our link:http://blogs.mulesoft.org/using-in-memory-database-to-help-with-flat-file-integration/[MuleSoft Blog].
