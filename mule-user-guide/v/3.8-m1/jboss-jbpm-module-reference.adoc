...
http://www.jbpm.org[JBoss jBPM] is a best-of-breed open source BPMS and is well-integrated with Mule. One advantage of jBPM is that it is embedded directly in the Mule runtime, allowing for faster performance. For general information on jBPM and how to configure it, refer to the link:http://docs.jboss.com/jbpm/v4/userguide/html_single/[jBPM User Guide].

[WARNING]
This module provides a "Plug-in" for JBoss jBPM to be used with Mule's BPM support. If you have not yet read the general documentation for Mule's link:/mule-user-guide/v/3.8-m1/bpm-module-reference[BPM Support], read that first and then come back to this page.
...
Refer to link:/mule-user-guide/v/3.8-m1/bpm-module-reference[BPM Module Reference] for a list of general features offered by Mule's BPM support.
...
This module uses the schema from the link:/mule-user-guide/v/3.8-m1/bpm-module-reference[BPM Module]; it does not have its own schema.
...
Refer to link:/mule-user-guide/v/3.8-m1/bpm-module-reference[BPM Module Reference] for detailed information on the elements of the BPM schema.
