...
image:flat-file-schema-diagram.png[diagram]
...
. Drag an link:/mule-user-guide/v/3.8-m1/http-connector[HTTP Connector] from the palette to your empty canvas, then a *Transform Message Component*.
+
