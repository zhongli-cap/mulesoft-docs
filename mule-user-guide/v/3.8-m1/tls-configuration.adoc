...
[TIP]
You can include a TLS context element in a link:/mule-user-guide/v/3.8-m1/shared-resources[domain project] so that it can be shared amongst multiple projects that are deployed to a same server.
...
[NOTE]
--
TLS 1.0 is no longer a valid protocol due to its significant vulnerabilities. We encourage all users to use TLS 1.1/1.2. +
...
Please refer to our documentation for link:/mulesoft-docs/mule-user-guide/v/3.7/tls1-0-migration[configuration instructions].
--
...
[TIP]
====
Cipher Suite names can be very lengthy, which can have an impact in the readability of your XML code. To keep things neater, you can instead keep your Cipher Suite names in an link:/mule-user-guide/v/3.8-m1/configuring-properties[external properties file] in your Mule project and refer to it.
...
* See how link:/mule-user-guide/v/3.8-m1/authentication-in-http-requests[authentication] works in the HTTP Connector
* Refer to the link:/mule-user-guide/v/3.8-m1/https-transport-reference[deprecated HTTPS Transport]
