...
This document assumes that you are familiar with Mule, the link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Anypoint Studio Interface], link:/mule-fundamentals/v/3.7/global-elements[Global Elements], link:/mule-user-guide/v/3.8-m1/datasense[DataSense], and link:/mule-user-guide/v/3.8-m1/batch-processing[Batch Processing] in Mule. Further, it assumes you are familiar with Salesforce.
...
The following example invokes an Apex method. In Salesforce we made  a custom object called **CustomOrder__c**, which has two custom fields *ProductName__c* and **ProductValue__c**. An Apex Rest class is deployed in Salesforce using the *Deploy metadata* operation.
