...
Use an *attachment transformer* to set, remove, or copy attachments on the outbound scope of a message. To learn more about message scopes, refer to link:/mule-fundamentals/v/3.8-m1/mule-concepts[Mule Concepts].
...
The attachment transformer is very similar in functionality to the link:/mule-user-guide/v/3.8-m1/property-transformer-reference[property transformer]. However, attachments are only supported by the following transports: 
...
* Refer to link:/mule-fundamentals/v/3.8-m1/mule-concepts[Mule Concepts] to learn more about message scopes.
* Read about related transformers, the link:/mule-user-guide/v/3.8-m1/property-transformer-reference[property transformer], the link:/mule-user-guide/v/3.8-m1/variable-transformer-reference[variable transformer], and the link:/mule-user-guide/v/3.8-m1/session-variable-transformer-reference[session variable transformer], which you can use to set properties and variables for different scopes.
