...
NOTE: All data types expose an input property Error Policy, that is used to specify how to handle bad input data in the mapping. For the semantics of Error Policy, see link:/mule-user-guide/v/3.8-m1/datamapper-input-error-policy-for-bad-input-data[DataMapper Input Error Policy for Bad Input Data].
...
|Error Policy |Input |How to handle bad input data. See link:/mule-user-guide/v/3.8-m1/datamapper-input-error-policy-for-bad-input-data[DataMapper Input Error Policy for Bad Input Data] for details.
|===
