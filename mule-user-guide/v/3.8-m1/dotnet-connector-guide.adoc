...
This document assumes that you are familiar with Mule, the link:/mule-fundamentals/v/3.8-m1/anypoint-studio-essentials[Anypoint Studio interface], and link:/mule-fundamentals/v/3.8-m1/global-elements[Global Elements]. Further, it is assumed that you are familiar with the Microsoft .NET Framework.
...
* Anypoint Studio, the graphical interface to Mule. See link:/mule-fundamentals/v/3.8-m1/download-and-launch-anypoint-studio[Download and Launch Anypoint Studio] for details
