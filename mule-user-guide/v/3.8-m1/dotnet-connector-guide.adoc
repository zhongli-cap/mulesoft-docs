...
|*link:/mule-user-guide/v/3.8-m1/datamapper-concepts[DataMapper]* |The DataMapper is a Mule transformer that delivers simple, yet powerful, visual design of complex data transformations for use in Mule flows
|===
...
|===
+
. Before you run this application, create a JSON sample file in your project named *input.json* and copy the following content into it for Dataweave to use as example input.
[source, code, linenums]
----
