...
* Explore a few link:/mule-fundamentals/v/3.8-m1/anypoint-exchange[example applications] in Anypoint Studio.
* Read about link:/mule-user-guide/v/3.8-m1/importing-a-maven-project-into-studio[Importing a Maven Project into Studio].
* Find out more about link:/mule-user-guide/v/3.8-m1/enabling-maven-support-for-a-studio-project[Enabling Maven Support for a Studio Project].
