...
. Once you have confirmed successful connection to Salesforce, insert a link:/mule-user-guide/v/3.8-m1/dataweave[*Transform Message Component*] before the connector on your canvas. +
...
[TIP]
See link:/mule-user-guide/v/3.8-m1/dataweave-quickstart[DataWeave Quickstart Guide] for more complete examples using the same features.
