...
This document assumes that you have link:/mule-user-guide/v/3.8-m1/installing-anypoint-enterprise-security[installed the Anypoint Enterprise Security] extensions.

It also assumes you are familiar with the link:/mule-fundamentals/v/3.8-m1/anypoint-studio-essentials[Anypoint Studio] interface. To increase your familiarity with Studio, consider completing one or more link:/mule-fundamentals/v/3.8-m1/first-day-with-mule[Anypoint Studio Tutorials].
...
Make sure to right click on any of the link:/mule-user-guide/v/3.8-m1/mule-message-encryption-processor[Mule Message Encryption Processors] and select `Add Encryption libraries to the project`.
...
* For more information on encryption in Mule, see link:/mule-user-guide/v/3.8-m1/mule-message-encryption-processor[Mule Message Encryption Processor].
* For more information on signatures in Mule, see link:/mule-user-guide/v/3.8-m1/mule-digital-signature-processor[Mule Digital Signature Processor].
