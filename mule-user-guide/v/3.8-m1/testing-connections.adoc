...
* Connection testing functionality is only available in link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Studio's Visual Editor].
...
* Review the link:/mule-user-guide/v/3.8-m1/datasense[DataSense] functionality. 
* See DataSense in action!  Examine two example applications which were built using DataSense: link:/mule-user-guide/v/3.8-m1/connect-with-salesforce-example[Connect with Salesforce Example].
