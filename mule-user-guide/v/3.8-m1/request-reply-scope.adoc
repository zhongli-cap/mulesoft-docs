...
This document assumes that you understand the difference between link:/mule-fundamentals/v/3.8-m1/flows-and-subflows[synchronous and asynchronous flows]. Furthermore, review link:/mule-user-guide/v/3.8-m1/scopes[Scopes] in general.
