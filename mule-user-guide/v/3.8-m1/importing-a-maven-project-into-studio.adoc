...
* Learn how to build a complete link:/mule-user-guide/v/3.8-m1/building-a-mule-application-with-maven-in-studio[Studio Maven Project], including tests and dependencies.
* Learn how to link:/mule-user-guide/v/3.8-m1/enabling-maven-support-for-a-studio-project["mavenize" an existing Mule project].
