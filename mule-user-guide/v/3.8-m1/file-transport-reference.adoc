...
For new dateTime functions introduced into MEL with Mule 3.4 and newer, see link:/mule-user-guide/v/3.8-m1/mule-expression-language-date-and-time-functions[MEL Date and Time Functions]. 
