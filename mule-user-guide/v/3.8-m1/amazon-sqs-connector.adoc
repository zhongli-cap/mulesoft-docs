...
To use the Amazon SQS connector in your Mule application, you must configure a global element that can be used by all the Amazon SQS connectors in the application (read more about link:/mule-fundamentals/v/3.8-m1/global-elements[global elements]).
...
* Learn how to use link:/mule-fundamentals/v/3.8-m1/mule-transformers[Mule Transformers].
