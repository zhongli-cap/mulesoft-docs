...
image:/documentation/download/attachments/122752068/db_example_flow.png?version=1&modificationDate=1405006923522[image]
...
image:/documentation/download/attachments/122752068/modif_flowchart.png?version=1&modificationDate=1405006923607[image]
...
. Click the image:/documentation/download/attachments/122752068/plus.png?version=1&modificationDate=1405092069913[image] icon to the right of *Connector configuration* to create a database global element for this database connector.
+
image:/documentation/download/thumbnails/122752068/choose.global.type.png?version=1&modificationDate=1405092403808[image]
...
+
image:/documentation/download/attachments/122752068/add.driver.oracle.png?version=1&modificationDate=1405092619138[image]
...
image:/documentation/download/attachments/122752068/installed_mysql_driver.png?version=1&modificationDate=1405093261232[image]
...
After adding the database driver for a database engine not supported out of the box, you need to enter the fully qualified name of the driver class in the global element referenced by the database connector. For details, see https://developer.mulesoft.com/docs/display/35X/Database+Connector#DatabaseConnector-generic[Configuring for Other Database Engines (Generic Configuration] below.
...
|*Name* |Use to define a unique identifier for the global Database connector element in your application. .6+|image:/documentation/download/attachments/122752068/oracle_global_elem.png?version=1&modificationDate=1405099943780[image]
...
|===
|Attribute, Required |Use |Properties Editor
|*Name* |Use to define a unique identifier for the global Database connector element in your application. .6+| image:/documentation/download/attachments/122752068/mysql_global_elem.png?version=1&modificationDate=1405100432807[image]
|*Database Configuration Parameters* +
...
|===
|Attribute, Required |Use |Properties Editor
|*Name* |Use to define a unique identifier for the global Database connector element in your application. .6+|image:/documentation/download/attachments/122752068/derby_global_elem.png?version=1&modificationDate=1405100546148[image]
|*Database Configuration Parameters* +
...
3+|*General tab*
|*Enable DataSense* |Use to "turn on" DataSense, which enables Mule to make use of message metadata during design time. |image:/documentation/download/attachments/122752068/config_enable_DS.png?version=1&modificationDate=1405006923492[image]
3+|*Advanced tab*
|*Use XA Transactions* |Enable to indicate that the created datasource must support extended architecture (XA) transactions. .6+|image:/documentation/download/attachments/122752068/Advanced+GE.png?version=1&modificationDate=1405006923395[image]
...
|*Driver Class Name*	|Fully-qualified driver class name of the driver for your database, which must be already imported into your project. (For details on importing the driver, see https://developer.mulesoft.com/docs/display/35X/Database+Connector#DatabaseConnector-db_drv[Adding the Database Driver] above.) You can enter the full name in the empty field or click ... to browse the available driver classes. +
  +
When browsing the available driver classes, type the beginning of the driver class name (which you can check by clicking the driver file under Referenced Libraries in the Package Explorer). Studio will display the list of classes provided by the driver. +
 +
For a list of driver classes of commonly-used database engines, see https://developer.mulesoft.com/docs/display/35X/Database+Connector#DatabaseConnector-drv_class[Common Driver Class Specifications] below.
...
|===
|Attribute, Required |Use |Properties Editor
|*Display Name* |Use to define a unique identifier for the Database Connector element in your flow. .5+a|image:/documentation/download/attachments/122752068/config_db_connector.png?version=1&modificationDate=1405006923458[image]

*Examples:*

image:/documentation/download/attachments/122752068/select.png?version=1&modificationDate=1405006923630[image]

image:/documentation/download/attachments/122752068/insert_w_MEL.png?version=1&modificationDate=1405006923598[image]

image:/documentation/download/thumbnails/122752068/truncate.png?version=1&modificationDate=1405006923674[image]
...
4+|*General tab*
|*Parameter Name* |Parametized Stored Procedure |Use to identify a named parameter in your SQL statement for which you wish to use the value at runtime, when your application submits your query which calls upon stored in the database instance. .4+|image:/documentation/download/attachments/122752068/stored+procedure.png?version=1&modificationDate=1405006923638[image]
...
|image:/documentation/download/attachments/122752068/bulk.png?version=1&modificationDate=1405006923429[image]
...
|*Dynamic query* |Execute DDL |Perform an operation on the data structure, rather than the data itself through a DDL request. |image:/documentation/download/attachments/122752068/DLL.png?version=1&modificationDate=1405006923537[image]
4+|*Advanced tab*
...
image:/documentation/download/attachments/122752068/advanced+insert.png?version=1&modificationDate=1405006923408[image]

Operation = Select

image:/documentation/download/attachments/122752068/advanced+select.png?version=1&modificationDate=1405006923418[image]
...
To utilize the *From Template* query type, you must first define the template as a http://www.mulesoft.org/documentation/display/34X/Understand+Global+Mule+Elements[global element], then reference the template from within the database connector in your flow.
...
+
image:/documentation/download/attachments/122752068/template.png?version=1&modificationDate=1405006923645[image]
...
+
image:/documentation/download/attachments/122752068/template_GE.png?version=1&modificationDate=1405006923659[image]
...
image:/documentation/download/attachments/122752068/global_var.png?version=1&modificationDate=1405006923589[image] 

. Click the blank space in the Studio canvas to save your changes.

*Example of Parameterized Query Using Variables*

image:/documentation/download/attachments/122752068/template_with_vars.png?version=1&modificationDate=1405006923666[image]
...
image:/documentation/download/attachments/122752068/datatypes_menu.png?version=1&modificationDate=1405006923514[image]
...
image:/documentation/download/attachments/122752068/dllexample.png?version=1&modificationDate=1405006923546[image]

===== Example 2

image:/documentation/download/attachments/122752068/dllexample2.png?version=1&modificationDate=1405006923554[image]
....
[tab,title="XML Editor"]
....
...
image:/documentation/download/attachments/122752068/bulkex1.png?version=1&modificationDate=1405006923439[image]

==== Example 2

image:/documentation/download/attachments/122752068/bulkex2.png?version=1&modificationDate=1405006923450[image]
....
[tab,title="XML Editor"]
....
==== Example 1
