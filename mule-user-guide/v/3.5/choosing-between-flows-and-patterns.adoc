...
Take a look at link:/mule-user-guide/v/3.5/configuration-patterns[configuration patterns] and link:/mule-user-guide/v/3.6/using-flows-for-service-orchestration[flows].
...
* link:/mule-user-guide/v/3.5/configuration-patterns[Using Mule Configuration Patterns]
