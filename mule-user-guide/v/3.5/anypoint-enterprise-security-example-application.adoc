...
This document assumes that you have link:/mule-fundamentals/v/3.5/anypoint-studio-essentials[Anypoint Studio Essentials] interface. To increase your familiarity with Studio, consider completing one or more link:/mule-fundamentals/v/3.5/basic-studio-tutorial[Basic Studio Tutorials].
