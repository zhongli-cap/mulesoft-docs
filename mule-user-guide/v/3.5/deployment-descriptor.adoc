...
For details on classloading in Mule, including a diagram of the Mule classloading architecture, see link:/mule-user-guide/v/3.5/classloader-control-in-mule[Classloader Control in Mule].
