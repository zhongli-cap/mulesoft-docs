...
* *siso*: The pattern receives messages from a single inbound endpoint and dispatches to a single outbound endpoint. The link:/mule-user-guide/v/3.7/bridge-pattern[Bridge], link:/mule-user-guide/v/3.6/validator-pattern[Validator], and link:/mule-user-guide/v/3.6/proxying-web-services[Web Service Proxy] patterns are of this kind.
