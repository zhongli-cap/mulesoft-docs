...
As the objective of this quick tutorial is get something built and running fast, this document doesn't spend much time explaining components. More detailed explanations and concepts exist in the link:/mule-fundamentals/v/3.5/first-day-with-mule[First Day with Mule] and link:/mule-fundamentals/v/3.5/first-week-with-mule[First Week with Mule] sections of the link:/mule-fundamentals/v/3.5[Mule Fundamentals], but for now, let's just see Mule work: you're about to build a very simple application in Studio, deploy it to Studio's embedded server, then interact with the application through a Web browser.

== Assumptions

This tutorial assumes that you have link:/mule-fundamentals/v/3.5/download-and-launch-anypoint-studio[downloaded, installed, and launched Anypoint Studio],  and that you've read through the link:/mule-fundamentals/v/3.5/anypoint-studio-essentials[Anypoint Studio Essentials].
...
* *NEXT STEP*: Dive into the more extensive *First Day* content starting with link:/mule-fundamentals/v/3.5/mule-concepts[Mule Concepts].
...
* Skip ahead in the syllabus to the link:/mule-fundamentals/v/3.5/basic-studio-tutorial[Basic Studio Tutorial].
