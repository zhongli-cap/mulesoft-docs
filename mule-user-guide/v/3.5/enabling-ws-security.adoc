...
To the Mule flow that involves a Web service, add a link:/mule-user-guide/v/3.5/cxf-component-reference[CXF Component] to publish, consume, or proxy a Web service. Complete the following steps to configure WS-security on the SOAP component.
...
link:http://www.mulesoft.org/schema/mule/cxf/3.5/mule-cxf.xsd[View the Mule 3.5 CXF schema].
...
* Learn more about configuring a link:/mule-user-guide/v/3.5/cxf-component-reference[CXF component] in your Mule application.
