...
[TIP]
Instead of building a proxy application from scratch, consider using an link:/api-manager/v/latest/proxy-about[Anypoint Platform Proxy].
...
This type of bridge can be combined with filters for easy message routing. For fast XPath routing of messages, you can use the link:/mule-user-guide/v/3.5/sxc-module-reference[SXC Module Reference].

Alternatively, you can use link:/mule-user-guide/v/3.5/bridge-pattern[Bridge Pattern].
