...
To associate an existing application with a domain, edit the mule-deploy.properties file to include the domain property:
...
* Note that although shared resources is limited to the selected connectors and libraries covered in this document, there are ways to share other configuration fragments in Mule. Refer to link:/mule-user-guide/v/3.5/sharing-custom-configuration-fragments[Sharing Custom Configuration Fragments] for details.
...
** link:/mule-user-guide/v/3.5/database-connector[DB]
...
** link:/mule-user-guide/v/3.5/jboss-transaction-manager-reference[JBoss]
** link:/mule-user-guide/v/3.5/setting-environment-variables[Set Environment Variables]
