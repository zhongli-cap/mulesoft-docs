...
|link:/mule-user-guide/v/3.6/mule-annotation[@Mule] |A parameter injection annotation that can be used on component entry points and transformer methods, this annotation can be used to execute a link:/mule-user-guide/v/3.7/mule-expression-language-mel[Mule Expression] |Parameter |annotations
