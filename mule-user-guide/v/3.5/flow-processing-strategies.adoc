...
This page assumes that you are familiar with link:/mule-user-guide/v/3.7/mule-concepts[Mule flows] and basic link:/mule-user-guide/v/3.6/mule-application-architecture[application architecture].
