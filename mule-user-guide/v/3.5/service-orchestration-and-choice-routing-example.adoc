...
As with the other link:/mule-user-guide/v/3.5/mule-examples[example templates], you can create a fully-functioning applications straight out of the box in *Anypoint Studio*. You can tweak the configurations of these use case-based examples to create your own customized applications in Mule.
