...
This document assumes that you are familiar with Mule ESB and the link:/mule-user-guide/v/3.5/anypoint-studio-essentials[Anypoint™ Studio interface]. To increase your familiarity with Studio, consider completing one or more link:/mule-user-guide/v/3.5/basic-studio-tutorial[Anypoint Studio Tutorials].
