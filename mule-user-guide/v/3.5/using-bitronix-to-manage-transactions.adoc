...
* Read more about how to link:/mule-user-guide/v/3.5/shared-resources[define a Bitronix transaction manager as a shared resource] for multiple applications associated with a domain.
