...
The Hello World example consists of one simple link:/mule-fundamentals/v/3.5/mule-application-architecture[Mule flow]. This flow accepts an HTTP request, sets a static payload on the message, then returns a response to the end user. 
...
* Read about the concept of link:/mule-fundamentals/v/3.5/mule-concepts[flows] in Mule.
