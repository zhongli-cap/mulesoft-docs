...
. In the Install menu, in the *Work with*: field, click the drop-down menu, and click `Anypoint Connectors Update Site`. In Studio 6.3.0 and later, select `https://repository.mulesoft.org/connectors/releases/3.5.0` to install this connector.
