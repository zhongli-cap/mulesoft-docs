...
|===
|Transformer |Description
|link:/mule-user-guide/v/3.5/xmlobject-transformers[XmlToObject < - > ObjectToXml] |Converts XML to a Java object and back again using http://xstream.codehaus.org[XStream].
