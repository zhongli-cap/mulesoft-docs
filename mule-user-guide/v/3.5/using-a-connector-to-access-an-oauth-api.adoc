...
This document assumes that you are familiar with the link:/mule-user-guide/v/3.6/anypoint-studio-essentials[Visual Editor in Anypoint Studio], link:/mule-user-guide/v/3.7/anypoint-connectors[Anypoint Connectors], and  link:/mule-user-guide/v/3.6/global-elements[Global Elements]. Review the link:/mule-user-guide/v/3.6/first-day-with-mule[First Day with Mule] chapter to learn more about developing with Mule ESB's graphical user interface.
