...
To learn more about endpoints, refer to link:/mule-user-guide/v/3.5/anypoint-connectors[Anypoint Connectors].
...
See the link:/mule-user-guide/v/3.5/http-transport-reference[HTTP Transport Reference] for details on setting the properties for a HTTP endpoint using an XML editor.
