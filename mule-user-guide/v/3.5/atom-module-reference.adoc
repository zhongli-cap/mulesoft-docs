...
http://www.mulesoft.org/schema/mule/atom +
 +
Defined Components: +
7 link:/mule-user-guide/v/3.5/atom-module-reference#a1[global elements], 1 link:/mule-user-guide/v/3.5/atom-module-referencee#a1[local element], 5 link:/mule-user-guide/v/3.5/atom-module-reference#a2[complexTypes], 1 link:/mule-user-guide/v/3.5/atom-module-reference#a3[attribute group] +
 +
...
Local Elements: qualified; Local Attributes: unqualified +
 +
Schema Location: +
http://www.mulesoft.org/schema/mule/atom/3.5/mule-atom.xsd; see https://developer.mulesoft.com/docs/schemas/mule-atom_xsd/schema-overview.html#xml_source[XML source] +
 +
Imports Schemas (4): +
 +
