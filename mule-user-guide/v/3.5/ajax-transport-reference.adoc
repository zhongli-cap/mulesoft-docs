...
|Doc |link:http://www.mulesoft.org/docs/site/3.5.0/apidocs/org/mule/transport/ajax/package-summary.html[JavaDoc], link:http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_ajax/namespace-overview.html[SchemaDoc]
...
|Maven Artifact |org.mule.transport:mule-transport-ajax |The group name an artifact name for this transport in link:http://maven.apache.org/[Maven]
|===
