...
This document assumes that you are familiar with the exercise of building and deploying Mule applications in Mule Studio. Consider reading the link:/mule-user-guide/v/3.7/mule-fundamentals[Mule Fundamentals] and link:/getting-started/index[Anypoint Fundamentals] for more information.
