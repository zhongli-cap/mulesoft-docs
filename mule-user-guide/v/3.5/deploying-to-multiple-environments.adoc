...
This document assumes that you are familiar with the exercise of building and deploying Mule applications in Mule Studio. Consider reading the link:/mule-user-guide/v/3.7[Mule Fundamentals] and link:/mule-user-guide/v/3.6/first-30-minutes-with-mule[First 30 Minutes with Mule] for more information.
