...
This document assumes that you are familiar with Mule ESB and its link:/mule-user-guide/v/3.5/mule-concepts[basic concepts]. Consider reading the chapter, link:/mule-user-guide/v/3.5/first-30-minutes-with-mule[First 30 Minutes with Mule] to gain familiarity before proceeding. 
...
* *NEXT STEP*: Learn the link:/mule-user-guide/v/3.5/mule-expression-language-basic-syntax[basic syntax of MEL], or dive into link:/mule-user-guide/v/3.5/mule-application-architecture[Mule Application Architecture].
...
* Learn better by tutorial? Access the link:/mule-user-guide/v/3.5/mule-message-tutorial[Mule Message Tutorial].
