...
A flow reference can route messages to any type of flow within the same application. Refer to link:/mule-fundamentals/v/3.7/flows-and-subflows[Flows and Subflows] for more information.
...
* Read more about the different kinds of link:/mule-fundamentals/v/3.7/flows-and-subflows[Flows and Subflows] that you can call using a flow reference component.
