...
* *NEXT STEP*: Read on about link:/mule-user-guide/v/3.5/mule-filters-scopes-and-routers[Filters, Scopes, and Routers].
...
* Learn more about setting, then using link:/mule-user-guide/v/3.5/mule-message-structure[properties and variables].
