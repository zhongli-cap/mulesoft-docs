...
[%autowidth.spread]
|===
|*link:https://blogs.mulesoft.com/dev/mule-dev/data-integration-patterns-migration/[Migration]* |*link:https://blogs.mulesoft.com/dev/mule-dev/data-integration-patterns-broadcast/[Broadcast]* |*link:https://blogs.mulesoft.com/dev/mule-dev/data-integration-patterns-bi-directional-sync/[Bi-Directional Sync]* |*link:https://blogs.mulesoft.com/dev/mule-dev/data-integration-patterns-aggregation/[Aggregation]* |*link:https://blogs.mulesoft.com/dev/mule-dev/data-integration-patterns-correlation/[Correlation]*
