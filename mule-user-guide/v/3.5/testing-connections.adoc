...
This document assumes that you are familiar with the link:/mule-fundamentals/v/3.6/anypoint-studio-essentials[Visual Editor in Anypoint Studio], as well as the link:/mule-user-guide/v/3.7/anypoint-connectors[Anypoint Connectors] and link:/mule-user-guide/v/3.7/datamapper-user-guide-and-reference[Anypoint DataMapper Transformer] that you can use to create applications in Studio. Further, this document references link:/mule-user-guide/v/3.7/connecting-using-transports[Connectors] and link:/mule-fundamentals/v/3.6/global-elements[Global Elements.] Review link:/mule-user-guide/v/3.6/datasense[DataSense] to learn more about the overall DataSense functionality; review the link:/mule-fundamentals/v/3.6/first-30-minutes-with-mule[First 30 Minutes with Mule] chapter to learn more about developing with Mule ESB's graphical user interface.
...
* Connection testing functionality is only available in link:/mule-fundamentals/v/3.6/anypoint-studio-essentials[Studio's Visual Editor].
