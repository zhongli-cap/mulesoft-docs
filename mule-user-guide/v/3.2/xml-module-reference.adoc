...
In addition to the functionality described on this page, you can also use the link:sxc-module-reference[SXC Module Reference], which enables efficient XPath XML routing.
...
The XML module contains various XPath filters. For general details on how to use filters, see link:using-filters[Using Filters].
...
The XML module contains two splitters, a filter-based splitter and a round-robin splitter. For more information on these splitters, see link:outbound-routers[Outbound Routers].
