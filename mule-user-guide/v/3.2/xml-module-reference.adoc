...
In addition to the functionality described on this page, you can also use the link:/mule-user-guide/v/3.2/sxc-module-reference[SXC Module Reference], which enables efficient XPath XML routing.
...
|link:/mule-user-guide/v/3.2/xmlobject-transformers[XmlToObject < - > ObjectToXml] |Converts XML to a Java object and back again using link:http://x-stream.github.io/[XStream].
...
The XML module contains various XPath filters. For general details on how to use filters, see link:/mule-user-guide/v/3.2/using-filters[Using Filters].
...
The XML module contains two splitters, a filter-based splitter and a round-robin splitter. For more information on these splitters, see link:/mule-user-guide/v/3.2/outbound-routers[Outbound Routers].
