...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/http-transport-reference[HTTP Transport Reference] for details on setting the properties for an HTTP endpoint using an XML editor.
