...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/smtp-transport-reference[SMTP]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/imap-transport-reference[IMAP]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/pop3-transport-reference[POP3]
