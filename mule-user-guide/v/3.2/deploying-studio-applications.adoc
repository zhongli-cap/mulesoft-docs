...
If you do not already have Mule ESB installed, consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/complete-installation-manual[Mule Installation] manual.
