...
This page provides details on the elements you configure for models. Some of this information is pulled directly from `mule.xsd` and is cached. If the information appears to be out of date, refresh the page. For more information on models, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/models[Models].
...
See link:https://docs.mulesoft.com/mule-user-guide/v/3.2/exception-strategy-configuration-reference[Exception Strategy Configuration Reference].

== Service

See link:https://docs.mulesoft.com/mule-user-guide/v/3.2/service-configuration-reference[Service Configuration Reference].

== Entry Point Resolver

See link:https://docs.mulesoft.com/mule-user-guide/v/3.2/entry-point-resolver-configuration-reference[Entry Point Resolver Configuration Reference].
