...
This is documented at link:transaction-management[Transaction Management], along with other information about managing transactions with Mule. In particular, the entire section on XA Transactions is extremely useful.
