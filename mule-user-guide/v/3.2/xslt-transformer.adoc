...
This transformer can be tested using the following functional test. Note that it uses `FunctionalTestCase`, which is part of Mule's link:https://docs.mulesoft.com/mule-user-guide/v/3.2/functional-testing[Test support].
