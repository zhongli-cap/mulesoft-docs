...
This page describes how to use a standalone CXF-generated client with Mule. This approach is different from the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/consuming-web-services-with-cxf[outbound router] approach, which is typically a more appropriate fit for most applications.
...
Following is an example of how to construct a client using the service that was developed in link:https://docs.mulesoft.com/mule-user-guide/v/3.2/building-web-services-with-cxf[Building Web Services with CXF]:
