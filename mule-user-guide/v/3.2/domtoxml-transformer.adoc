...
These transformers support the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/transformers-configuration-reference[standard transformer attributes] plus the following:
