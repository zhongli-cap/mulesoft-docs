...
This example requires that you run through the earlier example link:https://docs.mulesoft.com/mule-user-guide/v/3.2/transforming-data-in-a-flow[Transforming Data in a Flow].

=== Building the Example

1. We are going to continue editing the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/transforming-data-in-a-flow[example] and add a File component to the flow. Drag the File endpoint from the palette to the canvas after the Echo component.
