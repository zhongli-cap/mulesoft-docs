...
Mule offers automatic link:https://docs.mulesoft.com/mule-user-guide/v/3.2/jaxb-bindings[JAXB Bindings] so you don't even need use these transformers for most scenarios.
