...
If you want to update an existing transport instead of creating a new one, such as adding new schema namespaces and registry bootstrapping to the transport, use the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/creating-module-archetypes[Creating Module Archetypes] instead.
