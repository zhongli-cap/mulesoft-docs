...
The WebSphere MQ example demonstrates using Mule's link:mule-wmq-transport-reference[transport for WebSphere MQ] to send and receive transactional messages to WebSphere MQ. This example is available in the enterprise edition of Mule.
