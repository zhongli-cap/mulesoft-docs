...
Refer to the generic link:script-component-reference[Script Component Reference] page to see how a script works with one-way and request-response endpoints.
