...
EJB endpoints are configured the same way as link:https://docs.mulesoft.com/mule-user-guide/v/3.2/rmi-transport-reference[RMI endpoints]. Note that only outbound endpoints can use the EJB transport. For a given endpoint, you must provide the following information:
