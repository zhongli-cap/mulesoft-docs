...
The IMAP connector supports all the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/configuring-a-transport[common connector attributes and properties] and the following additional attributes:
...
IMAP and IMAPS endpoints include details about connecting to an IMAP mailbox. You link:https://docs.mulesoft.com/mule-user-guide/v/3.2/configuring-endpoints[configure the endpoints] just as you would with any other transport, with the following additional attributes:
