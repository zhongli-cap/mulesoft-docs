...
While many times you can proxy web services without using CXF (see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/proxying-web-services[Proxying Web Services]), there are several cases where you might want to use CXF proxies:
