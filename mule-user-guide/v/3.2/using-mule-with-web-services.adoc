...
[TIP]
As of the latest version of Mule ESB, the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/cxf-module-reference[CXF Module] is the recommended way to work with with Web services.
