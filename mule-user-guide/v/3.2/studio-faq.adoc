...
* To learn about Mule concepts and terminology as well as Mule flow architecture, see: link:mule-studio-essentials[Mule Studio Essentials].

* For a pair of tutorials that can get you started building Mule apps with Studio, go to: link:mule-studio[Getting Started with Mule Studio]
