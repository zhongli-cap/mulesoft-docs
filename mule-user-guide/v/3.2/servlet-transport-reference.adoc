...
Servlet endpoints accept the same attributes and child elements as HTTP endpoints. For more information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/http-transport-reference[HTTP Transport Reference].
