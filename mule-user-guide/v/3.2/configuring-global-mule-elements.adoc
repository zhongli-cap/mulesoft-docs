...
For additional information on configuring global elements, see the reference page specific to the associated building block. For example, if you are configuring a cloud connector, such as Twitter, see the link:twitter-cloud-connector-reference[Twitter Cloud Connector Reference] page.
