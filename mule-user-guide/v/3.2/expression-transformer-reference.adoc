...
For more information about using expressions, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-expressions[here].

== Mule ESB Reference

For more information on configuring expressions, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/expressions-configuration-reference[here].
