...
|===
|Name |Description
|link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mql-query-java-objects[Query Java Objects] |Query local POJOs and transform them into different objects.
|link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mql-merge-datasets[Merging Datasets] |In this example, see how you can take activity streams from Twitter and Yammer and merge them into a common format.
|link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mql-enrich-data[Enrich Data] |In this example, local data is enriched with data from SalesForce
|link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mql-service-versioning[Service Versioning] |Easily handle two different data formats (version 1.0 and version 2.0) for your service.
|===

== Resources

* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mql-download[Download]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mql-mule-integration[Mule Integration]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mql-spring-integration[Spring Integration]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mql-reference-guide[Syntax Guide]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mql-roadmap[Roadmap]
