...
JSON Path can be used in link:expressions-configuration-reference[Mule expressions] to query JSON message payloads for filtering or link:message-enricher[enrichment].
