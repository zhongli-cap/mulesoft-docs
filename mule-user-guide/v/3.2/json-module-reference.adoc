...
JSON Path can be used in link:/mule-user-guide/v/3.2/expressions-configuration-reference[Mule expressions] to query JSON message payloads for filtering or link:/mule-user-guide/v/3.2/message-enricher[enrichment].
