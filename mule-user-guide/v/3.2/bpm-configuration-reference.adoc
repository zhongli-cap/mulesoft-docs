...
This page provides details on the process components you configure for BPM. Some of this information is pulled directly from `mule-bpm.xsd` and is cached. If the information appears to be out of date, refresh the page. For more information on BPM, see link:bpm-module-reference[BPM Module Reference].
...
See link:exception-strategy-configuration-reference[Exception Strategy Configuration Reference].

== Service

See link:service-configuration-reference[Service Configuration Reference].

== Entry Point Resolver

See link:entry-point-resolver-configuration-reference[Entry Point Resolver Configuration Reference].
