...
This annotation controls how the current message inbound attachments are passed into a method. The annotation supports, Map, List, single attachment, wildcards and optional entries. It can be used on component entry points and link:https://docs.mulesoft.com/mule-user-guide/v/3.2/transformer-annotation[@Transformer] methods.
