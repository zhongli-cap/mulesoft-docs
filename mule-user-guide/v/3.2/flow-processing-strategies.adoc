...
* The flow's inbound endpoint must be notified of all errors that occur during the processing of the message. This situation is discussed further in link:/mule-management-console/v/3.2/reliability-patterns[Reliability Patterns].
