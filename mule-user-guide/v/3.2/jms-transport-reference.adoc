...
To see JMS with Mule in action (using ActiveMQ), take a look at the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/error-handler-example[Error Handler Example] (available in the full Mule distribution).

[TIP]
====
*WebSphere MQ*

Mule Enterprise includes an link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mule-wmq-transport-reference[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.
====
...
❶ New implementations are recommended to use link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-flows-for-service-orchestration[flows], but Mule 2.x users are more familiar with `<service>`.

== Vendor-specific Configuration

Mule Enterprise includes an link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mule-wmq-transport-reference[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.

Mule MQ is an enterprise-class JMS implementation officially supported by MuleSoft and has link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mulemq-integration[tight integration with Mule].

http://activemq.apache.org[ActiveMQ] is also widely-used with Mule and has link:https://docs.mulesoft.com/mule-user-guide/v/3.2/activemq-integration[simplified configuration].
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/fiorano-integration[FioranoMQ]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/hornetq-integration[HornetQ]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/jboss-jms-integration[JBoss MQ]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/openjms-integration[OpenJms]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/open-mq-integration[Open MQ]
* [Oracle AQ]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/seebeyond-jms-server-integration[SeeBeyond]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/sonicmq-integration[SonicMQ]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/sun-jms-grid-integration[Sun JMS Grid]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/swiftmq-integration[SwiftMQ]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/tibco-ems-integration[Tibco EMS]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/weblogic-jms-integration[WebLogic JMS]
