...
For a list of notification types, see link:/mule-user-guide/v/3.2/notifications-configuration-reference[Notifications Configuration Reference]. For a list of notification listener interfaces, see MULE3USER:Notification Interfaces below.
