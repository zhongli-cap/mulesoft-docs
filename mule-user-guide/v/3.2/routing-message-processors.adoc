...
Message Processors are used within flows to control how messages are sent and received within that flow. This is further described in link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-flows-for-service-orchestration[Using Flows for Service Orchestration]. (Within services, the same job is performed by message routers – see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-mule-services[Using Mule Services] and link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-message-routers[Using Message Routers] for further details.)
...
The Message Filter is used to control whether a message is processed by using a link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-filters[filter]. In addition to the filter, you can configure whether to throw an exception if the filter does not accept the message and an optional message processor to send unaccepted messages to.
...
See link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mule-object-stores[Mule Object Stores] for further information about object stores in Mule.
