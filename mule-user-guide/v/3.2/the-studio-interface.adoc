...
* link:the-studio-palette[The Studio Palette]
* link:studio-building-block-properties[Studio Building Block Properties]
* link:the-studio-xml-editor[The Studio XML Editor]
...
* Cloud Connectors +
 +
 See link:mule-studio-essentials[Mule Studio Essentials] for details.
...
For a discussion of key Mule concepts and terminology, including flow architecture, see: link:mule-studio-essentials[Mule Studio Essentials]
...
If you have questions about Mule or Studio, please take a look at our link:studio-faq[FAQ page].
