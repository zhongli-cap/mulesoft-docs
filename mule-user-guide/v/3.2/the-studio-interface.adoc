...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/the-studio-palette[The Studio Palette]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/studio-building-block-properties[Studio Building Block Properties]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/the-studio-xml-editor[The Studio XML Editor]
...
* Cloud Connectors +
 +
 See link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mule-studio-essentials[Mule Studio Essentials] for details.
...
For a discussion of key Mule concepts and terminology, including flow architecture, see: link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mule-studio-essentials[Mule Studio Essentials]
...
If you have questions about Mule or Studio, please take a look at our link:https://docs.mulesoft.com/mule-user-guide/v/3.2/studio-faq[FAQ page].
