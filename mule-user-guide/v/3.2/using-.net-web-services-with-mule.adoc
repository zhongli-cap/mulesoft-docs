...
For more information see link:configuring-security[Configuring Security] and #[Using HTTPS with CXF]#.
...
If you are using CXF, you can configure a client and service to use WS-Security. For details, see link:enabling-ws-security[Enabling WS-Security].
