...
For further information about the use of thread pools in services, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/tuning-performance[About Threads in Mule].
...
For more details, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mule-object-stores[Mule Object Stores].
