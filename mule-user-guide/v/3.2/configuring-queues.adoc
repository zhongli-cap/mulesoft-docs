...
Note that users of the Enterprise Edition of Mule ESB can use the management console to monitor queues and gain historical insight into the numbers of messages they have contained. For details, see link:/mule-user-guide/v/3.2/mule-management-console-3.2.x[Using the Mule Management Console].
