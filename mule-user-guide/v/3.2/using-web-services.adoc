...
link:cxf-module-reference[CXF Module Reference] - Describes how to build and consume web services with CXF.
...
link:web-service-wrapper[Web Service Wrapper] - Describes how to use the `WebServiceWrapperComponent` class to send the result of a web service call to another endpoint.
...
link:echo-example[Echo Example] - A simple example of exposing a Mule service as a web service using Axis.
