...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/hot-deployment[Hot Deployment]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/application-deployment[Application Deployment]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/application-format[Application Format]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/deployment-descriptor[Deployment Descriptor]
