...
* Using link:https://docs.mulesoft.com/mule-user-guide/v/3.2/quartz-transport-reference[Quartz] to generate a periodic input signal
* Using the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/ajax-transport-reference[AJAX transport] to update a web page from Mule
...
We declare Drools as the Rules Engine implementation, for more info. on this, refer to the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/drools-module-reference[Drools Module Reference].
...
Declare the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/ajax-transport-reference[AJAX connector] which will be used to update the Web UI.
...
To keep things simple for the example, we define link:https://docs.mulesoft.com/mule-user-guide/v/3.2/vm-transport-reference[in-memory ("VM") queues] to transport messages. If this were a real application, the incoming stock ticks would probably be received via a web service and the outgoing alerts would probably be delivered to a link:https://docs.mulesoft.com/mule-user-guide/v/3.2/jms-transport-reference[JMS queue] or via link:https://docs.mulesoft.com/mule-user-guide/v/3.2/xmpp-transport-reference[IM]/SMS/link:https://docs.mulesoft.com/mule-user-guide/v/3.2/email-transport-reference[E-mail].
...
In this flow, we use link:https://docs.mulesoft.com/mule-user-guide/v/3.2/quartz-transport-reference[Quartz] to generate a periodic signal which triggers our `TickFeed` component. The `TickFeed` component simulates a new stock tick by reading in a line from a text file and putting it on the `stockTick` queue.
...
For more info. on the configuration of the Rules Engine, refer to the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/drools-module-reference[Drools Module Reference].
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/drools-module-reference[Drools Module Reference]
* http://www.jboss.org/drools/documentation.html[Drools Documentation]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/ajax-transport-reference[AJAX Transport Reference]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/quartz-transport-reference[Quartz Transport Reference]
