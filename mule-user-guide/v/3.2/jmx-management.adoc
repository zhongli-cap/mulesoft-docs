...
There are several link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mule-agents[agents] provided with Mule ESB for JMX support. The easiest way to configure JMX is to use the default JMX support agent.
