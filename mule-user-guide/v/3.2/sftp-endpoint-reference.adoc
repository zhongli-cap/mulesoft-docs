...
. Choose between a one-way or request-response exchange pattern. (For details, see: link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mule-studio-essentials[About Main Flows]).
...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/sftp-transport-reference[SFTP Transport Reference] for details on setting the properties for an SFTP endpoint using an XML editor.
