...
For quick-start installation instructions that cover just the essentials installing the Mule development environment, go to link:hello-mule[Hello, Mule!], which leads you through a basic installation — and helps you write your first Mule application, as well.
