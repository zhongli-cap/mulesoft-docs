...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/[Back to Index] 
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-outbound-endpoints-to-publish-data[Using Outbound Endpoints to Publish Data]
