...
This page provides details on the elements you configure for link:https://docs.mulesoft.com/mule-user-guide/v/3.2/outbound-routers[outbound routers]. This information is pulled directly from the schema files and is cached. If the information appears to be out of date, refresh the page.
