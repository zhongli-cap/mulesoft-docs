...
This page provides details on the elements you configure for link:outbound-routers[outbound routers]. This information is pulled directly from the schema files and is cached. If the information appears to be out of date, refresh the page.
