...
Two methods exist for creating a global element. This discussion covers only the more direct procedure. (For details on the other, more general procedure, see: link:https://docs.mulesoft.com/mule-user-guide/v/3.2/configuring-global-mule-elements[Configuring Global Mule Elements]).
