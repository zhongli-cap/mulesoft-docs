...
Two methods exist for creating a global element. This discussion covers only the more direct procedure. (For details on the other, more general procedure, see: link:configuring-global-mule-elements[Configuring Global Mule Elements]).
