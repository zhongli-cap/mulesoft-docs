...
* services. For link:configuring-queues[SEDA queues], between an inbound and a service component.
...
* *Mule 3.2* Flows. Through the queued-asynchronous processing-strategy. See link:flow-processing-strategies[Flow Processing Strategies] for more information about the queued-asynchronous processing-strategy.
