...
This page provides details on the elements you configure for link:inbound-routers[inbound routers]. This information is pulled directly from `mule.xsd` and is cached. If the information appears to be out of date, refresh the page.
