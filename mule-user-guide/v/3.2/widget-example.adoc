...
These are instructions for running the Widget example in Mule 3.2. To run it in Mile 3.1, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/widget-example-mule-3.1[here].

This example illustrates the use of Mule's link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mule-high-availability[High Availability (HA)] module for failover.
