...
This example illustrates the use of Mule's link:mule-high-availability[High Availability (HA)] module for failover.
...
For more information, see link:mule-high-availability[Mule High Availability]
