...
The Process Engine is an instance of http://www.jboss.org/jbpm[JBoss jBPM] and is configured using defaults as follows. For more information refer to the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/bpm-module-reference[BPM Module Reference] documentation.
