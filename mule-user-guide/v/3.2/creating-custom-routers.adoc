...
Typically, you implement custom routing in Mule ESB with link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-filters[filters], but occasionally you may need to implement a custom router.
