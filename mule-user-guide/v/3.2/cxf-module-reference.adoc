...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/cxf-module-overview[Overview]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/building-web-services-with-cxf[Building Web Services]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/consuming-web-services-with-cxf[Consuming Web Services]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/proxying-web-services-with-cxf[Proxying Web Services]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-http-get-requests[Using HTTP GET Requests]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/bookstore-example[Bookstore Example]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/cxf-module-configuration-reference[Configuration Reference]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/wsdl-connectors[Using the WSDL Connector]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/upgrading-cxf-from-mule-2[Upgrading CXF from Mule 2]

*Web Service Standards*

* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/supported-web-service-standards[Supported Web Service Standards]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-mtom[Using MTOM]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/enabling-ws-addressing[Enabling WS-Addressing]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/enabling-ws-security[Enabling WS-Security]
