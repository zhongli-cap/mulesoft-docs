...
This page provides details on the elements you configure for link:catch-all-strategies[catch-all strategies]. This information is pulled directly from `mule.xsd` and is cached. If the information appears to be out of date, refresh the page.
