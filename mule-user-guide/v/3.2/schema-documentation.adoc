...
If you are familiar with previous versions of Mule, you may want to consult this list of link:https://docs.mulesoft.com/mule-user-guide/v/3.2/notes-on-mule-3.0-schema-changes[schema changes].
