...
For details on configuring WebLogic JMS in Mule, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/weblogic-jms-integration[WebLogic JMS Integration].
