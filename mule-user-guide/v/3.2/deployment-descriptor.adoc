...
For details on classloading in Mule, including a diagram of the Mule classloading architecture, see link:classloader-control-in-mule[Classloader Control in Mule].
