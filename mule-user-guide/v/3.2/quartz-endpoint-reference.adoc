...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/quartz-transport-reference[Quartz Transport Reference] for details on setting the properties for a Quartz endpoint using an XML editor.
