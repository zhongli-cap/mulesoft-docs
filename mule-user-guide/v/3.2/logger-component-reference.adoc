...
For more information about the Logger component, read link:logger-element-for-flows[Logger Element for Flows].

For more information about Mule expressions, read link:expressions-configuration-reference[Expressions Configuration Reference]
