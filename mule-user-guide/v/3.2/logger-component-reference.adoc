...
For more information about the Logger component, read link:https://docs.mulesoft.com/mule-user-guide/v/3.2/logger-element-for-flows[Logger Element for Flows].

For more information about Mule expressions, read link:https://docs.mulesoft.com/mule-user-guide/v/3.2/expressions-configuration-reference[Expressions Configuration Reference]
