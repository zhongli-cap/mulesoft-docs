...
To deploy Mule as a service to Tomcat or Tcat Server, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/deploying-mule-as-a-service-to-tomcat[Deploying Mule as a Service to Tomcat].
