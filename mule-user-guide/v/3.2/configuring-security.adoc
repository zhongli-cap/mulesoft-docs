...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/configuring-the-spring-security-manager[Configuring the Spring Security Manager]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/component-authorization-using-spring-security[Component Authorization Using Spring Security]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/setting-up-ldap-provider-for-spring-security[Setting up LDAP Provider for Spring Security]
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/configuring-the-acegi-security-manager[Configuring the Acegi Security Manager]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/component-authorization-using-acegi[Component Authorization Using Acegi]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/setting-up-ldap-provider-for-acegi[Setting up LDAP Provider for Acegi]
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/ws-security-example[WS-Security Example] The WS-Security example demonstrates the different possibilities available for incorporating WS-Security into your Mule application. This example is available in the enterprise edition of Mule as of version 2.2.3.
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/enabling-ws-security[Enabling WS-Security] - Describes how to secure your CXF SOAP endpoints with WS-Security.
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/saml-module[SAML Module] - Mule now supports the SAML standard for exchange of security information between systems. This module is available in the enterprise edition of Mule as of version 2.2.3

== Other Security Integration

Mule also supports the following security technologies:

* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/encryption-strategies[Encryption Strategies] - Secure your messages by encrypting them.
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/pgp-security[PGP Security] - Secure your messages by encrypting them with PGP.
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/jaas-security[Jaas Security]
