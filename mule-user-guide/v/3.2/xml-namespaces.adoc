...
You can specify the namespace on any XML-based functionality in Mule, including the JXPath filter, Jaxen filter, XPath filter, filter-based splitter, expression splitter, round-robin splitter, JXPath extractor transformer, and XPath expression transformer in the link:/mule-user-guide/v/3.2/xml-module-reference[XML Module Reference], link:/mule-user-guide/v/3.2/xpath-annotation[XPath Annotation], as well as the SXC filter and filtering router in the link:/mule-user-guide/v/3.2/sxc-module-reference[SXC Module Reference].
