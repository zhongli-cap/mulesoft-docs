...
* For more information about the And Filter, see link:filters-configuration-reference[here].
* For more information about the Not Filter, see link:filters-configuration-reference[here].
* For more information about the Or Filter, see link:filters-configuration-reference[here].
