...
This page provides reference information on the elements you configure for transactions. For more information on transactions, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/transaction-management[Transaction Management].
