...
For more information, see the Mule ESB page link:https://docs.mulesoft.com/mule-user-guide/v/3.2/creating-custom-transformers[Creating Custom Transformers]
