...
When Mule starts, it will discover this bootstrap file before loading any configuration and will install any objects listed in the file into the local registry. For more information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/bootstrapping-the-registry[Bootstrapping the Registry].
