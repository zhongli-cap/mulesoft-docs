...
This document assumes that you are familiar with [Mule ESB] and the link:/mule-user-guide/v/3.2/mule-studio-essentials[Mule Studio interface]. To increase your familiarity with Studio, consider completing one or more link:/mule-user-guide/v/3.2/mule-studio[Mule Studio Tutorials].
