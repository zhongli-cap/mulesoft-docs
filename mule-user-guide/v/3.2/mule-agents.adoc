...
For a list of agents provided with Mule and how to configure them, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/jmx-management[JMX Management]. You can also create a custom agent as described below.
