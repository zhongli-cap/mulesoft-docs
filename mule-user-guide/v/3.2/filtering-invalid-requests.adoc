...
This example adds a new filter to the existing 'core-concepts' project created in the link:understanding-the-mule-message[Understanding the Mule Message] example.
