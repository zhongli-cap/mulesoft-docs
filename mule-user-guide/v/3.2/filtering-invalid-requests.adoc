...
This example adds a new filter to the existing 'core-concepts' project created in the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/understanding-the-mule-message[Understanding the Mule Message] example.
