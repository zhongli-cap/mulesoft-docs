...
* For information on controlling the method to call in a class (the entry point) and working with component lifecycles, see link:/mule-user-guide/v/3.2/developing-components[Developing Components].
