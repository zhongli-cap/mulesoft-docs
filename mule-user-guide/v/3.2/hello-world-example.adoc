...
If you are using the Mule IDE, you can simply create a new project based on the Hello World example and run it from Eclipse as described on the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/hello-mule[Hello Mule Page].
