...
You can expose a manager's logging configuration over JMX by configuring a Log4J Jmx agent in your Mule configuration file. See link:https://docs.mulesoft.com/mule-user-guide/v/3.2/jmx-management[JMX Management] for more information.
