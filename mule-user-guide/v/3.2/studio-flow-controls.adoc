...
|image:AllRouter-24x16.png[AllRouter-24x16] |All |Sends one message to multiple message processors. |link:https://docs.mulesoft.com/mule-user-guide/v/3.2/all-flow-control-reference[All Flow Control Reference]


image:Choice-24x16.png[Choice-24x16] |Choice |Evaluates a message against specified criteria, then sends it to the first message processor that matches those criteria. |link:https://docs.mulesoft.com/mule-user-guide/v/3.2/choice-flow-control-reference[Choice Flow Control Reference]
