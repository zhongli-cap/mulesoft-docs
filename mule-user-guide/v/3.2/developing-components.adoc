...
For details on configuring entry point resolvers, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/entry-point-resolver-configuration-reference[Entry Point Resolver Configuration Reference].
...
See link:https://docs.mulesoft.com/mule-user-guide/v/3.2/service-messaging-styles[Service Messaging Styles] for more detail about the different configuration options that affect message flow.
