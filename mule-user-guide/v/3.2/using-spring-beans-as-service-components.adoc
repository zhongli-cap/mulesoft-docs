...
For more information on component configuration, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/configuring-components[Configuring Components]. For more information on the elements you use to configure components, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/component-configuration-reference[Component Configuration Reference].
