...
Mule ESB provides several link:/mule\-user\-guide/v/3\.2/expressions-configuration-reference[default expression evaluators], allowing you to embed expression logic in a variety of expression languages, or you can link:/mule\-user\-guide/v/3\.2/creating-expression-evaluators[create your own evaluators] to support additional languages.

This page describes how to use expressions. For more details on how to configure expressions, see link:/mule\-user\-guide/v/3\.2/expressions-configuration-reference[Expressions Configuration Reference].

== Message Property Scopes

Starting with Mule 3 expressions operating on message properties also support an optional scope qualifier syntax. Read link:/mule\-user\-guide/v/3\.2/message-property-scopes[Message Property Scopes] for more info.

== Using Expressions with Transformers

This section describes the transformers that support expressions. For more information on transformers, see link:/mule\-user\-guide/v/3\.2/using-transformers[Using Transformers].
...
To read more about configuring expressions, see link:/mule\-user\-guide/v/3\.2/expressions-configuration-reference[Expressions Configuration Reference].
