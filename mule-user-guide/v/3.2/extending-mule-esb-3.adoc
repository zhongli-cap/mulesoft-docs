...
* A *link:connecting-using-transports[transport]* is a type of module that carries messages between Mule services via a specific protocol. For a list of the available transports you can use, see link:transports-reference[Transports Reference].
