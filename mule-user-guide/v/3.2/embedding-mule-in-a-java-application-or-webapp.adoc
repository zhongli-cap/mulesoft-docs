...
To interact with the Mule server from your application, JSP, or servlet, you can use the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-the-mule-client[Mule Client].
