...
Mule ESB provides a mechanism for adding objects to the Mule registry as soon as a module or transport is loaded. This is useful for registering shared transformers or link:/mule-user-guide/v/3.2/using-expressions[expression evaluators].
