...
This example adds a new flow to the existing 'core-concepts' project created in the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/configuring-an-endpoint[Configuring an Endpoint] example.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/configuring-components[Mule Components]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/configuring-java-components[Configuring Java Components]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/developing-components[EntryPoint Resolvers]
