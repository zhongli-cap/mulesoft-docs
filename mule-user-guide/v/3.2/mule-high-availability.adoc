...
** For a non-transactional transport (like File or HTTP), the message is processed using a link:https://docs.mulesoft.com/mule-user-guide/v/3.2/reliability-patterns[reliability pattern].
