...
** For a non-transactional transport (like File or HTTP), the message is processed using a link:/mule-management-console/v/3.2/reliability-patterns[reliability pattern].
