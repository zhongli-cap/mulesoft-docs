...
Refer to the generic link:https://docs.mulesoft.com/mule-user-guide/v/3.2/script-component-reference[Script Component Reference] to see how a script works with one-way and request-response endpoints.
