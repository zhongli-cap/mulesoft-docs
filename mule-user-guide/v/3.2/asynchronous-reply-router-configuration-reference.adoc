...
This page provides details on the elements you configure for link:https://docs.mulesoft.com/mule-user-guide/v/3.2/asynchronous-reply-routers[asynchronous reply routers]. This information is pulled directly from `mule.xsd` and is cached. If the information appears to be out of date, refresh the page.
