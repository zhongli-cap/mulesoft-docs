...
For more details on the elements you configure for transactions, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/transactions-configuration-reference[Transactions Configuration Reference].

For information on using exception strategies to determine whether a transaction gets committed or rolled back in case of an error, see link:https://docs.mulesoft.com/mule-user-guide/v/3.2/error-handling[Error Handling with Transactions].
...
You can send multiple messages using the link:https://docs.mulesoft.com/mule-user-guide/v/3.2/outbound-routers[recipient list] router, which will send all messages in the same transaction.
...
If you run Mule outside an application server, you can use link:https://docs.mulesoft.com/mule-user-guide/v/3.2/jboss-transaction-manager-reference[JBoss Transaction Manager] to configure an embedded transaction manager.

Currently, only the following transports support XA transactions:

* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/vm-transport-reference[VM Transport Reference]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/jdbc-transport-reference[JDBC Transport Reference]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/jms-transport-reference[JMS Transport Reference]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/mule-wmq-transport-reference[Mule WMQ Transport Reference] (as of Mule Enterprise Edition 2.2)
