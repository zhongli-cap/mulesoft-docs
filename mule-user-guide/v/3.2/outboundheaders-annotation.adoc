...
There are no parameters for this annotation and the parameter must be `java.util.Map<String, Object>`. Any outbound headers set by previous elements in a link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-flows-for-service-orchestration[Flow] or link:https://docs.mulesoft.com/mule-user-guide/v/3.2/using-mule-services[Service] will be accessible and writable in this map.
