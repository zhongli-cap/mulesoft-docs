...
You have completed the Mule installation and setup. You can now go to the link:mule-studio[Mule Studio] for information on getting started, or skip to link:running-mule-esb-3[Running Mule ESB 3] if you will not use the Mule IDE.
