...
This configuration builder allows a JSR-223 complaint script engine such as Groovy or Jython to configure Mule. For more information, see link:scripting-module-reference[Scripting Module Reference].
...
AutoConfigurationBuilder is the default configuration builder. If you want to use another configuration builder, you can specify it in the link:deployment-descriptor[deployment descriptor] of an application.
