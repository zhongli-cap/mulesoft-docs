...
* link:/mule-user-guide/v/3.9/database-connector[DB]
...
* link:/mule-user-guide/v/3.9/jboss-transaction-manager-reference[JBoss]
* link:/mule-user-guide/v/3.9/setting-environment-variables[Set Environment Variables]
