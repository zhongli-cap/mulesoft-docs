...
The Mule message consists of two main parts:
...
Attributes are stored in the Mule message header. Examples include standard file metadata and HTTP headers. In addition to containing these standard attributes, it can also store custom attributes that you create.
