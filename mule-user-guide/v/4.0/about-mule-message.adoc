...
In Studio, you can see the structure of a Mule message at any given point of the flow. All you have to do is select an element in the flow and click the DataSense icon.
