...
* A Mule Message that contains a message payload and its associated attributes.
* Variables that are Mule event metadata that you can use to define variables in your flow.
