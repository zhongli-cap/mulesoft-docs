...
It can be applied to the result of any evaluated expression, and can return any evaluated expression. See the `match` operator in link:dataweave-pattern-matching[Pattern Matching in DataWeave].
