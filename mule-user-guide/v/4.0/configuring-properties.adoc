== Creating Property Placeholders for Apps and Spring Modules

You can create property placeholders that get injected into the Mule App and Spring modules when deploying the app.
...
== To Set Placeholders for Spring Configurations
