...
+
[TIP]
For a full reference about how to extract different values with Dataweave, see link:/mule-user-guide/v/4.0/dataweave-for-extracting-values[Dataweave for extracting values].
