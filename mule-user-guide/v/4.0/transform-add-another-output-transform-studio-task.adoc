...
link:transform-message-component-concept-studio[Transform Message Component]

link:transform-change-target-output-transformation-studio-task[Change the Target Output of a Transformation]
