...
You can [download the jar file](somewhere.com) for the tool that will allow you to encrypt or decrypt single values, and also complete files (both, YAML and Properties files). You can run it in the command line as:
