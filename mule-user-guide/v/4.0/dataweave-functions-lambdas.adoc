...
You can declare functions in the header of a DataWeave script and invoke them at any point in the body of the script. You can also declare functions anywhere in the body.
