...
//QQ: Community Edition Serialization API ??
// https://github.com/mulesoft/mule/blob/mule-3.x/core/src/main/java/org/mule/api/serialization/ObjectSerializer.java
...
//https://docs.mulesoft.com/mule-user-guide/v/3.8/improving-performance-with-the-kryo-serializer#problematic-types
