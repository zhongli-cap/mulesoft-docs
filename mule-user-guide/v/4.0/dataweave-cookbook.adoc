...
|link:/mule-user-guide/v/4.0/dataweave-java-methods[To Call Java Methods via DataWeave]
| Imports a Java class and calls a Java method from a DataWeave script.
