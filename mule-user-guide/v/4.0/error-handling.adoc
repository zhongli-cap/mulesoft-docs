...
Mule throws a messaging error whenever an exception is thrown within a flow. This error is known as a link:mule-user-guide/v/4.0/mule-error-concept[Mule Error]. +
