...
_Alt 1 notes:_
This section links to all known the DataWeave "operators". The main issue is the length of the list. Another is that we are probably missing some operators.
