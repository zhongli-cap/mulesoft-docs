...
For more information on the `<scheduler>` element, please read the link:/mule-user-guide/v/4.0/scheduler-concept[Scheduler documentation].
...
* link:/mule-user-guide/v/4.0/scheduler-concept[Scheduler documentation]