...
* See link:/design-center/v/1.0/to-set-up-connector-configurations[To set up connector configurations] to learn how to use the flow designer UI to create and configure global elements.
