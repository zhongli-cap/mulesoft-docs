...
* See link:/design-center/v/1.0/to-set-up-global-configurations[To set up global configurations] to learn how to use the flow designer UI to create and configure global elements.
