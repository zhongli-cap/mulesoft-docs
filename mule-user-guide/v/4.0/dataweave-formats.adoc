...
In the Transform component, you can define a Copybook type through the following methods:
...
You can import the copybook to your Mule project from a Transform component in Studio 7 through the Set Metadata, as shown in this figure.
...
>>>>>>> 0f9c0b6c6a6f53ec1afe6e98bddf3af7f50c85e5
