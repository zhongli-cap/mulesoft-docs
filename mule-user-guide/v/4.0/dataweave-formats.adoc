...
For Design Center see link:/anypoint-studio/v/6/input-output-structure-transformation-design-center-task[To Define Input and Output Structure of a Transformation (Design Center)].
====
== CSV
