...
|`InputStream/Array[Byte]`|link:/mule-user-guide/v/4.0/dataweave-types#boolean[:binary]
|`java.lang.Boolean`|link:/mule-user-guide/v/4.0/dataweave-types#binary[:boolean]
