...
Multi-part formats is an HTTP message with multiple parts, separated by boundaries that can be named. These parts can include attachments.

Here is an example with named parts, such as `text`, `file1`, and `file2`:

.Input (Multipart Document)
----
TODO
----
...
output multipart/form-data TODO
---
in0
----
