...
* `application/flatfile`: Flat file
...
* `text/plain`: Cobol copybook, Fixed width file, Plain text
...
Functions in the `dw::core::URL` module can transform non-URL-encoded text to URL-encoded (`application/x-www-form-urlencoded`) text and back.
...
---
{
	...
	{
		'encoding': encodeURI(' my text to encode '),
		'decoding': decodeURI('%20my%20text%20to%20decode%20')
	}
}
----
...
<?xml version='1.0' encoding='UTF-8'?>
<myStrings>
  <encoding>%20my%20text%20to%20encode%20</encoding>
  <decoding> my text to decode </decoding>
</myStrings>
----
