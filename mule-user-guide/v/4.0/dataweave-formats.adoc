...
* Cobol Copybook: `text/plain`
* CSV: `application/csv`
* DataWeave: `application/dw` (You might use it when testing a DataWeave expression.)
* Excel: `application/xlsx`
* Fixed Width: `text/plain`
* Form data: `multipart/form-data`, `application/x-www-form-urlencoded`
* Flat File: `application/flatfile`
