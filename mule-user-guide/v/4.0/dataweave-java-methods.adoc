...
Through DataWeave code, you can instance a new object of any class. Note that after creating an instance, you can't call its instance methods via DataWeave, you can however reference its variables.
