...
The link:/mule-user-guide/v/4.0/dataweave[DataWeave] Language is a powerful template engine that allows you to transform data to and from any kind of format (XML, CSV, JSON, Pojos, Maps, etc). In Anypoint Studio, this language can be used in:
...
* Any Mule component that accepts Mule Expression Language, through link:/mule-user-guide/v/4.0/mel-dataweave-functions[MEL DataWeave Functions]
...
Returns the present moment in link:/mule-user-guide/v/4.0/dataweave-types#dates[(:datetime)] type.
