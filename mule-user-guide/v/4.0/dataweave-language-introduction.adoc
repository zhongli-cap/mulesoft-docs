...
.DataWeave Comments
Comments are also accepted by DataWeave in Java-like comment syntax.
----
...
The DataWeave body contains an expression for generating the output structure.
...
The output can include these data types:
