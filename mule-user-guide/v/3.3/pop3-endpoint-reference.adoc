...
See the link:/mule-user-guide/v/3.4/pop3-transport-reference[POP3 Transport Reference] for details on setting the properties for a POP3 endpoint using an XML editor.
