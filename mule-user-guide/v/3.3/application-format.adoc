...
You can share libraries between applications via the link:https://docs.mulesoft.com/mule-user-guide/v/3.5/deployment-descriptor[domain deployment descriptor]
