...
For details on configuring WebLogic JMS in Mule, see link:weblogic-jms-integration[WebLogic JMS Integration].
...
. _Required_. Override commons-lang as described in link:deploying-mule-to-weblogic[Overriding commons-lang]
. Configure logging as described in link:deploying-mule-to-weblogic[Configuring Logging].
