...
For details on configuring WebLogic JMS in Mule, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/weblogic-jms-integration[WebLogic JMS Integration].
...
. _Required_. Override commons-lang as described in link:https://docs.mulesoft.com/mule-user-guide/v/3.3/deploying-mule-to-weblogic[Overriding commons-lang]
. Configure logging as described in link:https://docs.mulesoft.com/mule-user-guide/v/3.3/deploying-mule-to-weblogic[Configuring Logging].
