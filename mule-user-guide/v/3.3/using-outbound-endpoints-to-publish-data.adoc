...
This example requires that you run through the earlier example link:https://docs.mulesoft.com/mule-user-guide/v/3.3/transforming-data-in-a-flow[Transforming Data in a Flow].
...
link:https://docs.mulesoft.com/mule-user-guide/v/3.3/understanding-mule-interaction-with-exchange-patterns[Understanding Mule Interaction with Exchange Patterns]

== Previous Steps

link:https://docs.mulesoft.com/mule-user-guide/v/3.3/invoking-component-methods[Invoking Component Methods]
