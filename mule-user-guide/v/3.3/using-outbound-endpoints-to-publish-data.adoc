...
link:understanding-mule-interaction-with-exchange-patterns[Understanding Mule Interaction with Exchange Patterns]

== Previous Steps

link:invoking-component-methods[Invoking Component Methods]
