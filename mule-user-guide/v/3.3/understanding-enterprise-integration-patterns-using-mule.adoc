...
|File Transfer |link:file-transport-reference[File Transport]
|Shared Database |link:jdbc-transport-reference[JDBC Transport]
...
|Message Router |link:routing-message-processors[Message Routers]
|Message Translator |link:using-transformers[Message Transformer]
|Message Endpoint |Inbound & Outbound link:message-sources-and-message-processors[Endpoints]
|===
...
|===
|Pattern |Mapping to a Mule Object
|Content-Based Router |link:routing-message-processors[Choice]
|Message Filter |link:using-filters[Filters]
|Recipient List |link:message-sources-and-message-processors[Recipient List]
|Splitter |link:routing-message-processors[Collection Splitter, Message Chunk Splitter & Plain Splitter]
|Aggregator |link:routing-message-processors[Collection Aggregator, Message Chunk Aggregator & Custom Aggregator]
|Resequencer |link:routing-message-processors[Resequencer]
|===
...
|======
|Pattern |Mapping to a Mule Object
|Content Enricher |link:message-enricher[Message Enricher]
|======
...
|=======
|Pattern |Mapping to a Mule Object
|Wire Tap |link:routing-message-processors[Wire Tap]
|=======

== Related Topics

* link:using-mule-configuration-patterns[Configuring Mule with Patterns]
