...
Following is an introduction to configuring Mule ESB via the Spring XML file. For details on this file, see link:about-the-xml-configuration-file[About the XML Configuration File].
...
* link:custom-message-processors[Custom Message Processors] - Observe a message, or modify either a message or the message flow. Examples include transformers and filters.
* link:using-flows-for-service-orchestration[Flows] - Use message processors to define message flow between a source and a target.
