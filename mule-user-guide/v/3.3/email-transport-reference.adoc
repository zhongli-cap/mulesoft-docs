...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/smtp-transport-reference[SMTP]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/imap-transport-reference[IMAP]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/pop3-transport-reference[POP3]
