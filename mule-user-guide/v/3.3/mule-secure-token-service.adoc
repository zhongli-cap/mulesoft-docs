...
[WARNING]
The *Mule Oauth 2.0 Secure Token Service* is not yet fully certified for operation on *CloudHub*. If you are interested in deploying it in this environment, please visit the http://www.mulesoft.com/support-login[MuleSoft Customer Portal] and open a ticket to request guidance.
