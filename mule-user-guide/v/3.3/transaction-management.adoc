...
For more details on the elements you configure for transactions, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/transactions-configuration-reference[Transactions Configuration Reference].

For information on using exception strategies to determine whether a transaction gets committed or rolled back in case of an error, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/error-handling[Error Handling with Transactions].
...
If you run Mule outside an application server, you can use link:https://docs.mulesoft.com/mule-user-guide/v/3.3/jboss-transaction-manager-reference[JBoss Transaction Manager] to configure an embedded transaction manager.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-wmq-transport-reference[Mule WMQ Transport Reference] (as of Mule Enterprise Edition 2.2)
...
, which is the default receiver on inbound JMS endpoints that use XA transactions. If you are using JBoss transactions, please read link:https://docs.mulesoft.com/mule-user-guide/v/3.3/jboss-transaction-manager-reference[here] for information on how to configure the `timeout` value.
...
|JBoss |no |yes |java:/TransactionManager |http://www.mulesoft.org/docs/site/current/apidocs/org/mule/transaction/lookup/JBossTransactionManagerLookupFactory.html[org.mule.transaction.lookup.JBossTransactionManagerLookupFactory]

|Weblogic
|yes |yes |javax.transaction.TransactionManager |http://www.mulesoft.org/docs/site/current/apidocs/org/mule/transaction/lookup/WeblogicTransactionManagerLookupFactory.html[org.mule.transaction.lookup.WeblogicTransactionManagerLookupFactory]

|WebSphere
|? |yes |_Proprietary API call_ |http://www.mulesoft.org/docs/site/current/apidocs/org/mule/transaction/lookup/WebsphereTransactionManagerLookupFactory.html[org.mule.transaction.lookup.WebsphereTransactionManagerLookupFactory]

|Resin
|no |yes |java:comp/TransactionManager |http://www.mulesoft.org/docs/site/current/apidocs/org/mule/transaction/lookup/Resin3TransactionManagerLookupFactory.html[org.mule.transaction.lookup.Resin3TransactionManagerLookupFactory]
...
|_Other_
|? |yes |Specified via a _jndiName_ property |http://www.mulesoft.org/docs/site/current/apidocs/org/mule/transaction/lookup/GenericTransactionManagerLookupFactory.html[org.mule.transaction.lookup.GenericTransactionManagerLookupFactory]
|===
