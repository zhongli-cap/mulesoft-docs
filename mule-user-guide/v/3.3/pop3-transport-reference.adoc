...
|POP3 |http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc SchemaDoc] |image:check.png[check] | -  |image:check.png[check] | -  | -  | -  |one-way |one-way |org.mule.transport:mule-transport-pop3

|POP3S |http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc SchemaDoc] |image:check.png[check] | -  |image:check.png[check] | -  | -  | -  |one-way |one-way |org.mule.transport:mule-transport-pop3s
|===
...
POP3 and POP3S endpoints include details about connecting to a POP3 mailbox. You link:https://docs.mulesoft.com/mule-user-guide/v/3.3/configuring-endpoints[configure the endpoints] just as you would with any other transport, with the following additional attributes:
...
For more information about transformers, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/email-transport-reference[Transformers] section in the Email Transport Reference.

For more information about filters, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/email-transport-reference[Filters] section in the Email Transport Reference.

== Exchange Patterns / Features of the Transport

See link:https://docs.mulesoft.com/mule-user-guide/v/3.3/transports-reference[transport matrix].
...
For more information about the limitations, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/email-transport-reference[Limitations] section in the Email Transport Reference.
