...
|POP3 |http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc SchemaDoc] |image:check.png[check] | -  |image:check.png[check] | -  | -  | -  |one-way |one-way |org.mule. http://transportmule-transport-pop3[transport:mule-transport-pop3]

|POP3S |http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc SchemaDoc] |image:check.png[check] | -  |image:check.png[check] | -  | -  | -  |one-way |one-way |org.mule. http://transportmule-transport-pop3s[transport:mule-transport-pop3s]
|===
