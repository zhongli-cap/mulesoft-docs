...
Refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.3/authorization-grant-types[Authorization Grant Types] for more information on the other types of authorization grants.
...
* For more information on Oauth 2.0 in Mule, refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.8/mule-secure-token-service[Mule Secure Token Service].
