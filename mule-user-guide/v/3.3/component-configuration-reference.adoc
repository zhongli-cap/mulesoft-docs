...
This page provides details on elements you configure for components. This information is pulled directly from `mule.xsd` and is cached. For more information on components, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/configuring-components[Configuring Components].
...
See link:https://docs.mulesoft.com/mule-user-guide/v/3.3/using-interceptors[Using Interceptors].

== Entry Point Resolvers

See link:https://docs.mulesoft.com/mule-user-guide/v/3.3/entry-point-resolver-configuration-reference[Entry Point Resolver Configuration Reference].
