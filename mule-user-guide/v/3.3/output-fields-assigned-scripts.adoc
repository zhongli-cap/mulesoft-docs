...
[TIP]
This document assumes the reader is familiar with the DataMapper Transformer. Consult the link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper Transformer Reference] document for details.
...
. Alternatively, click to drag any input field from the *Expression* pane or any function from the *Function* pane into the *Script* pane. (Refer to the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/output-fields-assigned-scripts#example-using-functions[Using Functions] example below for an illustration of this activity.)
...
[TIP]
For more details on using DataMapper's Preview feature to test your mapping, consult link:https://docs.mulesoft.com/mule-user-guide/v/3.3/obtaining-a-preview-of-mapped-data[Obtaining a Preview of Mapped Data].
