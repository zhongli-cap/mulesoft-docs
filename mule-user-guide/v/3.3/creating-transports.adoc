...
For a quick start, use the Maven link:transport-archetype[Transport Archetype].
...
Each transport has a service descriptor that describes what classes are used to construct the transport. For complete information, see link:transport-service-descriptors[Transport Service Descriptors].
