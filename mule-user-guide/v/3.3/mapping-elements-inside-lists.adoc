...
* link:mapping-elements-inside-lists[Mapping Nested Lists to a Flat File (XML to CSV)]
* link:mapping-elements-inside-lists[Mapping Nested Lists to a Structured Data File (XML to JSON)]
