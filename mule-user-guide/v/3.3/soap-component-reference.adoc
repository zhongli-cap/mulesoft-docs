...
Consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/enabling-ws-security[Enabling WS-Security] document to configure the security elements of your Web service.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/cxf-module-reference[CXF Module]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/enabling-ws-security[security]
