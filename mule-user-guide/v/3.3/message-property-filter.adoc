...
For more information on using a Message Property Filter, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/using-filters[Using Filters].

== Mule Reference

For more information about Message Property Filter, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/filters-configuration-reference[Filters Configuration Reference].
