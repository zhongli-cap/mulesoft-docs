...
* *New Mule Project based on a template* — Studio opens a wizard to help you open a new project from a link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-examples[template].
* *Go to Mule Studio* — Studio opens without opening a new project.

== link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-studio-essentials[Next: Learn the Essentials >>]
