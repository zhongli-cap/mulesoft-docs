...
image:decrypt-xml.png[decrypt-xml]
...
* For more information on encryption in Mule, refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-message-encryption-processor[Mule Message Encryption Processor].
* For more information on signatures in Mule, refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-digital-signature-processor[Mule Digital Signature Processor].
