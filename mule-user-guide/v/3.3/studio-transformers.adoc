...
|image:python-transformer-24x16.png[python-transformer-24x16] |Python |Implements a script transformer backed by a Python script engine |link:script-transformer-reference[Script Transformer Reference]
