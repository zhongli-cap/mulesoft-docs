...
* If your application processes messages from a non-transactional transport, use a link:https://docs.mulesoft.com/mule-user-guide/v/3.3/reliability-patterns[reliability pattern] to move them to a transactional store such as a VM or JMS store.
...
* Implement link:https://docs.mulesoft.com/mule-user-guide/v/3.3/reliability-patterns[reliability patterns] to create high reliability applications.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/installing-a-commercial-license[Install an Enterprise License] to begin using the Mule Management Console to manage clusters in production.
