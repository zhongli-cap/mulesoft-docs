...
* If your application processes messages from a non-transactional transport, use a link:/mule-user-guide/v/3.3/reliability-patterns[reliability pattern] to move them to a transactional store such as a VM or JMS store.
...
* Implement link:/mule-user-guide/v/3.3/reliability-patterns[reliability patterns] to create high reliability applications.
