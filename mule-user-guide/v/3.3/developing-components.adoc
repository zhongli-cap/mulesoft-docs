...
For details on configuring entry point resolvers, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/entry-point-resolver-configuration-reference[Entry Point Resolver Configuration Reference].
