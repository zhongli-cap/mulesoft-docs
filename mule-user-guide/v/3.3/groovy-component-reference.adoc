...
Refer to the generic link:https://docs.mulesoft.com/mule-user-guide/v/3.4/script-component-reference[Script Component Reference] page to see how a script works with one-way and request-response endpoints.
