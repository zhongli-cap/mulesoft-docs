...
Servlet endpoints accept the same attributes and child elements as HTTP endpoints. For more information, see link:/mule-user-guide/v/3.7/http-transport-reference[HTTP Transport Reference].
