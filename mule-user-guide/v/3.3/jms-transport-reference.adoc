...
* Supports local (JMS), distributed (XA), and multi-resource link:https://docs.mulesoft.com/mule-user-guide/v/3.3/transaction-management[transactions] *Enterprise*
...
*Enterprise*
Mule Enterprise includes an link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-wmq-transport-reference[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.
====
...
Mule Enterprise includes an link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-wmq-transport-reference[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.

http://activemq.apache.org/[ActiveMQ] is also widely-used with Mule and has link:https://docs.mulesoft.com/mule-user-guide/v/3.7/activemq-integration[simplified configuration].
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/hornetq-integration[HornetQ]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.7/open-mq-integration[Open MQ]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.7/solace-jms[Solace JMS]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/tibco-ems-integration[Tibco EMS]
