...
For reference to the configuration of each filter, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/filters-configuration-reference[Filters Configuration Reference].
...
For more about expressions in Mule, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-expression-language-mel[Mule Expression Language MEL].
