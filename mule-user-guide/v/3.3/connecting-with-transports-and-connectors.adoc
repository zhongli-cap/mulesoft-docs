...
How to use each connector depends on the specific connector. You can find a list of available connectors in link:https://www.mulesoft.com/exchange[Anypoint Exchange].
