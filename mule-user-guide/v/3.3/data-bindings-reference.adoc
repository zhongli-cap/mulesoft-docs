...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.7/jaxb-bindings[JAXB Bindings]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.7/json-module-reference[JSON Bindings]
