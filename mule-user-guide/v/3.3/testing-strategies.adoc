...
Mule provides abstract parent classes to help with unit testing. See link:unit-testing[Unit Testing] for more information.
...
The FTC supports plenty of configuration options. Read more about it there: link:functional-testing[Functional Testing].
