...
Mule provides abstract parent classes to help with unit testing. See link:https://docs.mulesoft.com/mule-user-guide/v/3.6/unit-testing[Unit Testing] for more information.
