...
* Learn how to encrypt your properties file with the link:mule-credentials-vault[Mule Credentials Vault].
* Learn how to encrypt or decrypt messages with link:mule-message-encryption-processor[XML or JCE Encryption].
