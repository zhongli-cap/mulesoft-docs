...
In addition to the functionality described on this page, you can also use the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/sxc-module-reference[SXC Module Reference], which enables efficient XPath XML routing.
...
The XML module contains various XPath filters. For general details on how to use filters, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/using-filters[Filters].
