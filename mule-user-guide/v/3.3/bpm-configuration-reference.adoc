...
This page provides details on the process components you configure for BPM. Some of this information is pulled directly from `mule-bpm.xsd` and is cached. For more information on BPM, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/bpm-module-reference[BPM Module Reference].
...
See link:https://docs.mulesoft.com/mule-user-guide/v/3.4/exception-strategy-configuration-reference[Exception Strategy Configuration Reference].

== Entry Point Resolver

See link:https://docs.mulesoft.com/mule-user-guide/v/3.4/entry-point-resolver-configuration-reference[Entry Point Resolver Configuration Reference].
