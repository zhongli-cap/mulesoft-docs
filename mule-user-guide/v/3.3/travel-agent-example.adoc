...
Rather than use an expression transformer like the ConfirmFlight subflow, this subflow uses an link:/mule-user-guide/v/3.3/datamapper-transformer-reference[Anypoint DataMapper] transformer to prepare a request for the hotels’ SOAP Web service.
