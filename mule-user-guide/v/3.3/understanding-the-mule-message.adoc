...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-expression-language-mel[Mule Expression Language] - Mule has a powerful expression language built-in for querying request and response payloads and headers. We'll use an expression to log something useful with the logger component.
...
* Next: link:https://docs.mulesoft.com/mule-user-guide/v/3.3/filtering-invalid-requests[Filtering Invalid Requests]
