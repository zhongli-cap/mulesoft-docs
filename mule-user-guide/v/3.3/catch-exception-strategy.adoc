...
|Execute When |
A MEL expression to indicate the kind of exception the catch exception strategy handles when it is embedded within a link:choice-exception-strategy[*Choice Exception Strategy*].
