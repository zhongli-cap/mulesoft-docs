...
|Execute When |
A MEL expression to indicate the kind of exception the catch exception strategy handles when it is embedded within a link:https://docs.mulesoft.com/mule-user-guide/v/3.3/choice-exception-strategy[*Choice Exception Strategy*].
