...
This transformer sets the payload to the string you define. The payload can be a literal string or a link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-expression-language-mel[Mule Expression].
