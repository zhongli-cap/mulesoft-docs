...
Should you need to encrypt passwords in your properties file, consider using the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-credentials-vault[Mule Credentials Vault]. Refer to the documentation for link:https://docs.mulesoft.com/mule-user-guide/v/3.3/anypoint-enterprise-security[Anypoint Enterprise Security] for more information on securing applications in Mule.
