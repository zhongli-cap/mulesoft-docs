...
Should you need to encrypt passwords in your properties file, consider using the link:mule-credentials-vault[Mule Credentials Vault]. Refer to the documentation for link:anypoint-enterprise-security[Anypoint Enterprise Security] for more information on securing applications in Mule.
