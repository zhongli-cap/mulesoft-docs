...
Refer to link:mule-application-architecture[Mule Application Architecture] document for further details on how Mule works.

== link:getting-comfortable-with-studio[Next: Get Comfortable with Mule Studio >>]
