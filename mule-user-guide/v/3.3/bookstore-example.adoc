...
The Bookstore example is configured to run in an embedded link:https://docs.mulesoft.com/mule-user-guide/v/3.3/jetty-transport-reference[Jetty servlet container] from within the Mule server.
...
|`CatalogAdminInterface` |Invoked by the Admin Web app, uses a link:https://docs.mulesoft.com/mule-user-guide/v/3.3/servlet-endpoint-reference[Servlet Endpoint] to convert HTML into a book object for the Catalog Service
|=====
