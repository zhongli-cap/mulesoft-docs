...
....
In Studio, drag the *Choice* icon from the Studio palette to the canvas, positioning it within the sequence of link:studio-building-blocks[building blocks] that form the flow (below). 
