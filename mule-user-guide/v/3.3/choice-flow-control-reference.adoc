...
This document describes the behavior of the *Choice Flow Control* for Mule Studio 3.3.1 and 3.3.2 only. Refer to the link:mule-user-guide/v/3.2/choice-flow-control-reference[previous version] of this document for details pertaining to earlier versions of Mule Studio.
====
