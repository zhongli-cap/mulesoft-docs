...
Port 3300 is predefined by SAP, so if you need to validate other port numbers based on your SAP instance number, you can check the complete list of service-to-port mappings, which can be found link:https://docs.mulesoft.com/mule-user-guide/v/3.3/sap-jco-server-services-configuration[here].
...
|jcoClientExtendedProperties-ref |A reference to `java.util.Map` containing additional JCo connection parameters. Additional information and a complete list of parameters can be found link:https://docs.mulesoft.com/mule-user-guide/v/3.3/sap-jco-extended-properties[here] | 
|===
...
[NOTE]
You can use link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-expression-language-mel[Mule Expressions] inside the address attribute, just as you do for other Mule ESB transports.
...
|jcoServerExtendedProperties-ref |A Reference to `java.util.Map`, which contains additional JCo connection parameters. Additional information and a complete list of parameters can be found link:https://docs.mulesoft.com/mule-user-guide/v/3.3/sap-jco-extended-properties[here]. | 
|===
...
For more information, consult: link:https://docs.mulesoft.com/mule-user-guide/v/3.3/transactions-configuration-reference[Transactions Configuration Reference].
...
In this example, JCo libraries are informing that the parameter with name _type_ is not valid. The complete list of valid property names can be found link:https://docs.mulesoft.com/mule-user-guide/v/3.3/sap-jco-extended-properties[here].
