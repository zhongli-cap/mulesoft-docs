...
[NOTE]
====
You can create a global exception strategy (i.e. access the Choose Global Type panel) from the reference exception strategy’s pattern properties panel. Click the *image:add.png[(plus)]* button next to the *Global Exception Strategy* drop-down and follow the steps to create a global link:https://docs.mulesoft.com/mule-user-guide/v/3.3/catch-exception-strategy[catch], link:https://docs.mulesoft.com/mule-user-guide/v/3.3/rollback-exception-strategy[rollback], or link:https://docs.mulesoft.com/mule-user-guide/v/3.3/choice-exception-strategy[choice] exception strategy.
