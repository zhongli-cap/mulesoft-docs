...
The application serves these static contents from  *src/main/app/xsd*. See  link:http-static-resource-handler[HTTP Static Resource Handler] for more information about this.
