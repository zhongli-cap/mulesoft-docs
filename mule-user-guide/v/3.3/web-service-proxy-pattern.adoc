...
The application serves these static contents from  *src/main/app/xsd*. See  link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-static-resource-handler[HTTP Static Resource Handler] for more information about this.
