...
For more information on hot deploying Mule applications, see link:application-server-based-hot-deployment[Application Server Based Hot Deployment].
...
. Package your Mule application's configuration file and custom Java classes in `.war` file (see link:application-server-based-hot-deployment[Application Server Based Hot Deployment]).
