...
For more information on hot deploying Mule applications, see link:https://docs.mulesoft.com/mule-user-guide/v/3.7/application-server-based-hot-deployment[Application Server Based Hot Deployment].
...
. Package your Mule application's configuration file and custom Java classes in `.war` file (see link:https://docs.mulesoft.com/mule-user-guide/v/3.7/application-server-based-hot-deployment[Application Server Based Hot Deployment]).
...
* Learn about deploying Mule application in the cloud with link:https://docs.mulesoft.com/runtime-manager/cloudhub[CloudHub].
