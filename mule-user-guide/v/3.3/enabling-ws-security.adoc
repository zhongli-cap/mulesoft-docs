...
|cxf:saml2-token-validator |Checks messages against http://en.wikipedia.org/wiki/SAML_2.0SAML 2.0 assertion statements in order to approve or reject access to the Web service.
...
* link:/mule-user-guide/v/3.3/soap-component-reference[SOAP component]
