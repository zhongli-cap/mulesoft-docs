...
* Read about related transformers, the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/session-variable-transformer-reference[session variable transformer] and the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/property-transformer-reference[properties transformer], which you can use to set properties and variables for different scopes.
