...
You can expose a manager's logging configuration over JMX by configuring a Log4j JMX agent in your Mule configuration file. See link:jmx-management[JMX Management] for more information.
