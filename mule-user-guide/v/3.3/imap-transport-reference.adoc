...
|IMAP
|http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc SchemaDoc] |image:check.png[check] | - | -  | -  | -  | -  |one-way |one-way |org.mule. http://transportmule-transport-imap[transport:mule-transport-imap]
|IMAPS |http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc SchemaDoc] |image:check.png[check] | -  | -  | -  | -  | -  |one-way |one-way |org.mule. http://transportmule-transport-imaps[transport:mule-transport-imaps]
|===
