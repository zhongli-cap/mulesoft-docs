...
http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_ajax/namespace-overview.html[SchemaDoc] |image:check.png[check] |image:check.png[check] |image:error-1.png[error-1] |image:/documentation/images/icons/emoticons/error.gif[image] |image:check.png[check] |image:/documentation/images/icons/emoticons/error.gif[image] |one-way |one-way |org.mule.http://transportmule-transport-ajax/[transport:mule-transport-ajax]
|===
