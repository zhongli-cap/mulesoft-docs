...
The http://en.wikipedia.org/wiki/Multicast[Multicast] transport sends and receives messages from groups of multicast sockets. It is implemented on top of link:udp-transport-reference[UDP] and is highly scalable since knowledge of the receivers is not required.
