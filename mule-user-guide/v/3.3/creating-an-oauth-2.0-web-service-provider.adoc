...
. Add a *config-ref* attribute (*Config Reference* field in Studio) with a value that represents the name of the new global OAuth2 Provider element you created link:/mule-user-guide/v/3.3/creating-an-oauth-2.0-web-service-provider[above].
