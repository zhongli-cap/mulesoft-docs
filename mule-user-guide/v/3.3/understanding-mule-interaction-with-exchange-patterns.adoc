...
Next: link:https://docs.mulesoft.com/mule-user-guide/v/3.3/running-the-examples-from-the-management-console[Running the Examples From the Management Console]
