...
Access the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/embedding-mule-in-a-java-application-or-webapp[Bookstore example application] to witness Mule as an embedded as a web application inside a Servlet container.

== Interacting with Mule from Your Code

To interact with the Mule server from your application, JSP, or servlet, you can use the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-the-mule-client[Mule Client]
