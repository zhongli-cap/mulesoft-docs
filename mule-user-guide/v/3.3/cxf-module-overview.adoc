...
For information about what standards are supported, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/supported-web-service-standards[Supported Web Service Standards].
