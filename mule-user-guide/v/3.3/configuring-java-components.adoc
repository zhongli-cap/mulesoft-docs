...
For a real-world example of using `<spring-object/>`, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/using-spring-beans-as-flow-components[Using Spring Beans as Flow Components].
...
You can configure entry point resolvers that determine how your component is invoked when a message is received by the flow. See link:https://docs.mulesoft.com/mule-user-guide/v/3.3/developing-components[Developing Components] for a more detailed description of their functionality.
...
See link:https://docs.mulesoft.com/mule-user-guide/v/3.3/developing-components[Developing Components] for more information about lifecycles.
...
Binding can be used on Java components and script components. For more information see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/component-bindings[Component Bindings].
...
For more information about pooling and reference documentation for pooling configuration options, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/tuning-performance[Tuning Performance].
