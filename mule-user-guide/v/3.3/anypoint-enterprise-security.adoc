...
Install the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/installing-anypoint-enterprise-security[Anypoint Enterprise Security update] on your instance of Mule Studio Enterprise Edition 3.3.2.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/configuring-the-spring-security-manager[Mule Security Manager], client authentication and authorization on inbound requests as well as credential mapping for outbound calls
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/setting-up-ldap-provider-for-spring-security[LDAP] and third party identity management system integration
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/enabling-ws-security[Validation of inbound requests] through the SAML 2.0 federated identity standard
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/sftp-transport-reference[Secure FTP (SFTP) Transport] that enables Mule flows to read and write to remote directories over the SSH protocol.
...
link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-credentials-vault[Encrypt a properties file]
...
link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-message-encryption-processor[Encrypt a message payload]

link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-message-encryption-processor[Decrypt a message payload]
...
link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-digital-signature-processor[Add a digital signature to a message in Mule]

link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-digital-signature-processor[Sign part of a message payload]

link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-digital-signature-processor[Verify a digital signature in Mule]
...
link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-filter-processor[Filter unsecure messages]
...
link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-crc32-processor[Apply a CRC to a message]
