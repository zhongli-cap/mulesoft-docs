...
This example adds a new filter to the existing 'core-concepts' project created in the link:adding-business-logic-to-a-flow[Adding Business Logic to a Flow] example.
...
* link:developing-components[Working with Components]

== Next Steps

Next: link:transforming-data-in-a-flow[Transforming Data in a Flow]

Previous: link:understanding-the-mule-message[Understanding the Mule Message]
