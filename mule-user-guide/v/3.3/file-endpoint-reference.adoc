...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/file-transport-reference[File Transport Reference] for details on setting the properties for a File endpoint using an XML editor.
