...
The module archetype can be used for updating existing modules and transports. It allows developers to add template code for schema configurations and link:https://docs.mulesoft.com/mule-user-guide/v/3.3/bootstrapping-the-registry[bootstrap the registry]. It will leave your existing code untouched.
