...
link:/mule-user-guide/v/3.3/creating-flow-objects-and-transformers-using-annotations[Using Annotations]


== Next Steps

Next: link:/mule-user-guide/v/3.3/using-outbound-endpoints-to-publish-data[Using Outbound Endpoints to Publish Data]

Previous: link:/mule-user-guide/v/3.3/transforming-data-in-a-flow[Transforming Data in a Flow]
