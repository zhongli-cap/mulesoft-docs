...
This tutorial continues the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/adding-business-logic-to-a-flow[Adding Business Logic to a Flow] example. At this point, you should have created a flow called `_hello.mflow_` and a POJO component named `_Hello_` with a single method called `_sayHello_`. The `_sayHello_` method returns the text "Hello" with the name that you pass in.
...
+
image:studioMethodStub.png[image,align="center"]
...
+
image:studioAddTransformerComponent.png[image,align="center"]
...
+
image:studioConfigureTransformerComponent.png[image,align="center"]
+
...
+
image:studioCase1BrowserOutput.png[image,align="center"]
...
----
+
image:studioUserCode.png[image,align="center"]
...
----
+
image:studioHttpRequestToUserCode.png[image,align="center"]
...
+
image:studioAddHelloComponentMethod.png[image,align="center"]

. Run the project again and use the same URL:
+
`http://localhost:8082/?name=Jas&lname=bhatia`
+
image:studioCase2BrowserOutput.png[image,align="center"]
...
----
+
image:studioCase3Code.png[image,align="center"]
+
...
----
+
image:studioCase4Code.png[image,align="center"]

. Run the example again using `http://localhost:8082/?name=Jas&lname=bhatia`
+
image:studioCase4BrowserOutput.png[image,align="center"]
...
link:https://docs.mulesoft.com/mule-user-guide/v/3.3/creating-flow-objects-and-transformers-using-annotations[Using Annotations]


== Next Steps

Next: link:https://docs.mulesoft.com/mule-user-guide/v/3.3/using-outbound-endpoints-to-publish-data[Using Outbound Endpoints to Publish Data]

Previous: link:https://docs.mulesoft.com/mule-user-guide/v/3.3/transforming-data-in-a-flow[Transforming Data in a Flow]
