...
JSON Path can be used in link:non-mel-expressions-configuration-reference[Mule expressions] to query JSON message payloads for filtering or link:message-enricher[enrichment].
