...
JSON Path can be used in link:/mule-user-guide/v/3.3/non-mel-expressions-configuration-reference[Mule expressions] to query JSON message payloads for filtering or link:/mule-user-guide/v/3.3/message-enricher[enrichment].
