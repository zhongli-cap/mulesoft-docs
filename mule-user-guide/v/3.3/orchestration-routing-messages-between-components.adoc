...
Mule link:/mule-user-guide/v/3.3/understanding-configuration-patterns-using-mule[configuration patterns] make it easy to perform common bits of orchestration, for instance, bridging two endpoints. Using configuration patterns where possible simplifies the work required to configure Mule.
