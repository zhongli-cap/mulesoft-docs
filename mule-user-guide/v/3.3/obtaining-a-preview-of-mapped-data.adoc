...
[TIP]
For details on Anypoint DataMapper's *Input arguments* feature, consult link:https://docs.mulesoft.com/mule-user-guide/v/3.3/using-input-arguments[DataMapper - Using Input Arguments].
