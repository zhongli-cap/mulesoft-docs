...
** link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]
...
Consider setting up your application following a link:/mule-user-guide/v/3.3/reliability-patterns[reliability pattern].
