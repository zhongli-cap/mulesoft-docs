...
The VM transport has often been used to implement complex integrations made up of multiple applications. Improvements in Mule 3 obviate the need for VM in many cases. You can use link:https://docs.mulesoft.com/mule-user-guide/v/3.3/flow-ref-component-reference[Flow References] to directly reference one flow from another without a transport in the middle.
...
_One-way_ VM queues can take part in distributed link:https://docs.mulesoft.com/mule-user-guide/v/3.3/transaction-management[XA Transactions]. To make a VM endpoint transactional, use a configuration like the following:
...
Using XA requires that you add a transaction manager to your configuration. For more information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/transaction-management[Transaction Management].
...
The transaction element configures a transaction. Transactions allow a series of operations to be grouped together so that they can be rolled back if a failure occurs. For more information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/transaction-management[Transaction Management].
...
a|Schema Location:
a|http://www.mulesoft.org/schema/mule/vm/3.3/mule-vm.xsd; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/connector.html#xml_source[XML source]
a|Imports Schemas (3):
...
link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/connector.html[connector]
...
Content:
 ...
 a|
complex, 7 attributes, attr. link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/complexTypes/annotatedType.html#a5[wildcard], 8 elements
...
Defined:
 ...
 a|
globally in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/connector.html#xml_source[XML source]
...
link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/endpoint.html[endpoint]
...
Content:
 ...
 a|
complex, 12 attributes, attr. link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/complexTypes/annotatedType.html#a5[wildcard], 15 elements
...
Defined:
 ...
 a|
globally in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/endpoint.html#xml_source[XML source]
...
link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/inbound-endpoint.html[inbound-endpoint]
...
Defined:
 ...
 a|
globally in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/inbound-endpoint.html#xml_source[XML source]
...
link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/outbound-endpoint.html[outbound-endpoint]
...
Defined:
 ...
 a|
globally in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/outbound-endpoint.html#xml_source[XML source]
...
link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/queue-profile.html[queue-profile]
...
Type:
 ...
 a|
link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/complexTypes/queueProfileType.html[mule:queueProfileType]
...
Defined:
 ...
 a|
link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/vmConnectorType.html#a8[locally] witnin link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/vmConnectorType.html[vmConnectorType] complexType in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/queue-profile.html#xml_source[XML source]
...
Defined:
 ...
 a|
link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/vmConnectorType.html#a9[locally] witnin link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/vmConnectorType.html[vmConnectorType] complexType in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/queueProfile.html#xml_source[XML source]

|===

link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/transaction.html[transaction]
...
Type:
 ...
 a|
link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/complexTypes/baseTransactionType.html[mule:baseTransactionType]
...
Subst.Gr:
 ...
 a|
may substitute for element link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/elements/abstract-transaction.html[mule:abstract-transaction]

a|
Defined:

 a|
globally in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/elements/transaction.html#xml_source[XML source]
...
Defined:
 ...
 a|
globally in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/globalEndpointType.html#xml_source[XML source]

a|
Used:

 a|
at 1 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/globalEndpointType.html#a3[location]
...
Defined:
 ...
 a|
globally in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/inboundEndpointType.html#xml_source[XML source]

a|
Used:

 a|
at 1 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/inboundEndpointType.html#a3[location]
...
Defined:
 ...
 a|
globally in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/outboundEndpointType.html#xml_source[XML source]

a|
Used:

 a|
at 1 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/outboundEndpointType.html#a3[location]
...
Content:
 ...
 a|
complex, 7 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/vmConnectorType.html#a7[attributes], attr. link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/complexTypes/annotatedType.html#a5[wildcard], 8 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/vmConnectorType.html#a10[elements]

a|
Defined:

 a|
globally in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/vmConnectorType.html#xml_source[XML source]

a|
Includes:

 a|
definitions of 1 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/vmConnectorType.html#a6[attribute], 2 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/vmConnectorType.html#a8[elements]

a|
Used:

 a|
at 1 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/complexTypes/vmConnectorType.html#a3[location]
...
Content:
 ...
 a|
1 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/attributeGroups/addressAttributes.html#a5[attribute]

a|
Defined:

 a|
globally in link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/schema-overview.html[mule-vm.xsd]; see link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/attributeGroups/addressAttributes.html#xml_source[XML source]

a|
Includes:

 a|
definition of 1 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/attributeGroups/addressAttributes.html#a4[attribute]

a|
Used:

 a|
at 3 link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-vm_xsd/attributeGroups/addressAttributes.html#a2[locations]
...
Consider setting up your application following a link:https://docs.mulesoft.com/mule-user-guide/v/3.3/reliability-patterns[reliability pattern].
