...
For details on classloading in Mule, including a diagram of the Mule classloading architecture, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/classloader-control-in-mule[Classloader Control in Mule].
