...
* For more information about Mule high availability, consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-high-availability-ha-clusters[Mule High Availability] documentation.
...
|===
|link:https://docs.mulesoft.com/mule-user-guide/v/3.3/evaluating-mule-high-availability-clusters-demo[*<< Back to Demo Home*]
|===
