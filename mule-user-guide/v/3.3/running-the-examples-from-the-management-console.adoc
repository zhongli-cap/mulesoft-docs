...
Consult the link:installing[Installing] for details on launching Mule ESB Standalone with Management Console.
====
...
Next: link:basic-studio-tutorial[Basic Studio Tutorial]

Previous: link:understanding-mule-interaction-with-exchange-patterns[Understanding Mule Interaction with Exchange Patterns]
