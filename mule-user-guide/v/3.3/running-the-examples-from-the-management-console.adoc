...
Consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing[Installing] for details on launching Mule ESB Standalone with Management Console.
====
...
Next: link:https://docs.mulesoft.com/mule-user-guide/v/3.3/basic-studio-tutorial[Basic Studio Tutorial]

Previous: link:https://docs.mulesoft.com/mule-user-guide/v/3.3/understanding-mule-interaction-with-exchange-patterns[Understanding Mule Interaction with Exchange Patterns]
