...
. If you do not already have Mule (v3.3.2) Enterprise Edition with Mule Studi installed on your system, download link:http://www.mulesoft.com/mule-esb-open-source-esb[Mule 3.3 Enterprise trial Designtime]. Not sure which version of Mule you have installed? link:https://docs.mulesoft.com/mule-user-guide/v/3.3/complete-installation-manual[Here's how to find out.]
. Launch Mule Studio.
+
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/anypoint-enterprise-security-example-application[Anypoint Enterprise Security Example Application] demonstrates Mule Enterprise Security features in action.
