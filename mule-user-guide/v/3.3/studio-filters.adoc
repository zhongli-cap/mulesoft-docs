...
|image:Filter-24x16.png[Filter-24x16] |Message |Applies specified criteria to a message to determine whether it should be processed |link:message-property-filter[Message Filter Reference]
