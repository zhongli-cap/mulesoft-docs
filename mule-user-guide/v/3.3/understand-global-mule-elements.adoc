...
* In the *Anypoint Studio XML Editor*, scroll to the top of the XML config file to see the global elements configured _outside and above_ all flows in the application (below, right).
