...
AutoConfigurationBuilder is the default configuration builder. If you want to use another configuration builder, you can specify it in the link:https://docs.mulesoft.com/mule-user-guide/v/3.7/mule-application-deployment-descriptor[deployment descriptor] of an application.
