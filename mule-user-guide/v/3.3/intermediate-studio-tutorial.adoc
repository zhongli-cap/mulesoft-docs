...
Launch Mule Studio and create a new Mule Project named CBR Tutorial. If you need more directions on launching Studio and creating a project, please refer to the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/basic-studio-tutorial[Basic Studio Tutorial]. 
...
[cols="10,85"]
|===
|*link:https://docs.mulesoft.com/mule-user-guide/v/3.3/http-endpoint-reference[HTTP endpoint]* |Allows your Mule application to connect to Web resources through the HTTP or HTTPS protocol; find this in the Endpoints section of the palette
...
|*link:https://docs.mulesoft.com/mule-user-guide/v/3.3/variable-transformer-reference[Variable Transformer]* |Sets a flow variable on the message that can be invoked elsewhere in the flow; find this message processor in the Transformers section of the palette
|link:https://docs.mulesoft.com/mule-user-guide/v/3.3/choice-flow-control-reference[*Choice Router*] |Routes incoming messages according to configured logic; find this in the Flow Controls section of the palette
|*link:https://docs.mulesoft.com/mule-user-guide/v/3.3/set-payload-transformer-reference[Set Payload Transformer]* |Modifies your payload into a different message, depending on the results of the choice routing; find this in the Transformers section of the palette
|link:https://docs.mulesoft.com/mule-user-guide/v/3.3/logger-component-reference[*Logger*] |Logs messages or activity based on the value of a Mule expression; find this in the Components section of the palette at the right of the screen
|===
...
* a **link:https://docs.mulesoft.com/mule-user-guide/v/3.3/flow-ref-component-reference[Flow Reference Component]**, which invokes another flow in the application. Find this in the Components section of the palette.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-expression-language-mel[complete reference]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mel-cheat-sheet[cheat sheet]
