...
The following configuration demonstrates how to configure the link:jms-transport-reference[JMS Transport Reference] in Mule to use the http://www.sun.com/software/products/message_service_grid/index.xml[Sun JMS Grid] server.
