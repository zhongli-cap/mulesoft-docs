...
The Script Transformer has the same advanced properties as other transformers. Configuring these optional properties is covered in the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/script-transformer-reference[Studio Transformers] page.
