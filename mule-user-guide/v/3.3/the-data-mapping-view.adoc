...
[TIP]
This document assumes the reader is familiar with the Anypoint DataMapper Transformer. Consult the link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper Transformer Reference] document for details.
...
Click *Advanced Mapping Editor* to access DataMapper's advanced editor. For a detailed explanation of *Advanced Mapping Editor*, consult link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper Transformer Reference].
...
*Input arguments* enable you to include dynamic information, such as the output of Mule variables or functions in your mapping. Consult link:https://docs.mulesoft.com/mule-user-guide/v/3.3/using-input-arguments[Using Input Arguments] for details.

*Rules* enable you to dynamically define mappings based on properties of the input data. For a detailed explanation of rules, consult the link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[XPATH Mapping section] of the DataMapper Transformer Reference page.

*Lookup tables* facilitate mappings from one value to another on the basis of lookup table definitions. For details consult the link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[Lookup Tables section] of the DataMapper Transformer Reference page.

image:20-3.example.png[20-3.example]
|*21* |*Preview* tab. Click to obtain a preview of your mapping. Consult link:https://docs.mulesoft.com/mule-user-guide/v/3.3/obtaining-a-preview-of-mapped-data[Obtaining a Preview of Mapped Data] for details.
