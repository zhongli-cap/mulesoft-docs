...
*Input arguments* enable you to include dynamic information, such as the output of Mule variables or functions in your mapping. Consult link:using-input-arguments[Using Input Arguments] for details.
...
|*21* |*Preview* tab. Click to obtain a preview of your mapping. Consult link:obtaining-a-preview-of-mapped-data[Obtaining a Preview of Mapped Data] for details.
