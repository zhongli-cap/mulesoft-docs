...
[NOTE]
When sending requests to an external web service, the recommended approach is to use the link:/mule-user-guide/v/3.3/web-service-consumer[Web Service Consumer]﻿ rather than the CXF Module.
