...
The units from which Flows are constructed are known generically as Building Blocks. In general, these correspond to icons on the Studio graphical link:mule-studio-essentials[canvas] or link:mule-studio-essentials[XML elements] within the Mule application configuration file.
