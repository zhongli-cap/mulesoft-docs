...
The units from which Flows are constructed are known generically as Building Blocks. In general, these correspond to icons on the Studio graphical link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-studio-essentials[canvas] or link:https://docs.mulesoft.com/mule-user-guide/v/3.3/mule-studio-essentials[XML elements] within the Mule application configuration file.
...
Under certain conditions, Flows do not need to be triggered by Message Sources. For instance, a link:https://docs.mulesoft.com/mule-user-guide/v/3.3/flow-ref-component-reference[Flow Reference Component] can trigger a private, child Flow. Similarly, the link:https://docs.mulesoft.com/mule-user-guide/v/3.3/async-scope-reference[Async Scope] can trigger a child Flow that executes asynchronously, (i.e., in parallel with the parent Flow).
...
For further details, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/flow-processing-strategies[Flow Processing Strategies]
...
Studio provides four pre-packaged error handling strategies to handle exceptions thrown at various points during the message processing sequence. For details, see: link:https://docs.mulesoft.com/mule-user-guide/v/3.3/error-handling[Error Handling]
