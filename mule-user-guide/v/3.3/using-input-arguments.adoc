...
Consult link:https://docs.mulesoft.com/mule-user-guide/v/3.3/non-mel-expressions-configuration-reference[Mule Expressions Reference] for details.

DataMapper's *Preview* feature facilitates the display of input argument values when you preview mapped data. See link:https://docs.mulesoft.com/mule-user-guide/v/3.3/obtaining-a-preview-of-mapped-data[Obtaining a Preview of Mapped Data].
