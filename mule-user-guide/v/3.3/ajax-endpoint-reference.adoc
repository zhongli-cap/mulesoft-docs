...
For details on setting the properties for an Ajax endpoint using an XML editor, see the link:ajax-transport-reference[Ajax Transport Reference] discussion in the Mule ESB User Guide.
