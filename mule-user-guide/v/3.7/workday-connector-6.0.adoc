...
. Click *Test Connection* to confirm that the parameters of your global Workday connector are accurate, and that Mule is able to successfully connect to your Workday instance. Read more about link:/mule-user-guide/v/3.7/testing-connections[Testing Connections].
