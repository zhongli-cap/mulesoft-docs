...
Install the link:/mule-user-guide/v/3.7/installing-anypoint-enterprise-security[Anypoint Enterprise Security update] on your instance of Anypoint Studio Enterprise Edition 3.3.2 or later.
...
link:/mule-user-guide/v/3.7/mule-credentials-vault[Encrypt a properties file]
...
link:/mule-user-guide/v/3.7/mule-message-encryption-processor[Encrypt a message payload] +
link:/mule-user-guide/v/3.7/mule-message-encryption-processor[Decrypt a message payload]
...
link:/mule-user-guide/v/3.7/mule-digital-signature-processor[Add a digital signature to a message in Mule] +
link:/mule-user-guide/v/3.7/mule-digital-signature-processor[Sign part of a message payload] +
link:/mule-user-guide/v/3.7/mule-digital-signature-processor[Verify a digital signature in Mule]
...
link:/mule-user-guide/v/3.7/anypoint-filter-processor[Filter unsecure messages]
...
link:/mule-user-guide/v/3.7/mule-crc32-processor[Apply a CRC to a message] +
 +

== See Also

. Install the link:/mule-user-guide/v/3.7/installing-anypoint-enterprise-security[Anypoint Enterprise Security update] on your instance of Anypoint Studio or Standalone Enterprise 3.3.2 or later.
