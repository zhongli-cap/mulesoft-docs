...
|===
|Transformer |Description
|link:/mule-user-guide/v/3.7/xmlobject-transformers[XmlToObject < - > ObjectToXml] |Converts XML to a Java object and back again using link:http://xstream.codehaus.org[XStream].
...
The link:/mule-user-guide/v/3.7/scripting-module-reference[Scripting] transformer transforms objects using scripting, such as JavaScript or link:http://groovy.codehaus.org[Groovy] scripts. This transformer is in the link:http://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/module/scripting/transformer/package-summary.html[org.mule.module.scripting.transformer] package.
