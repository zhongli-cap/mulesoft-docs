...
* call various other link:/mule-user-guide/v/3.7/flows-and-subflows[flows]  +

== See Also

* *NEXT STEP:* Learn about how link:/mule-user-guide/v/3.7/flows-and-subflows[flows and subflows] work together in an application.
* Examine an link:/mule-user-guide/v/3.7/flow-architecture-advanced-use-case[advanced use case] showing a more complex flow architecture.
