...
link:/mule-user-guide/v/3.7/mule-filters-scopes-and-routers[image:filters-routers-scopes.png[Filters,Scopes, and Routers]]   link:/mule-user-guide/v/3.7/mule-exception-strategies[image:exception_strategies.png[Exception Strategies]]
