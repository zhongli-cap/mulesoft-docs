...
* *Studio* - An instance of link:https://www.mulesoft.com/lp/dl/mule-esb-enterprise[Anypoint Studio]. If you do not use Anypoint Studio for development, follow the instructions to  <<Configuring Maven Dependencies,Configuring Maven Dependencies>> in your `pom.xml` file.
