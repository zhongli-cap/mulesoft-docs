...
It also assumes you are familiar with the link:/anypoint-studio/v/5/index[Anypoint Studio] interface. To increase your familiarity with Studio, consider completing one or more link:/mule-user-guide/v/3.7/first-day-with-mule[Anypoint Studio Tutorials].
...
* For more information on encryption in Mule, see link:/mule-user-guide/v/3.7/mule-message-encryption-processor[Mule Message Encryption Processor].
* For more information on signatures in Mule, see link:/mule-user-guide/v/3.7/mule-digital-signature-processor[Mule Digital Signature Processor].
