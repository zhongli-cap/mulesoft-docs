...
http://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/module/atom/package-summary.html[Atom]
...
== See Also
* link:http://cwiki.apache.org/confluence/display/ABDERA/Your+first+AtomPub+Server[Your First AtomPub Server]
* link:http://cwiki.apache.org/confluence/display/ABDERA/Spring+Integration[Abdera Spring Integration]
* link:http://cwiki.apache.org/confluence/display/ABDERA/Documentation[Abdera User's Guide]
