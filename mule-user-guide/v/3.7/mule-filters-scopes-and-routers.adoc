...
* *NEXT STEP*: Read on about link:/mule-fundamentals/v/3.7/mule-exception-strategies[exception strategies].
* Skip ahead to understand the structure of a link:/mule-fundamentals/v/3.7/mule-message-structure[Mule message].
* View link:/mule-fundamentals/v/3.7/anypoint-exchange[examples].
