...
* *NEXT STEP*: Read on about link:/mule-fundamentals/v/3.7/mule-filters-scopes-and-routers[Filters, Scopes, and Routers].
...
* Learn more about setting, then using link:/mule-fundamentals/v/3.7/mule-message-structure[properties and variables].
