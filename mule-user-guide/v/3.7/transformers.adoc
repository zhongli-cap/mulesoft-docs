...
|image:Transformer-24x16.png[Transformer-24x16] |Serialize-to-Byte-Array |Converts a Java Object to a byte array by serializing the object |link:/mule-user-guide/v/3.7/object-to-xml-transformer-reference[Object-to-XML Transformer Reference]
...
|image:Transformer-24x16.png[Transformer-24x16] |XML-to-Json |Converts XStream to Json |link:/mule-user-guide/v/3.7/https://docs.mulesoft.com/mule-user-guide/v/3.7/dataweave-reference-documentation#example-transformation[DataWeave XML to Json Example]
...
For detailed information on configuring standard and custom Transformers with an XML editor, see link:/mule-user-guide/v/3.7/using-transformers[Using Transformers].
