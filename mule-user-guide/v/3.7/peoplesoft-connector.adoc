...
* For additional technical information regarding the PeopleSoft Connector, visit our link:http://mulesoft.github.io/mule-peoplesoft-connector/2.0.0/apidocs/mule/peoplesoft-config.html[online documentation].
