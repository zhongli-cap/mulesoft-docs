...
Add and configure the CloudHub connector according to the basic setup in our link:https://docs.mulesoft.com/cloudhub/hello-world-on-cloudhub["Hello World" CloudHub tutorial application].
...
* link:/cloudhub/index[Introducing CloudHub]
