...
Developing in Maven is greatly simplified by the link:/mule-user-guide/v/3.7/maven-tools-for-mule-esb[Maven Tools for Mule ESB] plugin, which provides Maven archetypes for building Mule applications.

== Assumptions

This document assumes that you are working with Maven outside of Anypoint Studio, and thus will be using archetypes to build Mule applications. See link:/mule-user-guide/v/3.7/using-maven-with-mule[Using Maven with Mule] for an overview of using Maven to manage your Mule projects.
...
* Learn about link:/mule-user-guide/v/3.7/maven-tools-for-mule-esb[Maven tools for Mule ESB], a Mule plugin to develop Mule applications in Maven.
* Control instances of Mule ESB using the link:/mule-user-guide/v/3.7/mule-esb-plugin-for-maven[Mule ESB plugin for Maven].
