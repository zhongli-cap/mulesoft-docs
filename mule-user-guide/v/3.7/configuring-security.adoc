...
For more information on these features and instructions for downloading them, see link:/mule-user-guide/v/3.7/anypoint-enterprise-security[Anypoint Enterprise Security].
====
...
* link:/mule-user-guide/v/3.7/enabling-ws-security[Enabling WS-Security] - Describes how to secure your CXF connectors with WS-Security.

* link:/mule-user-guide/v/3.7/saml-module[SAML Module] - Mule now supports the SAML standard for exchange of security information between systems. This module is available in the enterprise edition of Mule as of version 2.2.3
...
* link:/mule-user-guide/v/3.7/pgp-security[PGP Security] - Secure your messages by encrypting them with PGP.
