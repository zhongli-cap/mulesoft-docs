...
. link:/mule-user-guide/v/3.7/adding-community-runtime[Add Community runtime to AnypointStudio] (_optional_).
. link:/mule-user-guide/v/3.7/installing-an-enterprise-license[Install an Enterprise license] (_optional_).
. link:/mule-user-guide/v/3.7/installing-extensions[Extend Mule with plugins, modules, runtimes and connectors] (_optional_).
