...
:keywords: anypoint, studio, esb, on premises, on premise, properties, system properties, property placeholders
...
link:http://www.mulesoft.org/docs/site/current/apidocs/org/mule/config/DefaultMuleConfiguration.html[org.mule.config.DefaultMuleConfiguration]
