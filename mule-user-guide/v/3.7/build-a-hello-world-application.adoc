...
link:/mule-user-guide/v/3.7/first-day-with-mule[First Day with Mule] and link:/mule-user-guide/v/3.7/first-week-with-mule[First Week with Mule] sections of the link:/mule-user-guide/v/3.7[Mule Fundamentals].
