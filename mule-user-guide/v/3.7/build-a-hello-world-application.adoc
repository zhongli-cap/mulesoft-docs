...
This tutorial assumes that you have link:/anypoint-studio/v/5/download-and-launch-anypoint-studio[installed, and launched Anypoint Studio], and that you've read through the link:/anypoint-studio/v/5/index[Anypoint Studio Essentials].
