...
spend much time explaining components. More detailed explanations and concepts exist in the link:/getting-started/index[Anypoint Fundamentals].
...
This tutorial assumes that you have link:/anypoint-studio/v/5/download-and-launch-anypoint-studio[downloaded, installed, and launched Anypoint Studio], and that you've read through the link:/anypoint-studio/v/5/index[Anypoint Studio Essentials].
