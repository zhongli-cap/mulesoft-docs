...
* A link:/mule-user-guide/v/3.7/transaction-management[Transactional Scope] may include its own exception strategy, regardless of what you define at Flow level +
...
* *NEXT STEP*: Read on about the structure of a  link:/mule-fundamentals/v/3.7/mule-message-structure[Mule message].
* See the link:/mule-fundamentals/v/3.7/anypoint-exchange[examples].
* Learn more about configuring the link:/mule-user-guide/v/3.7/catch-exception-strategy[catch], link:/mule-user-guide/v/3.7/rollback-exception-strategy[rollback], link:/mule-user-guide/v/3.7/reference-exception-strategy[reference], and link:/mule-user-guide/v/3.7/choice-exception-strategy[choice] exception strategies.
