...
Users of link:/mule-user-guide/v/3.7/batch-processing[Batch] processing frequently need the ability to determine a Batch job's instance ID during the execution phases of a Batch job.
...
* link:/anypoint-connector-devkit/v/3.8/building-a-batch-enabled-connector[Mule How-to: Build a Batch Enabled Cloud Connector]
