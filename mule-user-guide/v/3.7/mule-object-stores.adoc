...
[NOTE]
====
To use the link:mule-user-guide/v/3.7/object-store-module-reference[Object Store module] in Anypoint Studio, you must first download the *Object Store Connector* from the link:/mule-fundamentals/v/3.7/anypoint-exchange[Anypoint Exchange].
