...
This document assumes that you are familiar with the exercise of building and deploying Mule applications in Mule Studio. Consider reading the link:/getting-started/index[Anypoint Fundamentals] for more information.
