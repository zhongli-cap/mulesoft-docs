...
See the link:/mule-user-guide/v/3.7/connector-configuration-reference[Connector Configuration Reference] for instructions for configuring connectors for endpoint functions or for operations.

See the link:/mule-user-guide/v/3.7/http-connector[HTTP Connector] for information on this operation-based connector.
