...
If you don't use Anypoint Studio for development, view link:http://mulesoft.github.io/servicenow-connector[ServiceNow reference to set dependencies] in your `pom.xml` file.
