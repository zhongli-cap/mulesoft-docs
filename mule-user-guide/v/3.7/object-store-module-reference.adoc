...
[NOTE]
====
To use the object Store module in Anypoint Studio, you must first download the *Object Store Connector* from the link:/mule-user-guide/v/3.7/anypoint-exchange[Anypoint Exchange]. +
