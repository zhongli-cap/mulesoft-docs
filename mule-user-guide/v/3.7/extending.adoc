...
* An *example* is a sample application that you create to help users get up and running more quickly. Several link:/anypoint-exchange[examples] are provided with Mule.
