...
This document assumes that you have read link:/mule-user-guide/v/3.7/mule-expression-language-mel[Mule Expression Language MEL] and have studied the link:/mule-fundamentals/v/3.7/mule-message-structure[Mule message structure]. 
