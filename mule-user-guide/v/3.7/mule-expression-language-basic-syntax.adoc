...
* Access a link:/mule-user-guide/v/3.7/mule-message-tutorial[*MEL tutorial*] that walks you through the various ways you can use MEL expressions in a sample application.
