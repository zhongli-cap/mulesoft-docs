...
This document assumes that you are familiar with the link:/anypoint-studio/v/5/index[Anypoint Studio interface]. To increase your familiarity with Anypoint Studio, consider completing one or more link:/getting-started/[Anypoint Studio Quickstarts].
