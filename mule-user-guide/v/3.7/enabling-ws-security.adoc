...
For more information, see link:https://www.mulesoft.com/exchange#!/soap-web-service-security[SOAP Web Service Security] in Anypoint Exchange. You can also use the link:/mule-user-guide/v/3.7/web-service-consumer[Web Service Consumer] to provide username token and timestamp support for WS-Security.
