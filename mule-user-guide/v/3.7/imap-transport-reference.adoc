...
IMAP and IMAPS endpoints include details about connecting to an IMAP mailbox. You can link:/mule-user-guide/v/3.7/endpoint-configuration-reference[configure the endpoints] just as you would with any other transport, with the following additional attributes:
