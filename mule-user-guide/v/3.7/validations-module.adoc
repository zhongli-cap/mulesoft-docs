...
*Note:* This feature is supported by the Mule runtime as of link:/release-notes/mule-esb-3.7.0-release-notes[Mule ESB 3.7.0] in both Community and Enterprise editions. However, Studio support only became available starting with the September 2015 release.
...
There are several different types of validator that out of the box cover most of the common use cases you might run into. If none of the validators described below cover what you need, you can also link:/mule-user-guide/v/3.7/building-a-custom-validator[build a custom validator].
...
* link:http://blogs.mulesoft.com/dev/tech-ramblings/introducing-the-validations-module/[Blogpost]
