...
For a detailed example in both Studio and XML about how to work with subflows, make sure to check the _Adding a Subflow_ section in our link:/mule-user-guide/v/3.7/content-based-routing-tutorial#sts=Adding%20a%20Subflow[routing tutorial].
