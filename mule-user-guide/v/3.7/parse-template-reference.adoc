...
NOTE: If the `response.template` file can't be opened, link:_attachments/responseHtml.txt[download this text file] and rename it to be `response.template`. 

The response.template file contains:
