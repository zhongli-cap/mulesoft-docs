...
This document assumes that you are familiar with Mule, the link:/anypoint-studio/v/5/anypoint-studio-essentials[Anypoint Studio interface], and link:/mule-fundamentals/v/3.7/global-elements[Global Elements]. Further, it is assumed that you are familiar with the Microsoft .NET Framework.
...
|*link:/mule-user-guide/v/3.7/datamapper-concepts[DataMapper]* |The DataMapper is a Mule transformer that delivers simple, yet powerful, visual design of complex data transformations for use in Mule flows
|===
