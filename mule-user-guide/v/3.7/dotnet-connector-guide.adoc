...
* Anypoint Studio, the graphical interface to Mule ESB. See link:/anypoint-studio/v/6/download-and-launch-anypoint-studio[Download and Launch Anypoint Studio] for details
