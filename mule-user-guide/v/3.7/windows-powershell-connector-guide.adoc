...
As mentioned above, you should keep in mind that the Gateway's response is a JSON serialized representation of the powershell object you returned (i.e. payload generated from the *send* operation is a string type).
