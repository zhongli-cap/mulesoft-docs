...
|*scriptFile* |Path a file containing a PowerShell script. You can use the classic "classpath:{resource_name}" if your script file is within your project's resources.
