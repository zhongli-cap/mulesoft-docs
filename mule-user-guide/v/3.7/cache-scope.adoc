= Cache Scope
:keywords: cache, anypoint, studio, esb, persistent, storage
...
+
[width="100%",cols="15a,15a,50a,20a",options="header"]
|===
...
|===
+
[width="100%",cols="25a,15a,60a",options="header"]
|===
...
[width="100%",cols="15a,15a,70a",options="header"]
|===
...
By default, Mule stores all cached responses in an InMemoryObjectStore. xref:createcachingstrategy[Creating a Caching Strategy] and define a new link:/mule-user-guide/v/3.7/mule-object-stores[object store] if you want to customize the way Mule stores cached responses.
...
[width="100%",cols="25a,35a,40a",options="header"]
|===
...
* Read more about link:/mule-user-guide/v/3.7/scopes[Scopes] in Mule.
