...
|File Transfer |link:/mule-user-guide/v/3.7/file-transport-reference[File Transport]
|Shared Database |link:/mule-user-guide/v/3.7/jdbc-transport-reference[JDBC Transport]
...
|Message Router |link:/mule-user-guide/v/3.7/routers[Message Routers]
|Message Translator |link:/mule-user-guide/v/3.7/using-transformers[Message Transformer]
|Message Endpoint |Inbound & Outbound link:/mule-user-guide/v/3.7/endpoint-configuration-reference[Endpoints]
|===
...
|===
|Pattern |Mapping to a Mule Object
|Content Enricher |link:/mule-user-guide/v/3.7/message-enricher[Message Enricher]
|===
