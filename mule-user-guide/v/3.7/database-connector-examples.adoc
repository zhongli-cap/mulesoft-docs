...
In this example, the database connector references the `MySQL_Configuration` link:/mule-user-guide/v/3.7/global-elements[global element] to obtain connection parameters. `MySQL_Configuration` is configured with the parameters listed below.
