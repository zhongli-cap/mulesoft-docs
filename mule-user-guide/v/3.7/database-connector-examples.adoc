...
link:/anypoint-studio/v/5/datamapper-visual-reference[Anypoint DataMapper Visual Reference] and Mule link:/mule-user-guide/v/3.7/batch-processing[batch processing]. You should also see link:/mule-user-guide/v/3.7/dataweave[DataWeave], which replaces DataMapper.
...
In this example, a database connector retrieves data from two tables. A link:/anypoint-studio/v/5/datamapper-visual-reference[DataMapper transformer] maps this data to the CSV format. A link:/mule-user-guide/v/3.7/file-connector[file connector] writes the resulting CSV file to disk, and a link:/mule-user-guide/v/3.7/logger-component-reference[logger component] logs processing details to the console.
