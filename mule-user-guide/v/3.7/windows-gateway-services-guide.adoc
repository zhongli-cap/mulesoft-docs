...
This setting will extend the error message returned by the service and, in adittion, it will add an internal stack trace of the cause that in some scenarios might help you to understand what the issue or problem could be.
