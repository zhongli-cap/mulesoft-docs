...
This setting will extend the error message returned by the service and, in adittion, it will add a stack trace of the error cause within the service and sometimes it could lead you to understand what the issue or problem could be.
