...
As you can see they all start with the 'CRM.' prefix.
...
This connector has no specific configuration other than the routing service configuration described above at the <<Configuring Dynamics CRM & AX connector settings>> section.
