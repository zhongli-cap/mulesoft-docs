...
<<<<<<< HEAD
* Anypoint Studio, the graphical interface to Mule ESB. See link:/mule-user-guide/v/3.7/download-and-launch-anypoint-studio[Download and Launch Anypoint Studio] for details
=======
