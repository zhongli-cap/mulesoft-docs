...
 link:/anypoint-studio/v/5/index[Visual Editor in Anypoint Studio]. Review the link:/anypoint-studio/v/5/index[Anypoint Studio Essentials] document to learn more about developing with Mule ESB's graphical user interface.
