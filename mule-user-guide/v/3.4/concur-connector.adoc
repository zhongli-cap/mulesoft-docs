...
* The consumer key assigned by Concur; refer to the detailed documentation on how to link:https://docs.mulesoft.com/mule-user-guide/v/3.4/using-a-connector-to-access-an-oauth-api[use the Concur connector to access an OAuth API].

== Assumptions

This document assumes that you are familiar with Mule, link:https://docs.mulesoft.com/mule-user-guide/v/3.4/anypoint-connectors[Anypoint(TM) Connectors], and the link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio interface]. To increase your familiarity with Studio, consider completing one or more link:https://docs.mulesoft.com/anypoint-studio/v/5/basic-studio-tutorial[Anypoint Studio Tutorials]. Further, this page assumes that you have a basic understanding of link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-concepts[Mule flows] and link:https://docs.mulesoft.com/mule-user-guide/v/3.4/global-elements[Mule Global Elements].

This document describes implementation examples within the context of Anypoint Studio, Mule ESB's graphical user interface, and, also includes configuration details for doing the same in the XML Editor.

== Installing Concur Connector in Anypoint Studio

You can "test drive" the Concur connector by installing it in Anypoint Studio. Follow the instructions to link:https://docs.mulesoft.com/mule-user-guide/v/3.4/downloading-and-launching-mule-esb[download and launch Anypoint Studio], then follow the steps below to install the Concur connector.
...
Contact the [MuleSoft Sales Team] to obtain either of these. (Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.4/installing-an-enterprise-license[Installing an Enterprise License].)
...
* A global Concur element that is used by all the Concur connectors in the application (read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.4/global-elements[global elements in Mule]).
...
* Learn more about working with link:https://docs.mulesoft.com/mule-user-guide/v/3.4/anypoint-connectors[Anypoint Connectors].
* Access the link:https://docs.mulesoft.com/release-notes/concur-connector-release-notes[release notes] for the Concur Connector.
