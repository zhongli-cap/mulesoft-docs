...
[TIP]
Placing a Python Component is actually the same as placing a link:https://docs.mulesoft.com/mule-user-guide/v/3.5/script-component-reference[Script component] and then selecting the Python engine.
