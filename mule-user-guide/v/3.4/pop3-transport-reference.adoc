...
|POP3 |  |image:check.png[check] |image:error.png[error] |image:check.png[check] |image:error.png[error] |image:error.png[error] |image:error.png[error] |one-way |one-way |org.mule.transport:mule-transport-pop3
|POP3S |  |image:check.png[check] |image:error.png[error] |image:check.png[check] |image:error.png[error] |image:error.png[error] |image:error.png[error] |one-way |one-way |org.mule.transport:mule-transport-pop3s
|===
...
The POP3 connector supports all the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/configuring-a-transport[common connector attributes and properties] and the following additional attributes:
...
POP3 and POP3S endpoints include details about connecting to a POP3 mailbox. You link:https://docs.mulesoft.com/mule-user-guide/v/3.4/configuring-endpoints[configure the endpoints] just as you would with any other transport, with the following additional attributes:
...
For more information about transformers, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/email-transport-reference[Transformers] section in the Email Transport Reference.

For more information about filters, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/email-transport-reference[Filters] section in the Email Transport Reference.

== Exchange Patterns / Features of the Transport

See link:https://docs.mulesoft.com/mule-user-guide/v/3.4/transports-reference[transport matrix].
...
For more information about the limitations, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/email-transport-reference[Limitations] section in the Email Transport Reference.
