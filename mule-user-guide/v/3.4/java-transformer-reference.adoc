...
For additional information regarding HTTP configuration, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/http-endpoint-reference[HTTP Endpoint Reference].

For more information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/creating-custom-transformer-classes[Creating Custom Transformers].
