...
You can also run multiple applications side-by-side in a Mule instance using the Mule Deployment Model. This model supports live deployment and hot redeployment of applications.  Further, Mule Standalone fully support for link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-high-availability-ha-clusters[Mule High Availability] module and use of the link:/mule-management-console/v/3.4[Mule management console].

For more information on running Mule standalone, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-deployment-model[Mule Deployment Model].
...
You can start and stop Mule from a Java application or embed it in a Webapp (such as a JSP or servlet). For general instructions, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/embedding-mule-in-a-java-application-or-webapp[Embedding Mule in a Java Application or Webapp]. Listed below are links to documentation which offer application server-specifc information regarding Mule application deployment.
...
* http://geronimo.apache.org[Geronimo] (The Geronimo application server uses ActiveMQ as its default JMS provider. For details, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/activemq-integration[ActiveMQ Integration].)

For details on how to support Mule hot deployment within some application servers, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/application-server-based-hot-deployment[Application Server Based Hot Deployment].
