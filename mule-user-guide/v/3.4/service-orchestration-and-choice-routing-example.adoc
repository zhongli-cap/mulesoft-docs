...
This flow is sourced by the HTTP Inbound Endpoint followed by a SOAP Component configured as a JAX-WS Service. The service implementation is in the `Samsung Service Impl`, a link:java-transformer-reference[Java Component]. 
...
* Learn more about about the link:soap-component-reference[SOAP Component].
* Learn more about the link:choice-flow-control-reference[Choice Router/Choice Flow Control].
* Learn more about the link:vm-transport-reference[VM] and link:jms-transport-reference[JMS] transports. 
