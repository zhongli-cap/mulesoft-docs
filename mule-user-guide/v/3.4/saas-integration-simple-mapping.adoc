...
If you were tempted to answer "b" or "c" to any of the questions above, we highly recommend that you take four minutes to read *link:/anypoint-fundamentals/[Anypoint Fundamentals]* before getting started with this Shortcut to Success.
