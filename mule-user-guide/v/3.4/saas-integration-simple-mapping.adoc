...
Before it can do anything with the contact information, the first thing the application has to do is actually accept a CSV file. The *link:https://docs.mulesoft.com/mule-user-guide/v/3.4/file-endpoint-reference[File endpoint]* in the flow behaves as the inbound link:https://docs.mulesoft.com/mule-user-guide/v/3.4/message-sources[message source], accepting files that get put into a specified folder. Once in a link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-concepts[Mule flow], the content of the file becomes a link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-concepts[Mule message] with a link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-concepts[header] and a link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-concepts[payload]. The other link:https://docs.mulesoft.com/mule-user-guide/v/3.4/message-processors[message processors] in the flow will act upon this message by adding to it, transforming it, or otherwise manipulating it.
...
The Salesforce connector also requires a link:https://docs.mulesoft.com/mule-user-guide/v/3.4/global-elements[Global Element], which contains global configurations. At minimum, the global configuration should include a Username, Password, and Security Token, shown in the orange box (below). 

image:Studio_SFglobal.png[Studio_SFglobal]

As you may have suspected, the real magic happens in the blue box (above). The** link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-datasense[Enable DataSense]** checkbox does two thrilling things:
...
. Configure the DataMapper transformer. If your connector is DataSense-enabled, you should only need to configure the input values. Otherwise, you can quickly map inputs to outputs by clicking and dragging input fields to output fields in the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/datamapper-concepts[Data Mapping Console]. 
. Save and run your application. 
. Bask in the glory of your success.

== Dive Deeper

* Walk through this example step by step using the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/connect-with-salesforce-example[Connect with Salesforce Example], included with your instance of Mule Studio.
* Try out more complex link:https://docs.mulesoft.com/mule-user-guide/v/3.4/choosing-mel-or-ctl2-as-scripting-engine[DataMapping using Mule Expression Language] to extract specific data from your message header or payload and dynamically map to your desired format.
* Learn how to customize your link:https://docs.mulesoft.com/mule-user-guide/v/3.4/error-handling[error handling] strategies for more fine-grained control of what kinds of errors are captured and where the data is sent.
