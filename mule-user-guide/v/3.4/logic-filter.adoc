...
* For more information about the And Filter, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/filters-configuration-reference[here].
* For more information about the Or Filter, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/filters-configuration-reference[here].
