...
. Select one of the link:anypoint-connectors[Anypoint Connectors which support connection testing]. 
+
...
* link:using-perceptive-flow-design[DataSense Perceptive Flow Design].
