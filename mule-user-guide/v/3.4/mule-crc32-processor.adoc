...
[NOTE]
This topic introduces the idea of Global Elements; if you are unfamiliar with this functionality, see link:global-elements[Global Elements] to learn more before proceeding.
