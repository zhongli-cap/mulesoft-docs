...
[NOTE]
This topic introduces the idea of Global Elements; if you are unfamiliar with this functionality, see link:/mule-user-guide/v/3.4/global-elements[Global Elements] to learn more before proceeding.
