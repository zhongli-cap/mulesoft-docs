...
Other namespaces can be introduced via `<spring:beans>` or by adding a dedicated element in a module (see the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/scripting-module-reference[Scripting module's] `<lang>` element).
