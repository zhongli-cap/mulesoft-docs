...
Script
|*Message Header* |Rather than acting upon the message payload, these transformers add, remove, or copy properties, variables and attachments within a message's header. This group of message processors doesn't so much transform as _manipulate_ or _enrich_ the contents of the message header. a|Attachment
...
* *NEXT STEP*: Read on about link:/mule-user-guide/v/3.4/mule-filters-wrappers-and-routers[Filters, Wrappers and Routers].
* Skip ahead to understand the structure of a link:/mule-user-guide/v/3.4/mule-message-structure[Mule message].
* Learn more about the link:/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper] transformer.
* Learn more about setting, then using link:/mule-user-guide/v/3.4/mule-message-structure[properties and variables].
