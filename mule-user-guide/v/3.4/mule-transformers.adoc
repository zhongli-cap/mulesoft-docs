...
* *NEXT STEP*: Read on about link:mule-filters-wrappers-and-routers[Filters, Wrappers and Routers].
...
* Learn more about setting, then using link:mule-message-structure[properties and variables].
