...
* *NEXT STEP*: Dive into the more extensive *First Day* content starting with link:mule-concepts[Mule Concepts].
* Happier using the command line to run applications? Learn more about link:starting-and-stopping-mule-esb[starting and stopping Mule].
