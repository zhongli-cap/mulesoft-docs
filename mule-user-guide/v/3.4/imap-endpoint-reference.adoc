image:imap-endpoint-48x32.png[imap-endpoint-48x32]
...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/imap-transport-reference[IMAP Transport Reference] for details on setting the properties for an IMAP endpoint using an XML editor.
