...
* For more information on the Choice Flow Control, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/routing-message-processors[Choice] section on the Routing Message Processor page.
