...
When you start Mule ESB in debug mode, _all_ applications that you launch in that server run in debug mode. Remote debugging does not work with link:mule-high-availability-ha-clusters[clusters].
