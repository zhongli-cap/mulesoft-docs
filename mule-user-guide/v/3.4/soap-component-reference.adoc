...
* Examine details about the link:cxf-module-reference[CXF Module] in Mule.
* Review a link:xml-only-soap-web-service-example[Mule example application] which demonstrates a SOAP Web service.
* Learn more about applying link:enabling-ws-security[security] to SOAP Web services.
* Review an the link:soap-web-service-security-example[Mule example application] which demonstrates the use of WS-security.
