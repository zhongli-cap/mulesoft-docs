...
This document assumes that you are familiar with the http://www.mulesoft.org/documentation/display/current/Mule+Studio+Essentials[Visual Editor in Mule Studio]. Review the link:/anypoint-studio/v/5/index[Mule Studio Essentials] document to learn more about developing with Mule ESB's graphical user interface.
...
* *NEXT STEP:* Use what you've learned to follow the link:/anypoint-studio/v/5/basic-studio-tutorial[Basic Studio Tutorial].
