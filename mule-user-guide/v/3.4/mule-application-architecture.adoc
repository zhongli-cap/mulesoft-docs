...
For further details, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/flow-processing-strategies[Flow Processing Strategies].
...
Studio provides four pre-packaged error handling strategies to handle exceptions thrown at various points during the message processing sequence. For details, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/error-handling[Error Handling].
...
* call various types of link:https://docs.mulesoft.com/mule-user-guide/v/3.4/flows-and-subflows[flows]

== See Also

* *NEXT STEP:* Learn about how link:https://docs.mulesoft.com/mule-user-guide/v/3.4/flows-and-subflows[flows and subflows] work together in an application.
* Examine an link:https://docs.mulesoft.com/mule-user-guide/v/3.4/flow-architecture-advanced-use-case[advanced use case] showing a more complex flow architecture.
