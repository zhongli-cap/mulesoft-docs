...
You can look at the values of these outbound variables by putting a break point after the splitter and running your flow with the link:https://docs.mulesoft.com/mule-user-guide/v/3.5/studio-visual-debugger[Studio Visual Debugger]:
...
* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.7/mule-expression-language-mel[Mule Expression Language (MEL)]
* Learn about other link:https://docs.mulesoft.com/mule-user-guide/v/3.6/all-flow-control-reference[Flow Control] elements
* Read more about the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/async-scope-reference[Async Scope]
