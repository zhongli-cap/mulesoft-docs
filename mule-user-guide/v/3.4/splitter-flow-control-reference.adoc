...
You can look at the values of these outbound variables by putting a break point after the splitter and running your flow with the link:studio-visual-debugger[Studio Visual Debugger]:
...
* Learn more about link:mule-expression-language-mel[Mule Expression Language (MEL)]
* Learn about other link:all-flow-control-reference[Flow Control] elements
* Read more about the link:async-scope-reference[Async Scope]
