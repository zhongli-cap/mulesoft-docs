...
* link:installing-an-enterprise-license[Install an Enterprise License] to begin using the Mule Management Console to manage clusters in production.
* For more information about Mule high availability, consult the link:mule-high-availability-ha-clusters[Mule High Availability] documentation.
