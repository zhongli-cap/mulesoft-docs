...
* *NEXT STEP:* Graduate to the content of the First Week with Mule chapter, starting with link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-application-architecture[Mule Application Architecture].
