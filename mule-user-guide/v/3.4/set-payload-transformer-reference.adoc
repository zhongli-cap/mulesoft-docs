...
This transformer sets the payload to whatever you define. The payload can be a literal string or a link:https://docs.mulesoft.com/mule-user-guide/v/3.5/mule-expression-language-mel[Mule Expression].
...
* See this transformer in action in the link:https://docs.mulesoft.com/mule-user-guide/v/3.5/hello-world-example[Hello World Example].
* Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.5/transformers[other transformers] available in Mule.
