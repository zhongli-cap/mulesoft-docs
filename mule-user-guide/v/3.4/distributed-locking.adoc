...
* Access link:mule-high-availability-ha-clusters[Mule High Availability (HA) Clustering] for an overview.
* Learn how to link:configuring-cluster-nodes[configure cluster nodes.]
* Learn how to enable link:distributed-file-polling[distributed file polling].
