...
* Access link:/mule\-user\-guide/v/3\.4/mule-high-availability-ha-clusters[Mule High Availability (HA) Clustering] for an overview.
* Learn how to link:/mule\-user\-guide/v/3\.4/configuring-cluster-nodes[configure cluster nodes.]
* Learn how to enable link:/mule\-user\-guide/v/3\.4/distributed-file-polling[distributed file polling].
