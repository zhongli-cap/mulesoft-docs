...
* Learn how to link:mule-and-maven[build new Maven projects] directly in Studio
* Learn how to link:converting-studio-into-maven["mavenize" existing Studio projects].
