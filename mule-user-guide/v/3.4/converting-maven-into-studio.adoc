...
* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-and-maven[build new Maven projects] directly in Studio
* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.4/converting-studio-into-maven["mavenize" existing Studio projects].
