...
See link:hardware-and-software-requirements[Hardware and Software Requirements] for information about hardware, operating systems, JDEs, and other software required to run Mule ESB, Mule Management Console, or Mule Studio.

link:installing[Which version of Mule an I using?]
...
* link:downloading-and-launching-mule-esb[download, install, and launch]
* link:installing-an-enterprise-license[Enterprise Edition license].
* link:studio-in-eclipse[Mule Studio as an Eclipse plug-in]