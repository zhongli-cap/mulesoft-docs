...
7 link:atom-module-reference[global elements], 1 link:atom-module-reference[local element], 5 link:atom-module-reference[complexTypes], 1 link:atom-module-reference[attribute group]
