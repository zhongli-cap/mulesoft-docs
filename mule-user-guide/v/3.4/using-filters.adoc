...
For reference to the configuration of each filter, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/filters-configuration-reference[Filters Configuration Reference].
...
For more about expressions, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-expression-language-mel[Mule Expression Language MEL].
