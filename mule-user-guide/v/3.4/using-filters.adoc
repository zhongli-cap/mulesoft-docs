...
For reference to the configuration of each filter, see link:/mule-user-guide/v/3.4/filters-configuration-reference[Filters Configuration Reference].
...
For more about expressions, see link:/mule-user-guide/v/3.4/mule-expression-language-mel[Mule Expression Language MEL].
...
Several Mule transports and modules provide their own filters. For example, the link:/mule-user-guide/v/3.4/xml-module-reference[XML Module Reference] includes a filter to determine if a message is XML. For more information, see link:/mule-user-guide/v/3.4/transports-reference[Transports Reference] and link:/mule-user-guide/v/3.4/modules-reference[Modules Reference]. 
