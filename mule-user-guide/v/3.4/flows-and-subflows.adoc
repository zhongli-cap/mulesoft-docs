...
* In clusters of Mule servers, messages can migrate between nodes when sent to an asynchronous flow. This allows for *load balancing between nodes* and higher performance of application. (See our link:https://docs.mulesoft.com/mule-user-guide/v/3.4/flow-architecture-advanced-use-case[advanced use case] for an example.)
...
Read more about setting up link:https://docs.mulesoft.com/mule-user-guide/v/3.4/transactional[Transactional units] in Mule applications.
====
...
|Asynchronous Flow |Flow Reference wrapped within an link:https://docs.mulesoft.com/mule-user-guide/v/3.4/async-scope-reference[Async Scope] |asynchronous |not inherited
|===

== See Also

* *NEXT STEP:* Learn the various ways you can link:https://docs.mulesoft.com/getting-started/index[deploy Mule applications].
* Read about some alternative ways to control message processing within a flow using link:https://docs.mulesoft.com/mule-user-guide/v/3.4/routing-message-processors[routing message processors].
* Refer to the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/flow-ref-component-reference[Flow Reference Component Reference] and link:https://docs.mulesoft.com/mule-user-guide/v/3.4/async-scope-reference[Async Scope].
* Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.4/flow-processing-strategies[Flow Processing Strategies].
* Read more about setting up link:https://docs.mulesoft.com/mule-user-guide/v/3.4/transactional[transactional units] in Mule applications.
