...
* See the Logger in action in the link:/mule-user-guide/v/3.4/service-orchestration-and-choice-routing-example[Service Orchestration and Choice Routing Example]. 
* Read more about link:/mule-user-guide/v/3.4/configuring-logging[Configuring Logging].
* Check the link:/mule-user-guide/v/3.4/mule-expression-language-mel[Mule Expression Language] reference for more ideas on how to format helpful logger messages.
