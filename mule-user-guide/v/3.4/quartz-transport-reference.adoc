...
* See the link:https://docs.mulesoft.com/mule-user-guide/v/3.5/quartz-connector[Quartz Connector] for details on setting the properties for a Quartz endpoint in Studio's visual editor.
