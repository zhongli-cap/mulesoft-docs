...
* See the link:quartz-endpoint-reference[Quartz Endpoint Reference] for details on setting the properties for a Quartz endpoint in Studio's visual editor.
