...
Namespaces can be configured in the Mule Configuration using the link:xml-namespaces[XML Namespaces], these will be made available for this annotation.

First declare the namespace using the link:xml-namespaces[Namespace Manager] -
