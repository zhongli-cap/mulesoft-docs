...
. Examine the link:/mule-user-guide/v/3.5/mule-sts-oauth-2.0-example-application[Mule STS Outh 2.0 Example Application] which illustrates how to add Outh 2.0 Web service provider in Mule.
