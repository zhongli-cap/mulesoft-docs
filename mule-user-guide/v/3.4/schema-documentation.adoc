...
If you are familiar with versions of Mule older than v 3.0, you may want to consult this list of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/notes-on-mule-3.0-schema-changes[schema changes].
...
* link:http://www.mulesoft.org/docs/site/3.4.0/apidocs/[API Docs]
* link:http://www.mulesoft.org/docs/site/3.4.0/testapidocs/[Test API Docs]
