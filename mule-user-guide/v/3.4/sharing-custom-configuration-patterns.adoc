...
For a list of configuration patterns that ship with Mule, see link:https://docs.mulesoft.com/mule-user-guide/v/3.5/configuration-patterns[Using Mule Configuration Patterns].
