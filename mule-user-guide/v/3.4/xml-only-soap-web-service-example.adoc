...
* Learn more about the link:/mule-user-guide/v/3.4/datamapper-user-guide-and-reference[DataMapper] in Studio.
* Examine other link:/mule-user-guide/v/3.4/mule-examples[Mule application examples], particularly the link:/mule-user-guide/v/3.4/foreach-processing-and-choice-routing-example[Foreach Processing and Choice Routing Example] which also demonstrates content-based routing in Web service integrations.
