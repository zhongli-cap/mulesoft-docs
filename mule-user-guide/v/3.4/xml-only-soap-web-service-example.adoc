...
* Learn more about the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/choice-flow-control-reference[Choice router] in Studio.
* Learn more about the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/soap-component-reference[SOAP component] in Studio.
* Learn more about the link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper] in Studio.
