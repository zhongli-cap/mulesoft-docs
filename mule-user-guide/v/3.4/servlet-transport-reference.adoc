...
For more information about using Mule with servlet containers, see link:/docs/display/34X/Embedding+Mule+in+a+Java+Application+or+Webapp[Embedding Mule in a Java Application or Webapp].
...
Servlet endpoints accept the same attributes and child elements as HTTP endpoints. For more information, see link:/mule-user-guide/v/3.4/http-transport-reference[HTTP Transport Reference].
