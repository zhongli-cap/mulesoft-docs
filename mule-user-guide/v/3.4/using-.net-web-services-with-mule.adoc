...
If you are using CXF, you can configure a client and service to use WS-Security. For details, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/enabling-ws-security[Enabling WS-Security].
