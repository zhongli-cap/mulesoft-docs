...
* *NEXT STEP*: Read on about the structure of a link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-message-structure[Mule message].
* See the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/foreach-processing-and-choice-routing-example[full example application].
* Learn more about configuring the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/catch-exception-strategy[catch], link:https://docs.mulesoft.com/mule-user-guide/v/3.4/rollback-exception-strategy[rollback], link:https://docs.mulesoft.com/mule-user-guide/v/3.4/reference-exception-strategy[reference] and link:https://docs.mulesoft.com/mule-user-guide/v/3.4/choice-exception-strategy[choice] exception strategies.
