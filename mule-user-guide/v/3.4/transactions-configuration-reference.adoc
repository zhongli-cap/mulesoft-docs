...
For more information on how to configure transactions in flows, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/transaction-management[Transaction Management].
====
