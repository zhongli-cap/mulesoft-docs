...
For Mule ESB Community _prior to Mule 3.2_, you must link:configuring-reconnection-strategies[create your own strategies] and configure them using standard Spring syntax
====
