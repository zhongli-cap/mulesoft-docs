...
For more information on component configuration, see link:configuring-components[Configuring Components]. For more information on the elements you use to configure components, see link:component-configuration-reference[Component Configuration Reference].
