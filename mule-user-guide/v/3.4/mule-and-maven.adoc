...
[WARNING]
If you disable *Maven support* in your Studio project _and_ delete the `pom.xml` file, you cannot re-enable it via the Maven Support in Studio menu item. To convert your Studio project into Maven, consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/converting-studio-into-maven[Converting Studio into Maven] documentation.


== See Also

* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/converting-studio-into-maven[Convert your existing Maven project into Studio]. Import the project, then run it as a Maven project directly in Studio.
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/converting-studio-into-maven[Convert your Studio project to Maven] for export.
* Explore how to use link:https://docs.mulesoft.com/mule-user-guide/v/3.4/using-subversion-with-studio[Studio and Subversion].
