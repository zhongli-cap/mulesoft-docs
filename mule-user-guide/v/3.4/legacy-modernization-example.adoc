...
* Learn more about the link:/anypoint-studio/v/6/datamapper-user-guide-and-reference[Anypoint DataMapper transformer] in Studio. link:/mule-user-guide/v/3.4/mule-datasense[DataSense] to intelligently connect an application to Salesforce.
