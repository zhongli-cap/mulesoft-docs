...
For more information on mapping nested elements, refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mapping-elements-inside-lists[Mapping Elements Inside Lists].
====
...
* Learn more about the link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[Anypoint DataMapper transformer] in Studio. link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-datasense[DataSense] to intelligently connect an application to Salesforce.
