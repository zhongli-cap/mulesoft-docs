...
. Optionally, configure the async scope itself with a *Display Name*. If you wish to specify a *Processing Strategy*, see the instructions in the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/async-scope-reference[next section].
+
...
. Configure one or more child elements within the async scope to define the processing that should occur within the asynchronous processing block. Refer to code sample below. If you wish to specify a *Processing Strategy*, see this instructions in the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/async-scope-reference[next section].
+
[%header%autowidth.spread]
|===
...
For more information about these processing strategies and how to configure them, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/flow-processing-strategies[Flow Processing Strategies].
...
. Configure the processing strategy as needed. For more information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/flow-processing-strategies[Flow Processing Strategies].
....
...
* For more information about processing strategies and how to configure them, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/flow-processing-strategies[Flow Processing Strategies]
