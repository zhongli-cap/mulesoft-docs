...
. Complete the procedure link:https://docs.mulesoft.com/mule-user-guide/v/3.4/adding-community-runtime[above] to install additional Mule runtimes on your instance of Studio.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/installing-an-enterprise-license[Install an Enterprise license].
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/studio-update-sites[update sites]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/installing[Mel versions]
