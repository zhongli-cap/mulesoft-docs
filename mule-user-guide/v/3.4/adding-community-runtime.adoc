...
. Complete the procedure link:adding-community-runtime[above] to install additional Mule runtimes on your instance of Studio.
...
* link:installing-an-enterprise-license[Install an Enterprise license].
* link:studio-update-sites[update sites]
* link:installing[Mel versions]
