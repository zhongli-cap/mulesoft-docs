...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/component-authorization-using-spring-security[Securing Flow Components]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/component-authorization-using-spring-security[Setting Security Properties on the Security Provider]
...
In addition to the `daoAuthenticationProvider` and `inMemoryDaoImpl` beans (see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/configuring-security[Configuring Security]), the following beans must be configured:
