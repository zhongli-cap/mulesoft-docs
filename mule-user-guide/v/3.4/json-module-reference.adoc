...
JSON Path can be used in link:mule-expression-language-mel[Mule expressions] to query JSON message payloads for filtering or link:message-enricher[enrichment].
