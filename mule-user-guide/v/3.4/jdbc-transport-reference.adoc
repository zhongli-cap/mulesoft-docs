...
Transactions are supported on JDBC endpoints. See link:https://docs.mulesoft.com/mule-user-guide/v/3.4/transaction-management[Transaction Management] for details.
