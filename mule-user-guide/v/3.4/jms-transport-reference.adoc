...
* Supports local (JMS), distributed (XA), and multi-resource link:https://docs.mulesoft.com/mule-user-guide/v/3.4/transaction-management[transactions] _*Enterprise*_
...
*Enterprise*  +
Mule Enterprise includes an link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-wmq-transport-reference[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.
====
