...
. _Optional_: link:adding-community-runtime[Add Community runtime] to your Mule Studio instance.
. _Optional_: link:installing-an-enterprise-license[Acquire an Enterprise license] (recommended for running applications in production).
...
* mailto:sales@mulesoft.com[Contact MuleSoft] to acquire entitlements to access the link:mulesoft-enterprise-java-connector-for-sap-reference[SAP Connector] and/or link:mule-high-availability-ha-clusters[High Availability Clustering].
...
* link:installing-extensions[Extend Mule] with plugins, modules, runtimes and connectors.
* Access a list of all the link:studio-update-sites[update sites] available for your version of Mule Studio.
