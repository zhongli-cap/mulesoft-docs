...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/cxf-module-overview[Overview]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/building-web-services-with-cxf[Building Web Services]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/consuming-web-services-with-cxf[Consuming Web Services]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/proxying-web-services-with-cxf[Proxying Web Services]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/using-http-get-requests[Using HTTP GET Requests]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/cxf-module-configuration-reference[Configuration Reference]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/wsdl-connectors[Using the WSDL Connector]
