...
Take a look at link:https://docs.mulesoft.com/mule-user-guide/v/3.4/using-mule-configuration-patterns[configuration patterns] and link:https://docs.mulesoft.com/mule-user-guide/v/3.4/using-flows-for-service-orchestration[flows].
...
For more information about patterns, read the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/general-configuration-reference[General Configuration Reference]
