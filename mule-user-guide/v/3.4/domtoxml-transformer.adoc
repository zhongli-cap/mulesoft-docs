...
These transformers support the link:transformers-configuration-reference[standard transformer attributes]. In addition, they support the following configuration.
