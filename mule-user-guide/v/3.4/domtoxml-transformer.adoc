...
These transformers support the link:/mule\-user\-guide/v/3\.4/transformers-configuration-reference[standard transformer attributes]. In addition, they support the following configuration.
