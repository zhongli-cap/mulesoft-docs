...
. link:/mule-user-guide/v/3.4/mule-examples[*Create*] the example application in Mule Studio. _Do not run the application._
...
* Learn more about link:/mule-user-guide/v/3.4/datamapper-user-guide-and-reference[Anypoint DataMapper].
