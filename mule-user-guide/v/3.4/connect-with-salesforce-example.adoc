...
* link:testing-connections[Connection Testing]
...
* link:legacy-modernization-example[Legacy Modernization]
* link:xml-only-soap-web-service-example[XML-only SOAP Web Service]
