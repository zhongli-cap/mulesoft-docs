...
This page assumes an understanding of basic link:mule-concepts[Mule Concepts], link:message-sources[Message Sources], link:message-processors[Message Processors], and link:global-elements[Global Elements].
