...
This page assumes an understanding of basic link:/mule-user-guide/v/3.4/mule-concepts[Mule Concepts], link:/mule-user-guide/v/3.4/message-sources[Message Sources], link:/mule-user-guide/v/3.4/message-processors[Message Processors], and link:/docs/display/34X/Understand+Global+Mule+Elements[Global Elements].
