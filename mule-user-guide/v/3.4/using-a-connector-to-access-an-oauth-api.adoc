...
This page assumes an understanding of basic link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-concepts[Mule Concepts], link:https://docs.mulesoft.com/mule-user-guide/v/3.4/message-sources[Message Sources], link:https://docs.mulesoft.com/mule-user-guide/v/3.4/message-processors[Message Processors], and link:https://docs.mulesoft.com/mule-user-guide/v/3.4/global-elements[Global Elements].
