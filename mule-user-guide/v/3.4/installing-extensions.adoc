...
* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.4/installing-connectors[uninstall Anypoint Connectors].
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/adding-community-runtime[Mule Community Runtime]  
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/installing-anypoint-enterprise-security[Anypoint Enterprise Security]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/installing-connectors[Anypoint Connectors]
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/using-subversion-with-studio[Using Subversion with Studio]
====
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/studio-update-sites[update sites]
