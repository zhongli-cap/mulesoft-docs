...
The Jetty SSL transport works exactly the same way as the link:https-transport-reference[HTTPS Transport Reference].
...
If you do not need this level of security, you can use the link:jetty-transport-reference[Jetty Transport Reference] instead.
