...
The Jetty SSL transport works exactly the same way as the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/https-transport-reference[HTTPS Transport Reference].
...
If you do not need this level of security, you can use the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/jetty-transport-reference[Jetty Transport Reference] instead.
