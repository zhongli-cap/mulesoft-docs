...
* If you see *Anypoint Studio with 3.5.0-M4 Runtime (Early Access)*,  please refer to the link:/mule-user-guide/v/3.4/studio-update-sites[Early Access] version of this page.
====
...
|*MuleStudio Cloud Connectors Update Site* |http://repository.mulesoft.org/connectors/releases/2 a|All Community, Standard, and Premium Anypoint Connectors available for Studio installation. |Access a list of link:/mule-user-guide/v/3.4/anypoint-connectors[Anypoint Connectors already installed in studio] with this version.
...
|Note that you need an Enterprise license to run applications containing link:/mule-user-guide/v/3.4/anypoint-enterprise-security[Anypoint Enterprise Security] features.
...
SAP Connector
|Read more about installing link:/mule-user-guide/v/3.4/studio-in-eclipse[Mule Studio as an Eclipse Plugin].
|===
