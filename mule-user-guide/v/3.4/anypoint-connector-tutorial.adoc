...
|https://www.anypoint.mulesoft.com/exchange/?type=connector&search=twitter[Twitter connector] |enables you to perform operations against one or more Twitter resources; find this in the Cloud Connectors section of the palette
...
* See https://www.anypoint.mulesoft.com/exchange/?type=connector[specific documentation for each connector].
