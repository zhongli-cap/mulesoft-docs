...
This tutorial assumes that you have link:https://docs.mulesoft.com/anypoint-studio/v/6/download-and-launch-anypoint-studio[downloaded and installed Mule Studio]. If you do not have any previous experience with Eclipse or an Eclipse-based IDE, please review the brief introduction to the link:https://docs.mulesoft.com/anypoint-studio/v/5/index[Mule Studio interface] and the document describing link:https://docs.mulesoft.com/mule-user-guide/v/3.4/global-elements[Global Elements in Mule]. Further, consider following the link:https://docs.mulesoft.com/anypoint-studio/v/5/basic-studio-tutorial[Basic] and link:https://docs.mulesoft.com/getting-started/content-based-routing[Content-Based Routing] tutorials.
...
However, if you wanted to expose such an application publicly, you would need to configure your application to link:https://docs.mulesoft.com/mule-user-guide/v/3.4/using-a-connector-to-access-an-oauth-api[authenticate via OAuth].
====
+
...
Launch Mule Studio and create a new Mule Project named `Connector Tutorial`. If you need more directions on launching Studio and creating a project, please refer to the link:https://docs.mulesoft.com/anypoint-studio/v/5/basic-studio-tutorial[Basic Studio Tutorial]. 
...
[%autowidth.spread]
|===
|*link:https://docs.mulesoft.com/mule-user-guide/v/3.4/http-endpoint-reference[HTTP endpoint]* |allows your Mule application to connect to Web resources through the HTTP or HTTPS protocol; find this in the Endpoints section of the palette
...
|*link:https://docs.mulesoft.com/mule-user-guide/v/3.4/foreach[Foreach scope]* |processes each item in a POJO iteratively
|*link:https://docs.mulesoft.com/mule-user-guide/v/3.4/logger-component-reference[Logger component]* |logs messages or activity based on the value of a Mule expression; find this in the Components section of the palette at the right of the screen
|===
...
Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.4/global-elements[Global Elements in Mule].
...
There are a few ways to accomplish this task, one of which is to add the extra text to the tweet inside a new variable. However, you can take a shortcut using the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/set-payload-transformer-reference[set payload] transformer. Replace the content of the entire payload using an expression composed of multiple parts, such as the following the following:
...
* *NEXT STEP:* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.4/starting-and-stopping-mule-esb[start and stop Mule] from the command line.
* See link:https://www.mulesoft.com/exchange#!/?types=connector&sortBy=name[specific documentation for each connector].
* Import link:https://docs.mulesoft.com/mule-user-guide/v/3.4/installing-connectors[additional connectors] into your instance of Studio.
