...
Starting with Mule 3 expressions operating on message properties also support an optional scope qualifier syntax. For more information about message scopes, see link:https://docs.mulesoft.com/mule-user-guide/v/3.7/mule-concepts[Mule Concepts].
