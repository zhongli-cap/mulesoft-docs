...
This reference page provides lists and brief explanations of the date and time functions in MEL. For explanatory information, see link:mule-expression-language-mel[Mule Expression Language], link:mule-expression-language-basic-syntax[MEL Basic Syntax], and the MEL examples.

== Assumptions

This document assumes you are familiar with link:mule-expression-language-mel[Mule Expression Language (MEL)].  Further, this document assumes you are using Mule 3.4.0 or later. 
...
|*link:mule-expression-language-date-and-time-functions[compare]* a|
...
* Learn more about the link:mule-expression-language-mel[Mule Expression Language (MEL)].
