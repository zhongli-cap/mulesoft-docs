...
This reference page provides lists and brief explanations of the date and time functions in MEL. For explanatory information, see link:/mule-user-guide/v/3.4/mule-expression-language-mel[Mule Expression Language], link:/mule-user-guide/v/3.4/mule-expression-language-basic-syntax[MEL Basic Syntax], and the http://www.mulesoft.org/documentation/display/current/Mule+Expression+Language+Examples[MEL examples].
