...
This reference page provides lists and brief explanations of the date and time functions in MEL. For explanatory information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-expression-language-mel[Mule Expression Language], link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-expression-language-basic-syntax[MEL Basic Syntax], and the MEL examples.

== Assumptions

This document assumes you are familiar with link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-expression-language-mel[Mule Expression Language (MEL)].  Further, this document assumes you are using Mule 3.4.0 or later. 
...
|*link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-expression-language-date-and-time-functions[compare]* a|
...
* Learn more about the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-expression-language-mel[Mule Expression Language (MEL)].
