...
This procedure assumes that you already have a Mule instance installed on your host machine. If not, then follow the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/installing[instructions] for downloading and installing Mule.
...
Port 3300 is predefined by SAP, so if you need to validate other port numbers based on your SAP instance number, you can check the complete list of service-to-port mappings, which can be found link:https://docs.mulesoft.com/mule-user-guide/v/3.4/sap-jco-server-services-configuration[here].
...
|jcoClientExtendedProperties-ref |A reference to `java.util.Map` containing additional JCo connection parameters. Additional information and a complete list of parameters can be found link:https://docs.mulesoft.com/mule-user-guide/v/3.4/sap-jco-extended-properties[here] |  |1.0
...
[NOTE]
You can use link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-expression-language-mel[Mule expressions] inside the address attribute, just as you do for other Mule ESB transports.
...
The complete documentation for the different XML documents can be found link:https://docs.mulesoft.com/mule-user-guide/v/3.4/xml-definitions[here]:

* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/xml-definitions[JCo Function]
** link:https://docs.mulesoft.com/mule-user-guide/v/3.4/xml-definitions[Version 1]
** link:https://docs.mulesoft.com/mule-user-guide/v/3.4/xml-definitions[Version 2]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/xml-definitions[IDoc]
...
|jcoClientExtendedProperties-ref |A Reference to `java.util.Map`, which contains additional JCo connection parameters. Additional information and a complete list of parameters can be found link:https://docs.mulesoft.com/mule-user-guide/v/3.4/sap-jco-extended-properties[here]. |  |1.0
|===
...
After the flow executes and if the SAP inbound endpoint is request-response, then Mule will return values to the calling SAP instance. Return values can be represented with the XML representation of the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/xml-definitions[JCo Function]. +
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/outbound-endpoint-transactions[sRFC stateful]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/outbound-endpoint-transactions[sRFC stateful BAPI transaction]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/outbound-endpoint-transactions[tRFC stateful]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/outbound-endpoint-transactions[qRFC stateful]

[WARNING]
If a transaction is not specified, then all calls (execute function or send IDoc) are stateless.

For examples, please take a look at link:https://docs.mulesoft.com/mule-user-guide/v/3.4/outbound-endpoint-transactions[Outbound Endpoint Transactions].
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/troubleshooting-sap-connector[Checking log files]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/troubleshooting-sap-connector[Enabling JCo trace]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/troubleshooting-sap-connector[Common errors]
