...
[TIP]
Consult link:https://docs.mulesoft.com/mule-user-guide/v/3.4/previewing-datamapper-results-on-sample-data[Previewing DataMapper Results on Sample Data] to learn more about generating a preview of your mapping.
...
[TIP]
To generate a preview of your mapping, click the *Preview* tab in the DataMapper view, then click *Run Mapping*. Consult link:https://docs.mulesoft.com/mule-user-guide/v/3.4/previewing-datamapper-results-on-sample-data[Previewing DataMapper Results on Sample Data] for details.
