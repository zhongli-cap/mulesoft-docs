...
For details on setting the properties for an AJAX endpoint using an XML editor, see link:ajax-transport-reference[AJAX Transport Reference] discussion in the Mule ESB User Guide.
