...
For details on setting the properties for an AJAX endpoint using an XML editor, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/ajax-transport-reference[AJAX Transport Reference] discussion in the Mule ESB User Guide.
