...
This document assumes you are familiar with Mule Expression Language's link:/mule\-user\-guide/v/3\.4/mule-expression-language-basic-syntax[basic syntax] and are comfortable building and running Mule applications using link:https://docs.mulesoft.com/anypoint-studio/v/5/[Mule Studio] or XML.
