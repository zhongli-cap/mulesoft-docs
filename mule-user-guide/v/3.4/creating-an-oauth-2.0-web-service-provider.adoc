...
The service provider in the link:/mule-user-guide/v/3.4/mule-secure-token-service[OAuth dance] is responsible for the following tasks (refers to the detailed explanation of the OAuth dance in the link:/mule-user-guide/v/3.4/mule-sts-oauth-2.0-example-application[Mule STS Oauth 2.0 Example Application])
...
|===
|Attribute |Req'd? |Value
|*config-ref* ^|x |Use the name of the new global OAuth provider module element you created link:/mule-user-guide/v/3.4/creating-an-oauth-2.0-web-service-provider[above].
...
|*Config Reference* ^|x |Use the name of the new global OAuth provider module element you created link:/mule-user-guide/v/3.4/creating-an-oauth-2.0-web-service-provider[above].
