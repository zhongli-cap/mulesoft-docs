...
See link:mule-object-stores[Mule Object Stores] for further information about object stores in Mule. The following code sample illustrates how to configure an in-memory store:
...
* Learn more about link:tuning-performance[Tuning Performance] in Mule.
* Learn more about link:scopes[Scopes] in Mule in general.
* Learn more about link:flows-and-subflows[Flows and Subflows]
