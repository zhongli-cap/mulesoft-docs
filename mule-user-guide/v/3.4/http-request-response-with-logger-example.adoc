...
The **HTTP Request-Response with Logger** example application consists of one, simple link:mule-application-architecture[flow] which receives end user HTTP requests, logs messages’ payloads, and returns the payloads to end users as HTTP responses.
...
* Learn more about thelink:logger-component-reference[Logger component].
* Learn more about the link:http-endpoint-reference[HTTP endpoint].
* Learn more about the link:echo-component-reference[Echo component].
