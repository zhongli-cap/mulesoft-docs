...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/smtp-transport-reference[SMTP]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/imap-transport-reference[IMAP]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.4/pop3-transport-reference[POP3]
