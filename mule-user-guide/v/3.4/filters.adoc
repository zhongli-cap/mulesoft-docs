...
|image:Filter-24x16.png[Filter-24x16] |Message |Applies specified criteria to a message to determine whether it should be processed. |link://mule-user-guide/v/3.4/message-filter[Message Filter Reference]
