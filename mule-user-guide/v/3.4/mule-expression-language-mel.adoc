...
This document assumes that you are familiar with Mule ESB and its link:/mule-user-guide/v/3.4/mule-concepts[basic concepts]. Consider reading the chapter, link:/mule-user-guide/v/3.4/first-30-minutes-with-mule[First 30 Minutes with Mule] to gain familiarity before proceeding. 
...
* Learn better by tutorial? Access the link:/mule-user-guide/v/3.6/mule-message-tutorial[Mule Message Tutorial].
