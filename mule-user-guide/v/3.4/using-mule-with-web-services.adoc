...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/proxying-web-services[Creating a proxy/gateway to existing Web services] (for example, adding security to an existing Web service)
...
For more information, you can check the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/consuming-web-services-with-cxf[Consuming Web Services with CXF] documentation.
...
For more information, read the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/consuming-web-services-with-cxf[Consuming Web Services with CXF] documentation.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/consuming-web-services-with-cxf[Use the JAX-WS Client API].
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/consuming-web-services-with-cxf[Build a Client Proxy].
...
For more information, read the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/building-web-services-with-cxf[Creating a JAX-WS Service] documentation.
...
For more information, read the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/building-web-services-with-cxf[Creating a WSDL First JAX-WS Service] documentation.
...
For more information, read the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/building-web-services-with-cxf[Creating a simple front-end Web service] documentation.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/proxying-web-services-with-cxf[Server-side Proxying]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/proxying-web-services-with-cxf[Client-side Proxying]

=== Web Service Proxy Pattern

For simple use cases, you may consider using the link:https://docs.mulesoft.com/mule-user-guide/v/3.5/web-service-proxy-pattern[Web Service Proxy Pattern], particularly when you don't need to accomplish much message processing. From Mule, you can use link:https://docs.mulesoft.com/mule-user-guide/v/3.5/configuration-patterns[Using Mule Configuration Patterns] to configure (with minor XML configuration) a specific integration feature.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.7/supported-web-service-standards[Supported Web Service Standards]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.5/web-service-proxy-pattern[Web Service Proxy Pattern]
* Examples
** Echo Example
** Bookstore Example
