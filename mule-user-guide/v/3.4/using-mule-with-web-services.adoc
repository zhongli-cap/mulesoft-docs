...
[WARNING]
If you plan to connect to an external web service that exposes a WSDL file, the recommended connector to use is the link:link:/mule-user-guide/v/3.7/web-service-consumer[Web Service Consumer].
...
For simple use cases, you may consider using the link:/mule-user-guide/v/3.5/web-service-proxy-pattern[Web Service Proxy Pattern], particularly when you don't need to accomplish much message processing. From Mule, you can use link:/mule-user-guide/v/3.5/configuration-patterns[Using Mule Configuration Patterns] to configure (with minor XML configuration) a specific integration feature.
