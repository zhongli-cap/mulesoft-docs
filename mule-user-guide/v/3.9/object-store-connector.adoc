...
*Note:* Object Store version 2 overrides the _defaultUserObjectStore object store. See https://docs.mulesoft.com/object-store[Object Store v2].
...
The `objectStore-ref="_defaultUserObjectStore"` parameter is declared as follows in XML:
