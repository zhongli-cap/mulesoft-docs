...
|Partition|Name of the partition. If set, and an object store is specified in the objectstore-ref attribute, the given Object Store must be partitionable. Object stores are partitionable by default.
