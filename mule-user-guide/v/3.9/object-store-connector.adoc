...
MIME Type: none +
Encoding: none
|entryTtl |Time To Live for stored values in milliseconds. If using this parameter, maxEntries, and expirationInterval are mandatory. The maximum value is approximately 24 days (2147483647 milliseconds).
