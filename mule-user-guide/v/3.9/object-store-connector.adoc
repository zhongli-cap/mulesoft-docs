...
*Note:* Object Store version 2 overrides the _defaultUserObjectStore and _muleObjectStoreManager object stores. See https://docs.mulesoft.com/object-store[Object Store v2].
