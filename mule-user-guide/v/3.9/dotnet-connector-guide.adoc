...
[WARNING]
====
The .NET connector version 1.0 is incompatible with version 2.0. Refer to the link:/mule-user-guide/v/3.9/dotnet-connector-migration-guide[.NET connector migration guide] if you are an existing user of .NET connector 1.0.
====
