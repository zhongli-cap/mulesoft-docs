...
You can create and configure clusters with the graphical interface available in the link:/mule-management-console/v/3.9/[Mule Management Console], or manually by link:/mule-management-console/v/3.9/creating-or-disbanding-a-cluster[editing the cluster configuration file.] For additional configuration options, including cluster network parameters, see link:/mule-user-guide/v/3.9/creating-and-managing-a-cluster-manually[Creating and Managing a Cluster Manually].
