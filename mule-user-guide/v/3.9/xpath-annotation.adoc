...
Namespaces can be configured in the Mule Configuration using the link:/mule-user-guide/v/3.9/xml-namespaces[XML Namespaces], these will be made available for this annotation.

First declare the namespace using the link:/mule-user-guide/v/3.9/xml-namespaces[Namespace Manager] -
