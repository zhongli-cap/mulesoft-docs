...
In Application servers -> server -> Java and Process Management -> Process Definition -> Additional Properties -> Java Virtual Machine -> Generic JVM argument
Set the following system properties with your digested license:
