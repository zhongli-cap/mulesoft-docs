...
Anypoint Connector for NetSuite OpenAir is a closed source enterprise connector which provides a connection between OpenAir and third-party software. The OpenAir connector is a SOAP-based connector developed with link:/anypoint-connector-devkit/v/3.9/[Anypoint Connector DevKit 3.8.1].
...
For hardware and software requirements, please visit link:/mule-user-guide/v/3.9/hardware-and-software-requirements[Mule Hardware and Software Requirements] page.
