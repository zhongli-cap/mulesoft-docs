...
This page serves as a reference for all of the supported attributes and child elements of the link:/mule-user-guide/v/3.9/http-connector[HTTP Connector].
...
Required: no +
Default: none
|clientSocketProperties-ref |Reference to a link:/mule-user-guide/v/3.9/tcp-transport-reference#client-socket-properties[TCP Client Socket properties element]. +
Type: string +
Required: no +
Default: none
...
* Learn how to link:/mule-user-guide/v/3.9/tuning-performance#connector-level[tune performance at the connector level].
