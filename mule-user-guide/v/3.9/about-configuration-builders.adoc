...
AutoConfigurationBuilder is the default configuration builder. If you want to use another configuration builder, you can specify it in the link:/mule-user-guide/v/3.9/mule-application-deployment-descriptor[deployment descriptor] of an application.
