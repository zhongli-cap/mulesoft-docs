...
The inbound endpoints can be any valid link:/mule-user-guide/v/3.9/endpoint-configuration-reference[Mule Endpoint], so you can receive JMS messages, SOAP requests, files, HTTP and servlet requests, TCP, multicast, and more.
