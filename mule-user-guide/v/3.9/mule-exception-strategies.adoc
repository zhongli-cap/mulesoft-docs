...
* A link:/mule-user-guide/v/3.9/transaction-management[Transactional Scope] may include its own exception strategy, regardless of what you define at Flow level.
...
* *NEXT STEP*: Read on about the structure of a link:/mule-user-guide/v/3.9/mule-message-structure[Mule message].
* Learn more about configuring the link:/mule-user-guide/v/3.9/catch-exception-strategy[catch], link:/mule-user-guide/v/3.9/rollback-exception-strategy[rollback], link:/mule-user-guide/v/3.9/reference-exception-strategy[reference], and link:/mule-user-guide/v/3.9/choice-exception-strategy[choice] exception strategies.
