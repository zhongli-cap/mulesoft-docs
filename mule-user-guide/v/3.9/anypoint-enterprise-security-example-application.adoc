...
This document assumes that you have link:/mule-user-guide/v/3.9/installing-anypoint-enterprise-security[installed the Anypoint Enterprise Security] extensions.
...
Make sure to right click on any of the link:/mule-user-guide/v/3.9/mule-message-encryption-processor[Mule Message Encryption Processors] and select `Add Encryption libraries to the project`.
...
* For more information on encryption in Mule, see link:/mule-user-guide/v/3.9/mule-message-encryption-processor[Mule Message Encryption Processor].
* For more information on signatures in Mule, see link:/mule-user-guide/v/3.9/mule-digital-signature-processor[Mule Digital Signature Processor].
