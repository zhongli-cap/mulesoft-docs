...
Beyond this example, access link:/mule-user-guide/v/3.9/salesforce-connector[introductory] and link:https://mulesoft.github.io/salesforce-connector/[reference] documentation for the Salesforce Connector.
...
* Access link:https://mulesoft.github.io/salesforce-connector/[full reference documentation] for the Salesforce Connector.
