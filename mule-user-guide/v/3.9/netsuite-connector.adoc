...
This document assumes that you are familiar with Mule, link:/mule-user-guide/v/3.9/anypoint-connectors[Anypoint Connectors], and the link:/mule-fundamentals/v/3.9/anypoint-studio-essentials[Anypoint Studio interface]. To increase your familiarity with Studio, consider completing one or more  link:/mule-fundamentals/v/3.9/basic-studio-tutorial[Anypoint Studio Tutorials]. Further, this page assumes that you have a basic understanding of link:/mule-fundamentals/v/3.9/mule-concepts[Mule flows] and link:/mule-fundamentals/v/3.9/global-elements[Mule Global Elements]. 
...
For compatibility details for your version see the link:/release-notes/netsuite-connector-release-notes[release notes]
...
If you’re using an older version of the connector, a small popup appears in the bottom right corner of Anypoint Studio with an "Updates Available" message.
...
To use the NetSuite connector in your Mule application, you must configure a global NetSuite element that can be used by all the NetSuite connectors in the application (read more about link:/mule-fundamentals/v/3.9/global-elements[global elements]).
