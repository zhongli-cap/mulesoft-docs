...
[NOTE]
This topic introduces the idea of Global Elements; if you are unfamiliar with this functionality, access link:/mule-user-guide/v/3.9/global-elements[Understand Global Mule Elements] to learn more before proceeding.
...
* Access the link:/mule-user-guide/v/3.9/anypoint-enterprise-security-example-application[example application] which demonstrate Anypoint Enterprise Security in action.
