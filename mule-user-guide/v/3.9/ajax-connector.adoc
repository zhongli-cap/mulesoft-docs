...
In Anypoint Studio, the Ajax connector is called the link:https://www.anypoint.mulesoft.com/exchange/68ef9520-24e9-4cf2-b2f5-620025690913/cometd-connector/[CometD connector] and is pre-installed in Anypoint Studio.
...
* For details on setting the properties for an Ajax endpoint using an XML editor, see the link:/mule-user-guide/v/3.9/ajax-transport-reference[Ajax Transport Reference] discussion in the Mule Runtime documentation.
* You can "test drive" a connector in Anypoint Studio using the instructions in link:/anypoint-exchange/ex2-studio[Installing a Connector from Anypoint Exchange].  
