...
This page requires some basic knowledge of link:/mule-user-guide/v/3.9/mule-concepts[Mule Concepts], 
link:/mule-user-guide/v/3.9/elements-in-a-mule-flow[Elements in a Mule Flow], 
and link:/mule-user-guide/v/3.9/global-elements[Global Elements]. 
...
. Convert it to an XSD. See link:https://www.google.com/?q=rosettanet+convert+dtd+to+xsd[this search].
...
In this example, you build two Mule applications to mimic the following diagram. You can download the link:_attachments/rosettanet-buyer-app.zip[buyer application] and the link:_attachments/rosettanet-seller-app.zip[seller application].

You can run these two applications in the link:/mule-user-guide/v/3.9/shared-resources[shared domain] in Studio, but to show the logged messages clearly, the example uses two Studio applications, one for the buyer app and the other for the seller app.
