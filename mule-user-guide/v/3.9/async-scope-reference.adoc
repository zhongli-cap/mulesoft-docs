...
An async scope is similar to an *link:/mule-user-guide/v/3.9/flows-and-subflows[asynchronous flow]* in that:
...
An async scope is similar to a *link:/mule-user-guide/v/3.9/flows-and-subflows[subflow]* in that it inherits the exception strategy of the main flow. 
...
For more information about processing strategies, see link:/mule-user-guide/v/3.9/flow-processing-strategies[Flow Processing Strategies].
...
* For more information about processing strategies and how to configure them, see link:/mule-user-guide/v/3.9/flow-processing-strategies[Flow Processing Strategies].
