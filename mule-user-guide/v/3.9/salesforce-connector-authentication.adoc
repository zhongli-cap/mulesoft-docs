...
This document gives examples of OAuth and basic configurations, but focuses on basic authentication. For an in-depth explanation of how to connect to Salesforce through OAuth, see link:/mule-user-guide/v/3.9/using-a-connector-to-access-an-oauth-api[Using a Connector to Access an OAuth API].

== Prerequisites

This document assumes that you have a Salesforce account with access to data. It also assumes you are familiar with the link:/mule-user-guide/v/3.9/salesforce-connector[Salesforce Connector] in Anypoint Studio.
...
For a detailed explanation of how perform these steps with Salesforce, read link:/mule-user-guide/v/3.9/using-a-connector-to-access-an-oauth-api[Using a Connector to Access an OAuth API.]
...
* link:/mule-user-guide/v/3.9/salesforce-connector-reference[Salesforce Connector Reference]

* Read about link:/mule-user-guide/v/3.9/using-a-connector-to-access-an-oauth-api[connecting to OAuth APIs] with Mule
