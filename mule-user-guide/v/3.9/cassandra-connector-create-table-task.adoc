...
* link:/mule-user-guide/v/3.9/cassandra-connector-ops-reference#create-keyspace[Create Keyspace reference]
* link:/mule-user-guide/v/3.9/cassandra-connector-datatypes#data-type-mapping[Data Type Mapping to Uppercase]