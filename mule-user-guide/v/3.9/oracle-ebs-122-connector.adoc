...
[NOTE]
Separately, there is a Oracle E-Business Suite (EBS) connector link:/mule-user-guide/v/3.9/oracle-ebs-connector[built for the Oracle EBS v12.1.x] that supports *SOAP web services and message queues*.
