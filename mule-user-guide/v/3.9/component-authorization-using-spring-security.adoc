...
In addition to the `daoAuthenticationProvider` and `inMemoryDaoImpl` beans (see link:/mule-user-guide/v/3.9/configuring-security[Configuring Security]), the following beans must be configured:
