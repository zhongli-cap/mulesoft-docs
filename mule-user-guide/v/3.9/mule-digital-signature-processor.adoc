...
[NOTE]
This topic introduces the idea of Global Elements; if you are unfamiliar with this functionality, access link:/mule-user-guide/v/3.9/global-elements[Global Elements] to learn more before proceeding.
...
+
image::mule-digital-signature-processor-9afd4.png[mule-digital-signature-processor-9afd4]
+
...
Examine the link:/mule-user-guide/v/3.9/anypoint-enterprise-security-example-application[Anypoint Enterprise Security Example Application] which illustrates how to verify the digital signature of a message.
