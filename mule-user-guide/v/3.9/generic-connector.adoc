...
link:/mule-user-guide/v/3.9/endpoint-configuration-reference#transformers[Nest transformers] inside your generic connector from its configured endpoint(s).
