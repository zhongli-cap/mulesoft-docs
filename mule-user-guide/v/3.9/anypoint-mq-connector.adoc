...
*Reference:* link:/mule-user-guide/v/3.9/anypoint-mq-connector-reference[Anypoint MQ Connector Reference] +
...
. Specify the URL for the region you want your MQ queues and exchanges to reside. See link:/anypoint-mq/[MQ available regions].
...
For a list of all other configuration fields, see the link:/mule-user-guide/v/3.9/anypoint-mq-connector-reference[Anypoint MQ Connector Reference].
...
For a list of XML fields, see link:/mule-user-guide/v/3.9/anypoint-mq-connector-reference[Anypoint MQ Connector Reference].
