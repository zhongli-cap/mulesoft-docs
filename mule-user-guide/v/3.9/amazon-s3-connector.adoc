...
To use the Amazon S3 connector in your Mule application, you must configure a global Amazon S3 element that can be used by all the Amazon S3 connectors in the application (read more about  link:/mule-user-guide/v/3.9/global-elements[Global Elements].)
...
* Learn about link:/mule-user-guide/v/3.9/using-maven-with-mule[Using Maven with Mule]
* link:/mule-user-guide/v/3.9/mule-transformers[Mule Transformers]
