...
See the link:/mule-user-guide/v/3.9/connector-configuration-reference[Connector Configuration Reference] for instructions for configuring connectors for endpoint functions or for operations.

See the link:/mule-user-guide/v/3.9/http-connector[HTTP Connector] for information on this operation-based connector.
...
* Refer to the overview of link:/mule-user-guide/v/3.9/anypoint-connectors[Anypoint Connectors].
* Access the link:http://www.mulesoft.org/connectors[full library of available connectors].
* Check out the link:/getting-started/anypoint-connector[Anypoint Connector quickstart]. 
