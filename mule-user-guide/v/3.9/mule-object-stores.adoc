...
* When storing or retrieving information from a Mule flow through the object store connector, link:https://www.mulesoft.com/exchange/org.mule.modules/mule-module-objectstore/[available for installation]
