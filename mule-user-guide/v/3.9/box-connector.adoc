...
*Technical Reference:* link:http://mulesoft.github.io/mule-box-connector[Mule Box Connector]
...
* **Anypoint Studio:** if you don't use Anypoint Studio for development, follow the link:/mule-user-guide/v/3.9/box-connector#using-the-connector-in-a-mavenized-mule-app[instructions] about specifying Maven dependencies in your `pom.xml` file.
...
To use the Box connector in your Mule application, you must configure a global Box element that can be used by the Box connector (read more about  link:/mule-user-guide/v/3.9/global-elements[Global Elements]).
...
* For additional technical information on the Box Connector, visit our link:http://mulesoft.github.io/mule-box-connector[technical reference documentation].
