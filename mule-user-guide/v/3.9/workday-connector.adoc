...
*Migration Guide*: link:/mule-user-guide/v/3.9/workday-connector-6.0-migration-guide[Workday Connector 6.0 and above Migration Guide]
...
* In the Global Element Properties image, the placeholder values refer to a configuration file in the `src` folder of your project. See link:/mule-user-guide/v/3.9/configuring-properties[Configuring Properties]. Either enter your credentials in the global configuration properties, or reference a configuration file containing these values.
...
image:workday-basic-global-properties.png[workday-basic-global-properties]
+
For more information on setting credentials inside a properties file, see link:/mule-user-guide/v/3.9/configuring-properties#properties-files[Properties Files].
+
