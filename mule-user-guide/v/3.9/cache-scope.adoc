...
You can customize the way Mule stores cached responses if you  xref:ccs[Create a Caching Strategy] and define a new object store.
...
| Cloudhub
2+| Cloudhub manages its own object store. You can learn more about them in the link:/runtime-manager/managing-application-data-with-object-stores[Managing Application Data Storage with Object Stores (Cloudhub)] guide.
|===

You can get more information about these base object stores in the link:mule-object-stores[Mule Object Stores] reference page.
...
* Read more about link:/mule-user-guide/v/3.9/scopes[Scopes] in Mule.
