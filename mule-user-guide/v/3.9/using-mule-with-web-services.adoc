...
* link:/mule-user-guide/v/3.9/proxying-web-services[Creating a proxy for existing Web services] (for example, adding security to an existing Web service)
...
For more information, you can check the link:/mule-user-guide/v/3.9/consuming-web-services-with-cxf[Consuming Web Services with CXF] documentation.
...
For more information, read the link:/mule-user-guide/v/3.9/consuming-web-services-with-cxf[Consuming Web Services with CXF] documentation.
...
* link:/mule-user-guide/v/3.9/consuming-web-services-with-cxf[Use the JAX-WS Client API].
* link:/mule-user-guide/v/3.9/consuming-web-services-with-cxf[Build a Client Proxy].
...
For more information, read the link:/mule-user-guide/v/3.9/building-web-services-with-cxf[Creating a JAX-WS Service] documentation.
...
For more information, read the link:/mule-user-guide/v/3.9/building-web-services-with-cxf[Creating a WSDL First JAX-WS Service] documentation.
...
For more information, read the link:/mule-user-guide/v/3.9/building-web-services-with-cxf[Creating a simple front-end Web service] documentation.
...
* link:/mule-user-guide/v/3.9/proxying-web-services-with-cxf[Server-side Proxying]
* link:/mule-user-guide/v/3.9/proxying-web-services-with-cxf[Client-side Proxying]
