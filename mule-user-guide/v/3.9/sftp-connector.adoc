...
* Mule 3.8 and newer accepts SSH known_hosts files. For more information, see the link:/mule-user-guide/v/3.9/sftp-transport-reference[SFTP Transport Reference].
...
See the link:/mule-user-guide/v/3.9/sftp-transport-reference[SFTP Transport Reference] for details on setting the properties for an SFTP endpoint using an XML editor.
