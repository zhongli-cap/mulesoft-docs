...
Writing JAX-RS services is an expansive topic and is not covered in this guide. However, the link:https://jersey.github.io/[Jersey] website has an excellent set of samples, and the link:http://jcp.org/aboutJava/communityprocess/final/jsr311/index.html[JAX-RS specification] is helpful as well.
...
For more information about context resolvers, check out the Jersey link:https://jersey.github.io/documentation/latest/index.html[user guide].
