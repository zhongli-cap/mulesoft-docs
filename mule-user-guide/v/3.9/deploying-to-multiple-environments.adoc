...
[TIP]
====
Should you need to encrypt passwords in your properties file, consider using the link:/mule-user-guide/v/3.9/mule-credentials-vault[Mule Credentials Vault]. Refer to the documentation for link:/mule-user-guide/v/3.9/anypoint-enterprise-security[Anypoint Enterprise Security] for more information on securing applications in Mule.
====
...
* Learn more about encrypting a properties file using the link:/mule-user-guide/v/3.9/mule-credentials-vault[Mule Credentials Vault].

* To learn more about deploying to test environments in CloudHub, access the CloudHub Sandbox Environments documentation.

* Learn more about link:/mule-user-guide/v/3.9/configuring-properties[Properties Placeholders] in Mule. 

* Learn how to proceed when deploying multiple applications with link:/mule-user-guide/v/3.9/shared-resources[Shared Resources]
