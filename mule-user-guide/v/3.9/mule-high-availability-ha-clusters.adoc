...
* Cluster lifecycle management and control. See link:/mule-management-console/v/3.9/managing-mule-high-availability-ha-clusters[Managing Mule High Availability (HA) Clusters].
* Cluster and node performance monitoring. See link:/mule-management-console/v/3.9/monitoring-a-cluster[Monitoring a Cluster].
