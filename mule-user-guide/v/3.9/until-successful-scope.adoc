...
See link:/mule-user-guide/v/3.9/mule-object-stores[Mule Object Stores] for further information about object stores in Mule. The following code sample illustrates how to configure an in-memory store:
...
* Learn more about link:/mule-user-guide/v/3.9/tuning-performance[Tuning Performance] in Mule.
* Learn more about link:/mule-user-guide/v/3.9/scopes[Scopes] in Mule in general.
