...
* Learn more about the Microsoft Service Bus connector in the link:/mule-user-guide/v/3.9/microsoft-service-bus-connector-faq[Microsoft Service Bus Connector FAQ].
* For code samples that illustrate more advanced scenarios, refer to link:_attachments/service-bus-connector-samples.zip[service-bus-connector-samples.zip].
* Learn how to link:/anypoint-exchange/ex2-studio[Install a Connector from Anypoint Exchange].
