...
[NOTE]
--
The default value in the *Expression* field is `#[]`. You need to type a valid expression without the square brackets. For syntax details see the link:/mule-user-guide/v/3.9/mule-expression-language-mel[Mule Expression Language MEL] documentation.
--
