...
The unified Mule Runtime 3.9 and API Gateway are compatible with APIkit 3.8.0 and Anypoint Studio 6.0.0 

Mule Runtime 3.9 is bundled with the Runtime Manager Agent plugin version 1.8.0.
