...
+
. Click the Anypoint Exchange image:365-exchange-icon.png[365-exchange-icon] icon in the taskbar, search for 365, and follow the prompts to install the connector.
...
+
. If needed, set the OAuth tab in Global Element Properties as described in link:/mule-user-guide/v/3.9/using-a-connector-to-access-an-oauth-api[Using a Connector to Access an OAuth API].
...
For information on setting the Pooling Profile tab, see link:/mule-user-guide/v/3.9/tuning-performance#about-pooling-profiles[About Pooling Profiles].

For information on setting the Reconnection tab, see link:/mule-user-guide/v/3.9/configuring-reconnection-strategies[Configuring Reconnection Strategies].
...
* link:_attachments/ms-dynamics-365-demo.zip[Samples]
* link:/mule-user-guide/v/3.9/microsoft-dynamics-365-operations-connector[Microsoft Dynamics 365 Operations connector]
