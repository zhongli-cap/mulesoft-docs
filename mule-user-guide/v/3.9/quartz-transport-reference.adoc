...
[TIP]
When scheduling tasks, it's recommended that you instead resort to the link:/mule-user-guide/v/3.9/poll-reference[Poll Scope]
...
* See the link:/mule-user-guide/v/3.9/quartz-connector[Quartz Connector] for details on setting the properties for a Quartz endpoint in Studio's visual editor.
