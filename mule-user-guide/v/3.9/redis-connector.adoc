...
Read through this user guide to understand how to set up and configure a basic flow using the connector. Track feature additions, compatibility, limitations and API version updates with each release of the connector using the link:/release-notes/redis-connector-release-notes[Redis Release Notes]. Review the connector operations and functionality using the lhttps://mulesoft.github.io/mule-redis-connector[Technical Reference] alongside the link:https://www.mulesoft.com/exchange#!/?filters=redis&sortBy=rank[demo applications].
