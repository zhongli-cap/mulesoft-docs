...
You can expose a manager's logging configuration over JMX by configuring a log4j2 JMX agent in your Mule configuration file. See link:https://docs.mulesoft.com/mule-user-guide/v/3.6/jmx-management[JMX Management] for more information.
