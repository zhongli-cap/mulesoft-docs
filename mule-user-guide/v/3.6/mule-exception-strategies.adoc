...
* A link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transaction-management[Transactional Scope] may include its own exception strategy, regardless of what you define at Flow level +
