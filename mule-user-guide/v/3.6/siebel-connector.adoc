...
*Release Notes*: link:https://docs.mulesoft.com/release-notes/siebel-connector-release-notes[Siebel Connector Release Notes]
...
This document assumes you are familiar with Mule, link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-connectors[Anypoint Connectors] , and link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio Essentials] To increase your familiarity with Studio, consider completing one or more link:https://docs.mulesoft.com/anypoint-studio/v/6/basic-studio-tutorial[Anypoint Studio Tutorials] . Further, this page assumes that you have a basic understanding of  link:https://docs.mulesoft.com/mule-user-guide/v/3.6/elements-in-a-mule-flow[Mule flows] and link:https://docs.mulesoft.com/mule-user-guide/v/3.6/global-elements[Mule Global Elements].
...
The Siebel Object Manager lets a connector use a generic interface that doesn’t depend on a customized installation. To discover the metadata of Siebel objects in design time, use link:https://docs.mulesoft.com/mule-user-guide/v/3.6/datasense[DataSense] in Anypoint Studio. The Siebel connector takes advantage of the Siebel Repository to show a list of available objects as well as their structures in a Siebel custom installation.
...
You can install a connector in Anypoint Studio using the instructions in link:https://docs.mulesoft.com/mule-user-guide/v/3.7/installing-connectors[To Install a Connector from Anypoint Exchange].
...
Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to arrange for either license. See also link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-an-enterprise-license[Installing an Enterprise License].
...
[NOTE]
====
If you intend to use a Siebel connector in conjunction with a link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper transformer] to map and transform data, you can make use of Anypoint Studio's link:https://docs.mulesoft.com/mule-user-guide/v/3.6/datasense[DataSense] functionality. You can enable DataSense as part of configuring the global element. 

* Follow the DataSense instructions to drop the transformer into your flow, then link:https://docs.mulesoft.com/mule-user-guide/v/3.6/testing-connections[test the connection] to Siebel using the Siebel connector. 
...
. Click *Test Connection* to confirm that the parameters of your global Siebel connector are accurate, and that Mule is able to successfully connect to your instance of Siebel. Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/testing-connections[Testing Connections].
...
|*Search Expression* |Use link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-expression-language-mel[Mule Expression Language (MEL)] to define a search expression that would return a list of business components. |
...
[NOTE]
Refer to documentation on the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/poll-reference[Poll Scope] , link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper], and the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/salesforce-connector[Salesforce connector] for in-depth information about these Mule elements.
...
+
link:https://docs.mulesoft.com/mule-user-guide/v/3.6/poll-reference[Poll Scope] executes any Mule element you place inside it, at regular intervals. In this case, it is a Siebel endpoint.
...
+
[NOTE]
To learn how watermarks work and what each attribute is for, read about  link:https://docs.mulesoft.com/runtime-manager/managing-schedules[Poll Schedulers].
...
. Drag a *Poll Scope*  into a new flow: +
 image:poll2.jpeg[poll2] +
+
link:https://docs.mulesoft.com/mule-user-guide/v/3.6/poll-reference[Poll Scope]  executes the Mule element placed inside it at regular intervals. In this case, it is a Salesforce connector.
+
...
|===
|Element |Description
|Poll |A  link:https://docs.mulesoft.com/mule-user-guide/v/3.6/poll-reference[Poll Scope] executes the Mule element you place inside it at regular intervals. In this case, it is a Salesforce connector.
|===
+
[%header,cols="2*"]
|===
...
* Learn about the link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper] transformer, the most efficient way to assign mappings to data.
