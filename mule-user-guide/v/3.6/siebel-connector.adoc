...
You can install a connector in Anypoint Studio using the instructions in link:/mule-user-guide/v/3.7/installing-connectors[To Install a Connector from Anypoint Exchange].
...
[NOTE]
Refer to documentation on the link:/mule-user-guide/v/3.6/poll-reference[Poll Scope] , link:/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper], and the link:/mule-user-guide/v/3.6/salesforce-connector[Salesforce connector] for in-depth information about these Mule elements.
...
[NOTE]
Refer to documentation on the link:/mule-user-guide/v/3.6/poll-reference[Poll Scope], link:/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper], and the link:/mule-user-guide/v/3.6/salesforce-connector[Salesforce Connector] for in depth information about these elements.
...
* Learn about the link:/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper] transformer, the most efficient way to assign mappings to data.
