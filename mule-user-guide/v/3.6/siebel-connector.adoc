...
[NOTE]
Refer to documentation on the link:/mule\-user\-guide/v/3\.6/poll-reference[Poll Scope] , link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper], and the link:/mule\-user\-guide/v/3\.6/salesforce-connector[Salesforce connector] for in-depth information about these Mule elements.
