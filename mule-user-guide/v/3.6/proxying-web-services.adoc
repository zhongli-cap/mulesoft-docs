...
This type of bridge can be combined with filters for easy message routing. For fast XPath routing of messages, you can use the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/sxc-module-reference[SXC Module Reference].
...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/proxying-web-services-with-cxf[Proxying Web Services with CXF] for more details.
