...
The legacy endpoint-based connector will be removed in a future version. See link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-connector[HTTP Connector] for more information about the HTTP operation-based connector and how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/migrating-to-the-new-http-connector[migrate] your projects to it.
====
...
This connector also accepts all the attributes from the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/tcp-transport-reference[TCP connector].
...
The HTTP inbound endpoint attributes override those specified for the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/endpoint-configuration-reference[default inbound endpoint attributes].
...
The HTTP outbound endpoint attributes override those specified for the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/endpoint-configuration-reference[default outbound endpoint attributes].
...
The HTTP endpoint attributes override those specified for the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/endpoint-configuration-reference[default global endpoint attributes].
