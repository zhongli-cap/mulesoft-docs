...
[NOTE]
 For a *full description* of the example and steps the batch job takes in each phase of processing, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing[Batch Processing].
...
* Learn link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-mel-with-batch-processing[MEL expressions you can use in Batch jobs] to simplify error handling

* Review the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing[basic anatomy] of batch processing in Mule.
