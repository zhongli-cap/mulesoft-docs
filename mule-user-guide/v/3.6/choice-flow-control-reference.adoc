...
....
In Studio, drag the *Choice* icon from the Studio palette to the canvas, positioning it within the sequence of link:/mule-fundamentals/v/3.6/elements-in-a-mule-flow[building blocks] that form the flow (below). 
