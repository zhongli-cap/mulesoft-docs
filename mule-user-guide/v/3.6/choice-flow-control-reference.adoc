...
....
In Studio, drag the *Choice* icon from the Studio palette to the canvas, positioning it within the sequence of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/elements-in-a-mule-flow[building blocks] that form the flow (below). 
...
* For more information on the Choice Flow Control, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/routers[Choice] section on the Routing Message Processors page.
