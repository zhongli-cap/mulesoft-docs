...
You can use JsonPath in link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-expression-language-mel[Mule expressions] to query JSON message payloads for filtering or link:https://docs.mulesoft.com/mule-user-guide/v/3.6/message-enricher[enrichment].
