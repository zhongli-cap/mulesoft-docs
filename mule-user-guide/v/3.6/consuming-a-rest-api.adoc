...
. Click on the green plus sign icon next to Connector Configuration to create a new link:https://docs.mulesoft.com/mule-user-guide/v/3.6/global-elements[global element] that will encapsulate several configuration parameters for the connector.
...
. You can also use a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-properties[property placeholder], then define the value in your *mule-app.properties* file
+
...
. Note that you can also replace these with link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-properties[property placeholders] and define the properties in your `mule-app.properties` file.
+
...
Rather than hardcode the values of your credentials, you can define them as link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-properties[property placeholders].
...
[NOTE]
Although the HTTP connector has built-in polling capabilities (described below), you can, instead, configure a *link:https://docs.mulesoft.com/mule-user-guide/v/3.6/poll-reference[Poll]* scope, then place your HTTP endpoint within it. Using a Poll scope allows you to take advantage of more robust polling functionality such as watermarking and scheduling with cron expressions.
...
* See some link:https://docs.mulesoft.com/mule-user-guide/v/3.6/rest-api-examples[example applications] that consume REST APIs.
