...
This page covers more complex configuration of the CXF Component than those described in the basic discussions of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/publishing-a-soap-api[publishing a SOAP API] and link:https://docs.mulesoft.com/mule-user-guide/v/3.6/consuming-a-soap-api[consuming a SOAP API]. You may also wish to refer to full link:https://docs.mulesoft.com/mule-user-guide/v/3.6/cxf-component-reference[CXF Component Reference] documentation.
...
* Access full link:https://docs.mulesoft.com/mule-user-guide/v/3.6/cxf-component-reference[CXF Component Reference] documentation.
* Learn the basics of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/publishing-a-soap-api[publishing a SOAP API].
* Learn the basics of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/consuming-a-soap-api[consuming a SOAP API].
