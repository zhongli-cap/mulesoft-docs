...
You can share libraries between applications via the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-application-deployment-descriptor[*application deployment descriptor*] attribute.
