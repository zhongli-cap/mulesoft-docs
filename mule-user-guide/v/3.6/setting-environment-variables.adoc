...
* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/shared-resources[Shared Resources]
* If you're deploying a single application, you can still set up link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-properties[Application Properties]
