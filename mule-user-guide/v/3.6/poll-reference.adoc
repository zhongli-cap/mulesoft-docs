...
----
 ...
 |You must create a Twitter connector as a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/global-elements[global element] to reference here. For your Twitter connector, you need a Twitter developer account.
|===
. Add more message processors to your flow to perform specific business logic after polling for data. The example below uses a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/logger-component-reference[logger] component. This logger uses the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-expression-language-mel[MEL] expression `#[payload]` to log the message payload collected by the Twitter connector every 1000 milliseconds.
+
...
|*config-ref* |string |You must create a Twitter connector as a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/global-elements[global element] to reference here. For your Twitter connector, you need a Twitter developer account. |`config-ref=` `"Twitter"`
...
|*message* |string or link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-expression-language-mel[Mule expression] |The content that will be logged to console. In this case, the Mule Expression `#[payload]` will output the message payload.
...
. Run your project in Debug Mode. (Refer to the link:https://docs.mulesoft.com/anypoint-studio/v/5/studio-visual-debugger[Visual Debugger] document for greater detail.)
...
Any connector which is enabled for link:https://docs.mulesoft.com/mule-user-guide/v/3.6/auto-paging-in-anypoint-connectors[auto-paging] allows you to process large data sets in separate batches. This capability mitigates for memory overload, but also imposes certain conditions when used in conjunction with watermarks. The following example illustrates the recommended method for using watermarks when polling a connector that auto-pages its response.
...
* Learn how to configure a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/poll-schedulers[polling schedule].
...
* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/logger-component-reference[Logger].
* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-connectors[Anypoint Connectors] and link:https://docs.mulesoft.com/mule-user-guide/v/3.6/auto-paging-in-anypoint-connectors[auto-paging].
* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/flow-processing-strategies[flow processing strategies].
