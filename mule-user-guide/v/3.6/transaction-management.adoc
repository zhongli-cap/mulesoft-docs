...
|link:https://docs.mulesoft.com/mule-user-guide/v/3.6/single-resource-transactions[Single Resource Transactions] a|
...
|link:https://docs.mulesoft.com/mule-user-guide/v/3.6/multiple-resource-transactions[Multiple Resource Transactions] a|
...
|link:https://docs.mulesoft.com/mule-user-guide/v/3.6/xa-transactions[XA Transactions] a|
* Receives or sends messages to more than one resource.
...
Use link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transactions-configuration-reference[Transactions Configuration Reference] for quick access to attribute configurations.
....
...
_Apply a transaction to a flow that involves a single resource. See link:https://docs.mulesoft.com/mule-user-guide/v/3.6/single-resource-transactions[Single Resource Transaction] for details.
|XA Transaction |Apply a transaction to a flow that involves multiple resources: JMS, VM or JDBC. See link:https://docs.mulesoft.com/mule-user-guide/v/3.6/xa-transactions[XA Transaction] for details.
|Multi Transaction |Apply a transaction to a flow that involves multiple resources: JMS or VM. See link:https://docs.mulesoft.com/mule-user-guide/v/3.6/multiple-resource-transactions[Multiple Resource Transaction] for details.
...
* If you apply an XA transaction to a JMS inbound connector in your flow, you have the option of specifying the polling frequency of the queue. Access link:https://docs.mulesoft.com/mule-user-guide/v/3.6/xa-transactions[XA Transactions] for configuration details.
...
Refer to the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/error-handling[Error Handling] documentation to learn more about Mule's default exception strategy and how to apply exception strategies to flows. Follow the steps below to apply an exception strategy to an individual transaction. 
...
+
. Configure the exception strategy as needed, keeping in mind Mule uses this exception strategy to handle any exceptions thrown while processing the transaction. Reference the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/error-handling[Error Handling] documentation for exception strategy configuration details.
....
[tab,title="Studio or Standalone XML"]
....
...
* Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/single-resource-transactions[Single Resource Transactions], link:https://docs.mulesoft.com/mule-user-guide/v/3.6/multiple-resource-transactions[Multiple Resource Transactions], and link:https://docs.mulesoft.com/mule-user-guide/v/3.6/xa-transactions[XA Transactions]. 
* Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/error-handling[Exception Strategies].
...
* Use the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transactions-configuration-reference[Transactions Configuration Reference] for quick reference to transactional attributes.
