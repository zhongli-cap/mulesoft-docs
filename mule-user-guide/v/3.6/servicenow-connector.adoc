...
*Release Notes*: link:https://docs.mulesoft.com/release-notes/servicenow-connector-release-notes[ServiceNow Connector Release Notes]
...
* A global ServiceNow element to be used by all the ServiceNow connectors in the application (read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/global-elements[global elements in Mule]).
...
|*Type* |Select the ServiceNow table to act upon. For a complete list, see the link:https://docs.mulesoft.com/release-notes/servicenow-connector-release-notes[ServiceNow Release Notes].
