...
[TIP]
The most powerful tool for transforming a message is the link:/mule-user-guide/v/3.8/dataweave[DataWeave Transformer], which cannot only change the format of the message, but also rename, aggregate, split, or rearrange the fields in it in any way you desire.
