...
[TIP]
Placing a Python Component is actually the same as placing a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/script-component-reference[Script component] and then selecting the Python engine.
...
* Refer to the generic link:https://docs.mulesoft.com/mule-user-guide/v/3.6/script-component-reference[Script Component Reference] to see how a script works with one-way and request-response connectors.
