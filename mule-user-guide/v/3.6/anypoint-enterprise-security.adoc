...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/setting-up-ldap-provider-for-spring-security[LDAP] and third party identity management system integration
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/sftp-transport-reference[Secure FTP (SFTP) Transport] that enables Mule flows to read and write to remote directories over the SSH protocol.
...
link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-digital-signature-processor[Add a digital signature to a message in Mule] +
link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-digital-signature-processor[Sign part of a message payload] +
link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-digital-signature-processor[Verify a digital signature in Mule]
...
link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-filter-processor[Filter unsecure messages]
