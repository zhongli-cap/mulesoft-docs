...
link:/mule-user-guide/v/3.6/mule-secure-token-service[Apply Oauth 2.0 to my Mule Web service provider] +
link:/mule-user-guide/v/3.6/mule-secure-token-service[Apply Oauth 2.0 to my Mule Web service consumer]
