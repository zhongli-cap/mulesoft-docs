...
If you are working with Maven outside Studio, see link:/mule\-user\-guide/v/3\.6/using-maven-in-mule-esb[Using Maven in Mule ESB].

For basic details on Maven, see link:/mule\-user\-guide/v/3\.6/maven-reference[Maven Reference].
