...
This document assumes that you are familiar with Mule, the link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio interface], link:/mule\-user\-guide/v/3\.6/global-elements[Global Elements], link:/mule\-user\-guide/v/3\.6/datasense[DataSense], and link:/mule\-user\-guide/v/3\.6/batch-processing[batch processing] in Mule. Further, it assumes you are familiar with Salesforce and have a link:https://developer.salesforce.com/[Salesforce developer] account.
