...
* The AMQP connector accepts and uses a `receiver-threading-profile` that is used to set the consumer thread pool as per the  link:https://www.rabbitmq.com/api-guide.html#consumer-thread-pool[RabbitMQ Consumer Thread Pool]. More information on how to set a receiver threading profile in the Mule link:https://docs.mulesoft.com/mule-user-guide/v/3.6/tuning-performance[Tuning Performance] guide.
...
* Read the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/amqp-connector-examples[AMQP Connector Examples] for practical illustrations of common use cases.

* Access the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/amqp-connector-reference[AMQP Connector Reference] for a complete list and description of all AMQP connector configuration attributes.
