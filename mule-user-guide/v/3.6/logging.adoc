...
For more on how to use the Logger component in Studio, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/logger-component-reference[Logger Component Reference]

You can configure what gets logged, where it gets logged, and how by editing a configuration file that sits in your project. For a description of what you can do through this and instructions on how to set it up, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/logging-in-mule[Logging in Mule].
