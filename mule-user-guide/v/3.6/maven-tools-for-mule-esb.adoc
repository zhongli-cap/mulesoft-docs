...
* Access additional Maven http://www.mulesoft.org/documentation/display/current/Maven+Reference[reference] and link:/mule-user-guide/v/3.5/configuring-maven-pom-files-and-settings[Configuration] information.
