...
Mule's link:https://docs.mulesoft.com/mule-user-guide/v/3.6/cxf-module-reference[CXF Module] includes WS-Security with a SAML option that supports SAML 2.0. 
====
