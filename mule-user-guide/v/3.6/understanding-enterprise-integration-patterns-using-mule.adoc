...
|File Transfer |link:https://docs.mulesoft.com/mule-user-guide/v/3.6/file-transport-reference[File Transport]
|Shared Database |link:https://docs.mulesoft.com/mule-user-guide/v/3.6/jdbc-transport-reference[JDBC Transport]
...
|Message Router |link:https://docs.mulesoft.com/mule-user-guide/v/3.6/routers[Message Routers]
|Message Translator |link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-transformers[Message Transformer]
|Message Endpoint |Inbound & Outbound link:https://docs.mulesoft.com/mule-user-guide/v/3.6/endpoint-configuration-reference[Endpoints]
|===
...
|===
|Pattern |Mapping to a Mule Object
|Content Enricher |link:https://docs.mulesoft.com/mule-user-guide/v/3.6/message-enricher[Message Enricher]
|===
