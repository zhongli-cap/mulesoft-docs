...
*Release Notes*:  link:https://docs.mulesoft.com/release-notes/microsoft-sharepoint-2013-connector-release-notes[Microsoft SharePoint 2013 Connector Release Notes]
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transformers[Studio Transformers]    
*  link:https://docs.mulesoft.com/mule-user-guide/v/3.6/flow-reference-component-reference[Flow References]
