...
|Error Policy |Input |How to handle bad input data. See link:https://docs.mulesoft.com/mule-user-guide/v/3.6/datamapper-input-error-policy-for-bad-input-data[DataMapper Input Error Policy for Bad Input Data] for details.
|===
