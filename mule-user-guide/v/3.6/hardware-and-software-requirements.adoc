...
Get more information about installing link:https://docs.mulesoft.com/mule-user-guide/v/3.6/studio-in-eclipse[Studio as an Eclipse plug-in].
...
* Learn more about installing an link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-an-enterprise-license[Enterprise license].
