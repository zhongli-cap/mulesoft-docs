...
. Click *OK*. At this point, the mapping is complete. Running a link:https://docs.mulesoft.com/anypoint-studio/v/5/previewing-datamapper-results-on-sample-data[preview] of the mapping gives the following result:
