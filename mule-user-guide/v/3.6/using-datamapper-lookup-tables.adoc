...
. Click *OK*. At this point, the mapping is complete. Running a link:/mule-user-guide/v/3.6/previewing-datamapper-results-on-sample-data[preview] of the mapping gives the following result:
