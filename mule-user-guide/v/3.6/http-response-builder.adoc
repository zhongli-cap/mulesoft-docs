...
When the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-listener-connector[HTTP Connector works as a listener], you can configure a status code and a status reason on the connector itself, separately for both success and failure scenarios. To generate a response from an HTTP template, use the *link:https://docs.mulesoft.com/mule-user-guide/v/3.6/parse-template-reference[Parse Template]* element.

See link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-connector[HTTP Connector] for information about the 3.6 and later operation-based HTTP connector. For information on the deprecated HTTP connector, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-connector-deprecated[HTTP Connector - Deprecated].
...
* Read about the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-connector[HTTP Connector]
* Learn how to create and manage a API with the link:https://docs.mulesoft.com/api-manager/[API Manager]
