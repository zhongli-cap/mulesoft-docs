...
* For more information about Mule high availability, consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-high-availability-ha-clusters[Mule High Availability] documentation.
