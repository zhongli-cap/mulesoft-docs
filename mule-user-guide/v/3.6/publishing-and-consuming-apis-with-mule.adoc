...
* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/publishing-a-soap-api[Publishing a SOAP API] with CXF
...
* For more information on this new connector, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/web-service-consumer[Web Service Consumer] .
* For a complete configuration reference, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/web-service-consumer-reference[Web Service Consumer Reference].
...
* Follow the link:https://docs.mulesoft.com/apikit/apikit-tutorial[APIkit Tutorial] to publish a sample RAML-based API.  
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/consuming-a-rest-api[Consuming REST APIs] with HTTP
