...
* Access the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing[full documentation for Batch Processing] for the latest general availability release of Mule.
