...
* Add some link:https://docs.mulesoft.com/mule-user-guide/v/3.6/choice-flow-control-reference[conditional logic] to your flow link:https://docs.mulesoft.com/mule-user-guide/v/3.6/routers[routers].
