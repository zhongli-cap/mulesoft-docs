...
This document assumes that you are familiar with Mule, the link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio interface], and link:/mule\-user\-guide/v/3\.6/global-elements[Global Elements]. Further, it is assumed that you are familiar with the Microsoft .NET Framework.
