...
[TIP]
Our default and recommended XA Transaction Manager is *Bitronix*, read link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-bitronix-to-manage-transactions[Using Bitronix to Manage Transactions] for details on how to implement it in Mule.
...
* Refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transaction-management[Transaction Management] for details on how to configure an XA transaction.
* Refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-bitronix-to-manage-transactions[Using Bitronix to Manage Transactions] to see how to implement our default and recommended XA Transaction Manager +
