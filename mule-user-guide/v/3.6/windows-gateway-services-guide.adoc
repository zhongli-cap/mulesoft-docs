...
For information on MSMQ, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/msmq-connector-user-guide[MSMQ Connector User Guide].
...
. Download the Windows Gateway Services installer from link:https://repository-master.mulesoft.org/nexus/content/repositories/releases/org/mule/modules/anypoint-windows-gateway-service/1.4.0/anypoint-windows-gateway-service-1.4.0.zip[here]. Unzip the software distribution. For more information, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/windows-gateway-services-guide[Windows Gateway Services Guide].
