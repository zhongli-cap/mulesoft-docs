...
Install the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/windows-gateway-services-guide[Windows Gateway Services] 
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/windows-gateway-services-guide[Windows Gateway Services]
