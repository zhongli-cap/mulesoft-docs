...
*Release Notes*: link:https://docs.mulesoft.com/release-notes/workday-connector-release-notes#version-5-0-july-1-2015[Workday Connector Release Notes]
...
You can install a connector in Anypoint Studio using the instructions in link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-connectors[To Install a Connector from Anypoint Exchange]. However, to use the Workday Connector in a production environment, you must have either:
...
Alternatively you can also link:https://docs.mulesoft.com/anypoint-studio/v/5/installing-extensions[install this extension via Maven].
...
To use the Workday connector in your Mule application, you must configure a global element for each Workday connector module in the application (read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/global-elements[global elements]). To create a global Workday connector configuration, follow these steps:
...
+
. Click *Test Connection* to confirm that the parameters of your global Workday connector are accurate, and that Mule is able to successfully connect to your instance of Workday. (Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/testing-connections[Testing Connections].)
...
* Learn about the link:https://docs.mulesoft.com/anypoint-studio/v/5/datamapper-concepts[DataMapper transformer].
