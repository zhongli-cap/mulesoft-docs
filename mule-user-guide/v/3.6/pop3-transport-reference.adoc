...
The POP3 connector supports all the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-a-transport[common connector attributes and properties] and the following additional attributes:
...
POP3 and POP3S endpoints include details about connecting to a POP3 mailbox. You link:https://docs.mulesoft.com/mule-user-guide/v/3.6/endpoint-configuration-reference[configure the endpoints] just as you would with any other transport, with the following additional attributes:
...
For more information about transformers, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/email-transport-reference[Transformers] section in the Email Transport Reference.

For more information about filters, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/email-transport-reference[Filters] section in the Email Transport Reference.

== Exchange Patterns / Features of the Transport

See link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transports-reference[transport matrix].
...
http://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/email/package-summary.html[Javadoc for POP3 Transport]
...
For more information about the limitations, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/email-transport-reference[Limitations] section in the Email Transport Reference.
