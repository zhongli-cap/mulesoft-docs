...
Typically, a message source comes in the form of an link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-connectors[*Anypoint Connector*]. 
...
Under certain conditions, flows do not need to be triggered by message sources. For instance, a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/flow-reference-component-reference[Flow Reference Component] can trigger a different flow in the same application. Similarly, the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/async-scope-reference[Async Scope] can trigger a another flow that executes asynchronously, (i.e. in parallel with the originating flow).
...
For further details, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/flow-processing-strategies[Flow Processing Strategies].
...
Studio provides four pre-packaged error handling strategies to handle exceptions thrown at various points during the message processing sequence. For details, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/error-handling[Error Handling].
...
* call various other link:https://docs.mulesoft.com/mule-user-guide/v/3.6/flows-and-subflows[flows]  +

== See Also

* *NEXT STEP:* Learn about how link:https://docs.mulesoft.com/mule-user-guide/v/3.6/flows-and-subflows[flows and subflows] work together in an application.
* Examine an link:https://docs.mulesoft.com/mule-user-guide/v/3.6/flow-architecture-advanced-use-case[advanced use case] showing a more complex flow architecture.
