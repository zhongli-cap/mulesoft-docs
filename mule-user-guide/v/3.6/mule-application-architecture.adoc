...
Typically, a message source comes in the form of an link:/mule-user-guide/v/3.6/anypoint-connectors[*Anypoint Connector*]. 
...
For further details, see link:/mule-user-guide/v/3.6/flow-processing-strategies[Flow Processing Strategies].
...
Studio provides four pre-packaged error handling strategies to handle exceptions thrown at various points during the message processing sequence. For details, see link:/mule-user-guide/v/3.6/error-handling[Error Handling].
...
* call various other link:/mule-user-guide/v/3.6/flows-and-subflows[flows]  +

== See Also

* *NEXT STEP:* Learn about how link:/mule-user-guide/v/3.6/flows-and-subflows[flows and subflows] work together in an application.
* Examine an link:/mule-user-guide/v/3.6/flow-architecture-advanced-use-case[advanced use case] showing a more complex flow architecture.
