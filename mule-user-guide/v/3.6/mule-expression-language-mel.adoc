...
This document assumes that you are familiar with Mule ESB and its link:/mule-user-guide/v/3.6/mule-concepts[basic concepts]. Consider reading the chapter, link:/getting-started/index[Anypoint Fundamentals] to gain familiarity before proceeding. 
