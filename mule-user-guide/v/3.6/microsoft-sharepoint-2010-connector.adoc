...
. From *Work with* drop down, select `Anypoint Connectors Update Site`. In Studio 6.3.0 and later, select `https://repository.mulesoft.org/connectors/releases/3.5.0` to install this connector.
...
More information on how to create the Kerberos configuration file can be found at link:http://web.mit.edu/kerberos/krb5-devel/doc/admin/conf_files/krb5_conf.html[MIT Kerberos Documentation - krb5.conf]
