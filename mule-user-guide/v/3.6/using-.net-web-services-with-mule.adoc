...
For more information see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-security[Configuring Security].
...
If you are using CXF, you can configure a client and service to use WS-Security. For details, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/enabling-ws-security[Enabling WS-Security].
