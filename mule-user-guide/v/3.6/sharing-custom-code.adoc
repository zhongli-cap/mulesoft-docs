...
* Custom components - typically Mule-aware or non-business oriented components, as business components are usually simple POJOs coming from pre-existing projects (see: link:https://docs.mulesoft.com/mule-user-guide/v/3.6/developing-components[here]).
