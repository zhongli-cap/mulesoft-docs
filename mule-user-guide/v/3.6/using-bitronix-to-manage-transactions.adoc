...
This document assumes you are familiar with working with link:https://docs.mulesoft.com/mule-user-guide/v/3.6/shared-resources[Shared Resources] in Mule.
...
Bitronix integration provides a datasource connection pool for the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/database-connector[Database connector], which you must use whenever you want to implement resource pooling in the database connector.
...
* Read more about how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/shared-resources[define a Bitronix transaction manager as a shared resource] for multiple applications associated with a domain.
