...
* Learn how to encrypt your properties file with the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-credentials-vault[Mule Credentials Vault].
* Learn how to encrypt or decrypt messages with link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-message-encryption-processor[XML or JCE Encryption].
