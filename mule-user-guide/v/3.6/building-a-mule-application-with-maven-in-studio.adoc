...
This document assumes that you have link:https://docs.mulesoft.com/anypoint-studio/v/5/[downloaded and installed Anypoint Studio]. If you do not have any previous experience with Eclipse or an Eclipse-based IDE, review the brief introduction to the link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio interface]. The document also assumes you're familiar with link:http://maven.apache.org/[Apache Maven] and know what it's used for.
...
* Line number 12: This class extends FunctionalTestCase, which is Mule's implementation of an abstract JUnit test case. For more information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/functional-testing[Functional Testing].
...
* Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-maven-with-mule[Using Maven with Mule].

* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/maven-support-in-anypoint-studio[configure your Studio Preferences to work with Maven].
* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/building-a-mule-application-with-maven-in-studio["mavenize" an existing Anypoint Studio project].

* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/importing-a-maven-project-into-studio[import an existing Maven project into Anypoint Studio].

* Access additional Maven link:https://docs.mulesoft.com/mule-user-guide/v/3.6/maven-reference[reference] and link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-maven-to-work-with-mule-esb[configuration] information.
