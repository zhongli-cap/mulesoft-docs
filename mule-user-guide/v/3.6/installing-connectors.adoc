...
Refer to link:https://docs.mulesoft.com/getting-started/index[Deploying Mule Applications] for more information on managing your user libraries in Studio.
...
* Read more about using link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-connectors[Anypoint Connectors]. 
...
* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/working-with-multiple-versions-of-connectors[work with multiple versions of connectors].
