...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/pop3-transport-reference[POP3 Transport Reference] for details on setting the properties for a POP3 endpoint using an XML editor.
