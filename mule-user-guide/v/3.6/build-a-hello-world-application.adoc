...
This tutorial assumes that you have link:https://docs.mulesoft.com/anypoint-studio/v/5/[downloaded, installed, and launched Anypoint Studio], and that you've read through the link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio Essentials].
...
* *NEXT*: Dive into the more extensive *First Day* content starting with link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-concepts[Mule Concepts].
* Happier using the command line to run applications? Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/starting-and-stopping-mule-esb[Starting and stopping Mule].
* Skip ahead in the syllabus to the link:https://docs.mulesoft.com/anypoint-studio/v/6/basic-studio-tutorial[Basic Studio Tutorial].
