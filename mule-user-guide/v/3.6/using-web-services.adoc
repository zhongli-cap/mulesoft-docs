...
link:/mule-user-guide/v/3.6/web-service-consumer[Web Service Consumer] - Describes how to consume web services.
...
link:/mule-user-guide/v/3.6/proxying-web-services[Proxying Web Services] - Describes how to use Mule as a web service proxy in various scenarios.

link:/mule-user-guide/v/3.6/supported-web-service-standards[Supported Web Service Standards] - Web service standards supported by Mule and CXF.
