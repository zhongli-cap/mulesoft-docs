...
* A global CassandraDB element for use by all the CassandraDB connectors in an application. For more information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/global-elements[Mule Global Elements].
