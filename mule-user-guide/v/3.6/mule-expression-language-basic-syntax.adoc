...
This document assumes that you have read link:/mule-user-guide/v/3.6/mule-expression-language-mel[Mule Expression Language MEL] and have studied the link:/mule-user-guide/v/3.6/mule-message-structure[Mule message structure]. 
