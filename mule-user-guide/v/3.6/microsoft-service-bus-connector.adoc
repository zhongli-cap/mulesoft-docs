...
*Release Notes:* link:https://docs.mulesoft.com/release-notes/microsoft-service-bus-connector-release-notes[Microsoft Service Bus Connector Release Notes]
...
* Learn more about the Microsoft Service Bus connector in the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/microsoft-service-bus-connector-faq[Microsoft Service Bus Connector FAQ].
* For code samples that illustrate more advanced scenarios, refer to link:_attachments/service-bus-connector-samples.zip[service-bus-connector-samples.zip].
* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-connectors[Install and Configure Anypoint Connectors] in Anypoint Studio.
...
* To access MuleSoft’s expert support team, https://www.mulesoft.com/support-and-services/mule-esb-support-license-subscription[subscribe] to Mule Enterprise and log into MuleSoft link:http://www.mulesoft.com/support-login[Customer Portal].
