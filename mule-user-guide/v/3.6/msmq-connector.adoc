...
*  Install the link:/mule\-user\-guide/v/3\.6/windows-gateway-services-guide[Windows Gateway Service] first before installing and configuring MSMQ.
* .NET 4.0
* MSMQ Service
...
*Important*: Install the link:/mule\-user\-guide/v/3\.6/windows-gateway-services-guide[Windows Gateway Service] first before installing and configuring MSMQ.
...
* link:/mule\-user\-guide/v/3\.6/msmq-connector-user-guide[MSMQ User Guide]
