...
[TIP]
Placing a Groovy Component is actually the same as placing a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/script-component-reference[Script component] and then selecting the Groovy engine.
...
* Refer to the generic link:https://docs.mulesoft.com/mule-user-guide/v/3.6/script-component-reference[Script component reference page] to see how a script works with one-way and request-response connectors.
