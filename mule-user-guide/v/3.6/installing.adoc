...
. link:https://docs.mulesoft.com/mule-user-guide/v/3.6/hardware-and-software-requirements[Check hardware and software requirements.]
. link:https://docs.mulesoft.com/mule-user-guide/v/3.6/downloading-and-starting-mule-esb[Download, then launch Mule.]
. link:https://docs.mulesoft.com/mule-user-guide/v/3.6/adding-community-runtime[Add Community runtime to AnypointStudio] (_optional_).
. link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-an-enterprise-license[Install an Enterprise license] (_optional_).
. link:https://docs.mulesoft.com/anypoint-studio/v/5/installing-extensions[Extend Mule with plugins, modules, runtimes and connectors] (_optional_).
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/starting-and-stopping-mule-esb[Starting and Stopping Mule]
