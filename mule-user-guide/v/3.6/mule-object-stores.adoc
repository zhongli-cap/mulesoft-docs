...
. When configuring an link:https://docs.mulesoft.com/mule-user-guide/v/3.6/idempotent-filter[idempotent message filter] or until successful scope.
...
* *In-memory store* – Prior to Mule 3.5.0, in-memory store was the default. As of Mule 3.5.0, persistent store is the default. For more information, see "Object Stores and Clustering" in the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/cache-scope[Cache Scope] document.
...
* link:https://docs.mulesoft.com/runtime-manager/managing-application-data-with-object-stores[CloudHub implementation of object stores].
