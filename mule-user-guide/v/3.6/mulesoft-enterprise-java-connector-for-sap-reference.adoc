...
[WARNING]
*IMPORTANT*: The key to a fully working application in cluster is the implementation of link:/mule-user-guide/v/3.6/reliability-patterns[reliability patterns].
