...
* Supports local (JMS), distributed (XA), and multi-resource link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transaction-management[transactions]  _*Enterprise*_
...
Mule Enterprise includes an link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-wmq-transport-reference[enhanced transport for WebSphereMQ] when using WebSphereMQ as your JMS provider.
====
...
http://activemq.apache.org/[ActiveMQ] is also widely-used with Mule and has link:https://docs.mulesoft.com/mule-user-guide/v/3.6/activemq-integration[simplified configuration].
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/open-mq-integration[Open MQ]
