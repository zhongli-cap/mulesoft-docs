...
* Learn how to exploit link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-perceptive-flow-design[DataSense Perceptive Flow Design].
* Learn how to use the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-the-datasense-explorer[DataSense Explorer] to preview to contents of the message
