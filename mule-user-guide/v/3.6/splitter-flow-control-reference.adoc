...
+
You can look at the values of these outbound variables by putting a break point after the splitter and running your flow with the link:https://docs.mulesoft.com/anypoint-studio/v/5/studio-visual-debugger[Visual Debugger]:
...
* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-expression-language-mel[Mule Expression Language (MEL)].
