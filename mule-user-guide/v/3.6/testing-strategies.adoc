...
Mule provides abstract parent classes to help with unit testing. Turn link:/mule-user-guide/v/3.6/unit-testing[here] for more information about them.
...
The FTC supports plenty of configuration options. Read more about it there: link:/mule-user-guide/v/3.6/functional-testing[Functional Testing].
