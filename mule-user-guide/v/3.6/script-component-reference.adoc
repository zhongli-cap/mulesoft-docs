...
For each of these languages, besides a "component", there's also a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/script-transformer-reference[transformer]. Transformers are more specialized in that they're already prepared to take a message's payload as input and to return a payload as output. Anything you can do with a transformer can also be done with a component.
...
[TIP]
Keep in mind that if you'd rather code in Java, there's also a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/java-component-reference[Java Component] that works very similarly.
...
* For more information see the Mule ESB page link:https://docs.mulesoft.com/mule-user-guide/v/3.6/scripting-module-reference[Scripting Module]
* Read more about the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/javascript-component-reference[JavaScript Component]
* Read more about the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/ruby-component-reference[Ruby Component]
* Read more about the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/groovy-component-reference[Groovy Component]
* Read more about the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/python-component-reference[Python Component]
* Read more about the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/java-component-reference[Java Component]
