...
For more information and full details about how to demarcate transactions in your Mule flow, refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transaction-management[Transaction Management].
