...
|*Anypoint Connectors* |Need to connect to a SaaS application? Check our link:http://www.mulesoft.org/connectors[library of Anypoint Connectors], and add them your instance of Mule. 2+|link:/mule\-user\-guide/v/3\.6/installing-connectors[Installing Connectors]
|*Modules* |Add suites of functionality to your instance of Mule such as link:/mule\-user\-guide/v/3\.6/installing-anypoint-enterprise-security[Anypoint Enterprise Security] and link:https://docs.mulesoft.com/healthcare-toolkit/v/3.0[Mule Healthcare Toolkit]. 2+|link:https://docs.mulesoft.com/anypoint-studio/v/6/installing-extensions[Installing Extensions]
