...
To learn more about endpoints, refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-connectors[Anypoint Connectors].
...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-transport-reference[HTTP Transport Reference] for details on setting the properties for a HTTP endpoint using an XML editor.
