...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/connector-configuration-reference[Connector Configuration Reference] for instructions for configuring connectors for endpoint functions or for operations.

See the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-connector[HTTP Connector] for information on this operation-based connector.
...
* Refer to the overview of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-connectors[Anypoint Connectors].
* Access the http://www.mulesoft.org/connectors[full library of available connectors].
* Check out the link:https://docs.mulesoft.com/getting-started/anypoint-connector[Anypoint Connector quickstart]. 
