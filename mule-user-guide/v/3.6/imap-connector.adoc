...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/imap-transport-reference[IMAP Transport Reference] for details on setting the properties for an IMAP endpoint using an XML editor.
