...
Refer to link:/mule-user-guide/v/3.6/rollback-exception-strategy[Rollback Exception Strategy] for detailed instructions on how to apply one to a flow.
