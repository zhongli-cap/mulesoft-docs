...
Refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/rollback-exception-strategy[Rollback Exception Strategy] for detailed instructions on how to apply one to a flow.
...
Refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/catch-exception-strategy[Catch Exception Strategy] for detailed instructions on how to apply one to a flow.
