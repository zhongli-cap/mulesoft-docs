...
* Anypoint Enterprise Security requires Mule Enterprise version 3.3.2 or later.  (Not sure which version of Mule you have installed? link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing[Find out.])
...
* You are using Mule ESB with a valid Enterprise license. (Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-an-enterprise-license[installing an Enterprise license] on your existing instance of Mule.)
