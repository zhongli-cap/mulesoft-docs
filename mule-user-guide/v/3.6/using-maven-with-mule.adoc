...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/building-a-mule-application-with-maven-in-studio[Building a Mule application with Maven in Studio]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/enabling-maven-support-for-a-studio-project[Enabling Maven support for an existing Studio project]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/importing-a-maven-project-into-studio[Importing a Maven project into Studio]

*In Mule* *ESB:*

Maven-Mule ESB functionality is provided by two Mule plugins for Maven.

* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/maven-tools-for-mule-esb[Maven tools for Mule ESB] is a plugin that provides archetypes for building regular Mule applications, allowing you to develop Mule applications from within Maven
* The link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-esb-plugin-for-maven[muleesb-maven-plugin] allows you to control Mule ESB instances from within a Maven environment
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-maven-in-anypoint-studio[Using Maven in Anypoint Studio]
** link:https://docs.mulesoft.com/mule-user-guide/v/3.6/maven-support-in-anypoint-studio[Maven Support in Anypoint Studio]
** link:https://docs.mulesoft.com/mule-user-guide/v/3.6/building-a-mule-application-with-maven-in-studio[Building a Mule Application with Maven in Studio]
** link:https://docs.mulesoft.com/mule-user-guide/v/3.6/enabling-maven-support-for-a-studio-project[Enabling Maven Support for a Studio Project]
** link:https://docs.mulesoft.com/mule-user-guide/v/3.6/importing-a-maven-project-into-studio[Importing a Maven Project into Studio]
...
* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/maven-support-in-anypoint-studio[adjusting your Studio Preferences to work with Maven]. 
...
* Access the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/maven-reference[Maven reference documentation].
