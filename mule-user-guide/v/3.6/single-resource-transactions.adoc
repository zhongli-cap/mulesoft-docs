...
Refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transaction-management[Transaction Management] for details on how to configure a Single Resource transaction.
