...
You can "test drive" the PeopleSoft connector in Anypoint Studio using the instructions in link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-connectors[To Install a Connector from Anypoint Exchange]. 
...
. Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-maven-with-mule[use Maven with Mule].
