...
[WARNING]
If you plan to connect to an external web service that exposes a WSDL file, the recommended connector to use is the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/web-service-consumer[Web Service Consumer].
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/proxying-web-services[Creating a proxy to existing Web services] (for example, adding security to an existing Web service)
