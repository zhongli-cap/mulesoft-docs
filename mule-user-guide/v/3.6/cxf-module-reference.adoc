...
[NOTE]
When sending requests to an external web service, the recommended approach is to use the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/web-service-consumer[Web Service Consumer]﻿ rather than the CXF Module.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/cxf-module-overview[Overview]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/building-web-services-with-cxf[Building Web Services]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/consuming-web-services-with-cxf[Consuming Web Services]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/proxying-web-services-with-cxf[Proxying Web Services]
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/cxf-module-configuration-reference[Configuration Reference]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/wsdl-connectors[Using the WSDL Connector]
