...
[TIP]
Placing a JavaScript Component is actually the same as placing a link:/mule-user-guide/v/3.6/script-component-reference[Script component] and then selecting the JavaScript engine.
