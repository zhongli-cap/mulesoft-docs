...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/smtp-transport-reference[SMTP]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/imap-transport-reference[IMAP]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/pop3-transport-reference[POP3]
