...
This document assumes you are familiar with Mule Expression Language's link:/mule\-user\-guide/v/3\.6/mule-expression-language-basic-syntax[basic syntax] and are comfortable building and running Mule applications using link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Mule Studio] or XML.
