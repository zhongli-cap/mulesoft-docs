...
This document assumes you are familiar with Mule Expression Language's link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-expression-language-basic-syntax[basic syntax] and are comfortable building and running Mule applications using link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Mule Studio] or XML.

If you aren't yet familiar with how to access information about the Mule messages that pass through your applications, consider following this link:https://docs.mulesoft.com/getting-started/mule-message[tutorial], which walks you through both examining your Mule message and its data structure and writing simple MEL expressions.
...
* Access the Mule Expression Language link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-expression-language-reference[Reference] and link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-expression-language-tips[Tips].
