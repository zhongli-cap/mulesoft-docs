...
This document assumes you are familiar with Mule ESB and the link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Studio interface]. Further, it assumes you have read the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-message-structure[Mule Message Structure document] to understand the contents of a Mule message. To increase your familiarity with Studio, consider reading link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio Essentials]. 
...
|Thelink:https://docs.mulesoft.com/mule-user-guide/v/3.6/flow-reference-component-reference[flow reference] in the previous step sent the message to a new flow.
...
* link:https://docs.mulesoft.com/anypoint-studio/v/5/studio-visual-debugger[Debug mode]
