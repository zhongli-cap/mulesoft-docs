...
* *NEXT STEP*: Read on about link:/mule\-user\-guide/v/3\.6/mule-filters-scopes-and-routers[Filters, Scopes, and Routers].
* Skip ahead to understand the structure of a link:/mule\-user\-guide/v/3\.6/mule-message-structure[Mule message].
* Learn more about setting, then using link:/mule\-user\-guide/v/3\.6/mule-message-structure[properties and variables].
