...
By default, Mule stores all cached responses in an InMemoryObjectStore. <<Creating a Caching Strategy>> and define a new link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-object-stores[object store] if you want to customize the way Mule stores cached responses.
...
* Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/scopes[Scopes] in Mule.
