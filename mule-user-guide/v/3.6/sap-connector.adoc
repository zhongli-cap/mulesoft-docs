...
Mule supports SAP integration through our link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-connectors[Anypoint Connector] for SAP, which is an SAP-certified Java connector that leverages the SAP Java Connector (JCo) libraries.  The SAP connector enables Mule applications to:
...
Download the requisite link:http://service.sap.com/connectors[SAP libraries]. To perform this download, you must have an SAP user ID.
...
If you intend to employ an SAP endpoint in conjunction with a link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper transformer] to map and transform data, you can make use of Anypoint Studio's link:https://docs.mulesoft.com/mule-user-guide/v/3.6/datasense[DataSense] functionality.

. Follow the detailed link:https://docs.mulesoft.com/mule-user-guide/v/3.6/datasense[DataSense] instructions to drop the endpoint into your flow, then link:https://docs.mulesoft.com/mule-user-guide/v/3.6/testing-connections[test the connection] to SAP using the SAP Connector. 
...
Port 3300 is predefined by SAP, so if you need to validate other port numbers based on your SAP instance number, you can check the complete list of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/sap-jco-server-services-configuration[service-to-port mappings].
...
In this case, you must know the configuration property _as defined by SAP_. You can check link:https://docs.mulesoft.com/mule-user-guide/v/3.6/sap-jco-extended-properties[the configuration properties list].
...
[NOTE]
With DataSense support, the recommended way to generate the XML definitions is using link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper] (and XML version 2 for BAPIs/Functions).
...
For more information about using XML definitions without DataMapper and DataSense, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/xml-definitions[XML Definitions].
...
|*Extended Properties* |jcoClientExtendedProperties-ref |Advanced |A Reference to `java.util.Map`, which contains additional JCo connection parameters. As necessary, consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/sap-jco-extended-properties[complete list of parameters]. | 
|===
...
For additional information, consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.8/mulesoft-enterprise-java-connector-for-sap-reference[Enterprise Java Connector for SAP Reference].
