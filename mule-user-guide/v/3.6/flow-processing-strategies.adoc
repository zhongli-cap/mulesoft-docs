...
In addition to fine-tuning the attributes of the queued-asynchronous processing strategy, you can also link:/mule-user-guide/v/3.6/tuning-performance[tune performance] of your Mule application by analyzing and configuring thread profiles.
...
* link:/mule-user-guide/v/3.6/tuning-performance[Tune performance]
