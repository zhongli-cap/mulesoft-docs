...
[NOTE]
====
Refer to documentation on link:/mule-user-guide/v/3.6/poll-reference[B]link:/mule-user-guide/v/3.6/batch-processing[atch Processor] and link:/anypoint-studio/v/6/datamapper-user-guide-and-reference[Data Mapper] for in-depth information about these Mule elements.
====
