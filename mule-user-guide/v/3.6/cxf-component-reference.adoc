...
* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/publishing-a-soap-api[publishing SOAP APIs] with Mule.

* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/consuming-a-soap-api[consuming SOAP APIs] with Mule.
