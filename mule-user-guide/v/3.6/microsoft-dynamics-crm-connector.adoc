...
*Release Notes*: link:https://docs.mulesoft.com/release-notes/microsoft-dynamics-crm-connector-release-notes[Microsoft Dynamics CRM Connector Release Notes]
...
Use the instructions in link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-connectors[To Install a Connector from Anypoint Exchange].
...
|Property |Usage
|*Query* a|
DataSense Query Language: The DSQL to run. The query is translated by the connector to a Fetch XML. For more information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/datasense-query-language[DataSense Query Language].
