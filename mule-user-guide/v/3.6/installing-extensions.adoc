...
.. Enter a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/studio-update-sites[specific update site URL] from which you wish to download a plugin, module, or connector
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/adding-community-runtime[Mule Community Runtime]  
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-anypoint-enterprise-security[Anypoint Enterprise Security]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-connectors[Anypoint Connectors]
