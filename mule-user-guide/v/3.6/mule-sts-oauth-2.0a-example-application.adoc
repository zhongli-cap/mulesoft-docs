...
This document assumes that you are familiar with the link:/mule-user-guide/v/3.6/anypoint-studio-essentials[Anypoint Studio interface]. To increase your familiarity with Anypoint Studio, consider completing one or more link:/quickstarts[Anypoint Studio Quickstarts].
