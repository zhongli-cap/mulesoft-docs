...
This document assumes that you are familiar with the link:/mule-fundamentals/v/3.6/anypoint-studio-essentials[Anypoint Studio interface]. To increase your familiarity with Anypoint Studio, consider completing one or more link:/mule-fundamentals/v/3.6/first-day-with-mule[Anypoint Studio Tutorials].
...
* For more information on OAuth 2.0a in Mule, refer to link:/mule-user-guide/v/3.6/mule-secure-token-service[Mule Secure Token Service].
