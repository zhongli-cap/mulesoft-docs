...
* Access link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-high-availability-ha-clusters[Mule High Availability (HA) Clustering] for an overview.

* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/creating-and-managing-a-cluster-manually[manually create and manage a cluster,] accessing additional options.

* Learn how to enable link:https://docs.mulesoft.com/mule-user-guide/v/3.6/distributed-file-polling[distributed file polling].
