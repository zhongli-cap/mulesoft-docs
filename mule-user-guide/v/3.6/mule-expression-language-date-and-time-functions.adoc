...
This reference page provides lists and brief explanations of the date and time functions in MEL. For explanatory information, see link:/mule-user-guide/v/3.6/mule-expression-language-mel[Mule Expression Language], link:/mule-user-guide/v/3.6/mel-basic-syntax[MEL Basic Syntax], and the link:/mule-user-guide/v/3.6/mule-expression-language-examples[MEL examples].
