...
As Mule’s default signature strategy, the link:http://www.oracle.com/technetwork/java/javase/downloads/jce-7-download-432124.html[Java Cryptology Extension (JCE) signer] enriches a message payload with a digital signature.

[NOTE]
This topic introduces the idea of Global Elements; if you are unfamiliar with this functionality, access link:https://docs.mulesoft.com/mule-user-guide/v/3.6/global-elements[Global Elements] to learn more before proceeding.
...
Examine the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-enterprise-security-example-application[Anypoint Enterprise Security Example Application] which illustrates how to verify the digital signature of a message.
