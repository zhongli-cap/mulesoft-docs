...
This document assumes that you have link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-anypoint-enterprise-security[installed the Anypoint Enterprise Security] extensions.

It also assumes you are familiar with the link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio] interface. To increase your familiarity with Studio, consider completing one or more link:/getting-started[Anypoint Studio Quickstarts].
...
* For more information on encryption in Mule, refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-message-encryption-processor[Mule Message Encryption Processor].
* For more information on signatures in Mule, refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-digital-signature-processor[Mule Digital Signature Processor].
