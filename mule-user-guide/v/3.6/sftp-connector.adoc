...
image:studio-sftp-gen.png[studio-sftp-gen]
...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/sftp-transport-reference[SFTP Transport Reference] for details on setting the properties for an SFTP endpoint using an XML editor.
