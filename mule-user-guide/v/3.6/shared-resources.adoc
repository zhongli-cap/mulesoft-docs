...
* Note that although shared resources is limited to the selected connectors and libraries covered in this document, there are ways to share other configuration fragments in Mule. Refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/sharing-custom-configuration-fragments[Sharing Custom Configuration Fragments] for details.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/database-connector[DB]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/jms-transport-reference[JMS]
*  link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-connector[HTTP Connector]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-wmq-transport-reference[WMQ]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/jboss-transaction-manager-reference[JBoss]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/setting-environment-variables[Set Environment Variables]
