...
* Learn how to migrate link:https://docs.mulesoft.com/mule-user-guide/v/3.6/importing-a-maven-project-into-studio[a Maven project into Studio].

* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/building-a-mule-application-with-maven-in-studio[build new Maven projects] directly in Studio.
