...
Instead, please refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-expression-language-mel[Mule Expression Language MEL] for a complete user guide and reference.
====
...
Mule ESB provides several link:https://docs.mulesoft.com/mule-user-guide/v/3.6/non-mel-expressions-configuration-reference[default expression evaluators], allowing you to embed expression logic in a variety of expression languages, or you can link:https://docs.mulesoft.com/mule-user-guide/v/3.6/creating-non-mel-expression-evaluators[create your own evaluators] to support additional languages.

This page describes how to use expressions. For more details on how to configure expressions, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/non-mel-expressions-configuration-reference[Non-MEL Expressions Configuration Reference].

== Message Property Scopes

Starting with Mule 3 expressions operating on message properties also support an optional scope qualifier syntax. For more information about message scopes, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-concepts[Mule Concepts].

== Using Expressions with Transformers

This section describes the transformers that support expressions. For more information on transformers, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-transformers[Using Transformers].
...
To read more about configuring expressions, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/non-mel-expressions-configuration-reference[Non-MEL Expressions Configuration Reference].
