...
This transformer sets the payload to whatever you define. The payload can be a literal string or a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-expression-language-mel[Mule Expression].
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transformers[other transformers]
