...
This page contains some common troubleshooting suggestions for the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mulesoft-enterprise-java-connector-for-sap-reference[SAP Connector].
...
In this example, JCo libraries are informing that the parameter with name _type_ is not valid. The complete list of valid property names can be found link:https://docs.mulesoft.com/mule-user-guide/v/3.6/sap-jco-extended-properties[here].
