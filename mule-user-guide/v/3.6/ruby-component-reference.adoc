...
* Placing a Ruby Component is actually the same as placing a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/script-component-reference[Script component] and then selecting the Ruby engine.
...
* For more information see the Mule page link:https://docs.mulesoft.com/mule-user-guide/v/3.6/scripting-module-reference[Scripting Module].
