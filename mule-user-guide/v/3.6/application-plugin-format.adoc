...
* `loader.override` - provides fine-grained control over link:https://docs.mulesoft.com/mule-user-guide/v/3.6/classloader-control-in-mule[class loading] within a plugin.
