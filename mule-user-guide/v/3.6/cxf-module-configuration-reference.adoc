...
This page provides reference information about the elements and attributes you can configure for the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/cxf-module-reference[CXF Module Reference] .
