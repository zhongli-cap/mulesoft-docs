...
This page summarizes reference information that is helpful for working with Maven and Mule. Refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-maven-with-mule[Using Maven with Mule] for an introduction and overview.
...
See link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-maven-to-work-with-mule-esb[Configuring Maven to Work with Mule ESB].
