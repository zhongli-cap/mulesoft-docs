...
This page provides details on the elements you configure for the security manager. For more information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-security[Configuring Security].
