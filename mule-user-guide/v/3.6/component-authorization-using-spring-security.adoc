...
In addition to the `daoAuthenticationProvider` and `inMemoryDaoImpl` beans (see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-security[Configuring Security]), the following beans must be configured:
