...
Access a list of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-connectors[Anypoint Connectors already installed in Studio] with this version.
...
|*API Gateway Update Site* |https://studio.mulesoft.org.s3.amazonaws.com/r3/api-gateway/ |API Gateway runtime |Read more about the link:https://docs.mulesoft.com/api-manager/api-gateway-runtime-archive[API Gateway Runtime].
...
Anypoint Studio Properties File Editor
 ...
 |Note that you need an Enterprise license to run applications containing link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-enterprise-security[Anypoint Enterprise Security] features.
...
DataMapper designer
 ...
 |Read more about installing link:https://docs.mulesoft.com/mule-user-guide/v/3.6/studio-in-eclipse[Anypoint Studio as an Eclipse Plugin].
|*MUnit* |http://studio.mulesoft.org/r4/munit |link:https://docs.mulesoft.com/mule-user-guide/v/3.6/munit[MUnit] beta framework for testing Mule Applications | 
|===
