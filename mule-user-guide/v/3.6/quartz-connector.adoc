...
When scheduling tasks, it's recommended that you instead resort to the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/poll-reference[Poll Scope].
...
Note that you also have the option to use a Poll scope at the beginning of a flow, which also supports Cron expressions and watermarks. Read more about the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/poll-reference[Poll scope].
...
|*Enable default events tracking* |Enable default link:https://docs.mulesoft.com/mule-user-guide/v/3.6/business-events[business event] tracking for this endpoint.
|=================
...
* See the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/quartz-transport-reference[Quartz Transport Reference] for details on setting the properties for a Quartz endpoint using an XML editor.
...
* Read about the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/poll-reference[Poll scope].
