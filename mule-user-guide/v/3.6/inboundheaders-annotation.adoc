...
This annotation controls how the current message inbound headers are passed into a method. The annotation supports, Map, List, single headers, wildcards and optional entries. It can be used on component entry points and link:https://docs.mulesoft.com/mule-user-guide/v/3.6/transformer-annotation[@Transformer] methods.
