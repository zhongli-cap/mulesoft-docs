...
This document assumes that you are familiar with link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio] and have reviewed the overview and basic anatomy of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing[Batch Processing], and that you understand how batch jobs handle link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing[records which fail processing]. You should also consider link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-streaming-and-job-execution#streaming-batch-commits[Streaming Batch Commits].
...
*Note:* See also link:https://docs.mulesoft.com/mule-user-guide/v/3.8/batch-streaming-and-job-execution#streaming-batch-commits[Streaming Batch Commits].
...
* Access link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing-reference[reference details] about batch processing.
* Read about the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing[basic anatomy] of batch processing in Mule.
* Examine the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing-reference[attributes] you can configure for batch jobs, steps and message processors.
* Learn more about setting and removing link:https://docs.mulesoft.com/mule-user-guide/v/3.6/record-variable[record-level variables.]
