...
A flow reference can route messages to any type of flow within the same application. Refer to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/flows-and-subflows[Flows and Subflows] for more information.
...
* Read more about the different kinds of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/flows-and-subflows[Flows and Subflows] that you can call using a flow reference component.
