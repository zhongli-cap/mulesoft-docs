...
image:connector_architecture.jpg[oracle ebs connector architeture]
...
+
.. On the pop-up window, select the image:plus-1.png[plus-1] button to add more entries.
...
* Access Oracle EBS connectorlink:https://docs.mulesoft.com/mule-user-guide/v/3.6/oracle-e-business-suite-connector[ release notes].
