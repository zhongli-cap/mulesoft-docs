...
* See how to configure the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-connector[HTTP Connector]
* See how link:https://docs.mulesoft.com/mule-user-guide/v/3.6/authentication-in-http-requests[authentication] works in the HTTP Connector
* Refer to the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/https-transport-reference[deprecated HTTPS Transport]
