...
Access the documentation for the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/scatter-gather[Scatter-Gather flow control] to take advantage of the newly-designed functionality.
====
