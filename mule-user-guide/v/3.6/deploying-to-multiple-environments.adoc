...
[TIP]
====
Should you need to encrypt passwords in your properties file, consider using the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-credentials-vault[Mule Credentials Vault]. Refer to the documentation for link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-enterprise-security[Anypoint Enterprise Security] for more information on securing applications in Mule.
====

== Assumptions

This document assumes that you are familiar with the exercise of building and deploying Mule applications in Mule Studio. Consider reading the link:https://docs.mulesoft.com/getting-started/index[Anypoint Fundamentals] for more information.

== Basic Anatomy

[WARNING]
====
If you're deploying multiple applications through a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/shared-resources[Shared Resources] structure, then you shouldn't set anything in the properties files, as there might potentially be conflicts between the various apps that share a domain. Instead, you can set environment variables over the scope of the deployed app, its domain and other apps under that domain.
...
[TIP]
====
Learn how to encrypt a properties file using the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-credentials-vault[Mule Credentials Vault].
====
...
[TIP]
====
Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-properties[configuring variable properties].
====

. To configure Studio to use a specific environment when  *deploying on-premise* , *debugging*  or  *using link:https://docs.mulesoft.com/mule-user-guide/v/3.6/datasense[DataSense]*  to retrieve metadata from a SaaS provider, double-click to open your application's  `mule-project.xml` file, located in the root directory of your project.
+
[WARNING]
====
...
* Learn more about encrypting a properties file using the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-credentials-vault[Mule Credentials Vault].

* To learn more about deploying to test environments in CloudHub, access the CloudHub Sandbox Environments documentation.

* Learn more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/configuring-properties[Properties Placeholders] in Mule. 

* Learn how to proceed when deploying multiple applications with link:https://docs.mulesoft.com/mule-user-guide/v/3.6/shared-resources[Shared Resources]
