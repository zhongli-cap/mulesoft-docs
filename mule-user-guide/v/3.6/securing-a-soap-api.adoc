...
To the Mule flow that involves an API, add a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/cxf-component-reference[CXF Component] to publish, consume, or proxy an API. Complete the following steps to configure WS-security on the CXF component.
