...
Access the documentation for the link:https://docs.mulesoft.com/mule-user-guide/v/3.8/database-connector[Database Connector] to take advantage of the newly-designed functionality.
====

link:http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_jdbc/namespace-overview.html[Schema]
...
NOTE: The JDBC connector supports multi-resource transactions. Multi-resource transactions are also supported by the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/database-connector[Database Connector]. Consider also the use of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/xa-transactions[XA Transactions] to handle this use case.
...
+
[NOTE]
JDBC Inbound Endpoints can only be set to a one-way exchange pattern. JDBC Outbound Endpoints can be set to either a one-way or request-response exchange pattern. For details about exchange patterns, see link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio Essentials].
...
For details on setting the properties for a JDBC endpoint using an XML editor, consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/jdbc-transport-reference[JDBC Transport Reference].
