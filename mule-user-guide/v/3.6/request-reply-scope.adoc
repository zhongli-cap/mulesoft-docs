...
This document assumes that you understand the difference between link:/mule-user-guide/v/3.6/flows-and-subflows[synchronous and asynchronous flows]. Furthermore, you're also familiar with link:/mule-user-guide/v/3.6/scopes[Scopes] in general.
...
* Learn more about link:/mule-user-guide/v/3.6/flows-and-subflows[synchronous and asynchronous flows].
