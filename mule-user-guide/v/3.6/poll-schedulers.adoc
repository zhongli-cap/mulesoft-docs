...
This document assumes that your are familiar with link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio] and http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about link:/mule\-user\-guide/v/3\.6/poll-reference[poll scopes] in Mule.
