...
This document assumes that your are familiar with link:/mule-user-guide/v/3.6/anypoint-studio-essentials[Anypoint Studio] and http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about link:/mule-user-guide/v/3.6/poll-reference[poll scopes] in Mule.
