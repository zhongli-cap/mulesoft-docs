...
For more information on these features and instructions for downloading them, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-enterprise-security[Anypoint Enterprise Security].
====
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/enabling-ws-security[Enabling WS-Security] - Describes how to secure your CXF connectors with WS-Security.

* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/saml-module[SAML Module] - Mule now supports the SAML standard for exchange of security information between systems. This module is available in the enterprise edition of Mule as of version 2.2.3

== Other Security Integration

Mule also supports the following security technologies:

* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/encryption-strategies[Encryption Strategies] - Secure your messages by encrypting them.

* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/pgp-security[PGP Security] - Secure your messages by encrypting them with PGP.
