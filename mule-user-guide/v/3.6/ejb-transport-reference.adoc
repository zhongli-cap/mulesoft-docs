...
http://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/ejb/package-summary.html[Javadoc for EJB Transport]
...
EJB endpoints are configured the same way as link:https://docs.mulesoft.com/mule-user-guide/v/3.6/rmi-transport-reference[RMI endpoints].
