...
See the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/ftp-transport-reference[FTP Transport Reference] for details on setting the properties for an FTP endpoint using an XML editor.
