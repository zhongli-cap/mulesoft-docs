...
Access link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing-reference[Batch Processing Reference] for more information.
...
* you can set *record variables* on records and pass them from step to step (link:https://docs.mulesoft.com/mule-user-guide/v/3.6/record-variable[read more])

* you can apply filters by adding *accept expressions* within each batch step to prevent the step from processing certain records; for example, you can set a filter to prevent a step from processing any records which failed processing in the preceding step (link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-filters-and-batch-commit[read more])

* you can **commit** records in groups, sending them as bulk upserts to external sources or services. (link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-filters-and-batch-commit[read more])
...
Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-filters-and-batch-commit[fine-tuning filters] on batch steps to manage failed records at a more granular level.
...
[TIP]
Note that this example introduces features not discussed in great detail in this document. Consult link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-filters-and-batch-commit[Batch Filters and Batch Commit] and link:https://docs.mulesoft.com/mule-user-guide/v/3.6/record-variable[Record Variable] for more information.
...
. The application first uses a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/file-connector[File connector] to upload a CSV file, then uses a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/datamapper-concepts[DataMapper] to convert the data format into a collection (see mapping below). Each item in the collection represents a lead. Each lead contains a company name, a first name, a last name, a birthday and an email address.
+
...
[start=3]
. Mule begins processing each lead as a record. The first batch step, **`lead-check`**, uses a *Salesforce Connector* wrapped with a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/message-enricher[Message Enricher] to: +
...
* Batch processing does not support the use of link:https://docs.mulesoft.com/mule-user-guide/v/3.6/business-events[Business Events].

* link:https://docs.mulesoft.com/runtime-manager/insight[Insight] does not support visibility into batch processing.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing-reference[reference details]

* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing-reference[attributes]

* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-filters-and-batch-commit[filters]

* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-filters-and-batch-commit[batch commit]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/record-variable[record-level variables]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing-reference[MEL expressions]

* link:https://docs.mulesoft.com/runtime-manager/cloudhub-fabric[CloudHub support for batch processing]

* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/anypoint-connectors[Anypoint Connectors]

* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/poll-reference[Polling and Watermarks]

* link:https://docs.mulesoft.com/anypoint-studio/v/6/datamapper-user-guide-and-reference[DataMapper]

* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/changing-runtimes-in-studio[Changing Runtimes in Studio]
