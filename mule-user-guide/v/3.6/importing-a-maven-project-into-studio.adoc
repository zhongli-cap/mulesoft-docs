...
If you have a Mule project that was built using link:http://maven.apache.org/[Maven] outside Anypoint Studio, you can still import it into Studio and continue to work on it with the benefits of the Studio IDE.
...
This document assumes that you have link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing[downloaded and installed Anypoint Studio]. If you do not have any previous experience with Eclipse or an Eclipse-based IDE, please review the brief introduction to the link:https://docs.mulesoft.com/anypoint-studio/v/6/index[Anypoint Studio interface]. The document also assumes you're familiar with link:http://maven.apache.org/[Apache Maven].
...
* Learn how to build a complete link:https://docs.mulesoft.com/mule-user-guide/v/3.6/building-a-mule-application-with-maven-in-studio[Studio Maven Project], including tests and dependencies.
* Learn how to link:https://docs.mulesoft.com/mule-user-guide/v/3.6/enabling-maven-support-for-a-studio-project["mavenize" an existing Mule project].
* Learn how to create a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/preparing-a-gitignore-file[gitignore] file if you want to implement Git.
* Explore how to use link:https://docs.mulesoft.com/mule-user-guide/v/3.6/using-subversion-with-studio[Studio and Subversion].
