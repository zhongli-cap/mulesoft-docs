...
+
You can look at the values of these outbound variables by putting a break point after the splitter and running your flow with the link:/anypoint-studio/v/6.0/studio-visual-debugger[Visual Debugger]:
