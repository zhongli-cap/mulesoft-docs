...
|*messageDelivery* |The message delivery working mode. Overrides the user name set in the Global element. Optional. For detailed info on how this works refer to <<Message delivery>> section above.
|===
