...
Message delivery can be chosen from two different options. The configuration setting *Message delivery* established the message delivering working mode, and details on each available option are described below.
