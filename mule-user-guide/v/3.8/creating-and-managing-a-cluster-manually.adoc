...
[CAUTION]
--
Oracle database support is a link:/release-notes/mule-3.8.0-release-notes#enterprise-edition-known-issues-and-limitations[known limitation for Mule 3.8] and is planned for a future release.
--
