...
The SSL transport can be used for secure socket communication using SSL or TLS. The Javadoc for this transport can be found link:http://www.mulesoft.org/docs/site/current/apidocs/org/mule/transport/ssl/package-summary.html[here].
...
Reference the link:http://www.mulesoft.org/docs/site/3.4.0/apidocs/[SSL Javadoc] for this module.
