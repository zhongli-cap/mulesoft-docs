...
This document assumes that you are familiar with the link:/anypoint-studio/v/6/[Visual Editor in Anypoint Studio], link:/mule-user-guide/v/3.8/anypoint-connectors[Anypoint Connectors], and  link:/mule-user-guide/v/3.8/global-elements[Global Elements]. Review the link:/mule-user-guide/v/3.8/first-day-with-mule[First Day with Mule] chapter to learn more about developing Mule Applications.
