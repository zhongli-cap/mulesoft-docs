...
....
. If you have not already done so, create a *global* link:/mule-user-guide/v/3.8/catch-exception-strategy[catch], link:/mule-user-guide/v/3.8/rollback-exception-strategy[rollback], or link:/mule-user-guide/v/3.8/choice-exception-strategy[choice] exception strategy to which your reference exception strategy can refer.
