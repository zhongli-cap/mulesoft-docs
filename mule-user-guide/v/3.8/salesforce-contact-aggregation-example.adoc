...
Beyond this example, access link:/mule-user-guide/v/3.8/salesforce-connector[introductory] and https://mulesoft.github.io/mule-salesforce-connector/[reference] documentation for the Salesforce Connector.
