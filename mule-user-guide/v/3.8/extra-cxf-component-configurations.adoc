...
This page covers more complex configuration of the CXF Component than those described in the basic discussions of link:/mule-user-guide/v/3.8/publishing-a-soap-api[publishing a SOAP API] and link:/mule-user-guide/v/3.8/consuming-a-soap-api[consuming a SOAP API]. You may also wish to refer to full link:/mule-user-guide/v/3.8/cxf-component-reference[CXF Component Reference] documentation.
