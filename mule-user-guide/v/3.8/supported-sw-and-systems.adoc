...
// updated per DOCS 1749, updated to match 3.8.4 release notes (4.18.2017 kris) 6/29/2017: no change for 3.8.5 
...
The unified Mule Runtime 3.8.5 and API Gateway is compatible with APIkit 3.8.5. Mule runtime comes bundled with the Runtime Manager Agent plugin version 1.6.4.
