...
Java is the default component type in Mule. Mule provides two link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/api/component/JavaComponent.html[JavaComponent] implementations:
...
[%autowidth.spread]
|===
|<prototype-object class=..."/> |http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/object/PrototypeObjectFactory.html[PrototypeObjectFactory]
|<singleton-object class=..."/> |http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/object/SingletonObjectFactory.html[SingletonObjectFactory]
|<spring-object bean=..."/> |http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/config/spring/util/SpringBeanLookup.html[SpringBeanLookup]
|===
