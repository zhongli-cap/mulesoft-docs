...
* Perceptive Flow Design is only available in link:/mule-fundamentals/v/3.8/basic-studio-tutorial[Studio's Visual Editor].
...
* Perceptive Flow Design only functions with Anypoint connectors which support link:/mule-user-guide/v/3.8/testing-connections[connection testing]. See link:/mule-user-guide/v/3.8/datasense-enabled-connectors[the list].
...
+
. Configure the Salesforce connector, and its corresponding global connector, then test the connection to confirm communication. Refer to link:/mule-user-guide/v/3.8/testing-connections[Testing Connections] for details.
...
** clicking the *Define Metadata* link in the input section of the Transform Message component. See link:/mule-user-guide/v/3.8/using-dataweave-in-studio#defining-input-and-output-structure[Using DataWeave in Studio]
