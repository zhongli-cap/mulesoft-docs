...
The less high-tech and most popular of all debugging techniques is to use logging to follow the evolution of an application's state. In Mule, the state you're interested in resides in the messages that are flowing through your configuration and, possibly, custom code.
