...
Read through this user guide to understand how to set up and configure a basic flow using the connector. Track feature additions, compatibility, limitations and API version updates with each release of the connector using the link:/release-notes/microsoft-dynamics-gp-connector-release-notes[Connector Release Notes]. Review the connector operations and functionality using the https://mulesoft.github.io/ms-dynamics-gp-connector/[Technical Reference].
...
|===
|Parameter |Description
|*Username* |The Windows username to connect to Dynamics GP. IMPORTANT: the user must be in the same domain as the dynamics GP and cannot be a local account, it must be a domain account
|*Password* |The password for the user to connect to Dynamics GP.
...
You can download fully functional demo applications using the Dynamics GP connector from the http://mulesoft.github.io/ms-dynamics-gp-connector/[Microsoft Technical Reference].
