...
* For more information on best design-time practices with DataSense and DataMapper, consult the link:/anypoint-studio/v/6.0/datasense[DataSense documentation].
