...
This document assumes that you are familiar with Mule, the link:/anypoint-studio/v/6.0/anypoint-studio-essentials[Anypoint Studio interface], and link:/mule-fundamentals/v/3.8/global-elements[Global Elements]. Further, it is assumed that you are familiar with the Microsoft .NET Framework.
...
* Anypoint Studio, the graphical interface to Mule. See link:/anypoint-studio/v/6.0/download-and-launch-anypoint-studio[Download and Launch Anypoint Studio] for details
