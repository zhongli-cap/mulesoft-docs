...
Profiling Mule can be useful in helping you identify memory leaks in your custom Mule extensions. link:https://www.yourkit.com/[YourKit] is a commonly used Java profiler for analyzing JVM performance. Hooking into YourKit can be achieved by <<Profiling with the YourKit Agent>>.
