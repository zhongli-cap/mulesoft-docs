...
The Microsoft SharePoint connector for Anypoint platform enables integration with a cloud-only SharePoint Online presence through its REST API.
...
*Note:* The FileQuery and FolderQuery operations are not supported when interacting with Sharepoint Online. 
...
[source, xml, linenums]
----
<sharepoint-online:list-create config-ref="Sharepoint_Online" doc:name="Sharepoint Online" baseTemplate="GENERIC_LIST" title="Title"> <sharepoint-online:list ref="#[payload]"/> </sharepoint-online:list-create>
----
...
[source, xml, linenums]
----
<sharepoint-online:list-create config-ref="Sharepoint_Online" doc:name="Sharepoint Online" baseTemplate="GENERIC_LIST" title="Title"> <sharepoint-online:list contentTypesEnabled="true" description="Description"/> </sharepoint-online:list-create>
----
...
You can use the _internal_ or _title_ field names in DSQL queries (as well as in other list's operations as detailed below).
