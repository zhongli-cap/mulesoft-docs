...
`<db:parameterized-query><![CDATA[call add_bonus_by_emp_no(#[payload],500);]]></db:parameterized-query>`. By the design of the example, the employee ID is passed as an HTTP parameter. `http://localhost:8081/getemps?emp=1065`
