...
For a detailed example in both Studio and XML about how to work with subflows, make sure to check the _Adding a Subflow_ section in our link:/quickstarts/content-based-routing[Content-Based Routing].
