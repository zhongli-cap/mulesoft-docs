...
link:/mule-user-guide/v/3.8/flows-and-subflows#sts=synchronous%20Flows[Flow and subflows] page.
...
This property is fully explained in the link:/mule-user-guide/v/3.8/flow-processing-strategies#synchronous-flow-processing-strategy[processing strategy settings] page and a detailed example of how an asynchronous processing strategy works can be found in its specific section within the link:/mule-user-guide/v/3.8/flows-and-subflows#sts=asynchronous%20Flows[Flow and subflows] page.
...
For a detailed example in both Studio and XML about how to work with subflows, make sure to check the _Adding a Subflow_ section in our link:/mule-user-guide/v/3.8/content-based-routing-tutorial#sts=Adding%20a%20Subflow[routing tutorial].
