...
|Doc
|link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/transport/email/package-summary.html[JavaDoc],
...
|Doc
|link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/transport/email/package-summary.html[JavaDoc],  link:http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_imaps/namespace-overview.html[SchemaDoc]
|Links to the JavaDoc and SchemaDoc for the transport
|Inbound |image:check.png[check] |Whether the transport can receive inbound events and can be used for an inbound endpoint.
|Outbound |image:error.png[check] |Whether the transport can produce outbound events and be used with an outbound endpoint.
|MEPs |one-way |Message Exchange Patterns supported by this transport.
