...
:keywords: anypoint studio, esb, xmpp, jabber
...
|XMPP |http://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/xmpp/package-summary.html[JavaDoc +
...
http://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/xmpp/filters/package-summary.html[org.mule.transport.xmpp.filters]
