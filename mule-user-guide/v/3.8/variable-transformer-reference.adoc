...
== Configurating the Variable Transformer
...
. This is an example of the exception output to the Studio console:
[source,code,linenums]
----
...
== Complete Example Code - Store Variable, Output in Exception Strategy
