...
* link:http://www.mulesoft.org/docs/site/current/schemadocs/[Mule 3.4.0 and later]
* link:http://www.mulesoft.org/docs/site/3.3.0/schemadocs/[Mule 3.3.x]
* link:http://www.mulesoft.org/docs/site/3.2.0/schemadocs[Mule 3.2.x]
* link:http://www.mulesoft.org/docs/site/3.1.0/schemadocs[Mule 3.1.x]
* link:http://www.mulesoft.org/docs/site/3.0.1/schemadocs[Mule 3.0.x]
