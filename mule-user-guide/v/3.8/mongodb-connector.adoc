...
. Select `Anypoint Connectors Update Site`. In Studio 6.3.0 and later, select `https://repository.mulesoft.org/connectors/releases/3.5.0`.
...
. Install the latest version of MongoDB Connector from the update site. Click *Help* > *Install New Software*. In the *Work with* drop-down menu, click `Anypoint Connectors Update Site`. In Studio 6.3.0 and later, select `https://repository.mulesoft.org/connectors/releases/3.5.0`. Expand the *Select* category and click the checkbox for the *Mongo DB Connector* version 4.1.x.
