...
You can use JsonPath in link:/mule-user-guide/v/3.8/mule-expression-language-mel[Mule expressions] to query JSON message payloads for filtering or link:/mule-user-guide/v/3.8/message-enricher[enrichment].
