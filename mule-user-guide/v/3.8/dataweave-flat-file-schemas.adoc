...
[NOTE]
The *tagStart* parameter is required when using flat file structures, using it, along with tagLength, is the only way for the parser to distinguish different segments. The the only supported value for now is 0.
...
----
  ...
  - name: 'Header File'
    ...
    - { name: 'Presentation Date', type: Integer, length: 6 }
    - { name: 'Presentation Time', type: Integer, length: 4 }
    - { name: 'File Identifier', type: String, length: 1 }
    - { name: 'Record Size', type: Integer, length: 3 }
  ...
  - groupId: 'Data'
    ...
    - name: 'Ticket'
      ...
      - { name: 'Deposit Bank', type: Integer, length: 8 }
      - { name: 'Reserved', type: Integer, length: 1 }
      - { name: 'Deposit Account', type: Integer, length: 17 }
      - { name: 'Amount', type: Integer, length: 10 }
      - { name: 'Type And ID', type: Integer, length: 15 }
    ...
    - count: '>1'
      ...
      - { name: 'Zip Code', type: Integer, length: 4 }
      - { name: 'Check', type: Integer, length: 8 }
      - { name: 'Account Check', type: Integer, length: 11 }
      - { name: 'Amount', type: Integer, length: 10 }
      - { name: 'Ticket Account', type: Integer, length: 11 }
  ...
  - name: 'End File'
    ...
    - { name: 'Reserved', type: String, length: 35 }
----
...
* a <<Group Definitions, group>> named Data that contains two types of segments
