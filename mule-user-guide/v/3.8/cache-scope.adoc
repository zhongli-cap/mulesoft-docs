...
NOTE: Do not use link:https://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/util/store/TextFileObjectStore.html[TextFileObjectStore] for a cache as the cache contains more than text content. For a list of all object store types, see the link:https://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/util/store/package-summary.html[mule.util.store] package summary. Mule provides the link:https://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/util/store/MuleObjectStoreManager.html[MuleObjectStoreManager], which creates object stores.
