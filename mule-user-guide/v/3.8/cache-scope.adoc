...
NOTE: Do not use link:https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/util/store/TextFileObjectStore.html[TextFileObjectStore] for a cache as the cache contains more than text content. For a list of all object store types, see the link:https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/util/store/package-summary.html[mule.util.store] package summary.
