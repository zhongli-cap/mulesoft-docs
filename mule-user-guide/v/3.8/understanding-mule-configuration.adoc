...
[NOTE]
Mule uses an XML configuration file that defines the constructs required to validate and run a Mule application.

A basic Mule application can use a very simple configuration, for instance:
