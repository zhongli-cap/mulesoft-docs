...
To install a connector, first open link:https://www.mulesoft.com/platform/studio[Anypoint Studio] and click the Exchange icon (image:exchange-studio-icon.png[exchange-studio-icon]) in the Studio taskbar.
