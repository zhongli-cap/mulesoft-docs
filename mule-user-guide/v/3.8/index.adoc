...
You can deploy Mule applications to MuleSoft's cloud platform via link://runtime-manager/cloudhub[CloudHub] and manage them via link:/runtime-manager/[Runtime Manager]. Runtime Manager can be used to manage local deployments as well.

For local management of Mule runtime see link:/mule-management-console/v/3.8/[Mule Management Console], which is the predecessor to Runtime Manager.
