...
Install Mule alone, along with Mule Management Console, or with Anypoint Studio IDE link:/mule-user-guide/v/3.8/downloading-and-starting-mule-esb[Download and Start Mule Runtime]
