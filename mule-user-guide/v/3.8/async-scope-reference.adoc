...
An async scope is similar to an *link:/mule-user-guide/v/3.8/flows-and-subflows[asynchronous flow]* in that:
...
An async scope is similar to a *link:/mule-user-guide/v/3.8/flows-and-subflows[subflow]* in that it inherits the exception strategy of the main flow. 
