...
. _Optional_: link:/anypoint-studio/v/6.0/adding-community-runtime[Add Community runtime] to your Studio instance.
...
* link:/anypoint-studio/v/6.0/installing-extensions[Extend Mule] with plugins, modules, runtimes, and connectors.

* Access a list of all the link:/anypoint-studio/v/6.0/studio-update-sites[update sites] available for your version of Studio.
