...
[NOTE]
Just like the Java class, the iterator is designed to be consumed only once. Passing this value to a link:/mule-user-guide/v/3.8/logger-component-reference[Logger] would result in consuming it.
