...
* Local Time
* Period
* TimeZone (only offset timezone ISO-8601 standard, no region timezone nor daylight time zone support)
* Date
...
(3) To make the locale value explicit, you can use language, country or both, as detailed in link:https://docs.oracle.com/javase/8/docs/api/java/util/Locale.html#forLanguageTag-java.lang.String-[Locale.forLanguageTag(String)].
