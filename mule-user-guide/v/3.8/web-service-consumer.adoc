...
To do this:
+
** Click the link *Search WSDL in Exchange* to open the link:/getting-started/anypoint-exchange[Anypoint Exchange] and select a WSDL definition residing there.
