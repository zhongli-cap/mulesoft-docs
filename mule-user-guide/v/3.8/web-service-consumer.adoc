...
** Click the link *Seach WSDL in Exchange* to open the link:/getting-started/anypoint-exchange[Anypoint Exchange] and select a WSDL definition residing there
