...
This document assumes that your are familiar with link:/anypoint-studio/v/6.0/anypoint-studio-essentials[Anypoint Studio] and link:http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about link:/mule-user-guide/v/3.8/poll-reference[poll scopes] in Mule.
