...
* *NEXT STEP*: Read on about the structure of a link:/mule-user-guide/v/3.8/mule-message-structure[Mule message].
* See the link:/mule-user-guide/v/3.8/anypoint-exchange[examples].
* Learn more about configuring the link:/mule-user-guide/v/3.8/catch-exception-strategy[catch], link:/mule-user-guide/v/3.8/rollback-exception-strategy[rollback], link:/mule-user-guide/v/3.8/reference-exception-strategy[reference], and link:/mule-user-guide/v/3.8/choice-exception-strategy[choice] exception strategies.
