...
* link:/anypoint-studio/v/6.0/enabling-maven-support-for-a-studio-project[Enabling Maven support for an existing Studio project]
...
* Learn more about link:/anypoint-studio/v/6.0/maven-support-in-anypoint-studio[adjusting your Studio Preferences to work with Maven]. 
* Learn more about link:/mule-user-guide/v/3.8/importing-a-maven-project-into-studio[importing Maven projects into Studio] or link:/anypoint-studio/v/6.0/enabling-maven-support-for-a-studio-project["mavenizing" existing Studio projects].
