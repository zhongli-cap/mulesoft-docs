...
. At this point, the database connection should be confirmed via *Test Connection* button.
. Make sure a valid query has been specified for the database connector building block(s) before running your app.
