...
* *DataWeave*: -- _(replaces DataMapper)_ -- When used in conjunction with a DataSense-enabled database connector, DataWeave can extract message metadata and assist in transforming it to a different data format or structure. For more information, see link:/mule-user-guide/v/3.8/dataweave[DataWeave].
