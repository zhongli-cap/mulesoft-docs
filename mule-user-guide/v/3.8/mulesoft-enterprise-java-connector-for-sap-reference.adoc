...
This procedure assumes that you already have a Mule instance installed on your host machine. If not, follow the instructions for link:/mule-user-guide/v/3.8/downloading-and-starting-mule-esb[Downloading Mule Runtime].
