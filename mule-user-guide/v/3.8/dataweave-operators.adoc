...
In link:/mule-user-guide/v/3.8/dataweave[DataWeave] you can carry out many different operations upon the elements of a transform. This document walks serves as a reference for all of the available operations.
