...
Returns the provided string with every word starting with a capital letter and no underscores. It will replace underscores with spaces and put a space before every capitalized word.
