...
////
TODO
Complete the start poll and resume poll button functions

|15
|image:start.poll.icon.png[start.poll.icon] |*Start Poll -*  |

|16
|image:resume.poll.icon.png[resume.poll.icon] |*Resume Poll -*  |
