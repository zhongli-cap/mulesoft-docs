...
For more advanced examples written directly in DataWeave code, see link:/mule-user-guide/v/3.8/dataweave-examples[DataWeave Examples].
...
* See our link:/mule-user-guide/v/3.8/dataweave-reference-documentation[DataWeave Reference Documentation]
