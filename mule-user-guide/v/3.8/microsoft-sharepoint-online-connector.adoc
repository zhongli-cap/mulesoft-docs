...
*Release Notes*:
link:/release-notes/microsoft-sharepoint-online-connector-release-notes.adoc[Microsoft SharePoint Online Connector Release Notes]

*Samples*: link:_attachments/sharepoint-online-crud-app-demo[Sharepoint Online Connector Demo]
