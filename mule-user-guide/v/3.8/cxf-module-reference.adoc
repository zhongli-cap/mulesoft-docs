...
* link:/mule-user-guide/v/3.8/cxf-module-overview[Overview]
* link:/mule-user-guide/v/3.8/building-web-services-with-cxf[Building Web Services]
* link:/mule-user-guide/v/3.8/consuming-web-services-with-cxf[Consuming Web Services]
* link:/mule-user-guide/v/3.8/proxying-web-services-with-cxf[Proxying Web Services]
* link:/mule-user-guide/v/3.8/using-http-get-requests[Using HTTP GET Requests]
* link:/mule-user-guide/v/3.8/cxf-module-configuration-reference[Configuration Reference]
* link:/mule-user-guide/v/3.8/wsdl-connectors[Using the WSDL Connector]
