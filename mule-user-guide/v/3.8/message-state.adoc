...
To examine the state of a message, this document uses an example application which converts the contents of a CSV file into contacts in Salesforce. You can view examples in link:/mule-user-guide/v/3.8/anypoint-exchange[the Library].
...
Learn more about how to examine the state of your messages using the link:/anypoint-studio/v/6/studio-visual-debugger[Visual Debugger] .
====
