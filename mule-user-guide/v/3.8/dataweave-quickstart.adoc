...
Here are the steps we take in this Quickstart Guide to design an example DataWeave transformation and run the example in the context of an HTTP request.
