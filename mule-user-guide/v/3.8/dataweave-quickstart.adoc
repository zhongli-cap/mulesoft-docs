...
Click your Transform Message component. In the link:/anypoint-studio/v/6/using-dataweave-in-studio#the-dataweave-text-editor[DataWeave text editor] replace the curly brackets '{}' for 'payload'.
