...
|`InputStream/Array[Byte]`|link:/mule-user-guide/v/3.8/dataweave-types#boolean[:binary]
|`java.lang.Boolean`|link:/mule-user-guide/v/3.8/dataweave-types#binary[:boolean]
