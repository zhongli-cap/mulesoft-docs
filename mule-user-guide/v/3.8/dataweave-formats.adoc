...
[TIP]
See link:/anypoint-studio/v/6.0/using-dataweave-in-studio#defining-metadata-via-the-ui[Using DataWeave in Studio] for more detailed instructions on how to set this up.
...
See link:/anypoint-studio/v/6.0/using-dataweave-in-studio#reader-configuration[Using DataWeave in Studio] for more detailed instructions on how to set these properties.
