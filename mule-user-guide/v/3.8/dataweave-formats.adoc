...
|`Collections/Array/Iterator/Iterable` | link:dataweave-types#array[:array]
|`String/CharSequence/Char/Enum/Class` | link:dataweave-types#string[:string]
|`int/Short/Long/BigInteger/Flat/Double/BigDecimal`|link:dataweave-types#number[:number]
|`Calendar/XmlGregorainCalendar`|link:dataweave-types#datetime[:datetime]
|`TimeZone`|link:dataweave-types#timezone[:timezone]
|`sql.Date/util.Date`|link:dataweave-types#date[:date]
|`Bean/Map`|link:dataweave-types#object[:object]
|`InputStream/Array[Byte]`|link:dataweave-types#binary[:binary]
|`java.lang.Boolean`|link:dataweave-types#boolean[:boolean]
...
[TIP]
====
See link:dataweave-flat-file-schemas[DataWeave Flat File or EDI Schemas] for instructions and examples on how to create the required schema file.
====
...
[TIP]
See link:dataweave-flat-file-schemas[Flat File Schemas] for more detailed instructions on how to write the required schema.


== See Also

* link:dataweave-quickstart[DataWeave Quickstart Guide]
...
* link:dataweave-operators[DataWeave Operators]
* link:dataweave-types[DataWeave Types]
* link:dataweave-memory-management[DataWeave Memory Management]
* link:dataweave-selectors[DataWeave Selectors]
* link:dataweave-examples[DataWeave Examples]
* link:mel-dataweave-functions[MEL DataWeave Functions]
