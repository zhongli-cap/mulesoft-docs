...
link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/module/client/MuleClient.html[MuleClient] is a simple interface for Java clients to send and receive messages from a Mule server and other applications. You can use the Mule client for:
...
link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/api/MuleEventContext.html[org.mule.api.MuleEventContext]
...
link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/api/lifecycle/Callable.html[org.mule.api.lifecycle.Callable]
interface.
...
link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/api/MuleMessageCollection.html[org.mule.api.MuleMessageCollection]

* This type of message contains all message results in the order they were received. Note that
http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/api/MuleMessageCollection.html[org.mule.api.MuleMessageCollection] extends link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/api/MuleMessage.html[org.mule.api.MuleMessage], so the interface is similar. If there are multiple results, the `MuleMessage.getPayload()` method returns a `java.util.List` containing the payloads of each of the returned messages.
...
link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/api/FutureMessageResult.html[FutureMessageResult]
...
          http://www.mulesoft.org/schema/mule/core/current http://www.mulesoft.org/schema/mule/core/current/mule.xsd">
  ...
