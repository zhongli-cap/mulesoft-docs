...
|Doc |link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/transport/file/package-summary.html[JavaDoc], link:http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_file/namespace-overview.html[SchemaDoc] |JavaDoc and Schema doc
...
link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/transport/file/package-summary.html[Javadoc] for File Transport.
