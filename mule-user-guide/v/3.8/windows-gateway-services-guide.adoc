...
link:https://repository.mulesoft.org/nexus/content/repositories/releases/org/mule/modules/anypoint-windows-gateway-service/1.11.0/anypoint-windows-gateway-service-1.11.0.zip[Install Windows Gateway Services]
...
. Download the Windows Gateway Services installer from link:https://repository.mulesoft.org/nexus/content/repositories/releases/org/mule/modules/anypoint-windows-gateway-service/1.11.1/anypoint-windows-gateway-service-1.11.1.zip[here]. Unzip the software distribution.
