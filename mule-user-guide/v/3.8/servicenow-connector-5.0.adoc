...
[IMPORTANT]
While the ServiceNow Advanced Configuration exposes various configurations of HTTP Request, the connector only supports the Basic Authentication, the proxy setting, the Connection Idle Timeout, Response Timeout.
