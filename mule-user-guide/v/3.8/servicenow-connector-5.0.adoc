...
For all operations and required attributes see the link:https://mulesoft.github.io/servicenow-wsdl-connector/5.3.0/apidocs/servicenow-apidoc.html[technical reference APIdocs]
