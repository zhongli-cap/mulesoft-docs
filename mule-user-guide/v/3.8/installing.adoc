...
. link:/mule-user-guide/v/3.8/downloading-and-starting-mule-esb[Download > Launch Mule]
. link:/mule-user-guide/v/3.8/adding-community-runtime[Install Mule Community Runtime in Anypoint Studio] (_optional_)
