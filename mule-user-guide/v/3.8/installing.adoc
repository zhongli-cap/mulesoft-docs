...
Community users can obtain the latest versions of Mule Community on the *link:https://www.mulesoft.com/lp/dl/mule-esb-enterprise[Downloads page]* on mulesoft.org.
