...
Use the Web Service Consumer to consume a SOAP service from within a Mule application. View the elements and attributes that are necessary for your use case or jump directly to the <<Complete Code Example>>.
...
[width"99a",cols="20a,20a,60a",options="header"]
|===
...
[width"99a",cols="10a,10a,30a,10a,40a",options="header"]
|===
...
[width"99a",cols="20a,20a,10a,10a,40a",options="header"]
|===
...
[width="100a",cols="20a,20a,10a,10a,40a",options="header"]
|===
|Child Element |Attribute |Value |Attribute Req'd |Attribute Description
