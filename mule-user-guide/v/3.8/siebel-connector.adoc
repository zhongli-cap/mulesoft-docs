...
image:siebel-connector-icon.png[siebel-connector-icon]
...
consider completing a link:/anypoint-studio/v/6/basic-studio-tutorial[Basic Studio Tutorial]. Further,
