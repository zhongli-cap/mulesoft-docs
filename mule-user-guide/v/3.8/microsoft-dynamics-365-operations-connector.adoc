...
////
*Technical Reference*: link:http://mulesoft.github.io/ms-dynamics-365-crm-for-operations-connector[MS Dynamics 365 for Operations Connector Technical Reference] (Coming)  +
...
* link:/mule-user-guide/v/3.8/microsoft-dynamics-365-crm-connector[Microsoft Dynamics 365 CRM connector]
