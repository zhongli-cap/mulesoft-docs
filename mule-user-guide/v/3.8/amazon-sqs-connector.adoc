...
|*Role ARN* |Constructs a new Amazon SQS client using the specified Assume Role (roleARN). ARN stands for Amazon Resource
Name. The Role ARN provides cross account access without using security credentials.
|===
+
[NOTE]
====
