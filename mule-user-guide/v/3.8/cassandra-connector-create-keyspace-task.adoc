...
----
+
. Create a flow by dragging an HTTP connector from the Mule palette to the canvas, select the connector, and set the Path in HTTP properties to */single*. In HTTP properties, click image:plus.png[Plus control].
