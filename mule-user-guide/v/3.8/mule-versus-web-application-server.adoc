...
* link:/mule-fundamentals/v/3.8/download-and-launch-anypoint-studio[Download, then install and launch Anypoint Studio].
* Investigate different link:/mule-user-guide/v/3.8/deployment-scenarios[Deployment Scenarios].
