...
* *NEXT STEP*: Read on about link:/mule-user-guide/v/3.8/mule-filters-scopes-and-routers[Filters, Scopes, and Routers].
...
* Learn more about setting, then using link:/mule-user-guide/v/3.8/mule-message-structure[properties and variables].
