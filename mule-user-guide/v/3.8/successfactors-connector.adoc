...
For details on operations see the https://mulesoft.github.io/success-factors-connector/[SuccessFactors connector technical reference] and click the APIdoc for your connector version.
