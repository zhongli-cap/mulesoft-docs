...
The first time you try to add any of the SAP components to your Mule configuration file, the SAP dependencies that match the version of the project ESB runtime get added automatically. If there is more than one SAP transport dependency for the ESB runtime configured in the project, then you will be prompted to select the one you want to use, the newest, oldest, or select *Choose manually*.
...
. From the list, check the SAP extension you require, noting the version of the connector and the Mule ESB/runtime version requirements.
