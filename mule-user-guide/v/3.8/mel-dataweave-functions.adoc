...
|Reader Properties	| For inputs such as CSV, sometimes some properties are needed to know how to parse the input, see link:/anypoint-studio/v/6.0/using-dataweave-in-studio#reader-configuration[Reader Configuration]
