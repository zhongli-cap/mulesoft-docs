...
|Property |Usage
|*Query* a|
DataSense Query Language: The DSQL to run. The query is translated by the connector to a Fetch XML. For more information, see link:/anypoint-studio/v/6.0/datasense-query-language[DataSense Query Language].
