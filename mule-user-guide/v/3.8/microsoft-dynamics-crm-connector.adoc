...
[NOTE]
See the *technical reference and demos* for these operations link:http://mulesoft.github.io/ms-dynamics-crm-connector/[here].
...
* Microsoft Dynamics CRM 2015 (on-prem)
* Microsoft Dynamics CRM 2013 (on-prem)
* Microsoft Dynamics CRM 2011 (on-prem)
