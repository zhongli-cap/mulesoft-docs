...
You can "test drive" this connector in Anypoint Studio using the instructions in link:/mule-user-guide/v/3.8/anypoint-exchange#installing-a-connector-from-anypoint-exchange[Installing a Connector from Anypoint Exchange].  
