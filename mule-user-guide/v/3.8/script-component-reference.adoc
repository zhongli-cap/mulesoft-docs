...
* For more information see the Mule ESB page link:/mule-user-guide/v/3.8/scripting-module-reference[Scripting Module]
* Read more about the link:/mule-user-guide/v/3.8/javascript-component-reference[JavaScript Component]
* Read more about the link:/mule-user-guide/v/3.8/ruby-component-reference[Ruby Component]
* Read more about the link:/mule-user-guide/v/3.8/groovy-component-reference[Groovy Component]
* Read more about the link:/mule-user-guide/v/3.8/python-component-reference[Python Component]
* Read more about the link:/mule-user-guide/v/3.8/java-component-reference[Java Component]
