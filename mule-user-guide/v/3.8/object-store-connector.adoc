...
This document assumes that you are familiar with Mule, the link:/anypoint-studio/v/6.0/anypoint-studio-essentials[Anypoint Studio Interface], link:/mule-fundamentals/v/3.8/global-elements[Global Elements], and link:/anypoint-studio/v/6.0/datasense[DataSense].
