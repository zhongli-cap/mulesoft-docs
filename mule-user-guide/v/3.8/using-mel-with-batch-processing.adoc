...
You can force the runtime to record the outbound-endpoint failre as a batch step failure by referencing the outbound endpoint as a synchronous process:
