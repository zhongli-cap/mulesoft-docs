...
Refer to link:/mule-user-guide/v/3.8/deploying-mule-applications[Deploying Mule Applications] for more information on managing your user libraries in Studio.
