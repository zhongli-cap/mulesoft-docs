...
* A couple of blog posts (link:http://blog.decaresystems.ie/index.php/2006/03/29/spring-20-hiding-services-behind-custom-schema-part-i/[1], link:https://decaresystemsblog.wordpress.com/2006/04/04/spring-20-hiding-services-behind-custom-xml-schema-part-ii/[2]) that give a developer's-eye overview.
