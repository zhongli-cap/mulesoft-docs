...
* Useful papers on mutable and extensible containers: link:http://www.xfront.com/VariableContentContainers.pdf[VariableContentContainers] and  link:http://www.xfront.com/ExtensibleContentModels.pdf[ExtensibleContentModels]
