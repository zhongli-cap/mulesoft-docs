...
This document assumes that you are familiar with Mule and its link:/mule-user-guide/v/3.8/mule-concepts[basic concepts]. Consider reading the chapter, link:/mule-user-guide/v/3.8/first-30-minutes-with-mule[First 30 Minutes with Mule] to gain familiarity before proceeding. 
