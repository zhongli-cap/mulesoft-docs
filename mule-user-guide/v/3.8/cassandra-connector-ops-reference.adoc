...
*NetworkTopologyStrategy DataWeave Code*
...
{
  firstDataCenter: {
    name: inboundProperties."http.query.params".dcA,
    value: inboundProperties."http.query.params".rfA
  },
  nextDataCenter: {
    name: inboundProperties."http.query.params".dcB,
    value: inboundProperties."http.query.params".rfB
  },
  nextDataCenter: {
    name: inboundProperties."http.query.params".dcC,
    value: inboundProperties."http.query.params".rfC
  },
