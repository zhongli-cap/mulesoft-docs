...
|File Transfer |link:/mule-user-guide/v/3.8/file-transport-reference[File Transport]
|Shared Database |link:/mule-user-guide/v/3.8/jdbc-transport-reference[JDBC Transport]
...
|Message Router |link:/mule-user-guide/v/3.8/routers[Message Routers]
|Message Translator |link:/mule-user-guide/v/3.8/using-transformers[Message Transformer]
|Message Endpoint |Inbound & Outbound link:/mule-user-guide/v/3.8/endpoint-configuration-reference[Endpoints]
|===
...
|===
|Pattern |Mapping to a Mule Object
|Content Enricher |link:/mule-user-guide/v/3.8/message-enricher[Message Enricher]
|===
