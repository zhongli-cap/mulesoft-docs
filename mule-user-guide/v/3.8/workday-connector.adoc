...
Here you can find implementation examples within the context of Anypoint Studio, Mule’s graphical user interface, and, also configuration details for doing the same in the XML Editor. 
