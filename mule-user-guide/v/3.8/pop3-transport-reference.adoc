...
|POP3 |http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/transport/email/package-summary.html[JavaDoc +
...
|POP3S |http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/transport/email/package-summary.html[JavaDoc +
]
...
http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/transport/email/package-summary.html[Javadoc for POP3 Transport]
