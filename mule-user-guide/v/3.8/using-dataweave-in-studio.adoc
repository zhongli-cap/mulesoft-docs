...
DataWeave supports streaming a large payload. No configuration is necessary in the Transform Message component, but other components need to be set up for this to work. See link:/mule-user-guide/v/3.8/dataweave-streaming[DataWeave Streaming].
