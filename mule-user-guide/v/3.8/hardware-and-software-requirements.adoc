...
Mule runs on operating systems that support the Java versions listed link:/mule-user-guide/v/3.8/hardware-and-software-requirements#supported-java-versions[Supported Java Versions]. The following operating systems have been tested for use with MuleSoft:
