...
The easiest way to write an outbound router is to extend the link:http://www.mulesoft.org/docs/site/3.8.1/apidocs/org/mule/routing/outbound/AbstractOutboundRouter.html[org.mule.routing.outbound.AbstractOutboundRouter] class:
