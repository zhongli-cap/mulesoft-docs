...
|Enable Datasense |The *Enable DataSense* checkbox allows Studio to use link:/anypoint-studio/v/6.0/datasense[DataSense] to expose metadata from the RAML file and interact with it on other elements in Studio.
|===
