...
* Anypoint Studio. See link:/anypoint-studio/v/6.0/anypoint-studio-essentials[Anypoint Studio Essentials] chapter to learn more about developing with Mule's graphical user interface.
