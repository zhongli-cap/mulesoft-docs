...
To build applications with Batch jobs and run them in a test or production environment, you must build the application with an Enterprise runtime. Learn more about link:/anypoint-studio/v/6.0/changing-runtimes-in-studio[Changing Runtimes in Studio].
====
