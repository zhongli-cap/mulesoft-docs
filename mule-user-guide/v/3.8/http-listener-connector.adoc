= About the HTTP Listener Configuration
...
In the connector configuration global element, set the *Host*, *Port* and *Base Path* properties to only process requests at a specific address.
