...
It also assumes you are familiar with the link:/mule-fundamentals/v/3.8/anypoint-studio-essentials[Anypoint Studio] interface. To increase your familiarity with Studio, consider completing one or more link:/mule-fundamentals/v/3.8/first-day-with-mule[Anypoint Studio Tutorials].
