...
It also assumes you are familiar with the link:/anypoint-studio/v/6/[Anypoint Studio] interface. To increase your familiarity with Studio, consider completing one or more link:/mule-user-guide/v/3.8/first-day-with-mule[Anypoint Studio Tutorials].
