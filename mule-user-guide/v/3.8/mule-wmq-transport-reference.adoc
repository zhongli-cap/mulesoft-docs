...
* This transport supports Mule 3.8 and later with IBM MQ 8 and 9, using the WMQ 7 driver. This transport was not tested on Mule 3.7 using IBM MQ 8 or 9. If you use the WMQ 7 driver in Mule 3.7, it may work, but this configuration is not supported.
