...
If at design time, you don't know how many query parameters a request might need, use DataWeave and a map variable to dynamically assign parameters to the request.

For example, you first create a variable named `customMap`. If you assign that variable a value through the following MEL expression:
