...
. Enter the message processor's properties editor, then click the green plus sign to create a new link:/mule-fundamentals/v/3.8/global-elements[Global Element] to set up connection parameters.
+
...
. Create a new Mule Project and add an `sfdc:global-element` at the start of your file. link:/mule-fundamentals/v/3.8/global-elements[Global Elements] set up reusable connection parameters.
+
[source, xml, linenums]
----
...
* link:/mule-user-guide/v/3.8/salesforce-connector-reference[Salesforce Connector Reference]
