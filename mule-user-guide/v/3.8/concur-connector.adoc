...
image:concur-connector-02297.png[concur connector]
...
The Anypoint Connector for Concur is a closed-source connector that provides a connection between Mule and third-party SaaS from SAP, called Concur, which helps manage business travel and expenses.

The connector implements SOAP calls to different API versions, depending on the Concur API. See what API versions and operations are supported in the release notes for the particular version of Concur connector you plan to use link:/release-notes/concur-connector-release-notes[here].

This document provides detailed instructions on how to install MuleSoft's Concur connector and demonstrates how to build and run simple demo applications that use this connector.
...
In order to use the connector and build the demo applications you need the following:
...
The latest version of the Concur connector at time of writing is 3.0. See the release notes link:/release-notes/concur-connector-release-notes[here].
[cols=",",options="header",]
|===
...
=== Concur Developer Sandbox Account

NOTE: You can skip this step if you already have a Concur account.
...
== Installing the Concur Connector
...
[NOTE]
See a full list of operations for any version of the connector link:https://mulesoft.github.io/concur-connector/[here].


With the Concur connector you can create and extract data with most of the Concur APIs, however certain operations are off-limits to the connector. The operations offered are based on what is available in *Concur's Developer Sandbox*.

=== Connector Namespace and Schema

When designing your application in Studio, the act of dragging the connector from the palette onto the Anypoint Studio canvas should automatically populate the XML code with the connector *namespace* and *schema location*.

*Namespace:* `http://www.mulesoft.org/schema/mule/concur`
*Schema Location:* `http://www.mulesoft.org/schema/mule/concur/current/mule-concur.xsd`
...
<mule xmlns="http://www.mulesoft.org/schema/mule/core"
      ...
      xmlns:sns="http://www.mulesoft.org/schema/mule/concur"
      xsi:schemaLocation="
...
== Example Concur Connector Use Cases
...
[[flow-xml]]
=== Complete Example Use Case Flow XML
...
== Concur API Availability with Concur Connector
