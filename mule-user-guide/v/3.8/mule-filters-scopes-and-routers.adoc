...
* *NEXT STEP*: Read on about link:/mule-user-guide/v/3.8/mule-exception-strategies[exception strategies].
* Skip ahead to understand the structure of a link:/mule-user-guide/v/3.8/mule-message-structure[Mule message].
* View link:/mule-user-guide/v/3.8/anypoint-exchange[examples].
