...
* Make sure that the `_config.adoc` file reflect the correct setting for `isLatest: true`. For example, if the latest archived version was 1.4, and you are now adding 1.5 docs to the archive, you need to change the setting to `false` for th 1.4 docs and to `true` for the 1.5 docs. 
