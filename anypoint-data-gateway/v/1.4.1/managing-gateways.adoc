...
After you have link:/anypoint-data-gateway/v/1.4.1/installing-anypoint-data-gateway[installed] Data Gateway, go to the *MuleSoft* tab to access Anypoint Data Gateway Designer.
...
For more information on how to assign permissions for Data Gateway follow the instructions in link:/anypoint-platform-administration/managing-accounts-roles-and-permissions#Data-Gateway-Permissions[Managing Accounts Roles and Permissions]
...
|===
[NOTE]
The *Organization Administrator* role in Anypoint Platform can access Data Gateway, even if no Data Gateway permissions are defined.
...
|4 |*Create Gateway* button. Click to create a new gateway (for details, see link:/anypoint-data-gateway/v/1.4.1/creating-and-configuring-a-gateway[Creating and Configuring a Gateway]).
...
For details on Cloud Extender, see the *Configuring a New Connection on a Private Network* in link:/anypoint-data-gateway/v/1.4.1/creating-and-configuring-a-gateway[Creating and Configuring a Gateway].
...
[TIP]
This section describes how to work with existing gateways. For information on creating a new gateway, see link:/anypoint-data-gateway/v/1.4.1/creating-and-configuring-a-gateway[Creating and Configuring a Gateway].
...
+
image:modifying_gw_status-1.2.png[modifying_gw_status-1.2] // UPDATE.
+
