...
Roles and permissions in Gateway Designer match those defined in Anypoint Platform. For details, see *User Roles and Permissions* in link:/anypoint-data-gateway/v/1.4.0/managing-gateways[Managing Gateways].
...
Additionally, you can specify your connection information using a *connection String* by clicking in the _Advanced_ tab:
...
[WARNING]
You can configure your Gateway using a *connection String* for any available link:anypoint-data-gateway/v/1.4.0/#supported-external-data-sources[external data sources], except for SAP and SQLServer databases.
...
For details on removing a Cloud Extender connection, see the *Cloud Extender* section in link:/anypoint-data-gateway/v/1.4.0/managing-gateways[Managing Gateways].
