...
* The product will not run after installation, unless you have completed the llink:/anypoint-data-gateway/v/1.3.0/installing-anypoint-data-gateway[post-installation steps]
