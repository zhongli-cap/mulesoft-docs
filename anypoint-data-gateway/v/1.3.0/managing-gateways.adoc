...
After you have link:/anypoint-data-gateway/v/1.3.0/installing-anypoint-data-gateway[installed] Data Gateway, go to the *MuleSoft* tab to access Anypoint Data Gateway Designer.
...
|4 |*Create Gateway* button. Click to create a new gateway (for details, see link:/anypoint-data-gateway/v/1.3.0/creating-and-configuring-a-gateway[Creating and Configuring a Gateway]).
...
For details on Cloud Extender, see the *Configuring a New Connection on a Private Network* in link:/anypoint-data-gateway/v/1.3.0/creating-and-configuring-a-gateway[Creating and Configuring a Gateway].
...
[TIP]
This section describes how to work with existing gateways. For information on creating a new gateway, see link:/anypoint-data-gateway/v/1.3.0/creating-and-configuring-a-gateway[Creating and Configuring a Gateway].
...
. Select from the available options: *Publish*, *Start*, *Delete* or *Settings*. This last option takes you to the Settings configuration screen, described below.
...
image:gw_settings-1.2.png[gw_settings-1.2]
