...
* link:https://developer.salesforce.com/docs/atlas.en-us.apexcode.meta/apexcode/platform_connect_about.htm[Salesforce Connect] activated as a feature. This is the feature that allows Salesforce to access and and modify data that resides outside of its own repositories.
...
* Create your first gateway following the steps in link:/anypoint-data-gateway/creating-and-configuring-a-gateway[Creating and Configuring a Gateway].
