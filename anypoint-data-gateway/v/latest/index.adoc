...
If you own an Anypoint Platform account, and your user owns the appropriate entitlements, a Data Gateway link will be present in your link:https://anypoint.mulesoft.com[Anypoint Platform home page], and in the left navigation bar.
...
See link:/anypoint-data-gateway/installing-anypoint-data-gateway[Installing Anypoint Data Gateway] for more details.
...
For details, see link:/anypoint-data-gateway/installing-anypoint-data-gateway[Installing Anypoint Data Gateway].
...
For details, see link:/anypoint-data-gateway/creating-and-configuring-a-gateway[Creating and Configuring a Gateway] and link:/anypoint-data-gateway/managing-gateways[Managing Gateways].
