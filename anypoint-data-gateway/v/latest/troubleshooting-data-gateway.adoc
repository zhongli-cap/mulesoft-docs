...
* The product will not run after installation, unless you have completed the link:/anypoint-data-gateway/installing-anypoint-data-gateway[post-installation steps]
