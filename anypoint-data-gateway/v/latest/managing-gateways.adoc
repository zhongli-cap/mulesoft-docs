...
For more information on how to assign permissions for Data Gateway follow the instructions in link:/access-management/managing-accounts-roles-and-permissions#Data-Gateway-Permissions[Managing Accounts Roles and Permissions]
