...
image::lookup-table-add.png[img-lookup-table-add, title="Add or Edit a Lookup Table Page"]
...
image::lookup-table-add.png[img-new-lookup-table, title="New Lookup Table Page"]
...
image::img-lookup-table-fields-and-keys.png[img-lookup-table-fields-and-keyse, title="Lookup Table Fields and Keys"]
