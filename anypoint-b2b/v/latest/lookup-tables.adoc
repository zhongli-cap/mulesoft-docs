...
+
----
curl -X GET -H  "http://qa.modusbox.com/b2b/tpm/api/lookupTables/lookup?key=OutboundProductCodes&lookupTable=ProductCodes&fields=InternalProductCode:Int1001%26PartnerName:Beta&environmentId=7025cf16-7581-49b3-b564-21564c1be2b1&apiKey=b10ddf010da74f4b8f515433e8c7156d"
----
+
