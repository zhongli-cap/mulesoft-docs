...
. When you have entered all values, click the pen icon at the right end of the new row (identified in to save it.
+
To cancel the new row without saving, click
