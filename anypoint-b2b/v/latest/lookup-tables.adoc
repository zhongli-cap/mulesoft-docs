...
+
If you want to enter data for a table, go to <<Enter Data for a Lookup Table>>.
The data that you add for each field will populate the rows of the field.

== Administer a Lookup Table

. In the *ADMINISTRATION* section of the left-hand navigation pane on the <<configure-trading-partners.adoc#img-company-information, Company Information Page>>, click *Lookup Tables Admin*.
+
The <<img-lookup-tables-admin>> appears.

[[img-lookup-tables-admin]]

image::lookup-table-admin.png[img-lookup-tables-admin, title="Lookup Tables Admin Page"]
...
This section shows you how to use the APM user interface to create a lookup table. Alternatively, you can create a lookup table through calls to the link:/anypoint-b2b/anypoint-partner-manager-api[Anypoint Partner Manager API]; see link:/anypoint-b2b/lookup-tables-programmatic[Create a Lookup Table]. See link:/anypoint-b2b/lookup-tables-programmatic[Create a Lookup Table] also for instructions for querying a table.
...
. In the *Field* dropdown listbox, click the down arrow.
+
...
. In the *ADMINISTRATION* section of the left-hand navigation pane on the <<configure-trading-partners.adoc#img-company-information, Company Information Page>>, click *Lookup Tables Data Entry*.
+
The <<img-lookup-tables-data-entry>> appears.

[[img-lookup-tables-data-entry]]

image::lookup-table-data-entry.png[img-lookup-tables-data-entry, title="Lookup Tables Data Entry Page"]

. In the *Lookup Tables* dropdown listbox, click the Down Arrow, then click the table for which you want to add or edit data.
