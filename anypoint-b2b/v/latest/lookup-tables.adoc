...
Anypoint Manager enables you to create, populate and edit _lookup tables_. In this context, a lookup table is a table that facilitates transaction processing. This page illustrates a lookup table that associates home partner product codes with trading partner product codes.  
