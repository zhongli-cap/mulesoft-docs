...
* link:/anypoint-b2b/x12-identity-settings[Go back to the previous configuration page]
* link:/anypoint-b2b/x12-outbound-(write)-settings[Move on to the next configuration page]
