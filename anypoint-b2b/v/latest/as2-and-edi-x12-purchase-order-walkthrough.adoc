...
This document is intended for a technical audience with basic knowledge of link:/mule-user-guide/v/3.8/dataweave[DataWeave], link:http://modusintegration.github.io/mule-connector-as2/[AS2 Connector], link:/anypoint-b2b/x12-module[X12 Module], and link:getting-started[Anypoint Anypoint Platform].
