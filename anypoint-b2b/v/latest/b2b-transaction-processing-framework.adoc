...
Transaction-processing terms can have different meanings in different contexts. Therefore, in this section, we define how we use the most common of them. For other definitions, see <<Information Architecture: APM-Configurable Entities and Terms>> and link:/anypoint-b2b/glossary[Glossary].



=== Transaction, Transmission, Document, Message, File
