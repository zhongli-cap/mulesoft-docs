...
image::img-functional-architecture.png[img-functional-architecture,title="Functional Architecture"]
=== Receive
...
image::2-b2b-message-processing-framework.png[img-b2b-message-processing,title="B2B Message Processing Framework"]
...
[[img-b2b-transaction]]
image::3-b2b-transaction.png[img-b2b-transaction,title="B2B Transaction"]
...
////
The following diagram depicts the relationships between these configuration entities relative to the processing of inbound or outbound transactions:

image:4-inbound-outbound.png[4-inbound-outbound.png]
[[img-inbound-outbound]]
image::4-inbound-outbound.png[img-inbound-outbound,title="B2B Directional Processing"]
NOTE: In the interest of covering the range of possible usage scenarios, this information architecture supports configuration options that are not all needed in every scenario.
