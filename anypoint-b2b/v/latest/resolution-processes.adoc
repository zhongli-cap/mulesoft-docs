...
for link:/anypoint-b2b/b2b-transaction-processing-framework#document-type[document types], link:/anypoint-b2b/b2b-transaction-processing-framework#endpoints[endpoints], and link:/anypoint-b2b/route[routes]. For example, you can configure
