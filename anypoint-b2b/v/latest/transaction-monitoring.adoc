...
+
To change the time period, see link:/anypoint-b2b/anypoint-b2b/central-pane-elements#overview-for-em-timeframe-em-dropdown-list[Overview for _timeframe_ Dropdown List].
+
