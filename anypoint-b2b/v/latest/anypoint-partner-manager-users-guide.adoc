...
. <<Set up the Home Partner>>
. <<Set up a trading partner>>

The _Home Partner_ is you - that is, the company licensing Anypoint B2B.
To use Anypoint Partner Manager to manage your B2B transmissions, first create this Home Partner in APM.
...
.. To edit information for the Home Partner (your company), click the name of your company,
.. To edit information for a trading partner, click the name of the partner.
. The _Company_ page appears.
