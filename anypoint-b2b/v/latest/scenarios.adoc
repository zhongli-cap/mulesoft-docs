...
This page identifies scenarios in which link:/anypoint-b2b/anypoint-partner-manager/[Anypoint Partner Manager] is commonly used. The procedures you would use to implement a given scenario are identified in link:/anypoint-b2b/configure-trading-partners[Configure Trading Parners] and link:/anypoint-b2b/monitor-b2b-transactions[Monitor B2B Transactions].
