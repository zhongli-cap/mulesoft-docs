. In the *CONFIGURATION* section of the left-hand navigation pane on the xref:img-certifcate[] (or any other APM Configuration page), click *Transaction Designer*.
+
