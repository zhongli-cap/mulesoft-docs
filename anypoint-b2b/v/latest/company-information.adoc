...
. After you enter a contact type, you can enter the following contact-specific information. All fields are link:/anypoint-partner-manager-glossary#sects[standard APM field format]
