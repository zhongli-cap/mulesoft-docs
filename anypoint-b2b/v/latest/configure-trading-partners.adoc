...
The <<anypoint-partner-manager-users-guide.adoc#img-apm-start,B2B Transactions Page>> appears.
...
== Promoting a Partner
APM provides the ability to _promote_ - that is, copy, a trading partner from one environment to another.
Only users with the appropriate role or permissions will be able to promote partners
