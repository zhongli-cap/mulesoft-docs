...
_ To save new settings, click *Save*.

== Company information

==== Enter Company information

. On the _Company information_ page, the name of the partner you selected on the Trading Partners page appears. If appropriate, you can change it.
...
When you click either the Source Document or the Target Document box, the Pick document selection page appears. You can make the following selections:
