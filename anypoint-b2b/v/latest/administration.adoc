...
image::api-key-warning.png[img-api-key-warning, title="API Key Warning"]

[start=2]

. Read the <<img-api-key-warning>> carefully.
+
If, after you hae read <<img-api-key-warning>>, you are sure you want to create the key, on <<img-api-key-warning>>, click *Generate*.
...
The information in the *Environemnts* section of <<img-administration>> is required when using link:/anypoint-b2b/partner-manager-connector[Partner Manager Connector].
