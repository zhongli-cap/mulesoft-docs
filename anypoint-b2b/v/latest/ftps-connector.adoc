...
To install the FTPS Connector in Anypoint Studio, see link:https://docs.mulesoft.com/getting-started/anypoint-exchange#installing-a-connector-from-anypoint-exchange["Installing a Connector from Anypoint Exchange]. 
