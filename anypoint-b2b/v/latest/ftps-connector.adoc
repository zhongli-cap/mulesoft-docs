...
Follow the link:https://docs.mulesoft.com/mule-fundamentals/v/3.7/anypoint-exchange#installing-a-connector-from-anypoint-exchange[instructions for installing a Connector from Anypoint Exchange] to install the AS2 Connector in Anypoint Studio.
...
image:_images/b2b_ftps_connector_01.png[b2b_ftps_connector_01]

*Step 2* +
Locate the FTPS Connector on the right hand-side palette:

image:_images/b2b_ftps_connector_02.png[b2b_ftps_connector_02]

*Step 3* +
Drag and drop the FTPS connector over to the canvas:

image:_images/b2b_ftps_connector_03.png[b2b_ftps_connector_03]

*Step 4* +
Create a connector configuration for the FTPS element

image:_images/b2b_ftps_connector_04.png[b2b_ftps_connector_04]

*Step 5* +
Set the FTPS settings according to your scenario. In this example, we have an FTPS server running on localhost.

image:_images/b2b_ftps_connector_05.png[b2b_ftps_connector_05]
...
+
image:_images/b2b_ftps_connector_06.png[b2b_ftps_connector_06]
...
image:_images/b2b_ftps_connector_07.png[b2b_ftps_connector_07]
...
image:_images/b2b_ftps_connector_08.png[b2b_ftps_connector_08]
...
image:_images/b2b_ftps_connector_09.png[b2b_ftps_connector_09]
...
image:_images/b2b_ftps_connector_10.png[b2b_ftps_connector_10]

*Step 8* +
Now let us set up the FTPS write file operation.

image:_images/b2b_ftps_connector_11.png[b2b_ftps_connector_11]
...
image:_images/b2b_ftps_connector_12.png[b2b_ftps_connector_12]
...
image:_images/b2b_ftps_connector_13.png[b2b_ftps_connector_13]
