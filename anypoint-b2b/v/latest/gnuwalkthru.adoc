...
+
The <<img-channel>> reappears; the document you selected in <<img-pick-map>> appears in the *Document* box.
...
. In the <<img-pick-endpoint>>, click *X12-00401-850-AcmeHomeSupply-JSON-PurchaseOrder-AAZFasteners*.
+
