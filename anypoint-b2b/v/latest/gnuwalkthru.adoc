...
In this walkthrough, you will work with two partners: a <<Supplier>> and a _<<Buyer>>_.
...
NOTE: If you are completing the walkthrough in sequence, these steps switch the partner you are configuring from AcmeHomeSupply (the Buyer) to AAZFasteners (the Supplier).
...
NOTE: If you are completing the walkthrough in sequence, these steps switch the partner you are configuring from AAZFasteners (the Supplier) to AcmeHomeSupply (the Buyer).
