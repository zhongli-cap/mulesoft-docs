...
All the X12 Time fields, are presented as Integer values with the number of miliseconds. For example, if a message comes with value "024020", in dataweave mapping
it appears as 9620000. Value "024020" is in format "HHMMSS" , so if we convert it to miliseconds, we need to do: **02*3600000 + 40*60000 + 20*1000 = 9620000**.
