...
This document assumes that you are familiar with Mule, the link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Anypoint Studio Essentials] and link:/mule-fundamentals/v/3.7/global-elements[Global Elements]. Further, it is assumed that you are familiar with AS2 endpoints and have received endpoint configuration requirements.
...
If you wish to use the AS2 Connector in conjunction with Maven, please follow the instructions link:http://modusintegration.github.io/mule-connector-as2/guide/install.html[here].
