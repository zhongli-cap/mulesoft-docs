...
Follow the link:/mule-user-guide/v/3.8/installing-connectors[instructions for installing a Connector from Anypoint Exchange] to install the AS2 Connector in Anypoint Studio.
