...
////
. On the <<img-transaction-designer>>, click *New*.

The <<img-td-transaction>> appears.

[[img-td-transaction]]

image::transaction.png[img-td-transaction, title="Transaction Page"]

. On the <<img-td-transaction>>, click *Create New Channel*.
+
The <<img-td-transaction>> displays the <<img-td-source-channel>>.
...
. On the <<img-td-source-channel>>, in the Source Document Pane, click *New Document*. +
The <<img-td-source-document>> appears.

[[img-td-source-document]]

image::transaction.png[img-td-source-document, title="Source Document Page"]
