...
For this tutorial, we have created and S3 bucket for you to use.  

CAUTION: This S3 Bucket is for demonstration purposes only, and is used by many parties. Therefore, when completing the tutorial, if you use the bucket, confientiality of your messages cannot be guaranteed. 

=== Configure the S3 Bucket

. On the APM Main Menu, click *Administration*. 
+
The Administration Page appears. 
. In the left-hand navigation pane, click *Security*.
+
...
image::partner/security.png[img-security, title="Security Page"]

. Complete the boxes as shown on the <<img-security>>, inserting *SV6ApnTjS05s1CltwS+I2vbFfm7cgHPN2MSr+3fB* for *Security Key*. 
+
For cutting and pasting purposes, the value for *Access Key ID* is *AKIAIDH7A447OHS5I6NQ*.
...
. In the project (expand if necessary), expand the *src/main/app*, double-click *apm.prod.edi.properties*. +
