...
. In the *Transaction Name* box, type *Draft Purchase Order*.
+
...
image::/yc/img-td-save-transaction-aaz.png[img-td-save-transaction-aaz, title="Save transaction Page"]
...
include::/_sources/tutorial/supplier/start-td-acme.adoc[]
