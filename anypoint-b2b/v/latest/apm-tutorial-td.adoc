...
. Click *Save*.
+
The <<td-possible-endpoints-acme>> appears. 
. Click *Save*.
+
...
[[td-source-channel-in-progress-acme-endpoint-added-acme]]

image::td-source-channel-in-progress-acme-endpoint-added-acme.png[img-td-source-channel-in-progress-acme-endpoint-added-acme, title="Source Channel in-progress"]
