...
This tutorial illustrates the role Anypoint Partner Manager (APM) plays in B2B transaction processing. 

The tutorial provides instructions for configuring APM so that you can simulate a transaction and see how APM processes it.
