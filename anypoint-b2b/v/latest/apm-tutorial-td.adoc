...
image::yc/img-td-target-channel-in-progress-aaz.png[img-td-target-channel-in-progress-aaz, title="Target Channel in-progress Page"]
...
+ The <<td-transaction-complete>> apppears.
