...
. To configure or edit the configuration of a trading partner, see link:/anypoint-b2b/configure-trading-partners[Configure Trading Partners].
+
To edit or configure the _Home Partner_ (a specific type of trading partner, typically your company) see link:/anypoint-b2b/administration[Administration].
