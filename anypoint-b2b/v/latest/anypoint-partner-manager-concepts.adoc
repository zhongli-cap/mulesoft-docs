...
The customer then uses <<Anypoint Partner Manager>> to request and view metadata and payload data, a process which includes the <<Trading Partner Management API>> and <<Tracking Data Storage>>.
