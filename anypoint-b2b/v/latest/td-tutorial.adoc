...
After you create *AcmeHomeSupply*, you will <<Add Identifiers>>.
...
image::partner/identifier-new-acme.png[img-identifier-new, title="New Identifier Page"]
...
image::identifiers-x12-acme.png[img-identifiers-x12, title="Identifiers Page (X12-ISA Identifier Added)"]
