...
.. In the *Server Address* field, enter address for the server you want to use.
.. In the *Port* field, enter the number of the port for your server (typically 21).
.. In the *User Name* field, the username for the account you created on the FTPS cloud service you procured in Step a.
.. In the *Password* field, the password for the account you created on the FTPS cloud service you procured in Step a.
