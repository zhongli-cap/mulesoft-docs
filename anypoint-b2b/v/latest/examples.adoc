...
In this example, a user performs a series of conifguration tasks in APM and Anypoint Studio, resulting in the ability to view events and track transmissions.
