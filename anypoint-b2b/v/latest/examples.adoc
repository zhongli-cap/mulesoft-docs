...
For information about the procedures you would use to implement a given example, see link:/anypoint-b2b/partner-configuration[Configure Trading Parners] and link:/anypoint-b2b/monitor-b2b-transactions[Monitor B2B Transactions].
