...
+
The <<img-endpoint-settings>> page appears. The settings that appear depend on the values for *Protocol* and *Type*.
...
image::endpoint.png[img-endpoint-add, title="Endpoint Page"]
