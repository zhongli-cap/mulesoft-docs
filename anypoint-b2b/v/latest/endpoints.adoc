...
+
The <<img-endpoint>> page appears. The settings that appear depend on the values for *Protocol* and *Type*.
...
. On the <<img-endpoint>>, enter the appropriate settings.
+
When you have entered settings for *Name*, *Protocol* and *Type*, the <<img-endpoint>> becomes the <<img-endpoint-settings>>.
+
