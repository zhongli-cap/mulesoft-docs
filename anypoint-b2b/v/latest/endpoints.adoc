...
+
To edit settings specific to the existing Name, Protocol, and Type, go the appropriate Protocol-Type combination in <<Endpoint settings>>.
...
|===
+
When you have entered settings for *Name*, *Protocol* and *Type*, additional settings specific to the protocol-type combination appear; the <<img-endpoint-add>> becomes the <<img-endpoint-settings>>. For  information about the additional settings, go to the appropriate Protocol-Type combination in <<Endpoint settings>>.
...
For a given endpoint, the values you select for *Protocol* and *Type* determine which additional settings that appear.
