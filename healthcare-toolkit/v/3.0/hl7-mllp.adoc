...
[NOTE]
The HL7 MLLP component is part of the link:/mule-healthcare-toolkit/v/3.6[Mule Healthcare Toolkit], which also includes transformers and components for receiving, processing and sending HL7 messages. For details and a full list of available tools, consult the Toolkit's link:/mule-healthcare-toolkit/v/3.6[documentation main page].
