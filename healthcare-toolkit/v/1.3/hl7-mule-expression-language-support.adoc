...
The Mule Healthcare toolkit includes two link:https://docs.mulesoft.com/mule-user-guide/v/3.8/mule-expression-language-mel[Mule Expression Language] (MEL) functions:
...
Use a link:https://docs.mulesoft.com/mule-user-guide/v/3.8/variable-transformer-reference[Variable Transformer] to initialize the variable `HL7event` with the value of the `EVN` segment of the HL7 message:
...
Use a link:https://docs.mulesoft.com/mule-user-guide/v/3.8/set-payload-transformer-reference[Set Payload Transformer] to obtain a string composed of the fields `PID-5-1` and `PID-5-2`:
...
Use an link:https://docs.mulesoft.com/mule-user-guide/v/3.8/expression-component-reference[Expression Component] to set modify fields `PID-5-1` and `PID-5-2`:
