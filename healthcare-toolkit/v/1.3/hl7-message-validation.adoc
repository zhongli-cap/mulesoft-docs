...
* A link:https://docs.mulesoft.com/mule-user-guide/v/3.8/variable-transformer-reference[Variable Transformer] defines variables for logging.
* A link:https://docs.mulesoft.com/mule-user-guide/v/3.8/logger-component-reference[Logger Component] performs logging.
* A link:https://docs.mulesoft.com/mule-user-guide/v/3.8/flow-reference-component-reference[Flow Ref Component] invokes the next flow.
