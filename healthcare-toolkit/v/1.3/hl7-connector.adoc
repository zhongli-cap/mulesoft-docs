...
The HL7 Connector also accepts all attributes configurable for TCP connectors. See the link:https://docs.mulesoft.com/mule-user-guide/v/3.8/tcp-transport-reference[TCP Transport Reference] for details.
