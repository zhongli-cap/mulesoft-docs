...
|*(Boolean)* Enables link:https://docs.mulesoft.com/mule-user-guide/v/3.8/business-events[Business Events] for the Endpoint.
|[source]
----
...
|XML
|*Connector Reference*
|References an HL7 connector configured as a link:https://docs.mulesoft.com/mule-user-guide/v/3.8/global-elements[Global Element].
|[source]
----
...
----
|*Connector Reference*
|Allows you to reference an HL7 connector configured as a link:https://docs.mulesoft.com/mule-user-guide/v/3.8/global-elements[Global Element].
|[source]
----
connector-ref="HL7connectorName"
----
