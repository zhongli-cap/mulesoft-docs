...
. In the *Work With* field of the *Install* wizard, use the drop-down menu to select: `Anypoint Connectors Update Site`. In Studio 6.3.0 and later, select `https://repository.mulesoft.org/connectors/releases/3.5.0` to install a connector.
+
[TIP]
====
