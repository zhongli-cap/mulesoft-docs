...
. In the *Work With* field of the *Install* wizard, use the drop-down menu to click: `Anypoint Connectors Update Site`. In Studio 6.3.0 and later, select `https://repository.mulesoft.org/connectors/releases/3.5.0` to install this connector.
+
[NOTE]
====
