...
Mule agent version 1.2.0 installs as a plugin from a zip file, available in the latest version page or in the corresponding link:/release-notes/mule-agent-release-notes[release notes page].
