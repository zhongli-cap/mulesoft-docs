...
| `RTF_INSTALL_PACKAGE_URL` | Url to download the installation package from. _If this is not specified, the installer will expect you to manually copy the installation package to `/opt/anypoint/runtimefabric/installer.tar.gz |
