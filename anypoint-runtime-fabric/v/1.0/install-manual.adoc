...
== Add a Mule license key to Runtime Fabric

After associating Runtime Fabric to one or more environments, you must add your Mule license key in order to deploy Mule applications to it.