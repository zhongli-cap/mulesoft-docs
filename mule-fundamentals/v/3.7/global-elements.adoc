...
 link:/anypoint-studio/v/5/anypoint-studio-essentials[Visual Editor in Anypoint Studio]. Review the link:/anypoint-studio/v/5/anypoint-studio-essentials[Anypoint Studio Essentials] document to learn more about developing with Mule ESB's graphical user interface.
