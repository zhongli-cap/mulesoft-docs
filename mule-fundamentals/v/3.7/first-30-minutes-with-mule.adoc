...
[%autowidth.spread]
|===
|*link:/getting-started/index[Anypoint Platform Fundamentals]* |Learn about the various features and functionality Mule has to offer, including its IDE, deployment options, and management capabilities.
