...
....
. Launch Anypoint Studio and create a new Mule Project. If you need more directions on launching Studio and creating a project, refer to the link:/anypoint-studio/v/5/basic-studio-tutorial[Basic Studio Tutorial]. 
...
* Learn more about link:/anypoint-studio/v/5/studio-visual-debugger[Visual Debugger], the link:/mule-user-guide/v/3.7/logger-component-reference[Logger], and link:/anypoint-studio/v/5/datasense[DataSense].
