...
After learning some of the basic functionality in the link:/mule-fundamentals/v/3.8/basic-studio-tutorial[Basic] and link:/mule-fundamentals/v/3.8/content-based-routing-tutorial[Content-Based Routing Tutorials], it's time to try your hand at developing a more complex application which makes use of *Anypoint Connectors*.
...
This tutorial assumes that you have link:/mule-fundamentals/v/3.8/download-and-launch-anypoint-studio[downloaded and installed Anypoint Studio]. If you do not have any previous experience with Eclipse or an Eclipse-based IDE, you can review the brief introduction to the link:/mule-fundamentals/v/3.8/anypoint-studio-essentials[Anypoint Studio interface] and the document describing link:/mule-fundamentals/v/3.8/global-elements[Global Elements in Mule]. Further, consider following the link:/mule-fundamentals/v/3.8/basic-studio-tutorial[Basic] and link:/mule-fundamentals/v/3.8/content-based-routing-tutorial[Content-Based Routing] tutorials.
...
. Create a new Mule Project named `Connector Tutorial`. If you need more directions on launching Studio and creating a project, see link:/mule-fundamentals/v/3.8/basic-studio-tutorial[Basic Studio Tutorial]. Press CMD + s (or CTRL + s in Windows) to save your project.
...
....
. Click the HTTP building block in your flow to open its link:/mule-fundamentals/v/3.8/the-properties-editor[Properties Editor].  For this element to work, we set an abstract element called a _Connector Configuration_, which contains several of the high-level necessary configuration properties. A single Connector Configuration element can be referenced by as many HTTP connectors as you like. Create a new Connector Configuration element by clicking the green plus sign next to the *Connector Configuration* field.
+
...
Read more about link:/mule-fundamentals/v/3.8/global-elements[Global Elements in Mule].
...
* *NEXT STEP:* Try the link:/mule-fundamentals/v/3.8/mule-message-tutorial[Mule Message Tutorial].
