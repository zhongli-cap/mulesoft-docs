...
After learning some of the basic functionality in the link:/mule-fundamentals/v/3.5/basic-studio-tutorial[Basic] and link:/getting-started/content-based-routing[Content-Based Routing], it's time to try your hand at developing a more complex application which makes use of **Anypoint™ Connectors**.
