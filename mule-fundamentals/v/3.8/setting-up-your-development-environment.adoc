...
* Please review the platform software compatible with Mule ESB link:/mule-user-guide/v/3.8/compatibility[here].

=== Install ESB

* Click link:/mule-user-guide/v/3.8/downloading-and-starting-mule-esb[here] for detailed steps on installing ESB on premises.
