...
able to apply what you have learned to create link:/mule-fundamentals/v/3.8/content-based-routing-tutorial[more complex applications].

== Prerequisites

Before going any further, make sure you have link:/mule-fundamentals/v/3.8/download-and-launch-anypoint-studio[downloaded and installed Anypoint Studio]. If you do not have any previous experience with link:https://eclipse.org/[Eclipse] or an Eclipse-based IDE, review the brief introduction to the link:/mule-fundamentals/v/3.8/anypoint-studio-essentials[Anypoint Studio interface].
...
For more information about how to use the visual editor, see this link:/mule-fundamentals/v/3.8/anypoint-studio-essentials[quick overview].
...
+
The String `#[message.inboundProperties.'http.request.path']` is a link:/mule-user-guide/v/3.8/mule-expression-language-mel[Mule expression] that evaluates to the requested property of the message as it passes this point in the flow. Including this message here instructs Mule to log this information in the application log files, which can be useful in more complex use cases, when you need to track the payload at different points in your flow.
+
...
Congratulations! You're all set to go on to the link:/mule-fundamentals/v/3.8/content-based-routing-tutorial[Content-Based Routing Tutorial].
...
* Learn about routing information: link:/mule-fundamentals/v/3.8/content-based-routing-tutorial[Content-Based Routing Tutorial].
...
* Get a deeper explanation about the Mule message and anatomy of a Mule flow in link:/mule-fundamentals/v/3.8/mule-concepts[Mule Concepts].
