...
|*link:/anypoint-studio/v/6/setting-up-your-development-environment[Development Environment Setup]* |Learn about setting up Anypoint Studio, Maven, code repositories, on premise Mule server, and cloud application management.
...
|*link:/anypoint-studio/v/6/anypoint-studio-essentials[Anypoint Studio Essentials]* |Learn the essentials for using Mule's own IDE, Anypoint Studio.
