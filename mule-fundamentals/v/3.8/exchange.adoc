...
. Open the zip file. Open the `content.xml` file and search for the `version=` value. In the following example, the last line shows the version as: `version='1.0.0.201607271521'` -- This version string is the Feature ID that we refer to shortly.
+
...
<repository name='file:/Users/me/AnypointStudio/workspace/c-demo-connector/target/update-site/ - metadata' type='org.eclipse.equinox.internal.p2.metadata.repository.LocalMetadataRepository' version='1.0.0'>
  ...
  <units size='4'>
    ...
    <unit id='org.mule.tooling.ui.extension.c-demo-connector.3.5.0.feature.group' version='1.0.0.201607271521' singleton='false'>
----
+
