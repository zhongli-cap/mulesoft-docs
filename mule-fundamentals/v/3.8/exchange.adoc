...
. Open the zip file. Open the `content.xml` file and search for the `version=` value. In the following example, the last line shows the version as: `version='1.0.0.2--cKMyWI7735E3G7G5C75'` -- This version string is the Feature ID that we refer to shortly.
+
[source,code,linenums]
----
<?xml version='1.0' encoding='UTF-8'?>
<?metadataRepository version='1.1.0'?>
<repository name='file:/Users/me/AnypointStudio/workspace/c-demo-connector/target/update-site/ - metadata' type='org.eclipse.equinox.internal.p2.metadata.repository.LocalMetadataRepository' version='1.0.0'>
  <properties size='2'>
    <property name='p2.timestamp' value='1469658172801'/>
    <property name='p2.compressed' value='false'/>
  </properties>
  <units size='4'>
    <unit id='file:/Users/me/AnypointStudio/workspace/c-demo-connector/target/classes/category.xml.org.mule.modules' version='1.0.0.2--cKMyWI7735E3G7G5C75'>
----
+
...
. In the Versions menu, put the Feature ID in both the *Connector version* and *Feature ID* fields. The following example shows how the fields are completed:
+
