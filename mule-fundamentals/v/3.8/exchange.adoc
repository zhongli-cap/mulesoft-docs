...
. In the Versions menu, put the version string (in previous example is: `1.0.0.201607271521`) in the *Connector version* and the Feature ID string (in previous example: `org.mule.tooling.ui.extension.my-connector.3.5.0.feature.group`) in  *Feature ID* fields. The following example shows how the fields are completed:
+
