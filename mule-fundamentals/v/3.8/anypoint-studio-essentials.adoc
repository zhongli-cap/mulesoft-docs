...
* *NEXT STEP:* link:/mule-fundamentals/v/3.8/build-a-hello-world-application[Build an application in Anypoint Studio].
...
* Skip ahead to learn about link:/mule-fundamentals/v/3.8/mule-message-structure[message structure].
