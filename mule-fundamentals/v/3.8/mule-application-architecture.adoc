...
* Call various other link:/mule-fundamentals/v/3.8/flows-and-subflows[flows]

== See Also

* *NEXT STEP:* Learn about how link:/mule-fundamentals/v/3.8/flows-and-subflows[flows and subflows] work together in an application.
* Examine an link:/mule-fundamentals/v/3.8/flow-architecture-advanced-use-case[advanced use case] showing a more complex flow architecture.
