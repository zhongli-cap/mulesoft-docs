...
The most direct and dynamic way of exploring which MEL expressions resolve as you expect them to is to use the Mule Expression Evaluator within the link:/anypoint-studio/v/6.0/studio-visual-debugger[Visual Debugger]. You can access the Mule Expression Evaluator while running in Debug mode, after having sent a message and paused it at a breakpoint in your flow.
...
* Learn more about link:/anypoint-studio/v/6.0/studio-visual-debugger[Visual Debugger], the link:/mule-user-guide/v/3.8/logger-component-reference[Logger], and link:/anypoint-studio/v/6.0/datasense[DataSense].
