...
....
. Launch Anypoint Studio and create a new Mule Project. If you need more directions on launching Studio and creating a project, please refer to the link:/anypoint-studio/v/6.0/basic-studio-tutorial[Basic Studio Tutorial]. 
