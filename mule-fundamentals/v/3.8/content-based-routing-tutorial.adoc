...
In the link:/anypoint-studio/v/6/basic-studio-tutorial[Basic Studio Tutorial], you got to know Anypoint Studio and built a simple "Hello, World" application.

Walk through Anypoint Studio to build a slightly more complex "Hello, World" application that routes messages according to their content. After creating and running the example in this tutorial locally, you should be able to apply what you have learned to create more complex applications.

== Prerequisites

This tutorial assumes that you have link:/anypoint-studio/v/6/download-and-launch-anypoint-studio[downloaded and installed Anypoint Studio]. If you do not have any previous experience with Eclipse or an Eclipse-based IDE, please review the brief introduction to the link:/anypoint-studio/v/6/[Anypoint Studio interface] or complete the link:/anypoint-studio/v/6/basic-studio-tutorial[Basic Studio Tutorial]. 
...
Launch Anypoint Studio and create a new Mule Project named CBR Tutorial. If you need more directions on launching Studio and creating a project, refer to the link:/anypoint-studio/v/6/basic-studio-tutorial[Basic Studio Tutorial]. 
...
[cols="30a,70a"]
|===
|*link:/mule-user-guide/v/3.8/http-connector[HTTP Connector]* |Allows your Mule application to connect to Web resources through the HTTP or HTTPS protocol.
|*Expression Filter* |Filters messages according to a Mule expression.
|*link:/mule-user-guide/v/3.8/variable-transformer-reference[Variable Transformer]* |Sets a flow variable on the message that can be invoked elsewhere in the flow.
|link:/mule-user-guide/v/3.8/choice-flow-control-reference[*Choice Router*] |Routes incoming messages according to configured logic.

|*link:/mule-user-guide/v/3.8/set-payload-transformer-reference[Set Payload Transformer]* |Modifies your payload into a different message, depending on the results of the choice routing.
|link:/mule-user-guide/v/3.8/logger-component-reference[*Logger*] |Logs messages or activity based on the value of a Mule expression.
|===
...
+
image:cbr-add-logger.png[cbr-add-logger]
...
== Configure the Elements of the Mule Flow
...
+
image:http+pelado.png[HTTP Connector location of green plus sign]
+
...
=== Configure the Choice Router and Constituent Message Processors
...
== Complete Application XML 

Your complete application XML, once configured, should look like the following:

[source,xml, linenums]
----
include::_sources/content-based-routing-tutorial_1.xml[]
----
...
. Check the console log in Studio again and look for this log message: [source, code, linenums]
+
[source]
----
...
* A *link:/mule-user-guide/v/3.8/flow-reference-component-reference[Flow Reference Component]*, which invokes another flow in the application. Find this in the Components section of the palette.
...
[source,xml, linenums]
----
include::_sources/content-based-routing-tutorial_2.xml[]
----
...
[cols="1*a",width=80%]
|===
|image:icon-question-blue-big.png[icon-question-blue-big]
|===
...
+
image:cbr-log-msgs.png[cbr-log-msgs]

Congratulations! You earned your extra credit. You're all set to go on to the link:/mule-fundamentals/v/3.8/anypoint-connector-tutorial[Connector Tutorial].

View the code of the revised application:

[source,xml, linenums]
----
include::_sources/content-based-routing-tutorial_3.xml[]
----
...
* *NEXT STEP:* Test yourself with the next, slightly more complex link:/mule-fundamentals/v/3.8/anypoint-connector-tutorial[Anypoint Connector Tutorial].
...
* Get a deeper explanation about the link:/mule-fundamentals/v/3.8/mule-message-structure[Mule message] and anatomy of a link:/mule-fundamentals/v/3.8/mule-application-architecture[Mule application].
