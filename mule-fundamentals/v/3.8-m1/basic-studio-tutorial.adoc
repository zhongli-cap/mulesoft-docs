...
able to apply what you have learned to create link:/mule-fundamentals/v/3.8-m1/content-based-routing-tutorial[more complex applications].

== Prerequisites

Before going any further, make sure you have link:/mule-fundamentals/v/3.8-m1/download-and-launch-anypoint-studio[downloaded and installed Anypoint Studio]. If you do not have any previous experience with link:https://eclipse.org/[Eclipse] or an Eclipse-based IDE, review the brief introduction to the link:/mule-fundamentals/v/3.8-m1/anypoint-studio-essentials[Anypoint Studio interface].
