...
* The Anypoint Exchange 1.6 update does not apply to the on-premises version. For more information, see the link:/release-notes/anypoint-exchange-release-notes[Anypoint Exchange Release Notes].
====
...
. Click organization's name in the top taskbar to view the current business groups:
+
