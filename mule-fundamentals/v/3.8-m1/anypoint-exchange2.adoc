...
The Business Groups feature in Exchange may seem complex, the published content is shared through the Business Groups using a kind of hierarchy. For example, if a template is published in the master organization, all organizations below see this template in the content list. Also, the content list has new filters to search content: 
