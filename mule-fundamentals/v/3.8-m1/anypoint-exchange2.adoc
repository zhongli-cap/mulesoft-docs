...
// In Exchange 1.6 and newer, after submitting an item, it is added to the Exchange with an *unpublished* status, which makes it only visible to yourself. If you have the Exchange Administrator role, you can easily publish it by opening the Exchange entry through the *View Details* button and clicking the *Publish* button. If you have the Exchange Contributor role, you can 'Request for publish' and then a user with the  Exchange Administrator role can see it and aprove.
