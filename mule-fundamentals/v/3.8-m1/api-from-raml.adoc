...
The first procedure in this section show you how to you build the interface based on RAML. The second procedure shows you how to add a new web service to the interface. Assuming the role of a user, you then access services over the API Network provided by the interface.
