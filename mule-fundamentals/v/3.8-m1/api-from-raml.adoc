...
The procedures in this section first show you how to you build the interface based on RAML, and then add a new web service to the interface. Finally, assuming the role of a user, you access services over the API Network provided by the interface.
