...
Anypoint Studio, the Eclipse-based, integration development environment offers two editors you can utilize to design and craft your applications:

* Anypoint Studio's *Visual Editor*
* Anypoint Studio's *XML Editor*

Whatever you do in one editor reflects in the other. If you drop a connector onto the Visual Editor's canvas, the addition of the connector to your application is recorded in the XML Editor. This real-time reflection of changes is referred to as *two-way editing*. Same application, two different editors.
...
Find out more about using expressions to access and manipulate the Mule message in the link:/mule-fundamentals/v/3.8-m1/mule-message-tutorial[Mule Message Tutorial].

== See Also 

* *NEXT STEP:* link:/mule-fundamentals/v/3.8-m1/build-a-hello-world-application[Build an application in Anypoint Studio].
* link:/mule-fundamentals/v/3.8-m1/setting-up-your-dev-environment[Setting Up Your Development Environment]
* Learn more about flows in link:/mule-fundamentals/v/3.8-m1/mule-application-architecture[Mule Application Architecture].
* Skip ahead to learn about link:/mule-fundamentals/v/3.8-m1/mule-message-structure[message structure].
