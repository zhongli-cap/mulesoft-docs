...
Whatever you do in one editor reflects in the other. If you drop a connector onto the Visual Editor canvas, the addition of the connector to your application is recorded in the XML Editor. This real-time reflection of changes is referred to as *two-way editing*. Same application, two different editors.
