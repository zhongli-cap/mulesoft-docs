...
Flexible and reliable by design, Mule adjusts to the demands of an interconnected network of systems and applications. As you quickly learn from designing even the simplest Mule applications in Anypoint Studio, there is a plethora of components that can be used to transform and capture any information as a "Mule message" as Mule moves it to be processed from one flow component to the next. Practically event that Mule is aware of can be optimized according to business needs at every stage/component in a flow.
