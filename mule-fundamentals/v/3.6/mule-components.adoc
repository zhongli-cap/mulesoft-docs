...
[TIP]
*APIkit* offers a new and improved way of building a REST API. Access the link:/apikit/apikit[APIkit Documentation] to learn how to build REST APIs in a few hours or days.
...
* *NEXT STEP*: Read on about link:/mule-fundamentals/v/3.6/mule-transformers[transformers].
