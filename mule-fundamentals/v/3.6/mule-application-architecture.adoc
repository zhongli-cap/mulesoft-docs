...
* call various other link:/mule-fundamentals/v/3.6/flows-and-subflows[flows]  +

== See Also

* *NEXT STEP:* Learn about how link:/mule-fundamentals/v/3.6/flows-and-subflows[flows and subflows] work together in an application.
