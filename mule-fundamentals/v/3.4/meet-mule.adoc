...
|image:apiKit.png[apiKit] |*link:/anypoint-platform-for-apis/apikit[APIkit]* is an open-source, declarative toolkit specially designed to facilitate REST API design and development. Add the APIkit module to your instance of Studio.
