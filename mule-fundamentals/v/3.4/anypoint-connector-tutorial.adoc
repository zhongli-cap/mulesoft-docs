...
After learning some of the basic functionality in the link:/mule-fundamentals/v/3.4/basic-studio-tutorial[Basic] and link:/mule-fundamentals/v/3.4/content-based-routing-tutorial[Content-Based Routing Tutorials], it's time to try your hand at developing a more complex application which makes use of **Anypoint Connectors**.
...
This tutorial assumes that you have link:/mule-fundamentals/v/3.4/download-and-launch-mule-studio[downloaded and installed Mule Studio]. If you do not have any previous experience with Eclipse or an Eclipse-based IDE, please review the brief introduction to the link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Mule Studio interface] and the document describing link:/mule-fundamentals/v/3.4/global-elements[Global Elements in Mule]. Further, consider following the link:/mule-fundamentals/v/3.4/basic-studio-tutorial[Basic] and link:/mule-fundamentals/v/3.4/content-based-routing-tutorial[Content-based Routing] tutorials.
...
Launch Mule Studio and create a new Mule Project named `Connector Tutorial`. If you need more directions on launching Studio and creating a project, please refer to the link:/mule-fundamentals/v/3.4/basic-studio-tutorial[Basic Studio Tutorial]. 
...
Read more about link:/mule-fundamentals/v/3.4/global-elements[Global Elements in Mule].
...
* *NEXT STEP:* Learn how to link:/mule-fundamentals/v/3.4/starting-and-stopping-mule-esb[start and stop Mule] from the command line.
