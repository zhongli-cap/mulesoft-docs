...
This tutorial walks you through how to use Mule Studio to build a simple HTTP request-response application. After creating and running the example locally, you should be able to apply what you have learned to create link:/getting-started/content-based-routing[more complex applications].
...
* NEXT STEP: Continue the hands-on learning experience with the link:/getting-started/content-based-routing[Content-Based Routing].
