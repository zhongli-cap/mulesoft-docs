...
* Editor: enables a user to view and modify the graph of an application network. This permission must be configured for each business group to allow users within the business group to access Anypoint Visualizer.
