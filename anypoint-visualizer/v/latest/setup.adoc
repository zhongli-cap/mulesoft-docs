...
* Visualizer Editor: enables a user to view and modify the graph of an application network. This permission can only be assigned to withing the master organization.
