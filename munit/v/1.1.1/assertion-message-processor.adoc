...
All the message processors listed bellow can be used either to validate the Mule message after the production code runs, or as part of the MUnit link:/munit/v/1.1.1/spy-message-processor[Spy message processor].
