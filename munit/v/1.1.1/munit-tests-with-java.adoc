...
In this guide, we explain how to configure your suites and create your tests with Java code.
...
Currently only XML testing allows coverage, dynamic ports, and use of the Maven plugin.
...
NOTE: To test more than one configuration file, return each
