...
The domain is a mavenizable artifact and you can link:/anypoint-studio/v/6/enabling-maven-support-for-a-studio-project#mavenizing-an-existing-mule-project[mavenize it directly from Studio]. +
