...
application XML file. You can use several of the Mule top level elements such as link:/mule-user-guide/v/3.7/flows-and-subflows[flow, sub-flow], link:/mule-management-console/v/3.7/automating-tasks-using-scripts[scripts], etc.
