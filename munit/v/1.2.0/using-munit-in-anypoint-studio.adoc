...
[NOTE]
--
Since version 1.2.1, MUnit supports link:/munit/v/1.2.0/munit-for-domain-based-applications[testing for domain based applications].
--
...
=== Running a Tests inside a Folder
