...
[NOTE]
--
Since version 1.2.0, MUnit supports link:/munit/v/1.2.1/munit-domain-support[testing for domain based applications].
--
...
The *Coverage* button in the image above allows you to see which flows, and the percentage of message processors in those flows that were covered by the test:
