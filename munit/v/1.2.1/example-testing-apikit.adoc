...
The new RAML scaffolder bundled in MUnit 1.2.1 generates external files located in `src/test/resources/scaffolder` based on the requests and responses examples in the API definition.
