...
Based on link:/quickstarts/_attachments/t-shirt.raml[complete t-shirt API definition], the MUnit's scaffolder automatically creates the following test Suite:
...
[NOTE]
--
While link:/munit/v/1.2.1/munit-coverage-report[app coverage] is a measure of quality based on how much of your application runs as a result of your test being executed, RAML (API) coverage refers to how many cases your RAML definition has and how many are being tested.
