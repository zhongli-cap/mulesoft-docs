...
To upgrade to MUnit 1.2.1, you mostly need to modify the `pom.xml` file.
...
MUnit 1.2.1 requires only the following artifacts:
...
MUnit 1.2.1 requires the following properties in the `pom.xml` file:
