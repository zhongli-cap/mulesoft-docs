...
The following section covers how to configure link:/munit/v/1.2.1/munit-coverage-report[MUnit Coverage].
...
To enable link:/munit/v/1.2.1/munit-coverage-report[MUnit Coverage], add the following configuration to the MUnit Plugin:
...
As we've shown before by default, link:/munit/v/1.2.1/munit-coverage-report[MUnit Coverage] shows summary report in the console. But that's not the only option.
