...
NOTE: For information on redirecting logs to a file, see link:/munit/v/1.3.0/logging-in-munit#redirecting-logs-to-a-file[Logging in MUnit].
...
To learn how to configure the plugin, follow our link:/munit/v/1.3.0/munit-maven-plugin-configuration[Maven Plugin configuration guide]. +
Usage specifics can be found at the link:/munit/v/1.3.0/munit-maven-plugin[MUnit Maven Plugin documentation].
