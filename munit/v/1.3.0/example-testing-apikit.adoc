...
[NOTE]
--
While link:/munit/v/1.3.0/munit-coverage-report[app coverage] is a measure of quality based on how much of your application runs as a result of your test being executed, RAML (API) coverage refers to how many cases your RAML definition has and how many are being tested.
...
Learn how to work with domains link:/munit/v/1.3.0/munit-domain-support[here].
