...
The MUnit Maven Plugin also offers a set of configurations that you can tune. Learn how to configure such parameters in the link:/munit/v/1.3.1/munit-maven-plugin-configuration[reference documentation].
...
[NOTE]
Since MUnit 1.3.1 the test suites run in a new JVM, providing a set of additional features
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <properties>
        <munit.version>1.3.1-SNAPSHOT</munit.version>
    </properties>
