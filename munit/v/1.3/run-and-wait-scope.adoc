...
If you choose to link:https://docs.mulesoft.com/anypoint-studio/v/6/enabling-maven-support-for-a-studio-project[mavenize] your project, Studio will notify you that the Synchronize module dependency will be added.
