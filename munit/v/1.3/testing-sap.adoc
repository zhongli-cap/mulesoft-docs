...
The SAP connector requires a set of specific libraries which are listed in the link:https://docs.mulesoft.com/mule-user-guide/v/3.8/sap-connector#requirements[SAP Connector requirements] documentation. These libraries need to be added manually in order to test the SAP-based application correctly.
...
[TIP]
--
This process is also described in the link:https://docs.mulesoft.com/mule-user-guide/v/3.8/sap-connector-troubleshooting#solution[SAP Connector documentation].
--
+
