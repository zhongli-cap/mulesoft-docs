= About Mock Event Processor
:version-info: 2.0 and later
:keywords: munit, testing, unit testing

The Mock Event Processor allows you to mock an Event Processor when it matches the defined Mock Event Processor name and attributes.
