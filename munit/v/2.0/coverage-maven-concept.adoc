...
Since MUnit 2.x, the coverage report goal is properly integrated with the maven reporting section. This means that when adding the MUnit Maven Plugin to the reporting section of the pom:
...
Coverage Reports is generated during Maven's site lifecycle. +
