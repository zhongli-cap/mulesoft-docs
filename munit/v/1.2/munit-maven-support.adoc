...
NOTE: For information on redirecting logs to a file, see link:/munit/v/1.2/logging-in-munit#redirecting-logs-to-a-file[Logging in MUnit].
...
TIP: If you are using Anypoint Studio, Maven integration is already solved for you. See link:https://docs.mulesoft.com/anypoint-studio/v/6/using-maven-in-anypoint-studio[Using Maven in Anypoint Studio] for details.
...
The following section covers how to configure link:/munit/v/1.2/munit-coverage-report[MUnit Coverage].
...
To enable link:/munit/v/1.2/munit-coverage-report[MUnit Coverage], add the following configuration to the MUnit Plugin:
