...
The MUnit Coverage Module unit of measure is the link:https://docs.mulesoft.com/mule-user-guide/v/3.8/mule-concepts#message-processors[message processor]. +
