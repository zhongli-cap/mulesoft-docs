...
MUnit has a set of dedicated link:https://docs.mulesoft.com/mule-user-guide/v/3.8/mule-concepts#message-processors[message processors] aimed to validate, assert and mock the content and status of the Mule message so you can run automatic tests against your Mule application.
