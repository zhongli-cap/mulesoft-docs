...
[NOTE]
--
Since version 1.2.0, MUnit supports link:/munit/v/1.2/munit-domain-support[testing for domain based applications].
--
...
You can run link:/munit/v/1.2/munit-coverage-report[coverage reports] in Studio.
...
You can debug MUnit tests just like Studio applications, using Studio's debugging perspective (for details on the debugging UI, see link:https://docs.mulesoft.com/anypoint-studio/v/5/studio-visual-debugger[Studio Visual Debugger]).
