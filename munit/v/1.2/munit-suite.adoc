...
application XML file. You can use several of the Mule top level elements such as link:https://docs.mulesoft.com/mule-user-guide/v/3.8/flows-and-subflows[flow, sub-flow], link:/mule-management-console/v/3.8/automating-tasks-using-scripts[scripts], etc.
