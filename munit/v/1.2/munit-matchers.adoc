...
NOTE: MUnit matchers are _always_ used in combination with the link:/munit/v/1.2/mock-message-processor[Mocks], link:/munit/v/1.2/spy-message-processor[Spy], link:/munit/v/1.2/verify-message-processor[Verify] and link:/munit/v/1.2/assertion-message-processor[Assert] message processors, but never on their own.
