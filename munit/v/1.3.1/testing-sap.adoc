...
One way of adding the libraries to the classpath is using the link:/munit/v/1.3.1/munit-maven-plugin-configuration#additional-classpath-elements[additionalClasspathElements] parameter in the maven plugin. +
...
To accomplish this, you can use the link:/munit/v/1.3.1/munit-maven-plugin-configuration#additional-argument-lines[argLine] parameter to add the additional vm argument.
...
[CAUTION]
The mentioned Maven Plugin configuration parameters are available since MUnit 1.3.1
