...
Depending on the execution context, the value of system properties may vary. Thus, when referencing to these properties, it is a good practice to override their value in order to enforce test reproducibility. 
