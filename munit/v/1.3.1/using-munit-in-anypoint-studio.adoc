...
[NOTE]
--
Since version 1.2.0, MUnit supports link:/munit/v/1.3.1/munit-domain-support[testing for domain based applications].
--
...
You can run link:/munit/v/1.3.1/munit-coverage-report[coverage reports] in Studio.
