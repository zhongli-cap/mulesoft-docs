...
To learn how to configure the plugin, follow our link:/munit/v/1.3.1/munit-maven-plugin-configuration[Maven Plugin configuration guide]. +
Usage specifics can be found at the link:/munit/v/1.3.1/munit-maven-plugin[MUnit Maven Plugin documentation].
