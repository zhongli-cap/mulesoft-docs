...
For information, see link:https://docs.mulesoft.com/mule-user-guide/v/3.5/datasense[DataSense], link:/anypoint-connector-devkit/v/3.5/adding-datasense[Adding DataSense], and link:/anypoint-connector-devkit/v/3.5/adding-datasense-query-language[Adding DataSense Query Language]
