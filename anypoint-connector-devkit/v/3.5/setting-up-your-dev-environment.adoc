...
If you have not already installed Anypoint Studio, follow the link:/mule-user-guide/v/3.5/installing[detailed instructions] to install. For a quick introduction to Anypoint Studio, review link:/anypoint-studio/v/5/basic-studio-tutorial[Anypoint Studio Essentials].
