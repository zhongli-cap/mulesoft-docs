...
* Once you add all required operations to your connector, develop tests, and finish documenting them, move on to link:/anypoint-connector-devkit/v/3.5/packaging-your-connector-for-release[packaging your connector for release].
