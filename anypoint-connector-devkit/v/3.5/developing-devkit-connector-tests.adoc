...
Also, update XML schemas and namespaces. See the link:https://docs.mulesoft.com/mule-user-guide/v/3.5/vm-transport-reference[VM endpoint documentation] for details.
