...
You must also arrange access to the API.  The process is specific to each API provider and the typical steps for this process are described in link:/anypoint-connector-devkit/v/3.5/setting-up-your-api-access[Setting up your API access]. 
...
[TIP]
For more information on configuring an *HTTPS connector,* consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.5/https-transport-reference[HTTPS Transport Reference].
