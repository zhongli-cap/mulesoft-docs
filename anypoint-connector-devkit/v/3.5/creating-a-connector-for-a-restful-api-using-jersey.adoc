...
This document assumes you are familiar with RESTful Web services, and have some understanding of Jersey. You can find useful background on Jersey in the link:https://jersey.java.net/documentation/1.6/user-guide.html[Jersey User Guide].
...
* Refine the appearance of the connector dialog boxes and XML element, as described in link:/anypoint-connector-devkit/v/3.5/defining-connector-attributes#customizing-attributes-look-and-feel[Defining Connector Attributes - Customizing Attributes look and feel]. 
