...
. Install link:http://www.oracle.com/technetwork/java/javase/archive-139210.html[JDK 6 or 7]
...
|link:/anypoint-connector-devkit/v/3.5/basic-auth[Basic Auth] |The simplest mode of authentication, often used with SOAP web services.
...
. Create an instance of link:https://docs.mulesoft.com/mule-user-guide/v/3.7/functional-testing[FunctionalTestCase] that runs the test. For DevKit testing, you run Mule inside a JUnit test case. Each test case you build will extend the class link:https://docs.mulesoft.com/mule-user-guide/v/3.7/functional-testing[FunctionalTestCase] (a subclass of JUnit). The test case manages the lifecycle of a Mule runtime instance and calls flow to carry out the test.
