...
For example the https://github.com/mulesoft/salesforce-connector[SalesForce Cloud Connector] supports the SalesForce Streaming API in which users can subscribe to topics and receive notifications when a new event related to that topic happens.
...
To see a full working example of using streaming APIs follow this link:https://github.com/mulesoft/salesforce-connector/blob/master/examples/salesforce-to-freshbooks-app/[link]. This application uses link:https://github.com/mulesoft/salesforce-connector[SalesForce Cloud Connector] and link:https://github.com/mulesoft/freshbooks-connector[FreshBooks Cloud Connector].
