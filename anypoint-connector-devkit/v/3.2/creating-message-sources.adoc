...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/message-sources-and-message-processors#message-sources[Message Sources]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/message-sources-and-message-processors#message-processors[Message Processors]
