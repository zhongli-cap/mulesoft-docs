...
Consult Mule ESB's link:https://docs.mulesoft.com/mule-user-guide/v/3.3/https-transport-reference[*HTTPS Transport*] documentation for more detail on how to configure an HTTPS connector.
