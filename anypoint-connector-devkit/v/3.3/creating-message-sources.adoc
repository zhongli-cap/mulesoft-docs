...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/message-sources-and-message-processors[Message Processors]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.3/message-sources-and-message-processors[Message Sources]
