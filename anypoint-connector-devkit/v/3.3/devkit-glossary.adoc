...
* DevKit: annotation processing tool that increases developer productivity by automatically generating a lot of the boiler plate code andXMLrequired for writing Mule modules. The DevKit enables you to build modules from "plain old Java objects" (POJOs).
