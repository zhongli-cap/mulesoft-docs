...
For OAuth-based authentication DevKit provides functionality using OAuth-related annotations. See link:/anypoint-connector-devkit/v/3.6/oauth-v1[OAuth V1] and link:/anypoint-connector-devkit/v/3.6/oauth-v2[OAuth V2] for details.
