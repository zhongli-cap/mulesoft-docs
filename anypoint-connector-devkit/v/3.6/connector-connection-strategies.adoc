...
This document assumes you are familiar with the link:/anypoint-connector-devkit/v/3.6/_fixed[Anypoint Connector DevKit] and you are ready to implement authentication on your connector. You should also be familiar with link:/anypoint-connector-devkit/v/3.6/authentication-methods[authentication methods].
