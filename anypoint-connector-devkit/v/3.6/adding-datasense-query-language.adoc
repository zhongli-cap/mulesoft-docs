...
* Familiarity with Anypoint Connectors, link:https://docs.mulesoft.com/mule-user-guide/v/3.6/datasense[DataSense], link:https://docs.mulesoft.com/mule-user-guide/v/3.6/datasense-query-editor[DataSense Query Editor], and link:/anypoint-connector-devkit/v/3.6/adding-datasense-query-language[Adding DataSense Query Language] from a user level.
* Understand Java "@" annotations. See link:/anypoint-connector-devkit/v/3.6/annotation-reference[Annotation Reference].
* Experience with implementing a basic connector with link:/anypoint-connector-devkit/v/3.6/[Anypoint DevKit].
