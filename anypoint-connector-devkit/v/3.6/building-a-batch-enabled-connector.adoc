...
This document explains how you can leverage your own connector to take advantage of this feature introduced in the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/batch-processing[Batch Processing] documentation.
