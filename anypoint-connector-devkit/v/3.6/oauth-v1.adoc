...
[NOTE]
For more information on configuring an *HTTPS connector,* see the link:https://docs.mulesoft.com/mule-user-guide/v/3.6/https-transport-reference[HTTPS Transport Reference] and link:https://docs.mulesoft.com/mule-user-guide/v/3.6/tls-configuration#examples-for-https[Examples for HTTPS].
