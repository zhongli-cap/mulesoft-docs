...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/http-transport-reference[HTTPS Transport Reference]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/tls-configuration#examples-for-https[HTTPS Examples]
