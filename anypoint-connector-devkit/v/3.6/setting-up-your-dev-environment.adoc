...
If you have not already installed Anypoint Studio, follow the link:/mule-user-guide/v/3.6/installing[detailed instructions] to install. For a quick introduction to Anypoint Studio, review link:/mule-user-guide/v/3.6/anypoint-studio-essentials[Anypoint Studio Essentials].
