...
. link:https://developer.salesforce.com/signup[Register for a Salesforce account]. You need to provide an email address to receive a confirmation email.
...
*NEXT:* Continue to link:/anypoint-connector-devkit/v/3.6/creating-an-anypoint-connector-project[Creating an Anypoint Connector Project] to begin developing your connector.
