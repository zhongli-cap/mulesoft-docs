...
This document assumes you are familiar with the link:/anypoint-connector-devkit/v/3.6/[Anypoint Connector DevKit] and you have already covered the connector's link:/anypoint-connector-devkit/v/3.6/authentication[authentication] methods.
