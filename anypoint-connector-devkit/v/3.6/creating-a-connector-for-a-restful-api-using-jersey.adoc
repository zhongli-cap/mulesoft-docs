...
* This sample implements OAuth1 authentication. Find a more detailed discussion of implementing OAuth1 support (with reference to the same sample code) in link:/anypoint-connector-devkit/v/3.6/oauth-v1[OAuth V1]. Implementing OAuth2 support is similar; see link:/anypoint-connector-devkit/v/3.6/oauth-v2[OAuth V2] for more details.
...
image:devkit-connector-jersey.png[devkit-connector-jersey]
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <properties>
      ...
      <jersey.client.version>${jersey.client.version}</jersey.client.version>
      <jersey.multipart.version>${jersey.multipart.version}</jersey.multipart.version>
  </properties>
...
* The use of `@Optional` and `@Default` with `@Configurable`. For more on these annotations, see link:/anypoint-connector-devkit/v/3.6/defining-connector-attributes[Defining Connector Attributes] and link:/anypoint-connector-devkit/v/3.6/annotation-reference[Annotation Reference].
...
For a detailed discussion on the code changes required for OAuth support, seelink:/anypoint-connector-devkit/v/3.6/oauth-v1[Implementing OAuth 1.0 Authentication], which references the same code sample used in this discussion.
...
The process is described in link:/anypoint-connector-devkit/v/3.6/installing-and-testing-your-connector-in-studio[Installing and Testing Your Connector]. 
...
image:rest-jersey-operation.png[rest-jersey-operation]
...
* Add tests to your test suite as described in link:/anypoint-connector-devkit/v/3.6/developing-devkit-connector-tests[Developing DevKit Connector Tests]. 
