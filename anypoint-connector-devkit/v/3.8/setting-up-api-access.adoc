...
** Consumer key
** Consumer secret
. For detailed instructions on creating an application on the Twitter platform, see link:/quickstarts/anypoint-connector#obtaining-access-to-the-twitter-api[Configure Twitter for API Access].
