...
** Consumer key
** Consumer secret
. For detailed instructions on creating an application on the Twitter platform, see link:/mule-user-guide/v/3.8/anypoint-connector-tutorial#obtaining-access-to-the-twitter-api[Configure Twitter for API Access].
