...
If you have not already installed Anypoint Studio, follow the link:https://docs.mulesoft.com/mule-user-guide/v/3.7/installing[detailed instructions] to install. For a quick introduction to Anypoint Studio, review link:https://docs.mulesoft.com/anypoint-studio/v/5/index[Anypoint Studio Essentials].
