...
* NEXT: Continue to link:/anypoint-connector-devkit/v/3.8/adding-datasense[Add DataSense] to your Connector.
* Learn how to link:/anypoint-connector-devkit/v/3.8/developing-devkit-connector-tests[Test Your Connector].
