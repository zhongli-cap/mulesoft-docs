...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.7/http-connector-reference[HTTPS Connector Reference]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.7/tls-configuration[HTTPS Examples]
