...
[IMPORTANT]
The *DevKit version number* does not correspond to the Mule version. All DevKit versions since DevKit 3.5 are backward-compatible with Mule versions from Mule 3.5.3. Hence *DevKit 3.8* works with *Mule 3.5.3 onward*.
