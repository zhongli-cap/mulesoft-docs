...
[NOTE]
====
Anypoint Connector DevKit 3.9 is the latest major version. Requirements and suggestions for writing connector code using DevKit have not changed since version 3.8.
