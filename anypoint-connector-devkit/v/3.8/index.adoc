...
The *MuleSoft's Anypoint Connector DevKit*, or simply *DevKit*, enables the development of link:/mule-user-guide/v/3.8-m1/anypoint-connectors[Anypoint Connectors]. An *Anypoint Connector* is an extension module to the MuleSoft Anypoint Platform that facilitates communication between third-party systems/APIs and Mule applications.
