...
This document assumes that you are familiar with the connector architecture presented in link:/anypoint-connector-devkit/v/3.8[Anypoint Connector DevKit], and that you are familiar with link:/anypoint-studio/v/5/datasense[DataSense] from an end-user's perspective.
