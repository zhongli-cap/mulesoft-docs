...
You can specify configurable fields (using `@Configurable`) inside your Connector Configuration classes, or as parameters of @Processor methods inside a @Connector.
