...
----
+
. Enter your `mule-cookbook` directory and run the following Maven command:
+
[source,bash,linenums]
----
...
[INFO] ------------------------------------------------------------------------
////
. When done, open Anypoint Studio, import the root project as an existing project. *File* > *Import* > *General* > *Existing Projects into Workspace*.

== Cookbook Description

Cookbook is a web service to help users organize ingredients and recipes for dishes they might like to access, store and update from the web.
