...
*Important:* To build connector projects, you must first install the link:/anypoint-connector-devkit/v/3.8/setting-up-your-dev-environment[Anypoint Connector DevKit Plugin] into Anypoint Studio.
