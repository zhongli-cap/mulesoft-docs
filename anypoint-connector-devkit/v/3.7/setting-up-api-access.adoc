...
** Consumer key
** Consumer secret
. For detailed instructions on creating an application on the Twitter platform, see link:/anypoint-connector-devkit/v/3.7/setting-up-api-access#twitter-example[Configure Twitter for API Access].
