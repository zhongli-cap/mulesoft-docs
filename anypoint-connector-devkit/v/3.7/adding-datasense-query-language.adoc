...
* Familiarity with Anypoint Connectors, link:/anypoint-studio/v/5/datasense[DataSense], link:/anypoint-studio/v/5/datasense-query-editor[DataSense Query Editor], and link:/anypoint-connector-devkit/v/3.7/adding-datasense-query-language[Adding DataSense Query Language] from a user level.
* Understand Java "@" annotations. See link:/anypoint-connector-devkit/v/3.7/annotation-reference[Annotation Reference].
