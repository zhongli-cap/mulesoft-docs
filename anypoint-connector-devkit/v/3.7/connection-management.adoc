...
The specific implementation of these methods depends on the target. For more information on annotations, see the link:/anypoint-connector-devkit/v/3.7/annotation-reference[Annotation Reference].
