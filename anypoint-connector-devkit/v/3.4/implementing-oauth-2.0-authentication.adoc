...
[TIP]
For details on configuring an *HTTPS connector*, consult the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/https-transport-reference[HTTPS Transport Reference].
