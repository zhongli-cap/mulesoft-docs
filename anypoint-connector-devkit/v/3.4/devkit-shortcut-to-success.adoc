...
. Create an instance of link:https://docs.mulesoft.com/mule-user-guide/v/3.4/functional-testing[FunctionalTestCase] that runs the test. For DevKit testing, you run Mule inside a JUnit test case. Each test case you build will extend the class link:https://docs.mulesoft.com/mule-user-guide/v/3.4/functional-testing[FunctionalTestCase]  (a subclass of JUnit). The test case manages the lifecycle of a Mule runtime instance and calls flows to carry out the test. 
