...
For details on Mule class loading, including class overrides and blocking, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/classloader-control-in-mule[Classloader Control in Mule].
