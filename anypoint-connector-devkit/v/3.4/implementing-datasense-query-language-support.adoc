...
* You have familiarity with Anypoint Connectors, link:/mule-user-guide/v/3.4/mule-datasense[Mule DataSense,] and link:https://docs.mulesoft.com/anypoint-studio/v/5/datasense-query-language[DataSense Query Language] from a user level.
