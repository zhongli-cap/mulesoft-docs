...
* You should be familiar with RESTful Web services. 
* You have some understanding of Jersey. See the http://repo1.maven.org/maven2/com/sun/jersey/jersey-documentation/1.6/jersey-documentation-1.6-user-guide.pdf[Jersey 1.6 User Guide] for more information.   
...
* This example uses the common 1.x branch of Jersey. Mule uses Jersey v1.6 for details where needed.
...
The sample connector used in this discussion connects to DropBox's Core API]. Find the connector source code on https://github.com/mulesoft/devkit-documentation-rest-jersey[GitHub REST Jersey documentation].
...
The client class builds on functionality provided by the Jersey Client. See the http://repo1.maven.org/maven2/com/sun/jersey/jersey-documentation/1.6/jersey-documentation-1.6-user-guide.pdf[Jersey 1.6 User Guide] for more information. 
...
See the http://repo1.maven.org/maven2/com/sun/jersey/jersey-documentation/1.6/jersey-documentation-1.6-user-guide.pdf[Jersey 1.6 User Guide] for more information. 
