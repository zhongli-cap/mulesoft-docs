...
This page assumes general knowledge of Mule ESB, as provided in link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-fundamentals[Mule Fundamentals]. As DevKit uses Java annotations extensively to integrate your Java connector code with Mule, this document assumes you are familiar with Java's annotations mechanisms. Further, it assumes you have general familiarity with the role of Anypoint Connectors and DevKit, as described in link:/anypoint-connector-devkit/v/3.4[Anypoint Connector DevKit].
