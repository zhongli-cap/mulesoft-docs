...
[NOTE]
Connectors built with DevKit 3.9 support specification of examples in a different format. See the new specification and generation format at https://docs.mulesoft.com/anypoint-connector-devkit/v/3.9/connector-reference-documentation[Connector Reference Documentation].
