...
Before developing a connector you should have a working knowledge of link:https://docs.mulesoft.com/getting-started/index[Mule], link:https://docs.mulesoft.com/anypoint-studio/v/6/download-and-launch-anypoint-studio[Anypoint Studio], and Java development in general, specifically the use of https://docs.oracle.com/javase/tutorial/java/annotations/basics.html[Java annotations].

[NOTE]
====
For information on software setup and DevKit, see link:/anypoint-connector-devkit/v/3.9/setting-up-your-dev-environment[Setting Up Your Development Environment] and link:/anypoint-connector-devkit/v/3.9/index[Anypoint Connector DevKit].
...
. Run the link:/anypoint-connector-devkit/v/3.9/creating-a-java-sdk-based-connector#generating-sources[Generate Sources] Action.
+
...
[NOTE]
Connectors built with DevKit 3.9 support specification of examples in a different format. See the new specification and generation format at link:https://docs.mulesoft.com/anypoint-connector-devkit/v/3.9/connector-reference-documentation[Connector Reference Documentation].
...
. Create a Mule application in Studio and add an HTTP listener and specify `/get-recently` for the path. If this is your first Mule app, take a look at our link:https://docs.mulesoft.com/getting-started/build-a-hello-world-application[Hello World Application].
...
* The full link:/anypoint-connector-devkit/v/3.9/developing-devkit-connector-tests[testing documentation].
...
* See documentation on setting up link:/anypoint-connector-devkit/v/3.9/authentication[Authentication] using DevKit.
...
* link:/anypoint-connector-devkit/v/3.9/authentication[Authentication] documentation.
