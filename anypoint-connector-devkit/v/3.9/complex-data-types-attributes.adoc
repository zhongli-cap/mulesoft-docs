...
* NEXT: Continue to link:/anypoint-connector-devkit/v/3.9/adding-datasense[Add DataSense] to your Connector.
* Learn how to link:/anypoint-connector-devkit/v/3.9/developing-devkit-connector-tests[Test Your Connector].
