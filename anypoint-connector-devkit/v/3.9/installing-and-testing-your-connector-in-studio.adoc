...
This document assumes you have link:/anypoint-connector-devkit/v/3.9/creating-an-anypoint-connector-project[created a connector project]. 
...
For more information about how to package your connector, check link:/anypoint-connector-devkit/v/3.9/packaging-your-connector-for-release[Packaging Your Connector for Release].
...
* *NEXT STEP:* Implement link:/anypoint-connector-devkit/v/3.9/authentication[authentication] on your connector.
