...
. link:/anypoint-connector-devkit/v/3.9/connector-attributes-and-operations[Choose the connector's data model] - Models can be static Java objects or dynamic objects. You can use link:https://docs.mulesoft.com/anypoint-studio/v/5/datasense[DataSense] - Determine what information the target resource expects.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.9/anypoint-connectors[Anypoint Connectors]
