...
More details can be found in link:/anypoint-connector-devkit/v/3.9/defining-connector-attributes[Defining Connector Attributes]. 
...
More details can be found in Static Data Model & Dynamic Data Model Examples in this document about link:/anypoint-connector-devkit/v/3.9/adding-datasense[Adding DataSense].
...
* *NEXT:* Continue to link:/anypoint-connector-devkit/v/3.9/defining-connector-attributes[Defining Connector Attributes].
