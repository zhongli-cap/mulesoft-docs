...
* Installed the Anypoint Connector DevKit Plugin as described in  link:/anypoint-connector-devkit/v/3.9/creating-an-anypoint-connector-project[Creating an Anypoint Connector Project]
* Are familiar with link:https://docs.mulesoft.com/anypoint-studio/v/5/index[Anypoint Studio]
...
After you complete your test suite, you can  link:/anypoint-connector-devkit/v/3.9/connector-reference-documentation[generate complete documentation and samples] for your connector.
