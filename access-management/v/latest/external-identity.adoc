...
Optionally, you can configure an <<External Oauth 2.0 Provider,External Oauth 2.0 service provider>> to delegate authorization for third-party applications.
