...
[TIP]
When integrating an External Identity Management system with Anypoint Platform, the "invite" button for inviting users to your organization is disabled. +
You may add new users to your organisation by adding them to your external identity management solution as per your normal internal provisioning process.
