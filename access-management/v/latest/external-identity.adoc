...
External identity applies to the entire organization and all business groups. User management and client management can not be set different for different business groups; the settings are global to your organization.
