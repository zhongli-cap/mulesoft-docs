...
Below are the list of providers which we have actively tested against :
* PingFederate
* OpenAM
* Okta
* Salesforce
...
Below are the list of providers which we have got reports of them working from our customers.:
* Shibboleth
* onelogin
* CA Single Sign-On
* SecureAuth
