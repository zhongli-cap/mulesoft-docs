...
If you want to use one of your existing accounts, consider the instructions below to understand the implications of migrating an account.
...
After selecting this account and entering your password, you are asked to confirm your decision:
...
After entering your password and clicking the *Sign In* button, if there are no other members in the organization you own, you are presented with a warning that all associations to the existing organization will be lost, and the organization left behind is deleted. +
