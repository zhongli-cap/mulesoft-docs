= Audit Logging
:keywords: anypoint platform, configuring, logs, auditing, test
...
[TIP]
Currently, audit logs persist indefinitely. +
This is likely to change in the near future so customers are advised to download logs periodically.
