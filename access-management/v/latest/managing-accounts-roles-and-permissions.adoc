...
. *Product Permissions*
:: Default permissions for each Anypoint Platform product (Runtime Manager, Data Gateway, etc) are environment specific – they grant you the ability to do something within a particular environment, but not to the entire organization
. *API Permissions*
