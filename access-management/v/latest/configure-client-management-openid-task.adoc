...
If you attempt to update a client application under Open ID Connect management, the following error occurs: `There was an error while talking to CoreServices` plus an error code.
