...
[CAUTION]
--
If the only permissions associated with your role are:

* *Portal Viewer* and/or *Exchange Viewer*
* *Portal Viewer* and/or *Application Owner*.

Users belonging to this role won´t have access to the organization's support portal.
--
