...
The scripts you run and the values of the `role` parameter depend on the type installation you are performing:
...
| |`gravity install` on 1 node |`flavor=three` |`role=data_node`
