= To Migrate to Anypoint Platform Private Cloud Edition, Version 1.6.0 to 1.6.1

This topic provides information about upgrading to Anypoint Platform Private Cloud Edition. This procedures are applicable to 3 and 6 node installations only.
...
. Obtain the `anypoint-1.6.0-installer.tar.gz` archive from your customer support representative.
...
. Navigate to the `anypoint-1.6.0` directory, then run the upload script.
+
----
sudo ./upload
----
