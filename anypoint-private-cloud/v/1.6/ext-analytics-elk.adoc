...
After installing Filebeat and Elastic Search, you must configure Kibana to be able to consume data from Anypoint Platform.
...
+
You must create an Elastic Search index for the Anypoint Platform data.
