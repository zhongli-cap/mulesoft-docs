= To Export Business and API Data to ELK (BETA)

*_The feature described in this topic is currently in BETA_*

This topic describes how to analize business data and API analytics using the Elastic Stack (ELK). This topic describes how to use Filebeat to process Anypoint Platform log files and insert them into an Elastic Search database. Once the files are in Elastic Search, you can view them in Kibana.
...
== Configure Kibana and Import the Mule Charts

. Configure and Index Pattern
+
In your Kibana installation, configure the following index patter:
+
----
mule-*
----

. Download the Mule Kibana charts from the following URL:
+
----
URL TO BE ADDED
----
+
This file contains a default dashboard, search, and visualization charts that you can use to analyze Anypoint Platform data.

. Import each of the charts into you Kibana installation.

== Install the Elastic Search Geoip and Agent Modules

You must install the following modules in  your Elastic Search database:
