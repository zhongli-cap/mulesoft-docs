...
** link:/anypoint-private-cloud/v/1.6/upgrade[To Migrate to Anypoint Platform Private Cloud Edition, Version 1.6.0]
** link:/anypoint-private-cloud/v/1.6.1/upgrade-1.6.1[To Migrate to Anypoint Platform Private Cloud Edition, Version 1.6.1]
