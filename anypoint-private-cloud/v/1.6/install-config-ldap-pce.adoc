...
+
1. Enter the connection settings for your LDAP service:
+
...
1. Set the distinguished names for your user and group
+
[%header%autowidth.spread]
|===
| Property | Description
...
1. Specify the user field mappings
+
[%header%autowidth.spread]
|===
| Property | Description
...
1. Map the group field mappings
+
[%header%autowidth.spread]
|===
| Property | Description
