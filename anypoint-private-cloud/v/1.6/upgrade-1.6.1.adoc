...
----
+
You may have to run this command on each node of your cluster. The node that returns the output above is the master node.
...
+
You must pass the nodename for each node.
+
----
