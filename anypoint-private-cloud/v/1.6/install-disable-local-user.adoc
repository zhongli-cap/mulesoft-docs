...
----
+
This command changes the owner from the default system user to a new user managed by the external authentication provider. The command you issues should be similar to the follwoing example:
+
----
