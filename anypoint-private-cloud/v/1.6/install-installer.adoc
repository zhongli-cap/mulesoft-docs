...
1. Download the `anypoint-1.6.0-installer.tar.gz` installation package from the support portal.
...
+
For your devices, you can either leave the default settings, or you can set up your own. Ensure that on each of your nodes, both devices are configured with enough space.
...
* link:/anypoint-private-cloud/v/1.6/system-requirements#supported-top[Supported Network Topologies]
* link:/access-management/organization[Organizations]
* link:/anypoint-private-cloud/v/1.6/demo-ldap-server[Demo LDAP Server]
* link:/anypoint-private-cloud/v/1.6/system-requirements#device-requirements[Device Requirements]