...
*** link:/anypoint-private-cloud/v/1.7/upgrade-1.7.1[To Migrate Anypoint Platform Private Cloud Edition, Version 1.5.x to 1.7.1]
*** link:/anypoint-private-cloud/v/1.7.1/upgrade-1.7.0-1.7.1[To Migrate Anypoint Platform Private Cloud, Version 1.7.0 to 1.7.1]
*** link:/anypoint-private-cloud/v/1.7.1/upgrade-1.7.0-1.7.1-one-node[To Migrate Anypoint Platform Private Cloud Edition, Version 1.7.0 to 1.7.1 (One Node)]