...
[WARNING]
During the update process, there may be some downtime as each node is upgraded. Also, any users who are currently sign in may be logged off.
...
1. Move to the directory where you unzipped this archive, then run the following command:
+
----
sudo ./upload
----
