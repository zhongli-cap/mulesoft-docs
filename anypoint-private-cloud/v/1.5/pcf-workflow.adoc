...
+
[WARNING]
To install Anypoint Platform Private Cloud Edition, contact your MuleSoft customer success representative to obtain a license and 
+
After installing the Anypoint Platform Private Cloud Edition, you must contact your MuleSoft customer success representative to obtain a PCF-specific license. This license is required to install the Anypoint Platform Service Brokers for PCF in the next step.
+
