= To Migrate to the Current Version of Anypoint Platform Private Cloud Edition

This topic describes how to migrate to Anypoint Platform Private Cloud Edition version 1.5.2.
...
* Enable TCP ports `5973`, `3022`, `7373` intra-node to allow communication to the database cluster.
