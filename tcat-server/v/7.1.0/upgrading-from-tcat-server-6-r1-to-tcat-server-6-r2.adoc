...
You must install the new LDAP JAR into the Console webapp as described in link:/tcat-server/v/7.1.0/integrating-with-ldap[Enabling Authentication Through LDAP].
