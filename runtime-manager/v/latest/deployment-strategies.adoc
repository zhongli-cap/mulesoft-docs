...
[TIP]
See link:/runtime-manager/developing-a-cloudhub-application[Developing a CloudHub Application], which illustrates the differences between apps destined for cloud and on-premises deployments, and shows some best practices for developing applications for CloudHub.
