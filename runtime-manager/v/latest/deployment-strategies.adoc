...
[TIP]
See link:/runtime-manager/developing-applications-for-cloudhub[Developing Applications for CloudHub] for best practices on how to handle properties on a CloudHub application.
