= Deploying Mule Applications in Runtime Manager

Runtime Manager enables you to deploy your Mule applications to Mule runtime instances in multiple ways. The method you choose depends on your Mule runtime server topology. 

[%header]
|===
| Runtime Manager Location |App Deployment Target
| Anypoint Platform |link:/runtime-manager/deploying-to-cloudhub[CloudHub]
| Anypoint Platform |link:/runtime-manager/deploying-to-your-own-servers[Hybrid Deployment]
| Anypoint Platform Private Cloud Edition | link:/runtime-manager/deploying-to-your-own-servers[Customer-managed Mules]
| Anypoint Platform Private Cloud Edition | link:http://docs.pivotal.io/pivotalcf/1-8/installing/pcf-docs.html[Pivotal Cloud Foundry]
|===
