...
Runtime Manager allows you to deploy your Mule applications to Mule runtime instances in several ways, depending on your Mule runtime server topology:

[%header]
|===
|Runtime Manager Location |Deployment Target
...
|link:/runtime-manager/deploying-to-pcf[Pivotal Cloud Foundry]; see also link:http://docs.pivotal.io/pivotalcf/1-8/installing/pcf-docs.html[Pivotal Cloud Foundry Installation Docs]
|===
