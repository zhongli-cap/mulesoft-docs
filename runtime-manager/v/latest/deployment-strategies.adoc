...
* image:logo-server-active.png[link="/runtime-manager/deploying-to-your-own-servers", title="Anypoint Platform On-Premises"] An *On-premises* edition of Runtime Manager to an *on-premises server* that runs an instance of Mule runtime
