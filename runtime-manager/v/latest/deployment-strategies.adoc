...
This packaging of the anypoint platform is currently lacking some <<Dashboards>>, <<Insights>>, as well as some of the <<Alerts and Notifications, alerts>> that are available in other deployment modalities. Future releases will bridge those gaps further.
