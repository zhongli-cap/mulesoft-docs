...
|image:logo-server-active.png[link="/runtime-manager/deploying-to-your-own-servers", title="Anypoint Platform On-Premises"] |*Anypoint Platform On-Premises* edition of Runtime Manager

* image:logo-server-active.png[link="/runtime-manager/deploying-to-your-own-servers", title="Anypoint Platform Private Cloud Edition"] A link:/anypoint-platform-private-cloud-edition/[*Private Cloud* edition] of Runtime Manager to an *on-premises server* that has Mule runtime.
+
link:/runtime-manager/deploying-to-your-own-servers[_See deployment instructions_]

* image:logo-pcf-active.png[link="/runtime-manager/deploying-to-pcf", title="Pivotal Cloud Foundry"] A link:/anypoint-platform-private-cloud-edition/[*Private Cloud* edition] of Runtime Manager to a link:http://docs.pivotal.io/pivotalcf/1-8/installing/pcf-docs.html[*Pivotal Cloud Foundry*] repository that manages an instance of Mule runtime *(Beta)*.
+
...
[NOTE]
The Anypoint Platform Private Cloud Edition doesn't currently support the dashboard feature. Future releases are planned to include it.
...
The Anypoint Platform Private Cloud Edition doesn't currently support the insights feature. Future releases are planned to include it.
====
