...
In between Runtime Manager and the external services is the link:/runtime-manager/mule-agent[Runtime Manager Agent], a module of Mule ESB that enables easy integration and sends event notifications to third party monitoring tools.
