...
If you deploy apps from Runtime Manager to customer-managed Mule servers, you can send your Mule app event and analytics data to third party monitoring software such as *Elk* and *Splunk*.
