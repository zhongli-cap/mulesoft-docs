...
In between Runtime Manager and the external services is the link:/mule-agent/v/1.5/[Mule Agent], a module of Mule ESB that enables easy integration and sends event notifications to third party monitoring tools.
...
See link:/mule-agent/v/1.5/installing-and-configuring-mule-agent[Installing the Mule Agent].
...
[TIP]
For more information on how to install or Update the Mule Agent, see link:/mule-agent/v/1.5/installing-and-configuring-mule-agent[Installing the Mule Agent]
