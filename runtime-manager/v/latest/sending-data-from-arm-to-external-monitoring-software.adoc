...
See link:/mule-agent/v/1.5/installing-mule-agent[Installing the Mule Agent].
...
[TIP]
For more information on how to install or Update the Mule Agent, see link:/mule-agent/v/1.5/installing-mule-agent[Installing the Mule Agent]
