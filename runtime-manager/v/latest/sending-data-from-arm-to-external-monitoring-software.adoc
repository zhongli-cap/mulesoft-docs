...
* a component of the link:/mule-user-guide/v/3.8/anypoint-platform-primer[Anypoint Platform]
...
In between Runtime Manager and the external services is the link:/runtime-manager/mule-agent[Mule Agent], a module of Mule ESB that enables easy integration and sends event notifications to third party monitoring tools.
...
See link:/runtime-manager/installing-and-configuring-mule-agent[installing and configuring Mule Agent].
...
[TIP]
For more information on how to install or Update the Mule Agent, see link:/runtime-manager/installing-and-configuring-mule-agent[installing and configuring Mule Agent]
