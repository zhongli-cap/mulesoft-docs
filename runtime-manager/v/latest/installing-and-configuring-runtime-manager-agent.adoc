...
[NOTE]
====
You can use the same copied registration command for multiple Mule runtimes, but make sure to change the default instance name `server_name` to a different and unique instance name for each Mule runtime.
====
