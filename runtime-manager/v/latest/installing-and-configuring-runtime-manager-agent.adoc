...
* _Proxy Host_ - The host of the desired proxy. You should be able to just specify the hostname. For example you can specify `proxy.acme.com`, not the full URL `http://proxy.acme.com` nor `https://proxy.acme.com`. 
