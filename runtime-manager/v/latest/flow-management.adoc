...
To act use flows, you must have the `Create Applications` permission on the desired applications. It is not possible to start/stop a flow without being able to deploy an application.
====
