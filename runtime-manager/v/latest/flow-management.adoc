...
[NOTE]
====
CloudHub apps and the Anypoint Platform Private Cloud Edition don't currently support the flow management feature. Future releases are planned to include it.
====
