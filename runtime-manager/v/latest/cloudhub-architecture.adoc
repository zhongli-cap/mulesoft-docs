...
|image:blue-2.png[blue-2] |<<Platform Services>> |This set of shared CloudHub platform services and APIs includes Insight, alerting, logging, account management, virtual private cloud/secure data gateway, load balancing, and others.
