= Sending API Analytics from Runtime Manager to External Data Bases
...
See link:/mule-agent/v/1.5/installing-and-configuring-mule-agent[Installing the Mule Agent] or link:/mule-agent/v/1.5/installing-and-configuring-mule-agent#running-the-updater[Updating the Mule Agent].
