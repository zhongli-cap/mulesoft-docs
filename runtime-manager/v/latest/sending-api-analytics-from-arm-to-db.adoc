...
See link:/mule-agent/v/1.4.0/installing-mule-agent[Installing the Mule Agent] or link:/mule-agent/v/1.4.0/installing-mule-agent#running-the-updater[Updating the Mule Agent].
