...
== Avoiding Public Discoverability for CloudHub Applications
...
. Remove the link:/runtime-manager/virtual-private-cloud#firewall-rules[VPC firewall rule] for ports 8091 and 8092.
