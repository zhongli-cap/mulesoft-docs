...
If you need to whitelist the IPs of the Runtime Manager's public services, see link:/mule-agent/v/1.4.0/installing-mule-agent#ips-to-whitelist[IPs to Whitelist].
