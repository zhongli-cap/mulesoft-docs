...
If you need to whitelist the IPs for the communication between the Mule Agent and the Runtime Manager console, see link:/mule-agent/v/1.5/installing-and-configuring-mule-agent#ports-and-ips-to-whitelist[IPs to Whitelist].
