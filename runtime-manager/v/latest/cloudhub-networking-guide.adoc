...
[NOTE]
You can assign Static IP to applications with multiple workers. It's not possible to pre-allocate static IPs for multiple workers, though. In case of multiple workers, the IPs will be automatically allocated.
