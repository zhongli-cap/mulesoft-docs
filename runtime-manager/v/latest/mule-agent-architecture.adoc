...
During installation, you also have the option to configure the Mule agent via a quick-start script. For details, see link:/runtime-manager/installing-and-configuring-mule-agent[installing and configuring Mule Agent]
