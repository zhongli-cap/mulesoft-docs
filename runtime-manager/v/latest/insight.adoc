...
[IMPORTANT]
====
Enabling insight introduces a significant performance impact on the processing of your data and it's stronly discoraged enabling it in production environments. For everyday monitoring, it's advisable to use the tools listed in the link:/runtime-manager/monitoring[monitoring section].
