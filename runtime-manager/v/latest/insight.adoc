...
The following image illustrates where to find transactions, events, and metadata on the Insight dashboard. By default, Insight does not have a size limit and displays all transactions in your application for a period of 30-days. Events are kept for a period of 2-days. 
