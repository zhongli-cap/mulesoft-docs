...
Insight retains Mule application data from the last 100,000 events in your app and keeps a record (without the Mule message content) of all events from the last 30 days.
