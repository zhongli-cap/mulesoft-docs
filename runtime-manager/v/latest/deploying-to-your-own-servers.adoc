...
+
The target must be a registered servers, server groups or clusters.
...
. Name your deployment, then select the deployment target. The target should be one of your registered servers, server groups or clusters.
