...
After deploying an application, you can modify application properties or create new ones from the Application Settings page. The values of properties defined on this tab override any application properties defined in the `mule-app.properties` of the Mule runtime.
