...
image:logo-cloud-active.png[alt="cloud", link:"/runtime-manager/deployment-strategies"]
image:logo-hybrid-active.png[alt="hybrid", link:"/runtime-manager/deployment-strategies"]
...
////
[NOTE]
Apps deployed to PCF currently don't support any Alerts.
////
