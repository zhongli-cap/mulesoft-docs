...
image:logo-cloud-active.png[cloud, link:"/runtime-manager/deployment-strategies"]
image:logo-hybrid-active.png[hybrid, link:"/runtime-manager/deployment-strategies"]
