...
* link:/mule-user-guide/v/3.8/begin-with-the-basics[Begin with the Basics]
...
[TIP]
Want to see examples of more elaborate applications? Check out all the examples in link:/mule-user-guide/v/3.8/anypoint-exchange[Anypoint Exchange].
