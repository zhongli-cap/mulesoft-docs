...
* link:/anypoint-studio/v/6/anypoint-studio-essentials[Studio Essentials]
...
With link:/anypoint-studio/v/6/anypoint-studio-essentials[Anypoint Studio] you can quickly build integration applications and deploy to CloudHub with just a few clicks, without even leaving the Studio IDE, see link:/runtime-manager/deploying-to-cloudhub#from-anypoint-platform[Deploying to CloudHub].
