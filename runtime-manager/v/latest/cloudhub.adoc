...
* link:/runtime-manager/managing-cloudhub-applications[Managing CloudHub Applications] for an overview on what you can do specifically with applications on the Runtime Manager
