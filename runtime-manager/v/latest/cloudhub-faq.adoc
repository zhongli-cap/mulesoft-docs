...
As CloudHub deploys on Amazon EC2, IP addresses are chosen from the Amazon EC2 IP pool. For a list of these ranges, see  link:https://forums.aws.amazon.com/ann.jspa?annID=1701[Amazon EC2 Public IP Ranges].
