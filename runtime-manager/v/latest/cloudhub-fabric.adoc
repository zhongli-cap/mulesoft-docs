...
Each application can be deployed with up to 8 workers of any kind. However, you may be limited to fewer vCores than those you need, based on how many are available in your subscription. See link:/runtime-manager/deploying-to-cloudhub[Worker Sizing] for more information about deploying to multiple vCores.
