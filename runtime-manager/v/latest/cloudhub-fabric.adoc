...
* Refer to the complete references for link:/mule-user-guide/v/3.8/transaction-management[Transaction Management], the link:/mule-user-guide/v/3.8/vm-transport-reference[VM transport], and link:/mule-user-guide/v/3.8/reliability-patterns[Reliability Patterns].
