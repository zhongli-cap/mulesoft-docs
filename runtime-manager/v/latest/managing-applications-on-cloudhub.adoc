...
Runtime Manager enables you to view information about an appliction.

1. From  Anypoint Platform, click Runtime Manager.
1. Click Applications, then select the application whose settings you want to view.
1. Click Manage Applications, then click Settings.

image:cloudhub-manage-application.png[manage app]

In this menu you will be able to change most of the settings you can configure when deploying. You can also view the following information:

* Status: the current status of the application.
* Last Updated: the date of the last application update.
* SHA-1: the internal identifier of the application.
* Uptime: the amount of time the application has been continuously running.
