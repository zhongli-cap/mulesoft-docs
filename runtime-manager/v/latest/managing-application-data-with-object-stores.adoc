...
[WARNING]
Currently, all object-store data is handled by servers in the *US-East zone*, indistinctly of what zone your application is deployed to. This may impact performance. In future releases there will be region-specific object stores to aid in deployments to other regions.
