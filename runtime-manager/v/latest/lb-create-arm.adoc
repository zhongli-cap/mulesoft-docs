...
* Ensure that your profile is authorized to perform this action by adding the CloudHub Network Administrator permission to your profile of the organization where you are creating the load balancer. Similarly, the adminstrator role of the same organization will also provide the authorization required.
