...
* link:/runtime-manager/[Runtime Manager] for Mule applications deployed to MuleSoft-hosted (CloudHub) and customer-hosted Mule runtimes
...
[IMPORTANT]
--
Anypoint-CLI is a link:https://nodejs.org/en/[Node.js] application. Before you can install Anypoint CLI on your computer, you first need to make sure you have the Node.js runtime environment installed on your computer. Along with it, you'll need to use the default Node.js package manager (npm) to be able to install Anypoint CLI.
