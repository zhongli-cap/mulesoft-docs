...
|<<runtime-mgr application upgrade-runtime>>| Upgrades application runtime to the latest patch version or if a version if specified, to that version.
|<<runtime-mgr application downgrade-runtime>>| Downgrades application runtime to the previous runtime version or if a version is specified, to that version.

// runtime Manager Cluster functions
...
|<<runtime-mgr hybrid-applications deploy>> | Deploys a new application to on-premise server, server group or cluster
|<<runtime-mgr hybrid-applications describe-json>> | Shows raw on-premise application JSON response
|<<runtime-mgr hybrid-applications modify>> | Changes on-premise application artifact
|<<runtime-mgr hybrid-applications start>> | Starts on-premise application
|<<runtime-mgr hybrid-applications delete>> | Deletes on-premise application
|<<runtime-mgr hybrid-applications describe>> | Shows detailed info of on-premise application
|<<runtime-mgr hybrid-applications list>> | Lists all applications in the environment
|<<runtime-mgr hybrid-applications restart>> | Restarts on-premise application
|<<runtime-mgr hybrid-applications stop>> | Stops on-premise application
...
|<<runtime-mgr server list>> | Changes on-premise application artifact
...
=== runtime-mgr application upgrade-runtime

[source,Example]
----
> runtime-mgr application upgrade-runtime [options] <name>
----
...
=== runtime-mgr application downgrade-runtime

[source,Example]
----
> runtime-mgr application downgrade-runtime [options] <name>
----
...
This command deletes teh server groups passeed in `serverGroupId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.
