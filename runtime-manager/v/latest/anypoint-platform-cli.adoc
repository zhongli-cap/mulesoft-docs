...
[source,Example]
----
> exchange asset upload [options] <assetIdentifier> <zipfile>
----

This command uploads the ZIP file passed in <zipfile> as an asset to Exchange using the Ids passed in <assetIdentifier>. +

The ZIP file must include an "exchange.json" file describing the asset.
Argument "assetIdentifier" must be formatted as: <group_id>/<asset_id>/<version>.
...
|===
|Command | Description |  Example
| --apiVersion |  Asset API version .3+<.<| `exchange asset upload --apiVersion 1.0 --name testProject --classifier mule-application`
//_TODO: valid classifier?
| --name       |  Asset name
...
The "assetIdentifier" argument must be formatted as: <group_id>/<asset_id>/<version>.
...
[source,Example]
----
> exchange asset page download [options] <assetIdentifier> <directory> [name]
----
//_TODO: What is [name] ??

This command downloads the description page for the Exchange asset identified with <assetIdentifier> to the directory passed in <directory>.
...
[source,Example]
----
> exchange asset page modify [options] <assetIdentifier> <name>
----

This command modifies the description page for the Exchange asset identified with <assetIdentifier>. +
The "assetIdentifier" argument must be formatted as: <group_id>/<asset_id>/<version>.
...
[source,Example]
----
> exchange asset page upload [options] <assetIdentifier> <name> <mdPath>
----

This command uploads a page description from the path passed in <mdPath> to the Exchange asset indetified with <assetIdentifier>.
...
[source,Example]
----
> exchange asset page delete [options] <assetIdentifier> <name>
----

This command deletes the description page for the asset identified with <assetIdentifier>.
