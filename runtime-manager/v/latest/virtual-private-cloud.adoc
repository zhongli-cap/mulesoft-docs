...
The SLA for configuring VPC is 5 business days after link:_attachments/VPN-form-v9.1-template.xlsm[the VPC discovery form] has been completed and returned, though it may be completed sooner.
