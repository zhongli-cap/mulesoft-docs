...
The SLA for configuring VPC is 5 business days after link:_attachments/VPC-form-v9.3-template.xlsx[the VPC discovery form] has been completed, returned and approved by support, though it may be completed sooner.
