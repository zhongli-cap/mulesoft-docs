...
The SLA for configuring VPC is 5 business days after link:_attachments/VPN-form-v9.1-template.xlsx[the VPC discovery form] has been completed, returned and approved by support, though it may be completed sooner.
