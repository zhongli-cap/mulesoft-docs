...
1. In the information panel, click the server status and choose the action you want to perform from the drop-down list. The following actions are available:
+
* Shutdown
* Restart
* Delete
