...
== Starting, Stopping, and Deleting a Server
...
1. In the information panel, click the server status label and choose the action you want to perform from the drop-down list. You can perform the following actions:
+
* Shutdown
* Restart
* Delete
