...
*If you're using link:/anypoint-platform-private-cloud-edition/v/1.5.0[Anypoint Platform Private Cloud Edition]*, make sure you have at least version *1.5.2* of the Runtime Manager agent installed.
====
