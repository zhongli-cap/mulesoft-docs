...
*If you're using link:/anypoint-platform-on-premises/v/1.5.0[Anypoint Platform On-premises Edition]*, make sure you have at least version *1.5.2* of the Runtime Manager agent installed.
====
