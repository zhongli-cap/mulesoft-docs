...
Runtime Manager is the enterprise link:/anypoint-fundamentals/[Anypoint Platform] tool used to deploy and manage all of your Mule applications in one central location, whether your apps are running in the cloud or on-premises.
