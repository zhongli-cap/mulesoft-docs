...
Runtime Manager is the link:/mule-user-guide/v/3.8/anypoint-platform-primer[Anypoint Platform] tool used to deploy and manage all of your link:/mule-user-guide/v/3.8/begin-with-the-basics[Mule applications] in one central location, whether your apps are running in the cloud or on-premises.

After you have created a Mule application (for example, see link:/mule-user-guide/v/3.8/build-a-hello-world-application[Hello World Mule application]), you can deploy to either CloudHub, our cloud iPaaS platform, or to one of your own servers, server groups, or clusters.
...
=== 3. Setup and Manage the Application
...
* link:/mule-user-guide/v/3.8/anypoint-platform-primer[Anypoint Platform]
* link:/mule-user-guide/v/3.8/begin-with-the-basics[Mule applications]
