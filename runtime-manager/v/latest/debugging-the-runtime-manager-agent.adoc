...
If you experience any issue with the Runtime Manager Agent Plugin and/or with managing applications on the Anypoint platform, it's higly recommended to obtain the output of this script before filling any support tickets.
