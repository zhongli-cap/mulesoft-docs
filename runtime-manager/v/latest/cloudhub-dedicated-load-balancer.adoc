...
In order to be able to create and configure a load balancer, your profile needs to be an link:/access-management/managing-your-account#the-organization-administrator[administrator] of the organization to which the load balancer is associated.
