...
[cols="10a,20a,20a,10a",options="header"]
|===
...
It is recommended that in order to whitelist inbound connections to your load balancer, link:/runtime-manager/deploying-to-cloudhub#static-ips-tab[static IP addresses]
...
You can send a PATCH request to your load balancer's endpoint to update any other property of your load balancer.
