...
[NOTE]
The configuration steps shown in this document are meant for deploying your app to CloudHub. If you instead intend to deploy your app locally, see link:/mule-user-guide/v/3.7/tls-configuration[TLS Configuration]. See link:/runtime-manager/cloudhub-and-mule[CloudHub and Mule] for a closer look at how to configuration should differ between each deploying scenario.
