...
See link:/mule4-user-guide/v/4.1/mule-credentials-vault[Credentials Vault] for more information on creating and using secure properties placeholders. 
...
== See Also
* link:/mule4-user-guide/v/4.1/mule-credentials-vault[Credentials Vault]
