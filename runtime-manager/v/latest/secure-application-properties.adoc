...
Safely hidden application properties are a separate feature and concept from encrypted Mule application properties that are stored in link:/mule-user-guide/v/4.1/secure-configuration-properties[Secure Configuration Properties] files.
