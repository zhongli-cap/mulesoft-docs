...
----
+
`anypoint.platfrom.on_prem` is set to `false` by default. To manage it through Anypoint Platform Private Cloud Edition, you must set it to `true`. To manage it throguh the Runtime Manager in the cloud, leave it as `false`.
