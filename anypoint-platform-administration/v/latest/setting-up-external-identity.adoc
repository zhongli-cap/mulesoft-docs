...
[NOTE]
====
In order to be able to use this feature you have to have the proper entitlement for it. If you don't have the option "External Identity" please contact your sales representative or customer success manager.
====
