...
* In clusters of Mule servers, messages can migrate between nodes when sent to an asynchronous flow. This allows for *load balancing between nodes* and higher performance of application. (See our link:/mule-user-guide/v/3.9/flow-architecture-advanced-use-case[advanced use case] for an example.)
...
Read more about setting up link:/mule-user-guide/v/3.9/transactional[Transactional units] in Mule applications.
====
...
|Asynchronous Flow |Flow Reference wrapped within an link:/mule-user-guide/v/3.9/async-scope-reference[Async Scope] |asynchronous |not inherited
|===

== See Also

* Examine an link:/mule-user-guide/v/3.9/flow-architecture-advanced-use-case[advanced use case] showing a more complex flow architecture that uses several child flows.
* Read about some alternative ways to control message processing within a flow using link:/mule-user-guide/v/3.9/routers[routing message processors].
* Refer to the link:/mule-user-guide/v/3.9/flow-reference-component-reference[Flow Reference Component Reference] and link:/mule-user-guide/v/3.9/async-scope-reference[Async Scope].
* Read more about link:/mule-user-guide/v/3.9/flow-processing-strategies[Flow Processing Strategies].
* Read more about setting up link:/mule-user-guide/v/3.9/transactional[transactional units] in Mule applications.
