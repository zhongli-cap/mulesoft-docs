...
* *NEXT STEP*: Read on about link:/mule4-user-guide/v/4.1/about-components[components].
* Skip ahead to understand the structure of a link:mule-concepts#mule-event[Mule Event object].
