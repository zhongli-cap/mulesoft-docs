    ...
    <build>
         <plugins>
             ...
             <plugin>
                 ...
                 <!-- 
                 This doesn't work. It fails with error:
                 Failed to execute goal org.mule.tools.maven:mule-maven-plugin:3.1.1:clean (default-clean) on project
                 
                 xxxx_m4: Unable to parse configuration of mojo org.mule.tools.maven:mule-maven-plugin:3.1.1:clean for parameter version: Cannot find 'version' in class org.mule.tools.api.classloader.model.SharedLibraryDependency -> [Help 1]
                 
                 Looking for the source for SharedLibraryDependency. Will add notes if I find anything useful
