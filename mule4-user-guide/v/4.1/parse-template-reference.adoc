...
//TODO? CODE EXAMPLE BELOW NEEDS TO BE UPDATED FIRST
//<<code_example>>
...
////
TODO: ENTIRE EXAMPLE NEEDS TO BE UPDATED TO MULE 4, LINKS ARE BROKEN, ETC.
[[code_example]]
== Code Example
...
////
TODO: FIND COUNTERPART:
//* link:/mule-user-guide/v/3.9/property-transformer-reference[properties transformer], which you can use to set properties and variables for different scopes.
////
