...
also use DataWeave `lookup` function in some component fields to pass the 
current event to another flow for further event processing. In this way, 
you can think of a flow or subflow as a function call that accepts
