...
String interpolation allows you to embed variables or expressions directly in a string. The expression need to be encolsed $( <expression> ) and it should always return String type or something coercible to String.
