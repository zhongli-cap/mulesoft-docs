...
In Mule 3, the Security Filters where part of the Mule Module Security. In Mule 4, this where migrated to the link:/connectors/v/latest/validation-connector[Mule Validation Module].
...
== See Also
link:/connectors/v/latest/validation-documentation[Validation Connector Technical Reference]
