...
|`flow`
|The name of the current flow. Since flow name's are static this has been deprecated and will only be available under specific components such as the logger.
a|
* Fields:
** `name`
