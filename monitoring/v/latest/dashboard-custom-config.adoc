...
You can create and configure as many custom dashboards as you need.  There are two types of custom dashboard configurations:
...
. Provide a name, and set other high-level properties for the dashboard.
+
For guidance, see <<config_dashboard, Performing High-Level Dashboard Configurations>>.
