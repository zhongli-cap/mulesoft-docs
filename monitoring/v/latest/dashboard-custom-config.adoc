...
| Tags | A short identifier that can help you locate a dashboard in the custom dashboard list. See link:dashboards-using#setting-favorite-custom-dashboards for an example.
| Timezone a|
