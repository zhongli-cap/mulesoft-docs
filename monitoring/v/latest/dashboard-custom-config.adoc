...
To perform dashboard-level configurations of custom dashboards, you need to navigate to a custom dashboard and click the <<dashboard_config, Pencil icon (beside the star)>> at the top of the page. Settings are for:
...
image::dup_delete_dashboard.png[Duplicate Dashboard]
+
