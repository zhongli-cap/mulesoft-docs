...
You can refresh data in the graphs at a default interval, or if your subscription permits, set an interval at which to refresh (such as 30s, 5m, 1h, 1d). Your refresh setting applies to all graphs in the dashboard.
