...
Dashboards in the Anypoint Monitoring provide visibility into Mule apps that are deployed to your environments (for example, Production, Sandbox, or Design).
...
You can select a built-in or custom dashboard from the Anypoint Monitoring.

image::dashboard-select.png[Select a Dashboard]

. From the Anypoint Monitoring, click Built-in Dashboards or Custom Dashboards.
