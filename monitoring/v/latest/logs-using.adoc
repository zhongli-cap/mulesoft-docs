...
image::logs-save-search-menu.png[Save Log Search Menu]

After saving a search, you can use View Saved Searches from the same menu, for example:

image::logs-save-search-view.png[View Saved Log Search]

You can view and delete the search from this page.
