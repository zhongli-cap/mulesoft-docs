...
From Alerts in Anypoint Monitoring, you can link out to configuration pages for API and Runtime alerts. If no alerts are set up, you see links alert configurations, for example:
...
If you have a Titanium (Premium) subscription to Anypoint Monitoring, you can set up alerts to trigger email notifications when a data point you are measuring (`JVM - CPU % Utilization`) exceeds a specified threshold.
