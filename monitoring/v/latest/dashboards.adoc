...
Built-in dashboards also display deployment information about your app, for example:

image::dashboard-build-in-info.png[Deployment Info on an App in a Built-In Dashboard]
