...
The graphs and tables in built-in dashboards support a number of uses, including:

* High-level, overview metrics.
* End-to-end tracing of API calls from the Inbound, Outbound, and Failure tabs. For example, you can track response times at each endpoint.
+
