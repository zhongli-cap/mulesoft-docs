...
| Type | Valid values are `dashboard` and `absolute`. *TODO: describe*
...
You can also display the following values beside the legend names:
...
== Stacking and Hover (Advanced Settings)
...
== Time Range Shift (Advanced Settings)
