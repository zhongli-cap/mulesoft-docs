...
| Dashboard | Appears if the `dashboard` type is selected. *TODO*
...
Url params work for both dashboard and absolute types of links. The idea is to pass parameters to the recipient end.
