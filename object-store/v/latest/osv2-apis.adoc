...
Object Store permits a key/list object to persist in the store for up to 14 days by default. 
If the list value is updated, the object can persist 14 days longer. 
You can specify a longer time to live (TTL) value for up to 30 days using the REST API.
...
* https://docs.mulesoft.com/connectors/object-store-connector[Mule 4 Object Store Connector documentation]
