...
The following procedure assumes you have already created an application and given it access to Object Store v2.

. Get your Client ID and Client Secret from Anypoint Platform > Runtime Manager. 
. Click an application and click Manage Application. Click Object Store > Show Client Credentials. 
. Open a text editor to prepare the curl command and copy the Client ID and Client Secret to your text.
. Submit this POST command to get an access token:
+
...
----
+
. In Access Management > Organization, copy your Organization ID and Environment ID.
