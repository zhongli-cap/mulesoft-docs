...
An object store belongs to an application. If you are the organization administrator for your Anypoint Platform
account, you can get the client ID and client secret from the *Application Data* menu
