= APIs: Object Store v2 REST Interfaces
...
*API:* https://anypoint.mulesoft.com/apiplatform/anypoint-platform/#/portals/organizations/68ef9520-24e9-4cf2-b2f5-620025690913/apis/16510/versions/17620[Object Store API (2.1.0) - Object Store] +
...
The link:/mule-user-guide/v/3.9/object-store-connector[Object Store Connector] reads and writes in the `key,value` format; whereas OSv2 supports `key,lists`. 
