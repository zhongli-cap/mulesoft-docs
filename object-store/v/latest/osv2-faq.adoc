...
https://www.anypoint.mulesoft.com/exchange/?search=object%20store%20connector[Anypoint Exchange] provides assets for the Mule 3 Object Store connector used by Anypoint Studio 6 and the Mule 4 Object Store connector used by Studio 7.
