...
* Persistent storage of objects with a flexible time to live (TTL) is allowed up to 30 days. See link:/object-store/osv2-faq#how-long-can-data-persist-in-osv2[How long can data persist in OSv2?] for more information.
