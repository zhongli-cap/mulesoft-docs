...
** Set the *Runtime version* to a 3.8.2 or 3.7.4 version when deploying a new app OR use the versions "3.8.2- 01-30-2017" OR "3.7.4 - 12-26-2016".
...
IMPORTANT: When you choose a supported *Runtime Version* "3.8.2- 01-30-2017" OR "3.7.4 - 12-26-2016" OR 3.7.4 or 3.8.2, the *Application Data* label in the Runtime Manager navigation bar on the left side of the screen changes to *Object Store*.
