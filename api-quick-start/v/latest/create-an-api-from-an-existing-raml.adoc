...
+
The link:/api-quick-start/create-an-api-from-an-existing-raml#create-the-raml[step-by-step procedure for creating this RAML] is described later.
...
+
Other ways an API can link:/api-quick-start/create-an-api-from-an-existing-raml#access-the-raml-file[access the RAML] are described later.
+
