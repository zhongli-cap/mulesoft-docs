...
This test triggers hits to the endpoint exposed by your APIkit router and verifies that the returned status code and payload are the ones you expect, based on your RAML definition. +
...
. Enhance an API to link:/api-quick-start/enhance-an-api-using-anypoint-studio[consume a SOAP Web Service].
