...
. Check out templates, connectors and more from link:/anypoint-exchange/anypoint-exchange[Anypoint Exchange], where you can find and publish developer resources. You can use Exchange to publish private repositories too.
