...
You can use this transformer as a building block in your flow or as a link:/mule-user-guide/v/3.6/global-elements[Global Element], which you define once and then reference from your building blocks.
...
----
|*Name*
|A unique name for this transformer. This is necessary when using this transformer as a link:/mule-user-guide/v/3.6/global-elements[Global Element.]
|[source, code, linenums]
----
name="toHAPI"
----
