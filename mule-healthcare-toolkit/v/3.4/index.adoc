...
[TIP]
This document assumes a working knowledge of Mule ESB and Mule Studio. To find out more about these applications, consult the link:/mule-user-guide/v/3.4[Mule Runtime documentation].
