...
The HL7 exception strategy sets the flow's link:/mule-user-guide/v/3.7/error-handling[exception strategy] to HL7, instead of the link:/mule-user-guide/v/3.7/error-handling[default]. Additionally, it generates and sends an ACK message with the appropriate error code to the originating application.
