...
|XML
|*Connector Reference*
|References an HL7 connector configured as a link:/mule-fundamentals/v/3.6/global-elements[Global Element].
|[source, code, linenums]
----
...
----
|*Connector Reference*
|Allows you to reference an HL7 connector configured as a link:/mule-fundamentals/v/3.6/global-elements[Global Element].
|[source, code, linenums]
----
connector-ref="HL7connectorName"
----
