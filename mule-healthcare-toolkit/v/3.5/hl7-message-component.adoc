...
[NOTE]
This HL7 message component cannot generate the HL7 message payload, nor incorporate data from an external source for the HL7 message payload. To add a payload, use an  link:/mule-healthcare-toolkit/v/3.7/hl7-append-segment-component-reference[HL7 Append Segment component].
