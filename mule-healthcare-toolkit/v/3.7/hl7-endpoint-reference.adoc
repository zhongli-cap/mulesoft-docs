...
|XML
|*Connector Reference*
|References an HL7 connector configured as a link:/mule-user-guide/v/3.7/global-elements[Global Element].
|[source, code, linenums]
----
...
----
|*Connector Reference*
|Allows you to reference an HL7 connector configured as a link:/mule-user-guide/v/3.7/global-elements[Global Element].
|[source, code, linenums]
----
connector-ref="HL7connectorName"
----
