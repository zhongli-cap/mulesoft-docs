...
* A link:/mule-user-guide/v/3.6/variable-transformer-reference[Variable Transformer] defines variables for logging.
...
* An link:/mule-healthcare-toolkit/v/3.6/hl7-ack-component-reference[HL7 ACK Component] sends an ACK message back to the originating application.
