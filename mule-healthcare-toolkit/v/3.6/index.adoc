...
[NOTE]
This document assumes a working knowledge of Mule ESB and Anypoint Studio. To find out more about these applications, consult the link:/mule-user-guide/v/3.6[Mule Runtime documentation].
...
|N/A
|N/A
|Use to configure a link:/mule-user-guide/v/3.6/global-elements[global connector] which connectors in Mule can reference.
