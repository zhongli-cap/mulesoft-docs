...
. link:/api-functional-monitoring/design-raml-api-task[Design an API to test]. For example, design the RAML API specification in Design Center.
. link:/api-functional-monitoring/publish-project-exchange-task[Publish the API to Exchange].
