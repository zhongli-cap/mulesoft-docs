...
* Figure out the frequency at which you would like the monitor to test the endpoints. The shortest interval is every fifteen minutes. You can also choose to run the monitor hourly, daily, weekly, or monthly. The schedule begins immediately after you create the monitor. You can edit the schedule later, starting the monitor on specific days, at specific times, and so on. You can also create more schedules for the monitor.
