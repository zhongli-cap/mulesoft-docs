...
Alternatebly could be used _bat init_ command (in any place) to sets up a basic project folder with config files, HelloWorld basic test, and a yaml descriptor file.
