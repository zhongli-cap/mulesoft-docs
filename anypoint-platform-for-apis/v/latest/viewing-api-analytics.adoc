...
As an Organization Administrator, you have access to the Analytics Dashboards for your organization. Go to *http://anypoint.mulesoft.com/analytics[http://anypoint.mulesoft.com/analytics]* to access your Analytics Dashboards. You can also navigate to the overview dashboard by clicking the menu icon option in the top-right of the window.

image:analytics-access.png[analytics-access]

If you don't see the Analytics option, you are not a member of the Organization Administrator role.
