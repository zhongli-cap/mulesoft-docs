...
In this tutorial, you create an API Notebook to connect to a RAML-based API managed by API Manager. To create a Notebook for an API that is not RAML-based, link:/anypoint-platform-for-apis/tutorial-proxy[create a proxy for the API].
