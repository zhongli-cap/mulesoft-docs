...
To run the RAML 0.8 version of this example in Anypoint Platform, link:_attachments/placeholder.raml[download] and deploy the RAML 0.8 version to Cloudhub. Cloudhub does not support Early Access RAML 1.0.  Enter the following URL in a browser:
