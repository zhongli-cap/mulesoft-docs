...
// Duplicate (temporary--to prevent broken links) of /anypoint-platform-for-apis/walkthrough-design-new, quickstart has the minimal design existing api from a wsdl stuff.
...
Assuming you have link:/anypoint-platform-for-apis/walkthrough-intro-create[set up the API], for ordering T-Shirts:
