...
In Anypoint Studio, you can set up an API for automatic discovery by and registration in an Anypoint Platform for APIs. Follow the step-by-step configuration procedure in the next section to perform these tasks:
...
=== API Gateway Version 1.3.2 or Earlier
...
=== API Gateway Version 1.3.2 or Earlier: Full Example
