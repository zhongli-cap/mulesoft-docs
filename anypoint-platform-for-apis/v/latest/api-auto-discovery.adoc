...
When creating or modifying an API project in Anypoint Studio, you can set an application to be automatically discovered and registered to one or more APIs in your Anypoint Platform for APIs organization.
