...
API Manager now incorporates the API Gateway functionality in the April 2016 release and earlier. The following table lists the policy template name and the supported API Gateway version in April 2016 and earlier releases.
