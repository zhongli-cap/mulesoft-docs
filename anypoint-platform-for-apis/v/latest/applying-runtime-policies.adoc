...
Anypoint Platform enforces runtime policies on HTTP/HTTPS endpoints. You can apply or remove one or more policies to govern your API version at runtime.
