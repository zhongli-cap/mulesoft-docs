...
You need an Anypoint Platform account to perform the API Manager tutorials. In a separate browser, go into the Anypoint Platform for APIs link:https://anypoint.mulesoft.com[Anypoint Platform].
