...
[WARNING]
Keep in mind that proxy implementation will vary according to the needs of your use case. You can https://www.mulesoft.com/support-and-services/mule-esb-support-license-subscription[contact MuleSoft support] for assistance with your proxy application.
