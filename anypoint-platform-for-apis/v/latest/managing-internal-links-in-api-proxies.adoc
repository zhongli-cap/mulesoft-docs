...
+
image::managing-internal-links-in-api-proxies-08328.png[managing-internal-links-in-api-proxies-08328]
+
...
+
image::managing-internal-links-in-api-proxies-f6189.png[managing-internal-links-in-api-proxies-f6189*]
+
...
[NOTE]
====
In the API output format differs, add a link:/mule-user-guide/v/3.7/choice-flow-control-reference[Choice Router] to treat each case accordingly:

image::managing-internal-links-in-api-proxies-4eab2.png[managing-internal-links-in-api-proxies-4eab2]
====
