...
This page describes the configuration and runtime application instructions for the OpenAM OAuth Token Enforcement policy. The OpenAM OAuth Token Enforcement policy connects to your existing OpenAM authorization server and enforces access according to your configuration.
