...
If you want to track application access to your API or enforce SLA limits:
...
When applying these policies, the credentials are expected in the form of query parameters named client_id and client_secret. In this release, you enter the client id and client secret as strings. In previous releases, these values had to be Mule expressions.
