...
On your API Version Details page, click *Configure Endpoint* to set the API type and an optional inbound endpoint for your deployed API. Provide the actual inbound URL of your API, not a placeholder URL.

If your API is deployed on-premises and you are using a load balancer, link:/anypoint-platform-for-apis/configuring-an-api-gateway[include your load balancer endpoint] here.
