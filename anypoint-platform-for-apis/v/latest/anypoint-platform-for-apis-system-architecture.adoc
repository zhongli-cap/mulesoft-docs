...
* API manager communicates with your existing services, exposed as APIs and client applications
...
image:3.on-premises.png[3.on-premises]
...
image:2.on-cloud-CROPPED.png[2.on-cloud-CROPPED]
