...
To deploy the API by proxy, you need a valid URL where your API is currently running. You also need one of the following:
...
If you use Mule 3.8.0 Runtime or API Gateway 2.0, you don't need to set up a proxy. Skip this section and go directly to the *Automatic - On Premises* tab below.
...
. In the API Status section of the API version page, click *Deploy proxy* to deploy your application by proxy to CloudHub.
+
