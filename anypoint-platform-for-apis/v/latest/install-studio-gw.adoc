...
To develop an API using Anypoint Studio 6.0 for deployment to Anypoint Platform, you no longer need to install and configure API Gateway because Anypoint Studio with Mule 3.8.0 Runtime includes API Gateway.
