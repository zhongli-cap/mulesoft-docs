...
As an API Version Owner, you typically add policies and SLA tiers to the API that you deploy by proxy. In this walkthrough, you create two tiers of access for developers who want to call the API:
