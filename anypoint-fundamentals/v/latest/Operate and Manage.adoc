...
After you link:/anypoint-fundamentals/v/latest/design-and-develop[Design and Develop] your integration applications for use with Mule runtime, you are ready to deploy them to a production environment.
