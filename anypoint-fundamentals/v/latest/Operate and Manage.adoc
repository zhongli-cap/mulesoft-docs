...
After you link:/anypoint-fundamentals/v/latest/design-and-develop[Design and Develop] your integration applications for use with Mule runtime, then what? How and where do you make the code come to life so you can see it in action?
