...
image:on-prem-logo.png[mule-server,width=70]
...
image:hybrid-logo.png[CloudHubLogo133high,width=70]
...
image:cloud-logo.png[CloudHubLogo133high,width=70]
...
image:runtime-manager-logo.png[CloudHubLogo133high,width=70]
...
image:api-logo.png[AnypointAPI_manager,width=70]
...
image:settings-logo.png[access management,width=70]
