...
Normally, developers tend to use the latest available version of a given product. This should not be the case with the Mule SDK. When extending Mule, you should:
