...
The sections below describe the specific details necessary for connector certification for Mule 4. Please visit [this page](https://docs.mulesoft.com/anypoint-connector-devkit/v/3.9/connector-certification-program-guidelines) for Mule 3 Connectors.
