...
To achieve this, there is no need to get them from the registry of the `MuleContext`. You can simply inject them to your component (such as an operation, source, or configuration) through the `@Inject` annotation.
