...
Video: https://youtu.be/kcIdsbJ7Puc[Examples and Templates]
...
Document: link:/design-center/v/1.0/upload-raml-task[To Upload an Existing RAML File to Exchange] and <<To Migrate a RAML>>. +
Video: https://youtu.be/WTIJrYydViQ[REST Assets]
|WSDL SOAP APIs |Manual publish in Exchange +
Document: link:/anypoint-exchange/ex2-add-asset[To Add an Asset to Exchange] and <<To Migrate a WSDL>>. +
