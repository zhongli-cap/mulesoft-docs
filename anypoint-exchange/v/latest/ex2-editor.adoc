...
*Note:* Editing in WYSIWYG or Markdown determines what state new assets open in the editor. If you want to only open new assets in WYSIWYG but need to use Markdown, say to add a link to a video, click WYSIWYG before exiting the asset.
...
+
[source]
![some alt text](http://www.example.com/image/image.png)
+
* Insert a link:
+
[source]
