...
visible by deprecating a version to hide it, and you can delete versions if needed. Asset versioning is a default functionality of Exchange that versions all assets published there. API versions are consumer facing.
