...
If you have contributor or admin access to an asset, you can update all of the information for an existing asset including adding a new file to the asset. 
