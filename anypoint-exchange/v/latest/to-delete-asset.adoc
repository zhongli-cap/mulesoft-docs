...
You can delete an asset in the first 7 days of its creation and reuse the asset's same name, group, asset ID, and version. If you delete the asset after 7 days, you can't reuse the same name, business group name, account ID, and version. 
After 7 days if you want to reuse the asset name, choose a new version number or put the asset in a different business group.
