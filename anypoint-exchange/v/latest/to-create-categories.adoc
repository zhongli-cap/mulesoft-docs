...
For example, a category called API Type with possible values `System API`, `Integration API`, 
and `Experience API` is applied to assets of type REST API, SOAP API, and HTTP API:
