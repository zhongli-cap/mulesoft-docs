...
== About search by Tags, Custom fields and Categories

You can also search for categories with the category: keyword, such as category:department=marketing, which searches 
for the department category and the marketing value. You can also use field: to search for custom field values, such 
as field:rating=15. Administrators create categories and custom fields.
