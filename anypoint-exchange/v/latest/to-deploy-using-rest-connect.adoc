...
REST Connect supports Basic Authentication and OAuth 2.0 client credentials. If you publish an API Specification with another authentication type, you may receive an alert email. To have an auto-generated connector, update your API specification to use Basic Authentication and OAuth 2.0 client credentials.
