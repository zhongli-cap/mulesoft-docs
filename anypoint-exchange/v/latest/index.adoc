...
Anypoint Exchange lists MuleSoft and organizational assets, which lets you reuse and collaborate within an organization. Assets can consist of examples, templates, REST or OAS APIs, connectors, and custom items. Exchange helps you create portals, view and test APIs, add mocking services to APIs, create assets, and to create API Notebooks that let you describe and test API functions. 
