...
MuleSoft provides or your organization can have a private Exchange where your organization provides the assets. 
This enables organizations to share information and custom assets for use within their organization. 
