...
The https://anypoint.mulesoft.com/apiplatform/anypoint-platform/#/portals/organizations/2559c34c-bbc7-4a5a-b078-bc1154594906/apis/8788430/versions/117434[Exchange Graph API] lets you search Exchange assets for a string value. You can specify what values
