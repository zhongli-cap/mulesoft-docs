...
----
+ 
Note: if the `<type>` element is not included your upload may succeed but not be displayed in Exchange. You will need to ensure that this element contains one of the following values in order for your asset to be visible in Exchange:
