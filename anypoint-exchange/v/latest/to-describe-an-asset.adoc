...
* To add an image, open an image and copy the image to your clipboard. In Exchange, click Edit and change the 
editor to Visual mode. You can then paste the image into the Exchange page.
