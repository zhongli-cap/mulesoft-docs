...
Click an asset, and click Edit to add a description. The editor lets you change the appearance of text, 
insert code samples, block quotes, and horizontal lines, and to add an image. The Markdown editor lets you also add videos.

After you create a page, you can add additional pages using the editor. See also: xref:editnotes[Editor Notes].
