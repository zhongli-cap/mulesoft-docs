...
A public portal is visible to anyone on the internet who has the URL of the portal. The URL for a public portal starts with `+https://anypoint.mulesoft.com/exchange/portals/ORGANIZATION_NAME/+` and 
public portals are crawled by search applications. To remove an asset from a public portal, you need to make the asset 
