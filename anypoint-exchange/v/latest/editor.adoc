...
After you create or upload an asset, click Edit to add content: image:ex2-edit.png[ex2-edit]

You can use the Exchange editor for WYSIWYG editing or for Markdown.
...
You can delete a page by clicking the trash can symbol: image:trashcan-delete-icon.png[trashcan-delete-icon]. 
