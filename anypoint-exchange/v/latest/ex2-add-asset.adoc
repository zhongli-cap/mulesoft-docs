...
** To add a connector to Exchange, see link:/anypoint-exchange/ex2-maven[To Publish and Deploy Exchange Assets Using Maven].
...
* To add a description for your asset, click Edit and see link:/anypoint-exchange/ex2-editor[To Use the Editor].
