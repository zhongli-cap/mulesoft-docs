...
|link:/anypoint-mq/mq-studio[To Set Up Studio for the MQ Connector] |Uses Anypoint Studio to install and configure the Anypoint MQ connector, and create and run an application.
