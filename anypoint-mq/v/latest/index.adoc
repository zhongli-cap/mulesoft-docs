...
Anypoint MQ is available in these regions: Singapore (ap-southeast-1), Sydney (ap-southeast-2), Ireland (eu-west-1), Northern Virginia (us-east-1), and Oregon (us-west-2). FIFO queues are available in Ireland (eu-west-1), Northern Virginia (us-east-1), and Oregon (us-west-2).

*See:* link:/mule-user-guide/v/3.9/anypoint-mq-connector[MQ Connector], link:/anypoint-mq/mq-apis[REST APIs],  link:/anypoint-mq/mq-faq[FAQ], and link:/release-notes/anypoint-mq-release-notes[Release Notes]
...
. Click *MQ* in the Anypoint Platform.
