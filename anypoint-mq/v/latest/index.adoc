...
Anypoint MQ is available in these regions: Singapore (ap-southeast-1), Sydney (ap-southeast-2), Ireland (eu-west-1), 
Northern Virginia (us-east-1), and Oregon (us-west-2). FIFO queues are available in Ireland (eu-west-1), Northern Virginia (us-east-1), and Oregon (us-west-2).
