...
*New: link:/anypoint-mq/mq-queues-and-exchanges#fifo-queues[FIFO Queues]*
...
link:/anypoint-mq/mq-queues-and-exchanges#fifo-queues[FIFO Queues] and link:/anypoint-mq/mq-queues-and-exchanges#dead-letter-queues[Dead Letter Queues].
