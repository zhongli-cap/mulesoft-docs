...
IMPORTANT: FIFO queues are only available in the US West region. If your Anypoint MQ user interface points to an alternate region, you cannot create a FIFO queue.
