...
The following example shows the use of the Anypoint MQ connector to consume information from an object
store:
...
<mule xmlns:anypoint-mq="http://www.mulesoft.org/schema/mule/anypoint-mq"
    ...
    <flow name="objectstore-store-flow">
        ...
        key="#[message.inboundProperties.'http.query.params'.key]"
        value-ref="#[message.inboundProperties.'http.query.params'.value]" doc:name="Store"/>
        <anypoint-mq:consume config-ref="" destination="" doc:name="Anypoint MQ"/>
    ...
    <flow name="objectstore-retrieve-employee-flow">
        ...
        key="#[message.inboundProperties.'http.query.params'.key]" doc:name="Retrieve"/>
        <logger message="Value: #[payload]" level="INFO" doc:name="Log"/>
        <set-payload value="Value : #[payload]" doc:name="Show"/>
    </flow>
    <flow name="object-storeFlow">
        <anypoint-mq:subscriber config-ref="" destination="" doc:name="Anypoint MQ"/>
    </flow>
</mule>
----
