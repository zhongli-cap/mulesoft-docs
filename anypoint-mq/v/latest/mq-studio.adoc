...
. Click the drop-down menu for *Work with* and select *Anypoint Connectors Update Site*. In Studio 6.3.0 and later, select th e *+https://repository.mulesoft.org/connectors/releases/3.5.0+* option.
