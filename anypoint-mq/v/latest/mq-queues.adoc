...
+
. Click Queue, Exchange, or FIFO Queue. For Exchange, see link:/anypoint-mq/mq-exchanges[To Configure Message Exchanges].
...
* FIFO queues support up to 300 transactions per second. In addition, FIFO permits up to 10 inflight messages per queue.
