...
. Log into link:https://anypoint.mulesoft.com/#/signin[Anypoint Platform] and click MQ.
. Click Destinations:
+
...
. Click the drop-down menu for Work With and select `Anypoint Connectors Update Site`. In Studio 6.3.0 and later, select `https://repository.mulesoft.org/connectors/releases/3.5.0` to install this connector.
+
