...
This tutorial covers how to create a standard queue. For information on creating a first-in, first-out (FIFO) queue, see 
link:/anypoint-mq/mq-queues-and-exchanges#fifoqueues[FIFO Queues] in the _Queues and Message Exchanges_ guide.
