...
* Publish to a queue, and view queue messages.
...
To use Studio with Anypoint MQ, first create a client application in link:https://anypoint.mulesoft.com/#/signin[Anypoint Platform], which provides you with a client ID and secret. When you configure the Anypoint MQ connector in Anypoint Studio, you need this information to access the queue you just created.
