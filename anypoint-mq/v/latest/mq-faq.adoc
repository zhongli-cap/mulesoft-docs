...
== FAQ: Why can't I see FIFO Queue in the menu to create a queue or exchange?
...
== FAQ: Can I share queues across regions?
...
== FAQ: How can I restrict access to a queue or message exchange?

Use Anypoint Platform > Access Management > link:/access-management/organization#business-groups[Business Groups]. Queues and message exchanges created in a business group are only visible to those with access to the business group.
...
== FAQ: Can we see the MQ headers in the browse message options?
