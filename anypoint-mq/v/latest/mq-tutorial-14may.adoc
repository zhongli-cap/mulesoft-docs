...
Default TTL (time-to-live) and Default Lock TTL values. If you want your queue encrypted,
...
+
image:mq-click-retmsgs.png[mq-click-retmsgs]
+
...
+
image:mq-message-delete-trash-can-icon.png[mq-message-delete-trash-can-icon]
