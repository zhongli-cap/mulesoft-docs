...
You can also see the Organization ID and Environment ID from Anypoint Platform by clicking *Access Management* and getting the ID values from the URLs in the *Environments* and *Organization* sections.
...
The following example with the Messaging API illustrates the workflow for accessing an API:
