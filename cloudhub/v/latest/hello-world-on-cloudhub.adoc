...
. The first time you start Anypoint Studio, you see a Welcome page. If this is the case, click *Create a Project*.
+
If you already launched Anypoint Studio and closed the Welcome page, click *File* > *New* > *Mule Project*.
+
...
+
. Browse to the URL of *_yourdomain_.cloudhub.io*, for example `helloworld.cloudhub.io`. You should see your application running on CloudHub! (Deployment may take a few minutes.)
+
