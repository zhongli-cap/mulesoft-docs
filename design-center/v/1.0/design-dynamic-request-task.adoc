...
** users is the path known to JSON Placeholder service that returns user data.
...
+
* In General, in Path or URL, click flow-designer-88d35.png[f of x key].
