...
There are many ways in which the flow designer can leverage information about the types of data that transition through your flows, see link:/design-center/v/1.0/about-data-shapes[About Data Shapes] to learn how it's used. This document covers how to provide that information to flow designer.
