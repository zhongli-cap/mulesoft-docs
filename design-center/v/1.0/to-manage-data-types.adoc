...
As a shortcut, instead of manually defining a data type, you can automatically create it based on live data that transitions through your flow once the project is deployed.
...
. Open a component that's processing the data you're interested in, then open its *Output* tab. You should now see the data of all the events it handled.
