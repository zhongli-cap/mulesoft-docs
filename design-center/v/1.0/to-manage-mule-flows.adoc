...
Every flow has a trigger and the trigger executes the flow. The trigger can either be an operation that is externally called, or a Scheduler which executes your flow at a given time interval.
