...
* Importing an OAS zip having nested references in JSON files is _not_ supported.
+
The main OAS file is converted to RAML. Other folders and files in the project as is (unconverted). Use one of the following workarounds:
+
