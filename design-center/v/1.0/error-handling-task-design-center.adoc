...
* link:/mule-user-guide/v/4.1/scopes-concept[About Scopes]
* link:/mule-user-guide/v/4.1/try-scope-concept[About the Try Scope]
* link:/mule-user-guide/v/4.1/error-handling[Error Handling]
