...
. Select a name under which to run your application and the CloudHub link:https://docs.mulesoft.com/access-management/environments[environment] to promote to.
...
. After promoting, you can go to the Runtime Manager console and link:https://docs.mulesoft.com/runtime-manager/managing-deployed-applications[manage your application] in the same way as any other.
+
