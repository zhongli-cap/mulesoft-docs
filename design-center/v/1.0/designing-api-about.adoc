...
* API fragment
+ 
A document, such as a data type, that begins with the RAML version, just like a RAML specification, and includes a fragment identifier.

You can publish an API fragment in Exchange and add it to your specification, and others, as a dependency. You can change the fragment outside the specification and update the fragment version in the specification.
