= To Design the API Specification (Visual Design)

link:/getting-started/api-lifecycle-overview#which-version[_Requires November 2017 Release_]

This procedure is covers how to begin designing an API with visual editing capabilities of Design Center. The following tasks are involved:
