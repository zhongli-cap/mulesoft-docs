...
If any of the flows on your project are triggered by a link:https://mule4-docs.mulesoft.com/mule-user-guide/v/4.0/poll-reference[Scheduler] element, then you can trigger that flow manually by clicking on the *Try* button.
