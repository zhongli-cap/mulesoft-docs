...
+
The possible entries you can make appear as options. Click an option to enter and correctly indent it into the code.
+
...
* Select Files > Import.
* Select the OAS file type to import from the drop-down. Click Choose File. Browse to and select `user-example.json`.
+
