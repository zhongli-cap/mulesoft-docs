...
+
The project opens for design in the master branch, which is a fork of a project that cannot be merged. Two lines of code based on the title and version of the API appear in the RAML editor.
+
