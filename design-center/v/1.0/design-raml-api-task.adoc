...
This procedure covers how to design an API that consumes the free online REST service JSONPlaceholder. For simplicity, the API has only one resource, users. The JSONPlaceholder service returns requests for information about users in JSON. 
