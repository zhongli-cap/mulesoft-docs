...
* The bottom-right corner of your screen displays error messages in red boxes. When you see an error message in this location and you are unable to resolve the error, open a support case for Design Center and paste the content of the message into the support case.
