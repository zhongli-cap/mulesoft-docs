...
After creating an API as described in the following procedure, the API is registered in API Manager. You can apply policies and otherwise manage a registered API.
