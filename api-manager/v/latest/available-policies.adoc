...
link:/api-manager/client-id-based-policies[Client ID Enforcement]:: All calls to the API must include a valid client ID and client secret. Update the RAML of your API using the provided snippet before using this policy.
