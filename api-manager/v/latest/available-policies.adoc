= About Provided Policies (Nov 2017 and July 2017)
...
Only Nov 2017 API Manager images are shown here; however, Nov 2017 and July 2017 versions support these features.
