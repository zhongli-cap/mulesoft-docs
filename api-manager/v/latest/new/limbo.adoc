...
You can use Anypoint Platform on the internet or private cloud. If you don't already have an account, you can sign up to use Anypoint Platform on the internet:
