...
After logging into Anypoint Platform, navigate to *API Manager*.

== Accessing the Analytics Dashboards

As an Organization Administrator or API Creator, you have access to the Analytics Dashboards for your organization. Click Analytics in API Manager.
