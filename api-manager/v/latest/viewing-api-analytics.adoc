...
After logging into Anypoint Platform, navigate to API Manager, and on the Administration page, click Analytics to open the dashboard. You need to belong to the Organization Administrator or API Creator role, to access the Analytics dashboard for your organization. From the dashboard, you can navigate to the analytics about your APIs gathered by Anypoint Platform.
...
. Save the chart.
+
The custom chart appears. Your custom charts are not shared with other members of the API Creators or Organization Administrator roles.
