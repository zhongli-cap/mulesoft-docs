...
* *Scopes*
+
In the optional Scopes field, enter a space-separated list of supported OAuth scopes, such as `read write`. These should match one or more of the scopes defined on the referenced OAuth 2.0 Provider app. If the OAuth 2.0 Provider app defines no scopes, leave this field blank. If you plan to use API Console to simulate your API, leave scopes blank and apply the CORS policy.
+
