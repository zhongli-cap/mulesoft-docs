...
API Gateway Runtime versions are on-premise and cloud. You can link:/api-manager/setting-up-an-api-proxy#using-https[use HTTPS protocol].

== On Premise Using Command Line
...
== On-Premise Using Runtime Manager
