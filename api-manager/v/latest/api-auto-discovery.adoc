...
The following diagram illustrates the process for a project containing an `api-platform-gw:api` auto-discovery global element in the configuration.xml:

image:api-auto-discovery-v2.png[api-auto-discovery-v2,height=602,width=800]
