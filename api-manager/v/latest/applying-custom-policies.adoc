...
* *Policy Definition* - YAML file that describes the policy and its configurable parameters, as shown in this <<Full Example of a Policy Configuration File, example>>
* *Policy Configuration* - XML file with the backend processes that implement the policy, as shown in this <<Full Example of a Policy Configuration File, example>>
