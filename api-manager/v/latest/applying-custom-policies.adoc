...
If you want an API policy that isn't included in the default set of policies, you can create your own custom policy. 

In Studio 6.1 and later, you can use the link:/anypoint-studio/v/6/studio-policy-editor[Studio custom policy editor] (Beta) to create the following required files:
