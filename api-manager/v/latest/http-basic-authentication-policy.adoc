...
This document assumes that you are an API Versions Owner for the API version that you want to manage, or that you are a member of Organization Administrators.
...
* Return to the link:/api-manager/using-policies[Applying Runtime Policies] page.
* Use the link:/api-manager/oauth-2.0-provider-and-oauth-2.0-token-enforcement-policies[OAuth 2.0 Provider and AES OAuth 2.0 Token Enforcement Policies].
