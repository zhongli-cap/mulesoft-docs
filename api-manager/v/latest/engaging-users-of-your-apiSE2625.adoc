...
image:add1.png[add1,height=108,width=150]
...
* API portals
+
Users can search, browse, and sort portals on this page, then navigate to a specific API. Use the sort icon by *API name* to sort portals.
+
...
* My applications
+
This tab lists apps approved to access the API on the *My Applications* tab. On this tab, you can search and sort apps.
