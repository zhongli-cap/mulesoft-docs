...
== Example of API Configured for Auto-Discovery

The following configuration.xml shows the auto-discovery configuration for three APIs described in the link:/apikit/apikit-tutorial-jsonplaceholder[Consuming a Web Service Tutorial].
