...
|*id* | No - API Gateway 2.0.2 and later|The name of the API auto-discovery config used in the main API http inbound endpoint and bean ID of the element. This value is not propagated to the Anypoint Platform.
