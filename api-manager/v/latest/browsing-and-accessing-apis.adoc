...
If you want to remove an application that was previously using your application you need to follow these steps:
* Go to Developer Portal of your API.
* Click on “Developer portal” link (upper left corner).
* Under “My Applications” tab, click on your application name link.
* Click “Delete” button (upper right corner), and confirm.
