...
Before you configure your production gateway, you may want to configure Anypoint Studio to work with your Anypoint Platform organization for testing. First, link:/anypoint-studio/v/6.0/install-studio-gw[download and install API Gateway Runtime] from the Studio Update Site.
