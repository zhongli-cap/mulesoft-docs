= To Avoid Same-Origin Restrictions (New and Classic)
...
=== Bypassing the Proxy for the API Console and API Designer (Classic)
...
=== Bypassing the Proxy for the API Notebook (Classic)
