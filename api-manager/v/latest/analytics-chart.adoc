= Analytics Chart in API Manager (New and Classic)
:keywords: analytics, chart, api, manager, api manager

API Analytics provides a summary in the API Manager view of Anypoint Platform.
...
. In API Manager, click the instance name of a deployed API.
+
The Analytics Chart appears,

== Requests Summary Chart

The Requests summary chart lists the total number of requests to your API by the duration you choose. The chart shows the HTTP status codes specified by W3C.
