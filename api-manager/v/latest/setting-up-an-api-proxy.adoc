...
|`--hostname` | The host name of the PCF App to which proxy is deployed. If nodejs-app.apps.pcf.com is the App url to which proxy is required, then nodejs-app is hostname and apps.pcf.com is domain.
...
|`hostname` | The host name of the PCF App to which proxy is deployed. It should match the hostname that you provided as properties on the command. If nodejs-app.apps.pcf.com is the App url to which proxy is required, then nodejs-app is hostname and apps.pcf.com is domain.
