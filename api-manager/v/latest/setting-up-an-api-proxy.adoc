...
[NOTE]
====
This modality is in *Beta* and only available with the link:/anypoint-platform-on-premises[Anypoint Platform On-premises Edition]. For it to be available, you must first install and configure the link:http://docs.pivotal.io/mulesoft/index.html[PCF Tile].
