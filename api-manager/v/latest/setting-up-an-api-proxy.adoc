...
A new link appears under the API Status labeled *Re-deploy proxy*. If you make changes to the configuration, re-deploy the proxy application to the same CloudHub application.
