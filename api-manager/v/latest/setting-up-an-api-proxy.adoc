...
=== Deploying to API Gateway 2.x

To deploy an API to API Gateway 2.x installations, follow instructions in the link:/api-manager/deploy-to-api-gateway-runtime[archive documentation].
