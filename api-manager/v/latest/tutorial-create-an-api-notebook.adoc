...
. Follow instructions below the code cell you created to create a new code cell and type the name of the API in that cell. For example, type tShirtOrderingService in the cell.
...
----
+
. Observe the autocompelte choices from your RAML that are offered to you as you type. To add a line break within the cell, press **Shift + Enter**.
