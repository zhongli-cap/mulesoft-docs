= About API Alerts (New and Classic)
...
You create and configure an API alert by adding alerts to an API instance (New) or a deployed version (Classic) in API Manager.

== Prerequisites for Adding and Viewing API Manager (Classic) Alerts

If you use the new API Manager and you have permission to work in an environment, you can add alerts to APIs there. If you use the classic API Manager, you need to belong to one of the following roles:
