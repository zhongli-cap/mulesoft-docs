= Client ID-Based Policies (Nov 2017 and July 2017)
...
When registering an application in an Exchange portal (Nov 2017) or API portal (July 2017), client app developers obtain credentials, the client ID and client secret, that you configured when applying the policy.
