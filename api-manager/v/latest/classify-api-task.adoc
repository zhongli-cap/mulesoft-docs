...
If the API is not running, following the single-step classification process in this procedure. If the API is running, you need follow the two-step classification process.
