...
. Depending on the policy, you may need to provide configuration details. See detailed instructions for configuring one of the available policies:
...
+
image::using-policies-28459.png[using-policies-28459,height=732,width=317]
+
