...
To disable a policy, click *Disable* in the list of applied policies. Disabling preserves the state of the policy and data values, but stops enforcement of the policy.
...
+
image::using-policies-28459.png[using-policies-28459]
+
