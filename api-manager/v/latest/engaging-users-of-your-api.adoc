= Engaging Users on an API Portal
:keywords: portal, notebook, terms, conditions

To engage users who might be interested in your API, use your organization's link:/api-manager/browsing-and-accessing-apis[Developer Portal] or create your own portal. 

A developer portal, such as the one at 
https://anypoint.mulesoft.com/apiplatform/anypoint-platform/#/portals is public and intended to list all Anypoint Platform APIs. You can use the APIs on this portal to automate Anypoint Platform activities. 

You can create and manage a developer portal for your organization's APIs or an API portal exclusively for one of your APIs. You can customize the content, configure privacy, and add an API Console and API Notebook to the portal as described in the link:/api-manager/tutorial-create-an-api-portal[API Portal tutorial].
