...
* My applications
+
You can search for and sort the lists apps approved to access the API.

Subject to role and permissions, you can use controls on the developer portal for removing app access privileges. Delete the app from the portal to remove access privileges. You can reset the client ID and client secret.
