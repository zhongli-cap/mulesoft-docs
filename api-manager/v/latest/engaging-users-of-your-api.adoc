...
To manage an app, click an app name in the list. The app page appears.

image::engaging-users-of-your-api-b2f1c.png[engaging-users-of-your-api-b2f1c]

Subject to role and permissions, you can use controls on the developer portal for removing app access privileges. Delete the app from the portal to remove access privileges. You can reset the client ID and client secret, update app properties, such as the name and URL, and view information about the app, such as its SLA tier.
