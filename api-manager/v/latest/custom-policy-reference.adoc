...
=== YAML Syntax Examples for Parameters

The following snippets show how to use the parameters previously listed.
...
The following example shows the interface of an IP White List policy:
