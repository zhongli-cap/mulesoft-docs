...
Examples of a custom policy that validates client IDs are variations from out-of-the-box policies that authenticate clients, such as Client ID Enforcement or SLA-based policies.
