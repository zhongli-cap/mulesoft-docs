...
API Manager environment administrator only relates to actions inside of API Manager. The API Manager Environment Administration role allows you to modify your APIs as well as those created by others. As administrator, you grant permissions to users as described in the topic linked below.
