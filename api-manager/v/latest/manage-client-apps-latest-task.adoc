...
The applications you grant access are listed on API Manager > Client Applications. As Organization Administrator or Environment Administrator, you can manage client applications registered to access your API. 
