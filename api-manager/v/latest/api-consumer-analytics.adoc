= Anypoint Analytics - API Consumer (New and Classic)
:keywords: analytics, consumer, api consumer, api

The way you view the metrics associated with the API calls made by your client applications depends on the version of API Manager you use.

* New API Manager
+
From the public Exchange portal
+
* Classic API Manager
+
...
Sign into Anypoint Platform and from API Manager, navigate to one of the following locations, depending on the version of API Manager you use.

* Classic API Manager: Choose Developer portal > My applications 
* New API Manager: Click Client Applications
