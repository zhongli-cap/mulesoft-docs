= LDAP Security Manager (Nov 2017 and Jul 2017)
...
. Navigate to API Manager and click an API version (Jul 2017) or instance (Nov 2017)  to which you want to apply the policy.
