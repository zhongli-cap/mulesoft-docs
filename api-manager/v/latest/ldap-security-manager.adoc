...
. Navigate to the link:/api-manager/tutorial-set-up-and-deploy-an-api-proxy[API version details page] for the API version to which you want to apply the policy.
