...
. In the API version details page, on the Policies tab, click the `RAML Snippet` link for the API, and add the RAML snippet to the RAML code of the API in Designer. 
