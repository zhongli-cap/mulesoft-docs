...
You can build the provider by downloading a template from Exchange and making configuration changes. One of the key configuration changes is specifying the following endpoint paths:
