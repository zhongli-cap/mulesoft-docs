...
To build a provider to run on Mule 3.8.x runtime or later, see the link:/mule-user-guide/v/3.8/creating-an-oauth-2.0a-web-service-provider[Creating an OAuth 2.0a Web Service Provider].
