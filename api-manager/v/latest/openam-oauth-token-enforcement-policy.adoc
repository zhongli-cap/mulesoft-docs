= About OpenAM, OpenID Connect, or PingFederate OAuth Token Enforcement Policies (Jul 2017)
...
* link:/api-manager/apply-oauth-token-policy-task[Configure and Apply an OAuth 2.0 Token Validation Policy]
