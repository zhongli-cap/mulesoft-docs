...
* link:/api-manager/v/1.x/aes-oauth-faq#about-oauth-provider-models[external OAuth 2.0 provider]
* link:/api-manager/v/1.x/building-an-external-oauth-2.0-provider-application[Build an external OAuth 2.0 provider].
