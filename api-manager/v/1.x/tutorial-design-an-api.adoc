...
The option baseUri serves as an identifier for the API and forms the base of the URLs of the resources. Configuring this URL does not deploy the API or guarantee that the API is accessible at that URL. To deploy the API, you need to link:/api-manager/v/1.x/setting-up-an-api-proxy[configure endpoints].
...
* link:/api-manager/v/1.x/designing-your-api#accessing-api-designer[API Designer Reference]. 
* link:/api-manager/v/1.x/designing-your-api#using-hints-raml-editor-shelf-and-autocompletion[The API Designer shelf]
* link:http://jsonplaceholder.typicode.com[JSONPlaceholder free REST service]
* link:/api-manager/v/1.x/designing-your-api#using-hints-raml-editor-shelf-and-autocompletion[The API Designer shelf]
* link:/api-manager/v/1.x/setting-up-an-api-proxy[Configure endpoints and deploy the API]