...
* link:/api-manager/v/1.x/cors-policy[Applying and Editing a CORS Policy]
* link:/api-manager/v/1.x/accessing-your-api-behind-a-firewall[Accessing your API Behind a Firewall]
