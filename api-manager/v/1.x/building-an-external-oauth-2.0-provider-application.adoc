...
* link:/api-manager/v/1.x/to-test-local-provider[Test the provider]
* link:/api-manager/v/1.x/external-oauth-2.0-token-validation-policy[Access Token Enforcement Using External Provider policy]
* link:/api-manager/v/1.x/aes-oauth-faq#about-oauth-provider-models[About the External OAuth 2.0 provider]
