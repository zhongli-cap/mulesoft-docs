...
:keywords: auto-discovery, autodiscovery, auto-discovery schema, Autodiscovery namespace
...
image::api-auto-discovery-reference-0dc02.png[api-Autodiscovery-reference-0dc02]
