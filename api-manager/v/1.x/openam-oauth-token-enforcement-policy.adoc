...
* link:/api-manager/v/1.x/apply-oauth-token-policy-task[Configure and Apply an OAuth 2.0 Token Validation Policy]
* link:/api-manager/v/1.x/using-policies#applying-and-removing-policies[General procedure for applying policies]
