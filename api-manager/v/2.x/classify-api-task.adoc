...
If you need to track APIs using environment credentials please follow the advanced section.
...
=== Advanced Section for classification to configure Mule Servers with environment credentials (Optional)

This configuration can be used for tracking APIs using environment credentails, please notes this configuration requires a server restart.
