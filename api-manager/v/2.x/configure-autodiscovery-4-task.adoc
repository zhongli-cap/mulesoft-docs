...
[NOTE]
====
Mule 4 relies on Crowd (API Manager v2) type organizations in order to bind to API Manager instance. Thus it won't work for customers on pre-crowd release.
====
