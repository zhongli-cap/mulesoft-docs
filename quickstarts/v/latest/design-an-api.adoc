...
+
NOTE: If you want to skip using the editor to create the RAML definition, you can download the completed link:_attachments/t-shirt.raml[t-shirt RAML definition file], and copy and paste it into the API Designer.
+
----
#%RAML 1.0
