...
If this is your first time using Studio, we also recommend you to take a quick look at our link:/mule-fundamentals/v/3.8-m1/basic-studio-tutorial[Basic Studio Tutorial] for a more detailed explanation of each tool and view within Studio.
--
