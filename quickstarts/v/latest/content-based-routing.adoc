...
Congratulations! You earned your extra credit. You're all set to go on to the link:/quickstarts/anypoint-connector[Anypoint Connector quickstart].
...
* *NEXT STEP:* Test yourself with the next, slightly more complex link:/quickstarts/anypoint-connector[Anypoint Connector quickstart].
