...
This tutorial also assumes that you have a basic understanding of the link:/mule-user-guide/v/3.8/mule-message-structure[Mule message structure].
...
* Learn more about link:/anypoint-studio/v/6/studio-visual-debugger[Visual Debugger], the link:/mule-user-guide/v/3.8/logger-component-reference[Logger], and link:/anypoint-studio/v/6/datasense[DataSense].
...
** link:/getting-started/content-based-routing[Content-Based Routing Tutorial]
** link:/getting-started/anypoint-connector[Anypoint Connector quickstart]
