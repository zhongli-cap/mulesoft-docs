...
* *System APIs* - facilitate connectivity to core storage systems. These APIs are more prone to change.
* *Process APIs* - APIs that work to collect, interact with and shape data, effectively isolating transformation of data from the data source in backend systems as well as from the user experience
* *Experience APIs* - used on top of System and Process APIs to enhance consumability of information from connected systems
