...
[NOTE]
Start setting up your link:/anypoint-studio/v/6/setting-up-your-development-environment[Development Environment] and get your feet wet by building integrations with Anypoint Studio, link:/getting-started/[Begin with the Basics of Mule].
