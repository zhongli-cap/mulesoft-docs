= Web Services and Anypoint Connectors
:keywords: connectors, tutorial, fundamentals

After learning some of the basic functionality in the link:/anypoint-studio/v/6/basic-studio-tutorial[Basic] and link:/getting-started/content-based-routing-tutorial[Content-Based Routing Tutorials], it's time to try your hand at enriching your application using web services and *Anypoint Connectors*.

Out of the box, Anypoint Studio comes with a set of connectors that you can easily add to your Studio flow to connect your application. Anypoint connectors for common software as a service (SaaS) such as Salesforce, Google Contacts, Facebook, and Twitter simplify the interaction with the SaaS providers' APIs, providing pre-built methods for all of the available operations.

Much of the functionality of each individual connectors is dependent upon its target; that said, there are also many features common to almost all connectors. After creating and running the applications in this tutorial, you should be able to apply what you've learned to connect applications to various SaaS applications. 

== Prerequisites

This tutorial assumes that you have link:/anypoint-studio/v/6/download-and-launch-anypoint-studio[downloaded and installed Anypoint Studio]. If you do not have any previous experience with Eclipse or an Eclipse-based IDE, you can review the brief introduction to the link:/anypoint-studio/v/6/[Anypoint Studio interface] and the document describing link:/mule-user-guide/v/3.8/global-elements[Global Elements in Mule]. Further, consider following the link:/anypoint-studio/v/6/basic-studio-tutorial[Basic] and link:/getting-started/content-based-routing-tutorial[Content-Based Routing] tutorials.
