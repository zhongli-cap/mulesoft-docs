= Anypoint Connector Intro
:keywords: connectors, tutorial, fundamentals

After learning some of the basic functionality in the link:/anypoint-studio/v/6/basic-studio-tutorial[Basic Studio Tutorial] and link:/getting-started/content-based-routing-tutorial[Content-Based Routing Tutorial], it's time to try your hand at enriching your application with web services, APIs, and *Anypoint Connectors*.
