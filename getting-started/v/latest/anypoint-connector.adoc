...
[NOTE]
link:/anypoint-studio/v/6/[Anypoint Studio] comes with a set of connectors that you can easily add to your Studio flow to connect your application. You can find all certified connectors in link:/anypoint-exchange[Anypoint Exchange].
