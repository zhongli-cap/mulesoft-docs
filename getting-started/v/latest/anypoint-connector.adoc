...
[NOTE]
link:/anypoint-studio/v/6/[Anypoint Studio] comes with a set of connectors that you can easily add to your Studio flow to connect your application. You can find all certified connectors in link:/anypoint-exchange/anypoint-exchange[Anypoint Exchange].
...
. Reference the properties from the *connector configuration*. The connector configuration is automatically stored by Studio as a link:/mule-user-guide/v/3.8/global-elements[global element] for use by any other connector instance using the same properties.
...
* link:/getting-started/mule-message[Mule Message Tutorial]
