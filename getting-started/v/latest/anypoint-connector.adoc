...
After learning some of the basic functionality described in the link:/anypoint-studio/v/6/basic-studio-tutorial[Basic Studio Tutorial] and link:/getting-started/build-a-hello-world-application[Create a Mule App] docs, it's time to try your hand at enriching your application with an *Anypoint Connector*.
