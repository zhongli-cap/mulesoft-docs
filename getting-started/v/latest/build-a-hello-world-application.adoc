...
As the objective of this quick tutorial is to get something built and running fast, this document doesn't spend much time explaining Mule concepts or components. For more background on Mule see the section on link:/mule-user-guide/v/3.8/[Mule Runtime] and for Mule application design, go to the link:https://docs.mulesoft.com/anypoint-studio/v/6/basic-studio-tutorial[Basic Studio Tutorial].
