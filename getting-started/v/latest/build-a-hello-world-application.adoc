...
As the objective of this quick tutorial is to get something built and running fast, this document doesn't spend much time explaining Mule concepts or components. You can read more in the section on /mule-user-guide/v/3.8/[Mule Runtime]. 
