= About the Crowd Release API Lifecycle
...
July 29 with no APIs in API Manager*: If you do not have subscription to API Manager and Analytics, you will have the new API designer starting Aug 14, 2017. The current API designer within API Manager will be disabled for these accounts.
