= How to Route Mule Messages Based on Content
...
[source,xml, linenums]
----
include::_sources/content-based-routing_1.xml[]
----
...
* Get a deeper explanation about the link:/mule-user-guide/v/3.8/mule-message-structure[Mule message] and anatomy of a link:/mule-user-guide/v/3.8/mule-application-architecture[Mule application].
