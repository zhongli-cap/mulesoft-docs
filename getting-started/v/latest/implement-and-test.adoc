...
To create a Studio project for the example T-Shirt API on Anypoint Platform, you first need to set up the t.shirt.raml definition link:/getting-started/create-an-api[in Anypoint Platform]
