...
You can have only 25 pieces of content on Exchange to start, and then you have to request more space from MuleSoft. Contact a  mailto:info@mulesoft.com[sales representative] for more information.
