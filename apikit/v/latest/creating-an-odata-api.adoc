...
+
. Click the Database component in one of the flows such as get:customers:config.
. In the properties editor, in *Connector configuration*, click image:Edit-16x16.gif[Edit-16x16].
+
The Global Element Properties dialog appears.
+
. Click *Test Connection* to test the connection to MySQL.
+
image::creating-an-odata-api-4b181.png[creating-an-odata-api-4b181,height=438,width=441]
