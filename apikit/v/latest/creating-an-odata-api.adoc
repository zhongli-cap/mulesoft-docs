...
. In the properties editor, in *Connector configuration*, click image:Edit-16x16.gif[Edit-16x16], and click *Test Connection* to test the connection to MySQL.
+
image::creating-an-odata-api-4b181.png[creating-an-odata-api-4b181]
