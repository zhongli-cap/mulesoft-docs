= APIkit Tutorial - Consuming a Web Service
...
+
* On the /users resource *GET* tab, click *Try It*, and then *GET* to retrieve the RAML example in the `users.json` file.
+
...
----
+
* On the /usersbyid resource *GET* tab, click *Try It*, and then *GET* to retrieve the RAML example for user 3 using the default parameter 3, as written in the RAML file.
+
----
{
  "id": 3,
...
. In Connector Configuration, click image:Edit-16x16.gif and click OK to accept the default host 0.0.0.0 and port 8081.
...
+
. In Connector Configuration, click image:Add-16x16.gif.
+
