...
. In the New Mule Project wizard, enter a Name for the project and select an *EE runtime*, for example Mule Server 3.8.1 EE.
. Click *Add APIkit components* and browse to the tshirt2.wsdl file you downloaded.
