...
See the link:/apikit/apikit-using[Using APIkit] section for more information about APIkit for SOAP.

== Create a New Project

To create an APIkit for SOAP using Studio, follow the instructions in this document. See the link:/apikit/apikit-reference[APIkit Reference] for information about using APIkit for SOAP from the command line.
...
. Search for `fault1 in the palette, drag and drop *SOAP Fault into the `ListInventory:api-config` flow.
