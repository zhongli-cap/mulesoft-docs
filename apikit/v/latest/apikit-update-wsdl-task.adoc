...
. Download `+https://ml-khahn-osx-sf.local/apikit/_attachments/tshirt-modified.wsdl+`, copy the entire contents of the downloaded file, and paste it in tshirt2.wsdl, replacing the tshirt2.wsdl content.
+
