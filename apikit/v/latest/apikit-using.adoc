...
Included in the project are backend flows containing REST resource-action mappings or SOAP message templates. You can simulate calls to the API using APIkit Console when you import a RAML, but not a WSDL. You need to use a SOAP testing tool, such as SoapUI.
