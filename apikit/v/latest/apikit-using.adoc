...
When using a reverse proxy, set the `keepRamlBaseUri` attribute in the `apikit:config` element to true. The app uses the URL of a proxy for the baseUri property of the RAML. You can access APIkit Console.
