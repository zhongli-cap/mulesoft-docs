...
When configuring an HTTP request after deployment, if the API is accessible, not blocked by a policy, you can use an HTTP client, such as Postman, to obtain the RAML definition.
...
image::apikit-using-adf02.png[apikit-using-adf02,height=341,width=729]
