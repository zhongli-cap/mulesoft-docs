...
APIkit 3.8.1 supports RAML 1.0 and 0.8 versions as described in the link:/release-notes/apikit-release-notes[release notes]. APIkit projects can run onsite or use CloudHub runtimes. To get started using APIkit in Anypoint Studio, do one of the following:
