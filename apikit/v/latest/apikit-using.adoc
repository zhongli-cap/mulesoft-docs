...
CloudHub requires a unique application name regardless of the region where you deploy the API; therefore, to deploy an API to multiple regions, you need to add the region name to the application name. For example:
