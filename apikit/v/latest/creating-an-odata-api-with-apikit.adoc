...
Using Studio, you install the APIKit OData Extension from the link:/anypoint-studio/v/6/studio-update-sites[OData update site] as described in the following procedure.
