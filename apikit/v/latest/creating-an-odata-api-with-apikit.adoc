...
* Studio 6.1.1-UI-Private
* OData extension update from the ODATA update site:  
+
`http://studio.mulesoft.org/r5/apikit-for-odata`
+
Update the site according to the instructions in the email you received from Product Management.

== GA Release Prerequisites
