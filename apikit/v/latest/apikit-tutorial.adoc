...
You can deploy the project to Anypoint Platform, thereby registering the API with API Manager. After registering the API, you can apply policies and perform link:https://docs.mulesoft.com/api-manager/creating-your-api-in-the-anypoint-platform[other API management tasks]. 

* Applying policies
* Enhancing the RAML using API Designer
* Creating a portal for the API to engage users

In Studio, you first prepare the API for auto-discovery, and then run the project as a Mule application. 
