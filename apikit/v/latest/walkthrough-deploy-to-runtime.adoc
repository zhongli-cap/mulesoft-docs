= Deploy an APIkit project
:keywords: deploy, api, runtime, apikit, gateway

Save an APIkit project as a deployable zip file. If you created or modified the file in Anypoint Studio:
...
== Tutorial for Deploying an APIkit Project
