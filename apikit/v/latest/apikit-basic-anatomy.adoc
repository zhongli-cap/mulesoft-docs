...
* Follow the link:/apikit/apikit-tutorial[APIkit Tutorial] to install APIkit, then build, deploy and test a REST API.
* Learn more about APIkit features and functionality in the link:/apikit/apikit-beyond-the-basics[Beyond the Basics] documentation.
