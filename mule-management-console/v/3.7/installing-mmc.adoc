...
|===
a|
link:/mule-management-console/v/3.7/installing-the-trial-version-of-mmc[image:MMC-trial.png[MMC-trial]]

*link:/mule-management-console/v/3.7/installing-the-trial-version-of-mmc[Install the trial version] if you are interested in evaluating the Mule Management Console.*
