...
Note that this syntax is an example. Be sure to find your own setting for mmc-console-3.7.3 which is usually the name of the .war file.
...
    ],
  "status":"OK",
  "href":"http://localhost:8080/mmc-console-3.7.3/api/servers/local$f151c1cb-634a-4da5-baba-806ee4a09464",
  "runningServices":-1,
...
[source, code, linenums]
----
GET http://localhost:8080/mmc-console-3.7.3/api/servers[?group={serverGroupId}]
----
...
----
 curl --basic -u admin:admin http://localhost:8080/mmc-console-3.7.3/api/servers
----
...
            {
              "name":"Production",
              "href":"http://localhost:8080/mmc-console-3.7.3/api/serverGroups/0bc8932b-8463-46cd-9a1f-77060756c5c0"
            }
          ],
        "status":"OK",
        "href":"http://localhost:8080/mmc-console-3.7.3/api/servers/local$a89eb3d0-68b9-44a0-9f6b-712b0895f469",
...
[source, code, linenums]
----
GET http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}
----
...
----
 curl --basic -u admin:admin http://localhost:8080/mmc-console-3.7.3/api/servers/local$97e3c184-09ed-423e-a5a5-9b94713a9e36
----
...
[source, code, linenums]
----
DELETE http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}
----
...
[source, code, linenums]
----
 curl --basic -u admin:admin -X DELETE http://localhost:8080/mmc-console-3.7.3/api/servers/local$a89eb3d0-68b9-44a0-9f6b-712b0895f469
----
...
[source, code, linenums]
----
 curl --basic -u admin:admin -X PUT -d "{ \"name\" : \"New Server Name\", \"groups\":[{\"href\":\"0bc8932b-8463-46cd-9a1f-77060756c5c0\"}]}" --header "Content-Type: application/json" http://localhost:8080/mmc-console-3.7.3/api/servers/local$a89eb3d0-68b9-44a0-9f6b-712b0895f469
----
...
Note that this syntax is an example. Be sure to find your own setting for mmc-console-3.7.3 which is usually the name of the .war file. Further, serverId must reference your own server.

[source, code, linenums]
----
GET http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/applications
----
...
[source, code, linenums]
----
 curl --basic -u admin:admin http://localhost:8080/mmc-console-3.7.3/api/servers/local$a89eb3d0-68b9-44a0-9f6b-712b0895f469/applications
----
...
`POST http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/restart`
...
[source, code, linenums]
----
 curl --basic -u admin:admin http://localhost:8080/mmc-console-3.7.3/api/servers/local$a89eb3d0-68b9-44a0-9f6b-712b0895f469/restart
----
...
[source, code, linenums]
----
POST http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/stop
----
...
[source, code, linenums]
----
 curl --basic -u admin:admin http://localhost:8080/mmc-console-3.7.3/api/servers/local$a89eb3d0-68b9-44a0-9f6b-712b0895f469/stop
----
...
`GET http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/files`
...
[source, code, linenums]
----
 curl --basic -u admin:admin http://localhost:8080/mmc-console-3.7.3/api/servers/local$97e3c184-09ed-423e-a5a5-9b94713a9e36/files
----
...
`GET http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/files/{relativePathToFile}[?metadata=true]`
...
[source, code, linenums]
----
 curl --basic -u admin:admin http://localhost:8080/mmc-console-3.7.3/api/servers/local$24600824-af33-4394-8e39-93f9fcf4faae/files/bin/mule
----
...
`POST http://localhost:8080/mmc-console-3.7.3/api/server/{serverId}/files/{relative path to file to be created}`
...
[source, code, linenums]
----
 curl --basic -u admin:admin -v --header "Content-Type:application/octet-stream" --data-binary "@test.xml" http://localhost:8080/mmc-console-3.7.3/api/servers/local$24600824-af33-4394-8e39-93f9fcf4faae/files/logs/fileOnLogsFolder.txt
----
...
`PUT http://localhost:8080/mmc-console-3.7.3/api/server/{serverId}/files/{relative path to file to be replaced}`
...
[source, code, linenums]
----
 curl --basic -u admin:admin -X PUT --header "Content-Type:application/octet-stream" --data-binary "@test.xml" http://localhost:8080/mmc-console-3.7.3/api/servers/local$24600824-af33-4394-8e39-93f9fcf4faae/files/logs/fileOnLogsFolder.txt
----
...
`DELETE http://localhost:8080/mmc-console-3.7.3/api/server/{serverId}/files/{relative path to file to be deleted}`
...
[source, code, linenums]
----
 curl --basic -u admin:admin -X DELETE http://localhost:8080/mmc-console-3.7.3/api/servers/local$24600824-af33-4394-8e39-93f9fcf4faae/files/logs/fileOnLogsFolder.txt
----
...
`GET http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/flows[?refreshStats=TRUE|FALSE]`
...
[source, code, linenums]
----
 curl --basic -u admin:admin http://localhost:8080/mmc-console-3.7.3/api/servers/local$97e3c184-09ed-423e-a5a5-9b94713a9e36/flows
----
...
`POST http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/flows/{flowName}/{applicationName}/start`
...
----
curl --basic -u admin:admin -X POST http://localhost:8080/mmc-console-3.7.3/api/servers/local$24600824-af33-4394-8e39-93f9fcf4faae/flows/Hello%20World/mule-example-hello/start
----
...
`POST http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/flows/{flowName}/{applicationName}/stop`
...
[source, code, linenums]
----
curl --basic -u admin:admin -X POST http://localhost:8080/mmc-console-3.7.3/api/servers/local$24600824-af33-4394-8e39-93f9fcf4faae/flows/Hello%20World/mule-example-hello/stop
----
...
`GET http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/flows/{flowName}/{applicationName}/endpoints`
...
[source, code, linenums]
----
 curl --basic -u admin:admin http://localhost:8080/mmc-console-3.7.3/api/servers/local$24600824-af33-4394-8e39-93f9fcf4faae/flows/Hello%20World/mule-example-hello/endpoints
----
...
`POST http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/flows/{flowName}/{applicationName}/endpoints/{endpointId}/start`
...
[source, code, linenums]
----
 curl --basic -u admin:admin -X POST http://localhost:8080/mmc-console-3.7.3/api/servers/local$24600824-af33-4394-8e39-93f9fcf4faae/flows/Hello%20World/mule-example-hello/endpoints/endpoint.http.localhost.8888/start
----
...
`POST http://localhost:8080/mmc-console-3.7.3/api/servers/{serverId}/flows/{flowName}/{applicationName}/endpoints/{endpointId}/stop`
...
[source, code, linenums]
----
 curl --basic -u admin:admin -X POST http://localhost:8080/mmc-console-3.7.3/api/servers/local$24600824-af33-4394-8e39-93f9fcf4faae/flows/Hello%20World/mule-example-hello/endpoints/endpoint.http.localhost.8888/stop
----
