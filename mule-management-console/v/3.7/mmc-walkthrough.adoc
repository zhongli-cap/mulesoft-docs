...
This walkthrough assumes that you are familiar with link:https://docs.mulesoft.com/mule-user-guide/v/3.7/mule-concepts[Mule applications and Mule flows] and that you have downloaded and installed the trial version of link:https://www.mulesoft.com/dl/mmc[MMC]. Beyond installation, you do not need to complete any specific setup configurations to complete this walkthrough.
