...
To set up MMC, you will first need to register your Mule ESB servers with MMC. For details on how to do this, see link:/mule-management-console/v/3.7/setting-up-mmc-mule-esb-communications[Setting Up MMC-Mule ESB Communications].

To use MMC in a production environment, you need to deploy MMC to a Web application server such as Tomcat. You do this when link:/mule-management-console/v/3.7/installing-the-production-version-of-mmc[installing the production version of MMC].
...
* link:/mule-management-console/v/3.7/persisting-mmc-data-on-external-databases[Set up external databases] to persist MMC environment or transaction data (Business Events)
* link:/mule-management-console/v/3.7/managing-mmc-users-and-roles[Manage MMC users and roles] via LDAP
...
* *a Web application server such as Tcat, Tomcat, or JBoss*. Refer to the link:/mule-user-guide/v/3.7/hardware-and-software-requirements[Hardware and Software Requirements] for the latest information about hardware requirements and supported application servers, Java Runtime Environments, and browsers.
...
See link:/mule-management-console/v/3.7/setting-up-and-managing-users-in-mmc[Setting Up and Managing Users in MMC] for more information.

If you have an existing LDAP database to manage user data such as usernames and passwords, you can configure MMC to connect directly to the LDAP server for user management. Note that you will still need to link:/mule-management-console/v/3.7/managing-mmc-users-and-roles[define user groups and permissions] using the MMC interface.

See link:/mule-management-console/v/3.7/setting-up-and-managing-users-via-ldap[Setting Up and Managing Users via LDAP] for more information.
...
* link:/mule-management-console/v/3.7/persisting-mmc-data-to-oracle[MMC version 3.4.1 and earlier]
* link:/mule-management-console/v/3.7/persisting-mmc-data-to-oracle[MMC version 3.4.2 and later]

==== PostgresSQL

* link:/mule-management-console/v/3.7/persisting-mmc-data-to-postgresql[MMC version 3.4.1 and earlier]
* link:/mule-management-console/v/3.7/persisting-mmc-data-to-postgresql[MMC version 3.4.2]link:/mule-management-console/v/3.7/persisting-mmc-data-to-oracle[and later]

==== MySQL

* link:/mule-management-console/v/3.7/persisting-mmc-data-to-mysql[MMC version 3.4.1 and earlier]
* link:/mule-management-console/v/3.7/persisting-mmc-data-to-mysql[MMC version 3.4.2]link:/mule-management-console/v/3.7/persisting-mmc-data-to-oracle[and later]

==== MS SQL Server

* link:/mule-management-console/v/3.7/persisting-mmc-data-to-ms-sql-server[MMC version 3.4.1 and earlier]
* link:/mule-management-console/v/3.7/persisting-mmc-data-to-ms-sql-server[MMC version 3.4.2]link:/mule-management-console/v/3.7/persisting-mmc-data-to-oracle[and later]

=== User Management

There are two ways of creating and configuring MMC user accounts:

* link:/mule-management-console/v/3.7/setting-up-and-managing-users-in-mmc[Through the MMC interface]
* link:/mule-management-console/v/3.7/setting-up-and-managing-users-via-ldap[Through LDAP]

To define user groups and assign fine-grained permissions to those groups, follow the instructions in link:/mule-management-console/v/3.7/managing-mmc-users-and-roles[Managing MMC Users and Roles]. You can manage user groups and their permissions only through the MMC interface, even if you set up an LDAP server to manage user accounts. 

== See Also

* Read more about link:/mule-management-console/v/3.7/managing-mmc-users-and-roles[Managing MMC Users and Roles].
* Find out how to set up an link:/mule-management-console/v/3.7/persisting-mmc-data-to-oracle[Oracle], link:/mule-management-console/v/3.7/persisting-mmc-data-to-postgresql[PostgreSQL], link:/mule-management-console/v/3.7/persisting-mmc-data-to-mysql[MySQL], or link:/mule-management-console/v/3.7/persisting-mmc-data-to-ms-sql-server[MS SQL Server] database to persist your environment or transaction data.
