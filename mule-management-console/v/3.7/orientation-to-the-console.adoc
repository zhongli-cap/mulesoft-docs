...
This document assumes that you have link:/mule-management-console/v/3.7/installing-mmc[downloaded and installed] the production version of the  *Mule Management Console*.
