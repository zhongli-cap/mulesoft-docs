...
In the metadata you set for custom events, you can make use of fine-grained link:https://docs.mulesoft.com/mule-user-guide/v/3.2/expressions-configuration-reference[expression language], as shown below.
