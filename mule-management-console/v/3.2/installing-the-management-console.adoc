...
See link:https://docs.mulesoft.com/tcat-server/v/7.1.0/[Tcat Server Documentation] for instructions on how to deploy web applications inside of Tcat. See link:/mule-user-guide/v/3.2/deploying-mule-as-a-service-to-tomcat[Deploying Mule as a Service to Tomcat] for specifics on this deployment configuration.
