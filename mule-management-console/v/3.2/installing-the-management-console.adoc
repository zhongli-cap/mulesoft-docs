...
See link:/tcat-server/v/7.1.0/[Tcat Server Documentation] for instructions on how to deploy web applications inside of Tcat. See link:https://docs.mulesoft.com/mule-user-guide/v/3.2/deploying-mule-as-a-service-to-tomcat[Deploying Mule as a Service to Tomcat] for specifics on this deployment configuration.
...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/deploying-mule-to-jboss[Deploying Mule to JBoss]
* link:/mule-management-console/v/3.5/installing-and-deploying-mmc-to-weblogic[Installing and Deploying MMC to Weblogic]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/deploying-mule-to-websphere[Deploying Mule to WebSphere]
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/deploying-mule-as-a-service-to-tomcat[Deploying Mule as a Service to Tomcat]
