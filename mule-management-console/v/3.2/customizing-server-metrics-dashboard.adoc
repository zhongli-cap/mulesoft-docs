...
link:/mule-management-console/v/3.2/editing-server-settings[<< Previous: *Editing Server Settings*]

link:/mule-management-console/v/3.2/mule-high-availability-ha-clusters[Next: *Mule High Availability (HA) Clusters* >>]
