...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.2/routing-message-processors[Using Message Processors to Control Message Flow] - Provides reference information for the available Mule message processors or routers.
