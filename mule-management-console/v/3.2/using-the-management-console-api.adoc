...
If you are programming in Java, it's recommended that you use the [Jersey client. Or, for JSON support, use the link:http://hc.apache.org/httpclient-3.x/index.html[HttpClient] with link:https://github.com/FasterXML/jackson[Jackson], the high-performance JSON processor.
