...
For a production instance of MMC, log into the http://www.mulesoft.com/support-login[Customer Portal]. Please link:https://www.mulesoft.com/support-and-services/mule-esb-support-license-subscription[contact the MuleSoft Support team] with any questions about downloading and deploying Mule Management Console.


== Prerequisites

This document assumes that you are have the current version of Mule EE (Enterprise) runtime already installed. Download it from the link:http://www.mulesoft.com/support-login[customer portal] if you need to upgrade to this version. If you are using an older version of Mule Enterprise, please link:/mule-management-console/v/3.3/installing-the-management-console[switch] to that version of this documentation.

This document assumes that your enterprise license is current. See link:https://docs.mulesoft.com/mule-user-guide/v/3.8/installing-an-enterprise-license[Installing an Enterprise License] for information on obtaining and installing an enterprise license. 
...
====
+
. If your link:https://docs.mulesoft.com/mule-user-guide/v/3.8/deployment-scenarios[Mule ESB instance is packaged as a Web app] (not recommended), please open a support case at: link:https://support.mulesoft.com[https://support.mulesoft.com] for special instructions. 
