...
Note that if you have downloaded MMC with Mule runtime from link:https://www.mulesoft.com/dl/mmc[here] – note that version of MMC is appropriate for trial use only and is not considered production-ready. For installation instructions for that trial version, see link:/mule-management-console/v/3.8/installing-the-trial-version-of-mmc[Installing the Trial Version of MMC].
...
====
+
. If your link:/mule-user-guide/v/3.8/deployment-scenarios[Mule ESB instance is packaged as a Web app] (not recommended), please open a support case at: link:https://support.mulesoft.com[https://support.mulesoft.com] for special instructions. 
