...
* the MMC agent
* JMX functionality exposed by Mule. (For more information on JMX management, see the link:https://docs.mulesoft.com/mule-user-guide/v/3.8/jmx-management[JMX Management] page)
