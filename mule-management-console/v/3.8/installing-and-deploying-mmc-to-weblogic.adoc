...
See link:/mule-management-console/v/3.8/installing-the-production-version-of-mmc[Installing the Production Version of MMC] for full details. 
...
* Get familiar with the link:/mule-management-console/v/3.8/orientation-to-the-console[Orientation to the Console].
* Learn the basics of using MMC with the link:/mule-management-console/v/3.8/mmc-walkthrough[MMC Walkthrough].
* Learn more about link:/mule-management-console/v/3.8/setting-up-mmc[Setting Up MMC] to meet your needs.
* Access the link:/mule-management-console/v/3.8/troubleshooting-with-mmc[Troubleshooting with MMC].
