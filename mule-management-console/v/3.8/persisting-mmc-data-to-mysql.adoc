...
* *a Web application server such as Tcat, Tomcat, or JBoss*. Please refer to the Hardware and Software Requirement] for the latest information about hardware requirements and supported application servers, Java Runtime Environments, and browsers.
