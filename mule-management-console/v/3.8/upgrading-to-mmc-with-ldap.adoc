...
If you are upgrading to the latest version of MMC, and your current MMC installation is configured to link:/mule-management-console/v/3.8/setting-up-and-managing-users-via-ldap[manage users via LDAP], you will need to migrate your existing LDAP configuration to your new MMC installation.
...
* Learn how to link:/mule-management-console/v/3.8/upgrading-to-mmc-with-an-external-database[upgrade to MMC with an external database].
