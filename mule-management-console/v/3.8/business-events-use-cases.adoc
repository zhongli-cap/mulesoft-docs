...
For more details about how to define and enable custom or default events in your Mule application, see link:https://docs.mulesoft.com/mule-user-guide/v/3.8/business-events[Business Events].
