...
* link:/mule-management-console/v/3.8/customizing-the-dashboard[Customizable Dashboard]
* link:/mule-management-console/v/3.8/customizing-the-dashboard[Viewing the Custom Dashboard]
* link:/mule-management-console/v/3.8/customizing-the-dashboard[Customizing the Dashboard Display]
