...
* A link:https://docs.mulesoft.com/mule-user-guide/v/3.8/downloading-and-starting-mule-esb[Mule ESB Enterprise] instance with a valid link:https://docs.mulesoft.com/mule-user-guide/v/3.8/installing-an-enterprise-license[enterprise license]
