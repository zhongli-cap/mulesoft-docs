...
You can also use the management console to monitor a cluster. A cluster is a set of Mule instances that acts as a unit. See link:/mule-management-console/v/3.8/monitoring-a-cluster[Monitoring a Cluster] for details.
...
See the link:/mule-management-console/v/3.8/working-with-alerts[Working With Alerts] page for more details on defining and managing alerts. Viewing server-specific alerts is covered in link:/mule-management-console/v/3.8/viewing-server-alerts[Viewing Server Alerts].
