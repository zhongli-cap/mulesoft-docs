...
+
[TIP]
You can also launch the Unix startup scripts with custom parameters, such as special listening ports. The Windows script automatically uses port 8585 for Tomcat and 7777 for Mule.
+
