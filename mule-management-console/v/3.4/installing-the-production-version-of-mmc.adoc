...
The Mule Management Console is a Web app designed to run in an application server or container, such as link:http://docs.mulesoft.com/tcat-server/v/7.1.0[Tcat Server] or http://www.mulesoft.com/understanding-apache-tomcat[Apache Tomcat], and usually packaged in a .war file.
