...
For more information on starting Mule with custom parameters, see link:https://docs.mulesoft.com/mule-user-guide/v/3.4/starting-and-stopping-mule-esb[Starting and Stopping Mule ESB].
====
