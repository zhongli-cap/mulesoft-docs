...
For more information on starting Mule with custom parameters, see link:/mule-fundamentals/v/3.4/starting-and-stopping-mule-esb[Starting and Stopping Mule ESB].
====
