...
This document also assumes that you are familiar with link:https://docs.mulesoft.com/mule-user-guide/v/3.4/mule-concepts[Mule applications and Mule flows].
