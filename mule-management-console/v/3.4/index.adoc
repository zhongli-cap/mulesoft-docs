...
* A link:https://docs.mulesoft.com/mule-user-guide/v/3.4/downloading-and-launching-mule-esb[Mule ESB Enterprise] instance with a valid link:https://docs.mulesoft.com/mule-user-guide/v/3.4/installing-an-enterprise-license[enterprise license]
* The MMC console application file (mmc.war) deployed in a link:https://docs.mulesoft.com/mule-user-guide/v/3.4/hardware-and-software-requirements[supported web application server]
