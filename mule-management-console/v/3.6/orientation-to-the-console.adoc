...
This document also assumes that you are familiar with  link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-concepts[Mule applications and Mule flows] .
