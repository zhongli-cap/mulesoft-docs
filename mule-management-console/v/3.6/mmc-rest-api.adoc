...
This section assumes that you have a clear picture of what link:http://www.mulesoft.org/documentation/display/current/Architecture+of+the+Mule+Management+Console[What MMC is for] and that you have already link:http://www.mulesoft.org/documentation/display/current/Installing+MMC[Installed the Management Console] in your machine.
