...
* A link:https://docs.mulesoft.com/mule-user-guide/v/3.6/downloading-and-starting-mule-esb[Mule ESB Enterprise] instance with a valid link:https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-an-enterprise-license[enterprise license]
* The MMC console application file (mmc.war) deployed in a link:https://docs.mulesoft.com/mule-user-guide/v/3.6/hardware-and-software-requirements[supported web application server]
