...
For more information on starting Mule with custom parameters, see link:/mule-user-guide/v/3.6/starting-and-stopping-mule-esb[Starting and Stopping Mule ESB].
====
