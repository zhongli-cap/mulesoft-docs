...
For more details about how to define and enable custom or default events in your Mule application, see link:/mule\-user\-guide/v/3\.6/business-events[Business Events].
