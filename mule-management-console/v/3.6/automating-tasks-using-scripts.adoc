...
For more information on the cron command and its options, see link:http://www.opensymphony.com/quartz/wikidocs/CronTriggers%20Tutorial.html[Cron Triggers Tutorial]
