...
The ticket file stores information as key=value pairs. For a list of the parameters allowed in this file, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/creating-and-managing-a-cluster-manually[Creating and Managing a Cluster Manually].
...
* Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.6/creating-and-managing-a-cluster-manually[Configuring Cluster Nodes] manually.
