...
[NOTE]
For an overview of clusters, including benefits and best practices, see link:https://docs.mulesoft.com/mule-user-guide/v/3.6/mule-high-availability-ha-clusters[Mule High Availability HA Clusters].
