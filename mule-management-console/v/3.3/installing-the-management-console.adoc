...
You can also deploy the Management Console agent in a link:https://docs.mulesoft.com/mule-user-guide/v/3.3/deployment-scenarios[Mule ESB instance packaged as a Web app].
