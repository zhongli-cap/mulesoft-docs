...
The Mule Management Console in a Web app designed to run in an application server or container, such as link:http://docs.mulesoft.com/tcat-server/v/7.1.0[Tcat Server] or link:https://www.mulesoft.com/tcat/understanding-apache-tomcat[Apache Tomcat], and usually packaged in a `.war` file.
...
(For instructions on setting up Mule for the first time, see link:https://docs.mulesoft.com/mule-user-guide/v/3.8/downloading-and-starting-mule-esb[Downloading Mule ESB].)
...
See link:http://docs.mulesoft.com/tcat-server/v/7.1.0[TCat Server Documentation] for instructions on how to deploy Web applications inside of Tcat.
