...
See link:https://docs.mulesoft.com/mule-user-guide/v/3.3/routing-message-processors[Using Message Processors to Control Message Flow] to find out more about these standard message processors and how to use them to control message flow.
