...
[TIP]
To evaluate Mule high availability clustering, see link:https://docs.mulesoft.com/mule-user-guide/v/3.3/evaluating-mule-high-availability-clusters-demo[Evaluating Mule HA Clustering].
