...
* A link:https://docs.mulesoft.com/mule-user-guide/v/3.5/downloading-and-starting-mule-esb[Mule ESB Enterprise] instance with a valid link:https://docs.mulesoft.com/mule-user-guide/v/3.5/installing-an-enterprise-license[enterprise license]
* The MMC console application file (mmc-3.7.0.war) deployed in a link:https://docs.mulesoft.com/mule-user-guide/v/3.5/hardware-and-software-requirements[supported web application server]
