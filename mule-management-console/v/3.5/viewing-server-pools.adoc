...
The Pools tab displays information about the thread pools used by this Mule ESB instance. For information on configuring thread pools in Mule, see https://docs.mulesoft.com/mule-user-guide/v/3.5/tuning-performance[Tuning Performance] in the Mule User Guide.
