...
[TIP]
You can also create and disband clusters programmatically using the Management Console link:/mule-management-console/v/3.5/rest-api-reference[REST API].
...
The ticket file stores information as key=value pairs. For a list of the parameters allowed in this file, see link:https://docs.mulesoft.com/mule-user-guide/v/3.5/creating-and-managing-a-cluster-manually[Creating and Managing a Cluster Manually].
...
* Read more about link:https://docs.mulesoft.com/mule-user-guide/v/3.5/creating-and-managing-a-cluster-manually[Configuring Cluster Nodes] manually.
* Learn about link:/mule-management-console/v/3.5/deploying-redeploying-or-undeploying-an-application-to-or-from-a-cluster[deploying] and link:/mule-management-console/v/3.5/monitoring-a-cluster[monitoring] clusters.
