...
To set up MMC, you first need to register your Mule servers with MMC. For details on how to do this, see link:/mule-management-console/v/3.7/setting-up-mmc-mule-esb-communications[Setting Up MMC-Mule ESB Communications].
...
* link:/mule-management-console/v/3.7/persisting-mmc-data-to-mysql[MMC version 3.4.2]link:/mule-management-console/v/3.6/persisting-mmc-data-to-oracle[and later]
