...
This section assumes that you have a clear picture of the link:/mule-management-console/v/3.8/architecture-of-the-mule-management-console[basic architecture of MMC] and that you have already installed MMC.
