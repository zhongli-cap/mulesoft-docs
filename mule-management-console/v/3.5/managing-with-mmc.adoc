...
This section assumes that you have a clear picture of the http://www.mulesoft.org/documentation/display/current/Architecture+of+the+Mule+Management+Console[basic architecture of MMC] and that you have already http://www.mulesoft.org/documentation/display/current/Installing+MMC[Installed the Management Console].
