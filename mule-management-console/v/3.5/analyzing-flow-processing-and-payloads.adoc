...
* link:https://docs.mulesoft.com/mule-user-guide/v/3.6/routers[Using Message Processors to Control Message Flow] provides reference information for the available Mule message processors or routers.
