...
* It provides error types that are specific to the File connector, such as FILE:CONNECTIVITY. See link:/intro-error-handlers[Introduction to Mule 4: Error Handlers].
+
...
//TODO: I'M NOT CLEAR HOW YOU COPY ALL FILES IN THE DIR TO A NEW LOCATION.
