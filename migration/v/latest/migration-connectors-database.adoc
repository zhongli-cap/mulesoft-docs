...
Here are some of the main changes to the Database connector from Mule 3 to Mule 4:
...
This section provides examples for these database connection configuration:
