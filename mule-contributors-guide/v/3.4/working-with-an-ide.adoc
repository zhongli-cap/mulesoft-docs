...
. Follow the link:https://docs.mulesoft.com/mule-user-guide/v/3.4/downloading-and-launching-mule-esb[instructions] to download, install and launch Mule Studio.
. Follow link:https://docs.mulesoft.com/mule-user-guide/v/3.4/converting-maven-into-studio[the procedure] to add the *`studio:studio`* plug in in your Maven `settings.xml` file.
