...
Uses an operation's *Error Mapping* fields to map custom error messages to the errors that the operation can return, such as the `CONNECTIVITY` or `REDELIVERY_EXHAUSTED`.
