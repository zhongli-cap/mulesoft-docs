...
| Customizations Separator a| String |  |__|
|===
...
=== Request Level Authentication Parameters
...
=== Request Level Token Based Authentication Parameters
...
| Username a| String |  |  |
| Password a| String |  |  |
| Partner ID a| String |  |  | x
| Partner Account a| String |  |  | x
| Company ID a| String |  |  | x
| User ID a| String |  |  | x
| Key File a| String |  |  | x
| Application ID a| String |  |  | x
| Reconnection Strategy a| * <<reconnect>>
...
| Folder Id a| <<RecordRefDTO>> |  |  `#[payload]` |
| Attributes a| Object |  |  |
