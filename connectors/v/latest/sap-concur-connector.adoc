...
+
image:sap-concur-postman-1[Postman basic auth setup]
+
. Configure the X-ConsumerKey with your Consumer Key in the Concur headers.
+
image:sap-concur-postman-1[Postman Concur header configuration]
+
+
...
----
+
. Put the token in the SAP Concur Connector configuration with the OAuth `0_PijEv7CuZl+123123123=` convention.
