...
. Please use the following step to create an access token for your concur instance.

 .. Specify https://www.concursolutions.com:443/net2/oauth2/accesstoken.ashx in Postman with GET method
 .. Configure the Basic Auth with your username and password
 [postman image 1]
 .. Configure X-ConsumerKey with your Consumer Key in Concur in headers.
  [postman image 2]
 .. You will get the following return from Concur.
 ...
 <Access_Token>
  ...
  .. Put the token in the SAP Concur Connector configuration with the following convention. _Oauth 0_PijEv7CuZl+123123123=_
