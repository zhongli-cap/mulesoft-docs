...
Review the connector operations and functionality using the http://mulesoft.github.io/sqs-connector/[technical reference and demos].
...
. Search for the Amazon SQS connector and click Install.
...
== To Configure a Global Element

You can configure a global element that can be used by all the Amazon SQS connector instances in your Mule project.
...
+
image:sqs-global-type.jpg[sqs-global-type]
+
. Click OK.
...
See the technical reference documentation for the link:http://mulesoft.github.io/sqs-connector/[connector configurations and operations].
...
=== About the Studio Visual Editor View
...
=== To Create a Flow to Send a Message
...
+
image:sqs-transform-message.png[Transform Message Component]
+
...
+
image:sqs-demo-connector-configuration.jpg[sqs-demo-connector-configuration]
+
. Configure the global element properties, then click *OK*.
. Configure the remaining parameters of the connector:
+
image:sqs-send-message.png[Send Message Parameters]
+
[%header,cols="30a,70a"]
|===
|Field |Value
...
+
image:sqs-demo-logger.jpg[sqs-demo-logger]
+
[%header,cols="30a,70a"]
|===
|Field |Value
...
+
image:sqs-demo-get-message-count.jpg[sqs-demo-get-message-count]
+
[%header,cols="30a,70a"]
|===
|Field |Value
...
+
image:sqs-demo-logger2.jpg[sqs-demo-logger2]

=== To Create a Flow to Receive a Message
...
|===
+
*Note:* The Message processor's Queue URL attribute takes precedence over the Global Element Properties Queue URL. If none of the attributes belonging to Global Element Properties, including Queue Name, Queue URL, and the Message Processor's Queue URL is provided, the connector throws an exception.
+
...
+
image:sqs-demo-display-message-handle.jpg[sqs-demo-display-message-handle]
+
[%header,cols="30a,70a"]
|===
|Field |Value
...
+
image:sqs-demo-delete-message.jpg[sqs-demo-delete-message]
+
[%header,cols="30a,70a"]
|===
|Field |Value
...
You can download a fully working example from http://mulesoft.github.io/sqs-connector/[github.io].
