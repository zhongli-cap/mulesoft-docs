...
Connection Pooling allows you to use a set of Mule connections to a server. Pooling can speed operations, such as file transfers between an FTP client and server.
