= Example: To Connect to Gmail over IMAPS
...
. In the General tab for the connection:
+
...
+
. In the Advanced tab for the connection, add the following key/value pair to Properties:
+
...
+
If the connection fails, recheck your settings.
