...
For example, if you've put your ORDERS schema (either overlay or full) under `src/main/app/mypartner/ORDERS.esl, 
your schema location is `${app.home}/mypartner/ORDERS.esl`.
...
* link:/release-notes/edifact-connector-release-notes[EDIFACT EDI Connector Release Notes].
