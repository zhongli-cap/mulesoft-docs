= To List Files in a Directory using the FTP Connector
...
For more on the capabilities of the matcher, see link:ftp-documentation[FTP Connector Documentation Reference].
