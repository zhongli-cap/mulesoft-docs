...
The connector also provides insert, update and delete operations. Just like the link:db-connector-query[select operation], these operations support dynamism and parameterization by using embedded DataWeave transformations:
