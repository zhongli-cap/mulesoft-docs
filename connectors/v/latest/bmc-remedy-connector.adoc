...
|===
+
. Upload the Remedy-java-api-jar to the Remedy configuration and select the specific jar.
+
Example: arapi81_build001-8.1.jar
+
. To make a simple flow, use the Create operation:
+
...
Ensure that this dependency is in your file pom.xml.
