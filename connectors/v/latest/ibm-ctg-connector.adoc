...
+
image:ibm-ctg-ibm-config-dc-2.png[config connector]
+
[%header%autowidth.spread]
|===
|Field |Description
...
+
image:ibm-ctg-ibm-config-dc-1.png[dependency connector]
+
image:ibm-ctg-ibm-config-dc-3.png[dependency connector]
+
[%header%autowidth.spread]
|===
|Field | Description
...
. Configure the Global element for the connector.
+
image:ibm-ctg-ibm-config-studio-1.png[config connector]
+
[%header%autowidth.spread]
|===
|Field |Description
...
image:commareaProgram.png[use-case-1]
...
// ibm-ctg-ctg-use-case-2.png[use-case-2]
...
* link:/anypoint-studio/v/7//studio/7/create-metadata-class-task[Create Metadata]
