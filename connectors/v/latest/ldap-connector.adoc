...
+
image:ldap-install-update-site.png[Anypoint Studio Install Window]
+
* Click Next and accept the License Agreement.
* Restart Studio when prompted.
* The LDAP connector should appear in your Studio Palette:
+
image:ldap-install-palette.png[Anypoint Studio palette - LDAP connector]

Read more about link:/mule-user-guide/v/3.8/installing-connectors[Installing Connectors].
