...
This document assumes you are familiar with Mule, Anypoint Connectors, and Anypoint Studioessentials. Further, this page assumes that you have a basic understanding of Mule flows and global elements.
...
Note: Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to obtain either of these.
...
[[config]]
== To Configure this Connector - Visual Editor

You can configure a global LDAP configuration element that can be used by as many LDAP connectors as you require for your application. Note that this connector supports connection caching, which can be configuring in the Cache Configuration tab of the global element.
...
== To Configure this Connector - XML Editor
...
See a full list of operations for any version of the connector https://mulesoft.github.io/ldap-connector/[here].
...
==== To Use with the Studio Visual Editor
...
|===
+
. Now that we have successfully added the entries, delete them using the LDAP connector.
...
* http://mulesoft.github.io/ldap-connector/[Download a fully functional example].
