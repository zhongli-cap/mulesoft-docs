...
This procedure uses the Delete operation to delete a file that is marked for deletion.
...
* link:to-set-up-a-file-connector-config[To set up a File Connector]
* link:to-create-error-messages[To Create Error Messages]
