...
== To Copy a Project to Studio

After developing your project in Flow Designer, if you want to move your project to 
Anypoint Studio, this section provides the necessary POM file modifications to enable use of 
the Web Service Consumer in Studio.
...
Before adding the Web Service Consumer connector to your Studio project, add the following to your 
