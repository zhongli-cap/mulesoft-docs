...
Read through this user guide to understand how to set up and configure a basic flow using the connector. Track feature additions, compatibility, limitations, and API version updates using the link:/doc/release-notes.adoc[Microsoft Dynamics CRM Connector Release Notes]. 
