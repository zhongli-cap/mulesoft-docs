...
A listener (called `On New or Updated file` in Studio and Flow Designer UI) polls a directory for files that have been created or updated. One message is generated for each file that is found.
