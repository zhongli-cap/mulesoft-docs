...
+
image:netsuite-loginStudio.png[login authentication]
+
[%header,cols="30%,70%"]
|===
...
+
image:netsuite-requestStudio.png[request based authentication]
+
[%header,cols="30%,70%"]
|===
|Parameter |Description
...
.. SSO Authentication
+
image:netsuite-ssoStudio.png[request based authentication]
+
[%header,cols="30%,70%"]
|===
|Parameter |Description
...
+
image:netsuite-tokenStudio.png[request based authentication]
+
[%header,cols="30%,70%"]
|===
|Parameter |Description
