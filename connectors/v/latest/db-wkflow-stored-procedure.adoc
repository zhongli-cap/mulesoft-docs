= Workflow: Use a Stored Procedure

This workflow uses the popular Classic Models MySQL database for example purposes. Generally, you perform the similar tasks regardless of the database.
