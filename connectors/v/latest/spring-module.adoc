...
IMPORTANT: The beans files used with the Spring Module must be exported, if not the application won't start. See link:../mule-user-guide/v.1/how-to-export-resources[How to export resources].
