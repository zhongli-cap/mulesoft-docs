...
This procedure queries the database for product information, logs the names of product lines, and inspects sample output. This procedure builds on the example that connects a Mule app to a database using the Classic Models sample database.
