...
Contact the MuleSoft Sales Team to arrange for either license. 
...
+
image:siebel-sales-config.jpg[siebel-sales-config]
+
[%header%autowidth.spread]
|===
|Attribute |Value
...
* http://docs.oracle.com/cd/E14004_01/books/EAI2/EAI2_UseEAIAdapt5.html[Siebel Query Method]
