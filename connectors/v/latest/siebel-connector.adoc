...
+
image:siebel-new-project1.png[siebel-new-project1]
+
...
See the technical reference documentation for the latest versions below to learn about the data types that the various Siebel connectors expect and return:
