...
NetSuite provides cloud-based business management software that help companies manage core business processes with an integrated system covering ERP and financials, CRM, e-commerce, inventory, and more.
...
* link:/release-notes/netsuite-connector-release-notes[Connector Release Notes]
* link:http://mulesoft.github.io/netsuite-connector/[Technical Reference]
* link:https://www.mulesoft.com/exchange#!/?filters=Netsuite&sortBy=rank[Exchange demo applications]
...
This document assumes that you are familiar with Mule, Anypoint Connectors, the Anypoint Studio interface, Mule flows, and Mule Global Elements. 
...
To use the NetSuite connector in your Mule application, you can configure a global NetSuite element that can be used by all the NetSuite connectors in your project.

You can choose from a list of four Global Elements, each representing a different way of authenticating to NetSuite:
