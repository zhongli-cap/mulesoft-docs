...
IBM MQ, previously know as WebSphere MQ, is the Message Oriented Middleware provided by IBM.
...
any message service which implements the JMS specification.

== Queues - Point-to-point

In the point-to-point or queuing model, a sender posts messages to a particular
