...
You can use the File connector's List operation to list all files in a directory that match file properties. The operation can recurse through subdirectories.
...
* link:/connectors/common-to-match-file-properties[To Match File Properties with a Connector]
