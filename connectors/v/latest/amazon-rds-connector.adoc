...
* You can download a fully functional example from http://mulesoft.github.io/rds-connector/[Mule Amazon RDS Connector on github.io].
...
* MuleSoft maintains this connector under the https://www.mulesoft.com/legal/versioning-back-support-policy#anypoint-connectors[Connector Support Policy - _Select_].
