...
The File connector handle files and folders on a locally mounted file system. Its main features include:
...
This connector is consistent with the FTP connector. They have the same set of operations.
