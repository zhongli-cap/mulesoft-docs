...
[[othello_lines]]
Now assume that you have the text of the entire play in the format shown above, and you use this script to extract all the lines that contain the word `handkerchief`:
