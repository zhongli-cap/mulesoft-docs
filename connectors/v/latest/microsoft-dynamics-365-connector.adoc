...
This document assumes that you are familiar with Mule, Anypoint Connectors, and the Anypoint Studio Essentials.  Further, this page assumes that you have a basic understanding of Mule flows and Mule Global Elements.
...
+
. If needed, set the OAuth tab in Global Element Properties.

To implement OAuth 2.0 in the Connection configuration, you need to use Mule Runtime 3.6.5, 3.7.6, or 3.8.5, or later versions.
...
----
************************************************************
INFO  2017-09-14 22:12:42,003 [main] org.mule.module.launcher.DeploymentDirectoryWatcher: 
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
+ Mule is up and kicking (every 5000ms)                    +
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
INFO  2017-09-14 22:12:42,006 [main] org.mule.module.launcher.StartupSummaryDeploymentListener: 
**********************************************************
*  - - + DOMAIN + - -               * - - + STATUS + - - *
**********************************************************
* default                           * DEPLOYED           *
