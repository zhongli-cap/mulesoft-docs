...
To configure the OAuth 2.0 Connection please follow the instructions from https://beta-mule-sdk.docs-stgx.mulesoft.com/mule-sdk/v/4.0/oauth_configuring.html.
...
For information on setting the Pooling Profile tab, see link:/mule-user-guide/v/4.0/tuning-performance#about-pooling-profiles[About Pooling Profiles].

For information on setting the Reconnection tab, see link:/mule-user-guide/v/4.0/configuring-reconnection-strategies[Configuring Reconnection Strategies].
