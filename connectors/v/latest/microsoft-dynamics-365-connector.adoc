...
////
Described in link:/mule-user-guide/v/3.8/using-a-connector-to-access-an-oauth-api[Using a Connector to Access an OAuth API].
////

To implement OAuth 2.0 in the Connection configuration, you need to use Mule Runtime 3.6.5, 3.7.6 or 3.8.5, or newer versions.
