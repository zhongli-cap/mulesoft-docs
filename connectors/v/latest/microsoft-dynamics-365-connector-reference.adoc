...
* https://msdn.microsoft.com/en-us/library/gg328090.aspx[Create New Entity]
* https://msdn.microsoft.com/en-us/library/mt607875.aspx#Anchor_4[Associate Entity upon Creation]
...
* https://msdn.microsoft.com/en-us/library/gg328090.aspx[Create New Entity]
* https://msdn.microsoft.com/en-us/library/mt607875.aspx#Anchor_4[Associate Entity upon Creation]
* https://msdn.microsoft.com/en-us/library/mt607719.aspx[Batch Request]
...
See: https://msdn.microsoft.com/en-us/library/mt607664.aspx[Delete an Entity]
...
* https://msdn.microsoft.com/en-us/library/mt607664.aspx[Delete an Entity] 
* https://msdn.microsoft.com/en-us/library/mt607719.aspx[Batch Request]
...
* https://msdn.microsoft.com/en-us/library/mt607600.aspx[Use Web API Actions]
...
| Bounded Entity Type a| String | An optional bounded entity type. It must be provided if the action is bounded. |  | An optional bounded entity id. It must be provided if the action is bounded. |  |
| Related Entities a| Object | This is the body that is send in the request as a Map. |  `#[payload]` |
| Target Variable a| String | The name of a variable on which the operation's output is placed |  |
| Target Value a| String | An expression that is evaluated against the operation's output and the outcome of that expression is stored in the target variable |  `#[payload]` |
| Reconnection Strategy a| * <<reconnect>>
* <<reconnect-forever>> |  A retry strategy in case of connectivity errors |  |
...
* https://msdn.microsoft.com/en-us/library/mt607871.aspx[Retrieve an Entity]
...
* https://msdn.microsoft.com/en-us/library/gg334767.aspx[Query Data using the Web API]
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | x
| Datasense Query a| String |  The DSQL query that is going to be used for retrieve. The query is transformed in a retrieve URL internally. |  | x
| Page Size a| Number |  |  5000 |
| Streaming Strategy a| * <<repeatable-in-memory-iterable>>
* <<repeatable-file-store-iterable>>
* <<non-repeatable-iterable>> |  Configure if repeatable streams should be used and their behaviour |  |
...
* https://msdn.microsoft.com/en-us/library/mt607664.aspx[Update Entity] 
* https://msdn.microsoft.com/en-us/library/mt607875.aspx#Anchor_4[Associate Entities upon Update]
* https://msdn.microsoft.com/en-us/library/mt607719.aspx[Batch Request]
...
|===
| Field | Type | Description | Default Value | Required
| Initial Buffer Size a| Number | This is the amount of instances that is initially be allowed to be kept in memory in order to consume the stream and provide random access to it. If the stream contains more data than can fit into this buffer, then it is expanded according to the bufferSizeIncrement attribute, with an upper limit of maxInMemorySize. Default value is 100 instances. |  | 
...
|===
| Field | Type | Description | Default Value | Required
| Max In Memory Size a| Number | This is the maximum amount of instances that is kept in memory. If more than that is required, then it starts to buffer the content on disk. |  | 
