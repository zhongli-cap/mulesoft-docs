...
image:netsuite-loginAuthentication.png[login authentication]
...
image:netsuite-requestBased.png[request based authentication]
...
image:netsuite-tokenBased.png[request based authentication]
...
image:netsuite-libraryUpload.png[library upload]
