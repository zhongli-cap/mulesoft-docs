= To Read then Write Mapped Content
...
. In the Content window, select the Mapping tab at the bottom so that you can provide a mapping between the full record and a partial record.
+
...
----
.. For the Output, create a custom data type that provides a subset of the full input record:
+
----
[
  {
