...
. Provide a Scheduler trigger for your flow with a Fixed Frequency of 1 per second (where Frequency = 1 and Time Unit = Seconds).
+
...
+
icon: image:icon_custom_data_type.png[Customize Data Type icon]
+
