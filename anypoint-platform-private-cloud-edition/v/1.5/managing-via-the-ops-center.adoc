...
You can filter data by *microservice*, this selects between the different sub-components of the platform, such as exchange, API notebooks, or the home page.
...
You can filter data by *nodename*, this selects between the various nodes that make up your platform cluster.
...
You can filter data by *namespace* and *podname*, this allows you to select between the individual docker containers running the different services that make up the platform.
