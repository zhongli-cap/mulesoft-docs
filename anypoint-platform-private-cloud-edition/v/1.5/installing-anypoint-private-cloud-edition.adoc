= Installing Anypoint Platform Private Cloud Edition
...
[NOTE]
====
Before you begin, make sure that you fulfill the link:/anypoint-platform-private-cloud-edition/v/1.5/prerequisites-anypoint-platform-private-cloud[Prerequisites] for installing Anypoint Platform On-premises Edition.
...
[TIP]
If you're not sure how to make a load balancer, see link:/anypoint-platform-private-cloud-edition/v/1.5/creating-load-balancer-onprem[creating a load balancer] for instructions on how to create a basic NGINX load balancer for Anypoint Platform On-premises Edition.
