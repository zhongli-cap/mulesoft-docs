...
[NOTE]
Only VMWare and bare metal are supported by the platform. For information on using VMWare, see link:create-vm-vmware[Creating a Virtual Machine using VMWare].
