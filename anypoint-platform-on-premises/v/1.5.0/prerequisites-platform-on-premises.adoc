...
[TIP]
For a guide to installing on VMWare using an OVA with recommended settings an operating system, see the link:/anypoint-platform-on-premises/v/1.5.0/vmware-ova-guide[VMWare OVA guide].
