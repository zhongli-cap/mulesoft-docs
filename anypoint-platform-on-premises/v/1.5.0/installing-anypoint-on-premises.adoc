...
. After installation is completed, the ops center password has to be reset. Please refer to link:/anypoint-platform-on-premises/v/1.5.0/installing-anypoint-on-premises#reset-ops-center-password[reset-ops-center-password] for more details.
...
Through the Ops center, you can monitor and manage several aspects of your platform.
