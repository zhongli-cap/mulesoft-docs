...
You can add more servers to your platform installation, even after the installation is complete.
...
. Once you do, your server should show up as listed on the UI. Select it and click *Start* to begin the installation on this new server.
