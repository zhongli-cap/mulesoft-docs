...
Once the installation is complete, you're prompted to choose if you want to enable remote help on your application. If you choose to enable this option, this will allow MuleSoft support employees to have access to view info about your platform when and if you request it.
