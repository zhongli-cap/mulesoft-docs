...
For step by step instructions on how to install and configure Anypoint Platform for PCF, see link:/anypoint-platform-on-premises/v/1.5.0/configuring-anypoint-platform-for-pcf[Configuring Anypoint Platform for PCF].
