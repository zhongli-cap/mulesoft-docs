...
before space configuration, after on-prem

https://docs.google.com/document/d/1JiAw5w4rYzufbnQgCU2-tD4uDYwjzRZE8_C3dhIvwbg/edit#heading=h.fgpkgp2uce4j
  ...
  manifest:
    applications:
      ...
      env:
         ...
         COM_MULESOFT_CLOUD_MANAGER_PCF_USERNAME: PCF username and password to have access to current ORG/SPACE
         COM_MULESOFT_CLOUD_MANAGER_PCF_PASSWORD:
         COM_MULESOFT_CLOUD_MANAGER_PCF_SPACE:
         COM_MULESOFT_CLOUD_MANAGER_PCF_ORG:
         COM_MULESOFT_ARMSERVICES_CLIENT_CLIENTID:  `clientId` to access Anypoint platform.
         COM_MULESOFT_ARMSERVICES_CLIENT_CLIENTSECRET: `clientSecret` to access Anypoint platform.
...
The “uuid” is a unique value for a combination of space and Anypoint Platform organization.
====
