...
=== Verify Hazelcast Installation

To verify that your installation was successful, tail the logs of the application after pushing it to PCF and you should find similar entries in the log:
