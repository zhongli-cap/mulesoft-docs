...
* link:_attachments/anypoint-runtime-manager-1.1.0.zip[Anypoint Runtime Manager On Premise Edition]: For installing the reduced verison of the Anypoint Platform, limited only to the Runtime Manager, which manages your deployed applications.
