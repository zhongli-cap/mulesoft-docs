...
This section details connection parameters and recommended settings for connecting to your ARM On-Premise Edition installation. You can complete the steps in this section before or after installing ARM, or you can use your own custom network configuration.
...
== Adding a Server to Your ARM On-Premise Edition

[[download_agent]]
=== Downloading Mule Agent for ARM On-Premise Edition
...
In your ARM On-Premise Edition installation, click *Applications* in the navigation bar and select your environment. Then, select *Servers* in the left-hand menu.
...
For example, the command listed below adds server `testsrv1` to the ARM On-Premise Edition residing on `anypoint.mulesoft.local`:
...
=== Starting and Stopping ARM On-Premise Edition
...
The output below shows the listing for a full running ARM On-Premise Edition installation (only the first five columns are displayed).
