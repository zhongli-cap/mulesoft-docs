...
+
[TIP]
The demo installation includes its own LDAP server to use together with it. See link:/anypoint-platform-on-premises/v/1.5/demo-ldap-server[Demo LDAP Server] for details on what it contains and how to use it.
