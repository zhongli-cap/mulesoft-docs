...
* A _1 node_ installation is instanced as a demo

+
[TIP]
Demo installations includes its own LDAP server to use together with it.
...
. To register your servers, you must run a code in the command line of each, with admin permissions. This code is presented to you on this screen with your specific credentials:
