...
[NOTE]
Setting this up is an optional step when link:/anypoint-platform-on-premises/v/1.5/configuring-anypoint-platform-for-pcf[configuring Anypoint Platform for PCF]. You need this in case you plan to deploy your applications to clusters on PCF.
