...
Once in one of the dashboards, you can navigate it by selecting a *namespace*. In some dashboards, you can also select an individual element, such as an individual podname. The displayed data is always in reference to one of these, and by selecting a different one you're choosing to view the data corresponding to it
