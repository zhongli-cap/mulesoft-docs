...
This document assumes that you are familiar with Maven, and that you have link:/anypoint-studio/v/5/maven-support-in-anypoint-studio[Maven Support in Anypoint Studio] enabled.
...
* Learn how to migrate link:/anypoint-studio/v/5/importing-a-maven-project-into-studio[a Maven project into Studio].

* Learn how to link:/anypoint-studio/v/5/building-a-mule-application-with-maven-in-studio[build new Maven projects] directly in Studio.
