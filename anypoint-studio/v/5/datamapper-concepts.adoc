...
[TIP]
====
For instructions on how to do this see the link:/mule-user-guide/v/3.7/anypoint-connector-tutorial[Anypoint Connector Tutorial], under the section *Obtaining Access to the Twitter API*.
====
+
