...
[TIP]
====
For instructions on how to do this see link:/quickstarts/anypoint-connector[Anypoint Connector quickstart], under the section *Obtaining Access to the Twitter API*.
====
+
