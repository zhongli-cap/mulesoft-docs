...
* Start learning how to use Maven with Mule link:/anypoint-studio/v/5/maven-support-in-anypoint-studio[here].
...
* Start learning how to use Subversion with Studio link:/anypoint-studio/v/5/using-subversion-with-studio[here].
...
No. Studio does not require any customer specific license keys. Just download Studio link:https://www.mulesoft.com/platform/studio[here] and start learning how to use it link:/anypoint-studio/v/5/index[here].
...
3. Click the "Create New Case" button, at the right of the page header.

4. Fill out the required information (marked by an asterisk(*)). Our support team will respond soon.
...
* link:/mule-user-guide/v/3.7/anypoint-platform-primer[Anypoint Platform Primer]
* link:/mule-user-guide/v/3.7/begin-with-the-basics[Begin with the Basics]
* link:/mule-user-guide/v/3.7/build-a-hello-world-application[Build a Hello World Application]
