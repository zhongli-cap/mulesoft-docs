...
To deploy a project that includes DataMapper and is built with Mule Runtime 3.6 or older in one of your own servers, you must link:/anypoint-studio/v/5/including-the-datamapper-plugin[Include the DataMapper Plugin]
...
[TIP]
====
For an introduction to the DataMapper graphical interface and basic concepts, see link:/anypoint-studio/v/5/datamapper-concepts[DataMapper Concepts]. For a complete description of DataMapper's graphical interface, see link:/anypoint-studio/v/5/datamapper-visual-reference[DataMapper Visual Reference].
====
