...
* Learn how to build a complete link:/anypoint-studio/v/5/building-a-mule-application-with-maven-in-studio[Studio Maven Project], including tests and dependencies.
...
* Explore how to use link:/anypoint-studio/v/5/using-subversion-with-studio[Studio and Subversion].
