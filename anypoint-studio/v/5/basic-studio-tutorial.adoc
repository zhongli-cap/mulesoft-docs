...
able to apply what you learn to create link:/quickstarts/content-based-routing[more complex applications].
...
Congratulations! You're all set to go on to the link:/quickstarts/content-based-routing[Content-Based Routing Tutorial].
