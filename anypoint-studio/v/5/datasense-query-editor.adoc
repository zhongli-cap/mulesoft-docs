...
* *link:/anypoint-studio/v/5/datasense-query-language[DataSense Query Language]*  allows you to perform queries using SQL elements and syntax. Using the DataSense query language, you can use the Query Editor's graphical interface for almost all operations. 
