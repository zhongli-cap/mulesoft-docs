...
Find out more about using expressions to access and manipulate the Mule message in the link:/mule-user-guide/v/3.7/mule-message-tutorial[Mule Message Tutorial].

== See Also 

* *NEXT STEP:* link:/mule-user-guide/v/3.7/build-a-hello-world-application[Build an application in Anypoint Studio].
