...
=== Connecting to the Remote Mule Runtime Server

Before accessing and debugging your application on a remote server, you must first link:/mule-management-console/v/3.9/deploying-applications[export and deploy] your application to the desired Mule ESB server.
...
* *Host:* indicates the location of the remote Mule Runtime server
* *Port:* indicates the listening port for the remote Mule Runtime server
