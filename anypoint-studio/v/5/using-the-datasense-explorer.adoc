...
This document assumes you are familiar with Mule ESB and the link:/anypoint-studio/v/5/index[Studio interface]. Further, it assumes you have read the link:/mule-fundamentals/v/3.7/mule-message-structure[Mule Message Structure document] to understand the contents of a Mule message. To increase your familiarity with Studio, consider reading link:/anypoint-studio/v/5/index[Anypoint Studio Essentials]. 
