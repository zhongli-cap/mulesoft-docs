...
* link:/mule-user-guide/v/3.7/build-a-hello-world-application[Build an application in Anypoint Studio].
* link:/mule-user-guide/v/3.7/setting-up-your-dev-environment[Setting Up Your Development Environment]
