...
You should not remove this configuration when using a proxy. Otherwise the embeded Mule Runtime within Studio won't be able to reach your developing application.
|===
