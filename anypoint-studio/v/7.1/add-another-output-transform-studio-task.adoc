...
* link:/anypoint-studio/v/7.1/transform-message-component-concept-studio[Transform Message Component]
* link:/anypoint-studio/v/7.1/change-target-output-transformation-studio-task[Change the Target Output of a Transformation]
