...
* *link:/anypoint-studio/v/6/datasense-query-language[DataSense Query Language]*  allows you to perform queries using link:http://en.wikipedia.org/en/wiki/SQL[SQL] elements and syntax. Using the DataSense query language, you can use the Query Editor's graphical interface for almost all operations. 
...
* Learn more about the Query Editor's link:/anypoint-studio/v/6/datasense-query-language[DataSense Query Language]. 
* Learn more about link:/anypoint-studio/v/6/datasense[DataSense].
