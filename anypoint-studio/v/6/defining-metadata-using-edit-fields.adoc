...
[TIP]
====
This document assumes the reader is familiar with the DataMapper Transformer. Consult the link:/anypoint-studio/v/6/datamapper[DataMapper User Guide and Reference] document for details.
====
