...
* Learn more about link:/mule-user-guide/v/3.8/importing-a-maven-project-into-studio[importing Maven projects into Studio] or link:/anypoint-studio/v/6/enabling-maven-support-for-a-studio-project["mavenizing" existing Studio projects].
