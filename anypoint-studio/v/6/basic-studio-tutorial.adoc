...
able to apply what you have learned to create link:/mule-user-guide/v/3.8/content-based-routing-tutorial[more complex applications].
...
Congratulations! You're all set to go on to the link:/mule-user-guide/v/3.8/content-based-routing-tutorial[Content-Based Routing Tutorial].
...
* Learn about routing information: link:/mule-user-guide/v/3.8/content-based-routing-tutorial[Content-Based Routing Tutorial].
