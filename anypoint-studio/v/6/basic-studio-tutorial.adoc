...
able to apply what you have learned to create link:/quickstarts/content-based-routing[more complex applications].
...
Congratulations! You're all set to go on to the link:/quickstarts/content-based-routing[Content-Based Routing].
...
* Learn about routing information: link:/quickstarts/content-based-routing[Content-Based Routing].
