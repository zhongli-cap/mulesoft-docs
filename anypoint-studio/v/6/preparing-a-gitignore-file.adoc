...
This document assumes familiarity with link:http://git-scm.com/[git] as a software version control system, and that you are using link:/anypoint-studio/v/6[Anypoint Studio] to build a new application that you intend to manage using git.
