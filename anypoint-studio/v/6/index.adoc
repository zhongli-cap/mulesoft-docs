...
For the HTTP connector, first click the *Connector Configuration* green plus sign, which displays the additional Global Element Properties screen to enter the host and port.
