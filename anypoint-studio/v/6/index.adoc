...
Find out more about using expressions to access and manipulate the Mule message in the link:/mule-user-guide/v/3.8/mule-message-tutorial[Mule Message Tutorial].
