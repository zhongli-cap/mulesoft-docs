...
The same editor also allows you to edit API definition files (in link:raml.org[RAML]) files, create domains that define link:/mule-user-guide/v/3.8/shared-resources[shared resources]. As a beta feature, with the latest release you can also create link:/api-manager/creating-acustom-policy[API custom policies].
