...
. Configure link:/anypoint-studio/v/6/api-sync-reference[API Sync] and link:/api-manager/api-Autodiscovery[API Autodiscovery] for APIs in your Private Cloud Edition platform.
