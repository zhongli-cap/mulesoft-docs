...
. Access your On-Premises link:/anypoint-exchange/anypoint-exchange[Exchange] Artifacts.

=== Customize the Exchange Address

You can change the default location of link:/anypoint-exchange/anypoint-exchange[Anypoint Exchange] to point to a private version of exchange.
