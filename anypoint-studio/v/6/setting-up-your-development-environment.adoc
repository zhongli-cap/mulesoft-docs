...
link:/release-notes/anypoint-studio-6.2-with-3.8.3-runtime-release-notes[Anypoint Studio 6.2] and higher support the link:/anypoint-platform-private-cloud-edition/v/1.5/[On-Premises Edition] of Anypoint Platform.
