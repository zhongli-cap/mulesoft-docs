...
. Click *OK*. At this point, the mapping is complete. Running a link:/anypoint-studio/v/6/using-dataweave-in-studio#the-preview-section[preview] of the mapping gives the following result:
+
[source, code, linenums]
----
