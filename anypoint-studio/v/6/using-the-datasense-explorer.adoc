...
This document assumes you are familiar with Mule and the link:/anypoint-studio/v/6/[Studio interface]. Further, it assumes you have read the link:/mule-fundamentals/v/3.8/mule-message-structure[Mule Message Structure document] to understand the contents of a Mule message. To increase your familiarity with Studio, consider reading link:/anypoint-studio/v/6/[Anypoint Studio Essentials]. 
