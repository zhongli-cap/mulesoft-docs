...
Once connected you will see "Connected with Mule. Waiting for a Mule Message to arrive" as the watermark background on Mule Debug perspective.

Note that this won't stop on java break points. If you want both types of breakpoints to work (mule and java) you need to connect both debuggers in different ports at the same time using the below example configuration in the wrapper.conf:
...
Remote Mule Application will connect to 5005 and Remote Java Application will use 5006
