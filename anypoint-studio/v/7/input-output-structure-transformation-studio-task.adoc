...
+
See link:/anypoint-studio/v/7/defining-metadata[Defining Metadata].
...
See link:/mule-user-guide/v/4.0/dataweave-xml-reference#defining-metadata-via-xml[DataWeave XML Reference].
