...
* Explore link:/anypoint-studio/v/6.5/datasense[DataSense], another tool to facilitate development of applications with fewer bugs at runtime
* Use Studio, including Studio Visual Debugger, as an link:/anypoint-studio/v/6.5/studio-in-eclipse[Eclipse plugin].
