...
The images below illustrate DataMapper's link:/anypoint-studio/v/6.5/datamapper-visual-reference[Script view] displaying the same mapping, in CTL2 (below, at top) and MEL (below, at bottom.
