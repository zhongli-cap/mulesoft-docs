...
* Learn how to link:/anypoint-studio/v/6.5/maven-support-in-anypoint-studio[configure your Studio Preferences to work with Maven].
* Learn how to link:/anypoint-studio/v/6.5/enabling-maven-support-for-a-studio-project["mavenize" an existing Anypoint Studio project].

* Learn how to link:/anypoint-studio/v/6.5/importing-a-maven-project-into-studio[import an existing Maven project into Anypoint Studio].
