...
* Learn how to build a complete link:/anypoint-studio/v/6.5/building-a-mule-application-with-maven-in-studio[Studio Maven Project], including tests and dependencies.
* Learn how to link:/anypoint-studio/v/6.5/enabling-maven-support-for-a-studio-project["mavenize" an existing Mule project].
