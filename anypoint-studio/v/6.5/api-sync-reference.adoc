...
. The project can be link:/anypoint-studio/v/6.5/importing-and-exporting-in-studio#exporting-projects-from-studio[exported from your environment] and imported into another user's project.
