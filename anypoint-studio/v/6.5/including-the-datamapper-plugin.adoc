...
DataMapper is deprecated as of Mule runtime 3.7.0 and superseded by the link:/anypoint-studio/v/6.5/transform-message-component-concept-studio[Transform Message Component]. 
