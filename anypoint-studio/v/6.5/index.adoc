...
[TIP]
Anypoint Studio 6.5 updates its' base Eclipse version. It is recommended to run a fresh install.
...
. *Connection Explorer*
. *Console*
. link:/anypoint-studio/v/6.5/#properties-editor[*Properties Editor*]
. *DataSense Explorer*
...
* link:/anypoint-studio/v/6.5/anypoint-studio-features[Studio Features]
