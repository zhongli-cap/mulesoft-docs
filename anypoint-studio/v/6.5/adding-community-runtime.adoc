...
* Access a list of all the link:/anypoint-studio/v/6.5/studio-update-sites[update sites] available for your version of Anypoint Studio.
* link:/mule-user-guide/v/3.8/installing[Which version of Mule am I using?]
* Read a link:http://blogs.mulesoft.com/dev/mule-dev/one-studio/[blog post] and/or release strategy explaining the Single Studio distribution.
