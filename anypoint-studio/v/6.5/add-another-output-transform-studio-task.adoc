...
* link:/anypoint-studio/v/6.5/transform-message-component-concept-studio[Transform Message Component]
* link:/anypoint-studio/v/6.5/change-target-output-transformation-studio-task[Change the Target Output of a Transformation]
