...
This document assumes you are familiar with Mule and the link:/anypoint-studio/v/6.5/[Studio interface]. Further, it assumes you have read the link:/mule-user-guide/v/3.8/mule-message-structure[Mule Message Structure document] to understand the contents of a Mule message. To increase your familiarity with Studio, consider reading link:/anypoint-studio/v/6.5/[Anypoint Studio Essentials]. 
...
* Need more information about the payload or metadata? Try running your application in link:/anypoint-studio/v/6.5/studio-visual-debugger[Debug mode] to inspect your message contents step by step at runtime.
