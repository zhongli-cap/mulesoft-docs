...
[NOTE]
This page describes a feature that is currently available using *Mule Studio (December 2013)* or newer.  Download and launch the link:https://www.mulesoft.com/platform/studio[latest version of Anypoint Studio] to take advantage of this feature.
...
This document assumes familiarity with link:https://git-scm.com/[git] as a software version control system, and that you are using link:/anypoint-studio/v/6[Anypoint Studio] to build a new application that you intend to manage using git.
...
* Learn about link:/anypoint-studio/v/6.5/using-subversion-with-studio[Using Subversion with Studio].
