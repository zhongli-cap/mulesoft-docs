...
* See link:/anypoint-studio/v/6.0/download-and-launch-anypoint-studio[Download Anypoint Studio] for detailed instructions

* If you have any extensions you wish to add to Studio, such as premium connectors or the enterprise security package, see link:/anypoint-studio/v/6.0/installing-extensions[Installing Extensions]

=== Adding Mule Runtimes

* Anypoint Studio always comes bundled with the latest enterprise version of the Mule Runtime. If you wish to install any prior or beta version of the Runtime to develop applications with it in Studio, see link:/anypoint-studio/v/6.0/studio-update-sites[Studio Update Sites].

* If you wish to develop applications with the free Community version of the Mule Runtime, see link:/anypoint-studio/v/6.0/adding-community-runtime[Installing Community Edition of Mule Runtime]
...
* Start learning how to use Maven with Mule link:/anypoint-studio/v/6.0/using-maven-in-anypoint-studio[here].
...
* Start learning how to use Subversion with Studio link:/anypoint-studio/v/6.0/using-subversion-with-studio[here].
...
No. Studio does not require any customer specific license keys. Just download Studio link:https://www.mulesoft.com/platform/studio[here] and start learning how to use it link:/anypoint-studio/v/6.0/anypoint-studio-essentials[here].
