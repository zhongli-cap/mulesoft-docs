...
* Perceptive Flow Design only functions with Anypoint connectors which support link:/anypoint-studio/v/6.0/testing-connections[connection testing]. See link:/anypoint-studio/v/6.0/datasense-enabled-connectors[the list].
...
+
. Configure the Salesforce connector, and its corresponding global connector, then test the connection to confirm communication. Refer to link:/anypoint-studio/v/6.0/testing-connections[Testing Connections] for details.
...
** clicking the *Define Metadata* link in the input section of the Transform Message component. See link:/anypoint-studio/v/6.0/using-dataweave-in-studio#defining-input-and-output-structure[Using DataWeave in Studio]
