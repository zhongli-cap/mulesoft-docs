...
.. Enter a link:/anypoint-studio/v/6.0/studio-update-sites[specific update site URL] from which you wish to download a plugin, module, or connector
...
* link:/anypoint-studio/v/6.0/adding-community-runtime[Mule Community Runtime]  
