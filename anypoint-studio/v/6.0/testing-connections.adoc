...
* Connection testing functionality is only available in link:/mule-fundamentals/v/3.8/anypoint-studio-essentials[Studio's Visual Editor].



== See Also

* Learn how to exploit link:/anypoint-studio/v/6.0/using-perceptive-flow-design[DataSense Perceptive Flow Design].
* Review the link:/anypoint-studio/v/6.0/datasense[DataSense] functionality. 
