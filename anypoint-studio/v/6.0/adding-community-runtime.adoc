= Installing Community Edition of Mule Runtime
:keywords: installing, community runtime, ce, open source

*Anypoint Studio* comes bundled with an embedded Enterprise runtime with a 30-day Enterprise trial license. You can add Community runtime to your Anypoint Studio instance to build and test applications in Mule's free, open-source runtime environment.

[TIP]
The steps explained in this document are also valid for downloading and installing earlier versions of the Mule runtime, whether Enterprise or Community versions.
...
* Access a list of all the link:/anypoint-studio/v/6.0/studio-update-sites[update sites] available for your version of Anypoint Studio.
